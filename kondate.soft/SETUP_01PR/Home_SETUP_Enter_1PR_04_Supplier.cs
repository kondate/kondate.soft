...
{
    public partial class Home_SETUP_Enter_1PR_04_Supplier : Form
    {
        //Move Form ====================================
        ...
        public Home_SETUP_Enter_1PR_04_Supplier()
        {
            InitializeComponent();
        }
        ...
        private void BtnNew_Click(object sender, EventArgs e)
        {
            ...
            this.Hide();
            var frm2 = new Home_SETUP_Enter_1PR_04_Supplier();
        ...
        private void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                this.txtsupplier_branch_name.Text = "สำนักงานใหญ่";
            }
            if (this.chsupplier_branch.Checked == true)
            {
                this.txtsupplier_branch_name.Text = this.txtsupplier_branch_id.Text.Trim();
            }
            //======================================================
            //เชื่อมต่อฐานข้อมูล=======================================================
            //SqlConnection conn = new SqlConnection(KRest.W_ID_Select.conn_string);
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                try
                {
                    if (this.iblword_status.Text.Trim() == "เพิ่ม Supplier ใหม่")
                    {
                        ...
                        cmd2.Parameters.Add("@txtsupplier_branch_name", SqlDbType.NVarChar).Value = this.txtsupplier_branch_name.Text.ToString();
                        ...
                        cmd2.Parameters.Add("@txtsupplier_registered_capital", SqlDbType.Float).Value = Convert.ToDouble(string.Format("{0:n4}", this.txtsupplier_registered_capital.Text.ToString()));
                    ...
                    if (this.iblword_status.Text.Trim() == "แก้ไขSupplier")
                    {
                        ...
                        cmd2.CommandText = "UPDATE k016db_2supplier_address SET " +
                                                                     ...
                                                                     "txtsupplier_branch_name = '" + this.txtsupplier_branch_name.Text.Trim() + "'," +
                        ...
                        cmd2.CommandText = "UPDATE k016db_4supplier_detail SET " +
                                                                     ...
                                                                     "txtsupplier_registered_capital = '" + Convert.ToDouble(string.Format("{0:n4}", this.txtsupplier_registered_capital.Text.ToString())) + "'," +
        ...
        private void PANEL1310_CODE_BANK_BRANCH_GridView1_code_bank_branch()
        {
            ...
            this.PANEL1310_CODE_BANK_BRANCH_dataGridView1_code_bank_branch.GridColor = Color.FromArgb(227, 227, 227);
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            GridView1.Rows[index].Cells["Col_txtsupplier_no"].Value = dt2.Rows[j]["txtsupplier_no"].ToString();      //1
                             GridView1.Rows[index].Cells["Col_txtsupplier_id"].Value = dt2.Rows[j]["txtsupplier_id"].ToString();      //2
                            GridView1.Rows[index].Cells["Col_txtsupplier_name"].Value = dt2.Rows[j]["txtsupplier_name"].ToString();      //3
                            GridView1.Rows[index].Cells["Col_txtsupplier_name_eng"].Value = dt2.Rows[j]["txtsupplier_name_eng"].ToString();      //4
                            ...
                            GridView1.Rows[index].Cells["Col_txtsupplier_status"].Value = dt2.Rows[j]["txtsupplier_status"].ToString();      //8
                        }
                        //=======================================================
                        Cursor.Current = Cursors.Default;
        ...
        private void PANEL_FORM1_GridView1()
        {
            ...
            this.GridView1.Columns[1].Name = "Col_txtsupplier_no";
            this.GridView1.Columns[2].Name = "Col_txtsupplier_id";
            this.GridView1.Columns[3].Name = "Col_txtsupplier_name";
            this.GridView1.Columns[4].Name = "Col_txtsupplier_name_eng";
            ...
            this.GridView1.Columns[8].Name = "Col_txtsupplier_status";

            this.GridView1.Columns[0].HeaderText = "No";
            this.GridView1.Columns[1].HeaderText = "ลำดับ";
            this.GridView1.Columns[2].HeaderText = " รหัส";
            this.GridView1.Columns[3].HeaderText = " ชื่อ Supplier";
            this.GridView1.Columns[4].HeaderText = " ชื่อ Supplier Eng";
            ...
            this.GridView1.Columns[1].Visible = true;  //"Col_txtsupplier_no";
            ...
            this.GridView1.Columns[2].Visible = true;  //"Col_txtsupplier_id";
            ...
            this.GridView1.Columns[3].Visible = true;  //"Col_txtsupplier_name";
            ...
            this.GridView1.Columns[4].Visible = false;  //"Col_txtsupplier_name_eng";
            ...
            this.GridView1.Columns[8].Visible = false;  //"Col_txtsupplier_status";
