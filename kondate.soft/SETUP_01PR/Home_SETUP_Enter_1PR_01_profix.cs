...
{
    public partial class Home_SETUP_Enter_1PR_01_profix : Form
    {
        //Move Form ====================================
        ...
        public Home_SETUP_Enter_1PR_01_profix()
        {
            InitializeComponent();
        }

        private void Home_SETUP_Enter_1PR_01_Load(object sender, EventArgs e)
        {
            W_ID_Select.M_FORM_NUMBER = "S101";
            CHECK_ADD_FORM();


            //MessageBox.Show("" + W_ID_Select.M_USERNAME_TYPE.Trim() +"");
            CHECK_USER_RULE();
            ...
            this.iblword_status.Text = "เพิ่มคำนำหน้าใหม่";
            this.txtprefix_id.ReadOnly = false;

            this.ActiveControl = this.txtprefix_id;
        ...
        private void Run_ID()
        {
            if (this.txtprefix_no.Text == "")
            {
                this.txtprefix_no.Text = "001";
            }
            ...
            if (this.txtprefix_no.Text == "999")
            {
                this.txtprefix_no.Text = "998";
            }
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            //this.PANEL_FORM1_dataGridView1.Columns[1].Name = "Col_txtprefix_no";
                            //this.PANEL_FORM1_dataGridView1.Columns[2].Name = "Col_txtprefix_id";
                            //this.PANEL_FORM1_dataGridView1.Columns[3].Name = "Col_txtprefix_name";
                            //this.PANEL_FORM1_dataGridView1.Columns[4].Name = "Col_txtprefix_name_eng";
                            //this.PANEL_FORM1_dataGridView1.Columns[5].Name = "Col_txtprefix_name_remark";
                            //this.PANEL_FORM1_dataGridView1.Columns[6].Name = "Col_txtprefix_status";

                            var index = GridView1.Rows.Add();
                            GridView1.Rows[index].Cells["Col_Auto_num"].Value = ""; //0
                            GridView1.Rows[index].Cells["Col_txtprefix_no"].Value = dt2.Rows[j]["txtprefix_no"].ToString();      //1
                            GridView1.Rows[index].Cells["Col_txtprefix_id"].Value = dt2.Rows[j]["txtprefix_id"].ToString();      //2
                            GridView1.Rows[index].Cells["Col_txtprefix_name"].Value = dt2.Rows[j]["txtprefix_name"].ToString();      //3
                            GridView1.Rows[index].Cells["Col_txtprefix_name_eng"].Value = dt2.Rows[j]["txtprefix_name_eng"].ToString();      //4
                            GridView1.Rows[index].Cells["Col_txtprefix_name_remark"].Value = dt2.Rows[j]["txtprefix_name_remark"].ToString();      //5
                            GridView1.Rows[index].Cells["Col_txtprefix_status"].Value = dt2.Rows[j]["txtprefix_status"].ToString();      //6
        ...
        private void PANEL_FORM1_GridView1()
        {
            ...
            this.GridView1.Columns[1].Name = "Col_txtprefix_no";
            this.GridView1.Columns[2].Name = "Col_txtprefix_id";
            this.GridView1.Columns[3].Name = "Col_txtprefix_name";
            this.GridView1.Columns[4].Name = "Col_txtprefix_name_eng";
            this.GridView1.Columns[5].Name = "Col_txtprefix_name_remark";
            this.GridView1.Columns[6].Name = "Col_txtprefix_status";

            this.GridView1.Columns[0].HeaderText = "No";
            this.GridView1.Columns[1].HeaderText = "ลำดับ";
            this.GridView1.Columns[2].HeaderText = " รหัส";
            this.GridView1.Columns[3].HeaderText = " ชื่อคำนำหน้า";
            this.GridView1.Columns[4].HeaderText = "ชื่อคำนำหน้า Eng";
            ...
            this.GridView1.Columns[1].Visible = true;  //"Col_txtprefix_no";
            ...
            this.GridView1.Columns[2].Visible = true;  //"Col_txtprefix_id";
            ...
            this.GridView1.Columns[3].Visible = true;  //"Col_txtprefix_name";
            ...
            this.GridView1.Columns[4].Visible = true;  //"Col_txtprefix_name_eng";
            ...
            this.GridView1.Columns[5].Visible = true;  //"Col_txtprefix_name_remark";
            ...
            this.GridView1.Columns[6].Visible = false;  //"Col_txtprefix_status";
        ...
        private void PANEL_FORM1_dataGridView1_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                if (cell != null)
                {
                    ...
                    this.txtprefix_no.Text = row.Cells[1].Value.ToString();
                    this.txtprefix_id.Text = row.Cells[2].Value.ToString();
                    this.txtprefix_name.Text = row.Cells[3].Value.ToString();
                    ...
                    if (conn.State == System.Data.ConnectionState.Open)
                    {
                        ...
                        cmd2.CommandText = "SELECT *" +
                                            " FROM k016db_supplier_1profix" +
                                             //" WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                             //" AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                             " WHERE (txtprefix_id = '" + this.txtprefix_id.Text.Trim() + "')" +
                                           " ORDER BY txtprefix_no ASC";
                        ...
                        try
                        {
                            ...
                            if (dt2.Rows.Count > 0)
                            {
                                for (int j = 0; j < dt2.Rows.Count; j++)
                                {
                                    this.txtprefix_no.Text = dt2.Rows[j]["txtprefix_no"].ToString();      //1
                                    this.txtprefix_id.Text = dt2.Rows[j]["txtprefix_id"].ToString();      //2
                                    this.txtprefix_name.Text = dt2.Rows[j]["txtprefix_name"].ToString();      //3
                                    this.txtprefix_name_eng.Text = dt2.Rows[j]["txtprefix_name_eng"].ToString();      //4
                                    this.txtprefix_name_remark.Text = dt2.Rows[j]["txtprefix_name_remark"].ToString();      //5
                                }
                                this.iblword_status.Text = "แก้ไขคำนำหน้า";
                                this.BtnCancel_Doc.Enabled = true;
                                this.txtprefix_id.ReadOnly = true;
                                //=======================================================
                            }
                            else
                            {
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                cmd2.CommandText = "SELECT *" +
                                    " FROM k016db_supplier_1profix" +
                                     //" WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                     //" AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                     " WHERE (txtprefix_name LIKE '%" + this.PANEL_FORM1_txtsearch.Text.Trim() + "%')" +
                                   " ORDER BY txtprefix_no ASC";
        ...
        private void BtnNew_Click(object sender, EventArgs e)
        {
            ...
            this.Hide();
            var frm2 = new Home_SETUP_Enter_1PR_01_profix();
        ...
        private void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            if (this.txtprefix_no.Text == "")
            {
                ...
                this.txtprefix_no.Focus();
                return;
            }
            else
            {
                if (this.txtprefix_no.TextLength == 3)
                {
                }
                else
                {
            ...
            if (this.txtprefix_id.Text == "")
            {
                MessageBox.Show("โปรดใส่รหัสคำนำหน้า ก่อน !", "ผลการทำงาน", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                this.txtprefix_id.Focus();
                return;
            }
            if (this.txtprefix_name.Text == "")
            {
                MessageBox.Show("โปรดใส่ชื่อคำนำหน้าก่อน !", "ผลการทำงาน", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                this.txtprefix_name.Focus();
                return;
            }
            //======================================================
            //เชื่อมต่อฐานข้อมูล=======================================================
            ...
            if (this.iblword_status.Text.Trim() == "เพิ่มคำนำหน้าใหม่")
            {
                conn.Open();
                if (conn.State == System.Data.ConnectionState.Open)
                {
                    ...
                    cmd1.CommandText = "SELECT * FROM k016db_supplier_1profix" +
                                       // " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                       //" AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                       " WHERE (txtprefix_id = '" + this.txtprefix_id.Text.Trim() + "')";
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        MessageBox.Show("รหัสคำนำหน้า นี้ซ้ำ   : '" + this.txtprefix_id.Text.Trim() + "' โปรดใส่ใหม่ ", "ผลการทำงาน", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                        this.txtprefix_id.Focus();
                        conn.Close();
                        return;
                    }
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                try
                {
                    if (this.iblword_status.Text.Trim() == "เพิ่มคำนำหน้าใหม่")
                    {
                        cmd2.CommandText = "INSERT INTO k016db_supplier_1profix(cdkey,txtco_id," +  //1
                                           "txtprefix_no,txtprefix_id," +  //2
                                           "txtprefix_name,txtprefix_name_eng," +  //3
                                           "txtprefix_name_remark," +  //4
                                          "txtprefix_status) " +  //5
                        ...
                        cmd2.Parameters.Add("@txtprefix_no", SqlDbType.NVarChar).Value = this.txtprefix_no.Text.ToString();
                        cmd2.Parameters.Add("@txtprefix_id", SqlDbType.NVarChar).Value = this.txtprefix_id.Text.ToString();
                        cmd2.Parameters.Add("@txtprefix_name", SqlDbType.NVarChar).Value = this.txtprefix_name.Text.ToString();
                        cmd2.Parameters.Add("@txtprefix_name_eng", SqlDbType.NVarChar).Value = this.txtprefix_name_eng.Text.ToString();
                        cmd2.Parameters.Add("@txtprefix_name_remark", SqlDbType.NVarChar).Value = this.txtprefix_name_remark.Text.ToString();
                        cmd2.Parameters.Add("@txtprefix_status", SqlDbType.NChar).Value = "0";
                        //==============================

                        cmd2.ExecuteNonQuery();

                    }
                    if (this.iblword_status.Text.Trim() == "แก้ไขคำนำหน้า")
                    {
                        cmd2.CommandText = "UPDATE k016db_supplier_1profix SET " +
                                                                     "txtprefix_no = '" + this.txtprefix_no.Text.Trim() + "'," +
                                                                     "txtprefix_name = '" + this.txtprefix_name.Text.Trim() + "'," +
                                                                     "txtprefix_name_eng = '" + this.txtprefix_name_eng.Text.Trim() + "'," +
                                                                     "txtprefix_name_remark = '" + this.txtprefix_name_remark.Text.ToString() + "'" +
                                                                   // " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                                                   //" AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                                                   " WHERE (txtprefix_id = '" + this.txtprefix_id.Text.Trim() + "')";
                        cmd2.ExecuteNonQuery();
                    ...
                    if (dialogResult == DialogResult.Yes)
                    {
                        ...
                        this.txtprefix_id.Text = "";
                        this.txtprefix_name.Text = "";
                        this.txtprefix_name_eng.Text = "";
                        this.txtprefix_name_remark.Text = "";
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                try
                {
                    if (this.iblword_status.Text.Trim() == "ยกเลิกเอกสาร")
                    {
                        ...
                        cmd2.CommandText = "INSERT INTO k016db_supplier_1profix_cancel(cdkey,txtco_id,txtbranch_id," +  //1
                                                                                                                //"txttrans_date," +
                        ...
                        cmd2.CommandText = "INSERT INTO k016db_supplier_1profix_cancel_detail(cdkey,txtco_id," +  //1
                                             "txtprefix_no,txtprefix_id," +  //2
                                             "txtprefix_name,txtprefix_name_eng," +  //3
                                             "txtprefix_name_remark," +  //4
                                            "txtprefix_status,cancel_id) " +  //5
                                             "VALUES (@cdkey2,@txtco_id2," +  //1
                                             "@txtprefix_no,@txtprefix_id," +  //2
                                             "@txtprefix_name,@txtprefix_name_eng," +  //3
                                             "@txtprefix_name_remark," +  //4
                                            "@txtprefix_status,@cancel_id2)";   //5
                        ...
                        cmd2.CommandText = "DELETE FROM k016db_supplier_1profix" +
                                                                    " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                                                    " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                    ...
                    DialogResult dialogResult = MessageBox.Show("คุณต้องการ ยกเลิกเอกสาร รหัส  " + this.txtprefix_id.Text.ToString() + " ใช่หรือไม่่ ?", "โปรดยืนยัน", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question);
                    if (dialogResult == DialogResult.Yes)
                    {
        ...
        private void txtprefix_id_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            if (e.KeyChar == (char)Keys.Enter && this.txtprefix_id.Text == "")
            {
                this.txtprefix_id.Focus();
            }
            //========================================
            else if (e.KeyChar == (char)Keys.Enter && this.txtprefix_id.Text.Trim() != "")
            {
                this.txtprefix_no.Focus();
        ...
        private void txtprefix_no_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == (char)Keys.Enter && this.txtprefix_no.Text == "")
            {
                this.txtprefix_no.Focus();
            }
            //========================================
            else if (e.KeyChar == (char)Keys.Enter && this.txtprefix_no.Text.Trim() != "")
            {
                if (this.txtprefix_no.TextLength == 3)
                {
                    this.txtprefix_name.Focus();
            ...
            else if ((e.KeyChar > '9') && (e.KeyChar != '\b') && (e.KeyChar != '.') && txtprefix_no.Text.Length == 0)
            {
                //e.KeyChar <= '0' || 
                e.Handled = true;
                return;
        ...
        private void txtprefix_name_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
                this.txtprefix_name_eng.Focus();

        }

        private void txtprefix_name_eng_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
                this.txtprefix_name_remark.Focus();

        }

        private void txtprefix_name_remark_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
                this.BtnSave.Focus();
                ...
                if (conn.State == System.Data.ConnectionState.Open)
                {
                    ...
                    try
                    {
                        cmd2.CommandText = "INSERT INTO k016db_supplier_1profix(cdkey,txtco_id," +  //1
                                           ...
                                           "txtprefix_name_remark," +  //4
                                          "txtprefix_status) " +  //5
                                           "VALUES (@cdkey999,@txtco_id999," +  //1
                                           "@txtprefix_no999,@txtprefix_id999," +  //2
                                           "@txtprefix_name999,@txtprefix_name_eng999," +  //3
                                           "@txtprefix_name_remark999," +  //4
                                          "@txtprefix_status999)";   //5

                        cmd2.Parameters.Add("@cdkey999", SqlDbType.NVarChar).Value = W_ID_Select.CDKEY.Trim();
                        cmd2.Parameters.Add("@txtco_id999", SqlDbType.NVarChar).Value = W_ID_Select.M_COID.Trim();
                        cmd2.Parameters.Add("@txtprefix_no999", SqlDbType.NVarChar).Value = "999";
                        cmd2.Parameters.Add("@txtprefix_id999", SqlDbType.NVarChar).Value = "";
                        cmd2.Parameters.Add("@txtprefix_name999", SqlDbType.NVarChar).Value = "";
                        cmd2.Parameters.Add("@txtprefix_name_eng999", SqlDbType.NVarChar).Value = "";
                        cmd2.Parameters.Add("@txtprefix_name_remark999", SqlDbType.NVarChar).Value = "";
                        cmd2.Parameters.Add("@txtprefix_status999", SqlDbType.NChar).Value = "0";
                        //==============================
