...
{
    public partial class HOME04_Warehouse_02approve_request_sell_record_detail : Form
    {
        //Move Form ====================================
        ...
        public HOME04_Warehouse_02approve_request_sell_record_detail()
        {
            InitializeComponent();
        }

        private void HOME04_Warehouse_02approve_request_sell_record_detail_Load(object sender, EventArgs e)
        {
            this.WindowState = FormWindowState.Maximized;
            this.btnmaximize.Visible = false;
            this.btnmaximize_full.Visible = true;

            W_ID_Select.M_FORM_NUMBER = "H0402ATFDL";
            CHECK_ADD_FORM();
            ...
            this.iblword_status.Text = "ดูข้อมูลใบอนุมัติโอนสินค้า หรือ วัตถุดิบ";

            this.ActiveControl = this.txtATF_remark;
        ...
        private void Fill_DATA_TO_GridView1()
        {
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                cmd2.Connection = conn;
                    ...
                    cmd2.CommandText = "SELECT m001db_02approve_request_sell_record.*," +
                                       "m001db_02approve_request_sell_record_detail.*," +
                                       "m001db_01berg_main.*," +
                                        "k013_1db_acc_06wherehouse.*" +

                                        " FROM m001db_02approve_request_sell_record" +

                                       " INNER JOIN m001db_02approve_request_sell_record_detail" +
                                       " ON m001db_02approve_request_sell_record.cdkey = m001db_02approve_request_sell_record_detail.cdkey" +
                                       " AND m001db_02approve_request_sell_record.txtco_id = m001db_02approve_request_sell_record_detail.txtco_id" +
                                       " AND m001db_02approve_request_sell_record.txtATF_id = m001db_02approve_request_sell_record_detail.txtATF_id" +

                                       " INNER JOIN m001db_01berg_main" +
                                       " ON m001db_02approve_request_sell_record.cdkey = m001db_01berg_main.cdkey" +
                                       " AND m001db_02approve_request_sell_record.txtco_id = m001db_01berg_main.txtco_id" +
                                       " AND m001db_02approve_request_sell_record.txtRTF_id = m001db_01berg_main.txtWH_id2" +

                                       " INNER JOIN k013_1db_acc_06wherehouse" +
                                       " ON m001db_02approve_request_sell_record.cdkey = k013_1db_acc_06wherehouse.cdkey" +
                                       " AND m001db_02approve_request_sell_record.txtco_id = k013_1db_acc_06wherehouse.txtco_id" +
                                       " AND m001db_02approve_request_sell_record.txtwherehouse_id_source = k013_1db_acc_06wherehouse.txtwherehouse_id" +

                                       //" INNER JOIN k013_1db_acc_06wherehouse" +
                                       //" ON m001db_02approve_request_sell_record.cdkey = k013_1db_acc_06wherehouse.cdkey" +
                                       //" AND m001db_02approve_request_sell_record.txtco_id = k013_1db_acc_06wherehouse.txtco_id" +
                                       //" AND m001db_02approve_request_sell_record.txtwherehouse_id_destination = k013_1db_acc_06wherehouse.txtwherehouse_id" +

                                       " WHERE (m001db_02approve_request_sell_record.cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                       " AND (m001db_02approve_request_sell_record.txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                       " AND (m001db_02approve_request_sell_record.txtATF_id = '" + W_ID_Select.TRANS_ID.Trim() + "')" +
                                      " ORDER BY m001db_02approve_request_sell_record.txtATF_id ASC";
                    ...
                    try
                    {
                        ...
                        if (dt2.Rows.Count > 0)
                        {
                            ...
                            this.txtATF_id.Text = dt2.Rows[0]["txtATF_id"].ToString();
                            this.txtRTF_id.Text = dt2.Rows[0]["txtRTF_id"].ToString();
                        this.txtWH_id.Text = dt2.Rows[0]["txtWH_id"].ToString();
                        ...
                        this.dtpdate_record.Value = Convert.ToDateTime(dt2.Rows[0]["txttrans_date_server"].ToString());
                            ...
                            this.txtATF_remark.Text = dt2.Rows[0]["txtATF_remark"].ToString();
                        ...
                        for (int j = 0; j < dt2.Rows.Count; j++)
                            {
                               var index = GridView1.Rows.Add();
                                ...
                                GridView1.Rows[index].Cells["Col_txtqty_source_yokma"].Value = Convert.ToSingle(dt2.Rows[j]["txtqty_source_yokma"]).ToString("###,###.00");      //9
                                GridView1.Rows[index].Cells["Col_txtqty_source"].Value = Convert.ToSingle(dt2.Rows[j]["txtqty_source"]).ToString("###,###.00");      //9
                                GridView1.Rows[index].Cells["Col_txtqty_source_yokpai"].Value = Convert.ToSingle(dt2.Rows[j]["txtqty_source_yokpai"]).ToString("###,###.00");      //9

                                GridView1.Rows[index].Cells["Col_txtqty_destination_yokma"].Value = Convert.ToSingle(dt2.Rows[j]["txtqty_destination_yokma"]).ToString("###,###.00");      //9
                                GridView1.Rows[index].Cells["Col_txtqty_destination"].Value = Convert.ToSingle(dt2.Rows[j]["txtqty_destination"]).ToString("###,###.00");      //9
                                GridView1.Rows[index].Cells["Col_txtqty_destination_yokpai"].Value = Convert.ToSingle(dt2.Rows[j]["txtqty_destination_yokpai"]).ToString("###,###.00");      //9
                                ...
                                GridView1.Rows[index].Cells["Col_mat_status"].Value = "";      //24
        ...
        private void Show_GridView1()
        {
            ...
            this.GridView1.Columns["Col_txtqty_destination"].ReadOnly = true;
        ...
        private void GridView1_Color()
        {
            for (int i = 0; i < this.GridView1.Rows.Count - 0; i++)
            {
                ...
                if (Convert.ToDouble(string.Format("{0:n}", this.GridView1.Rows[i].Cells["Col_txtqty_destination"].Value.ToString())) > Convert.ToDouble(string.Format("{0:n}", this.GridView1.Rows[i].Cells["Col_txtqty_destination_yokma"].Value.ToString())))
                {
            ...
            for (int i = 0; i < this.GridView1.Rows.Count - 0; i++)
            {
                ...
                if (valu != "")
                {
                    ...
                    else
                    {
                        ...
                        //txtqty_source_yokpai  เมื่ออนุมัติ จะลบจากสต๊อคต้นทาง ยกเลิก บวก
                        Sum_Total_source_yokpai = Convert.ToDouble(string.Format("{0:n}", this.GridView1.Rows[i].Cells["Col_txtqty_source_yokma"].Value.ToString())) + Convert.ToDouble(string.Format("{0:n}", this.GridView1.Rows[i].Cells["Col_txtqty_destination"].Value.ToString()));
                        this.GridView1.Rows[i].Cells["Col_txtqty_source_yokpai"].Value = Sum_Total_source_yokpai.ToString("N", new CultureInfo("en-US"));

                        //txtqty_destination_yokpai  เมื่ออนุมัติ จะบวกสต๊อคปลายทาง  ยกเลิก ลบ
                        Sum_Total_destination_yokpai = Convert.ToDouble(string.Format("{0:n}", this.GridView1.Rows[i].Cells["Col_txtqty_destination_yokma"].Value.ToString())) - Convert.ToDouble(string.Format("{0:n}", this.GridView1.Rows[i].Cells["Col_txtqty_destination"].Value.ToString()));
                        this.GridView1.Rows[i].Cells["Col_txtqty_destination_yokpai"].Value = Sum_Total_destination_yokpai.ToString("N", new CultureInfo("en-US"));
        ...
        private void BtnCancel_Doc_Click(object sender, EventArgs e)
        {
            for (int i = 0; i < this.GridView1.Rows.Count - 0; i++)
            {
                if (Convert.ToDouble(string.Format("{0:n}", this.GridView1.Rows[i].Cells["Col_txtqty_destination"].Value.ToString())) > 0)
                {
                    if (Convert.ToDouble(string.Format("{0:n}", this.GridView1.Rows[i].Cells["Col_txtqty_destination"].Value.ToString())) > Convert.ToDouble(string.Format("{0:n}", this.GridView1.Rows[i].Cells["Col_txtqty_destination_yokma"].Value.ToString())))
                    {
                        MessageBox.Show("สต๊อค ปลายทาง มียอดแดง ติดลบ ไม่พอให้โอน  !", "ผลการทำงาน", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                        return;
                    }
                }
            }
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                cmd1.CommandText = "SELECT * FROM m001db_02approve_request_sell_record" +
                                    " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                    " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                    " AND (txtATF_id = '" + this.txtATF_id.Text.Trim() + "')" +
                                    " AND (txtATF_status = '1')";
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    MessageBox.Show("เอกสารนี้   : '" + this.txtATF_id.Text.Trim() + "' ยกเลิกไปแล้ว ", "ผลการทำงาน", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                    conn.Close();
                    return;
                }
            }
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                try
                {
                    ...
                    if (this.iblword_status.Text.Trim() == "ยกเลิกเอกสาร")
                    {
                        ...
                        cmd2.CommandText = "INSERT INTO m001db_02approve_request_sell_record_cancel(cdkey,txtco_id,txtbranch_id," +  //1
                                                                                                                      //"txttrans_date," +
                        ...
                        for (int i = 0; i < this.GridView1.Rows.Count; i++)
                        {
                            ...
                            "VALUES ('" + W_ID_Select.CDKEY.Trim() + "','" + W_ID_Select.M_COID.Trim() + "','" + W_ID_Select.M_BRANCHID.Trim() + "'," +  //1
                                ...
                                "'ATF'," +  //9
                                       ...
                                       "'ยกเลิก อนุมัติโอนสินค้า คลังต้นทาง '," +
                            ...
                            "VALUES ('" + W_ID_Select.CDKEY.Trim() + "','" + W_ID_Select.M_COID.Trim() + "','" + W_ID_Select.M_BRANCHID.Trim() + "'," +  //1
                                ...
                                "'ATF'," +  //9
                                       ...
                                       "'ยกเลิก อนุมัติโอนสินค้า คลังปลายทาง '," +
                    ...
                    DialogResult dialogResult = MessageBox.Show("คุณต้องการ ยกเลิกเอกสาร รหัส  " + this.txtATF_id.Text.ToString() + " ใช่หรือไม่่ ?", "โปรดยืนยัน", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question);
