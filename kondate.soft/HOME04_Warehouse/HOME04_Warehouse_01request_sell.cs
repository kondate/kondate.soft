...
{
    public partial class HOME04_Warehouse_01request_sell : Form
    {
        //Move Form ====================================
        ...
        public HOME04_Warehouse_01request_sell()
        {
            InitializeComponent();
        }

        private void HOME04_Warehouse_01request_sell_Load(object sender, EventArgs e)
        {
            this.WindowState = FormWindowState.Maximized;
            this.btnmaximize.Visible = false;
            this.btnmaximize_full.Visible = true;

            W_ID_Select.M_FORM_NUMBER = "H0401RTFGR";
            CHECK_ADD_FORM();

            CHECK_USER_RULE();

            this.iblword_top.Text = W_ID_Select.WORD_TOP.Trim();
            this.iblword_status.Text = "ระเบียนใบขอโอนสินค้า หรือ วัตถุดิบ";
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        ...
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            //this.GridView1.Columns[3].Name = "Col_txtRTF_id";
                            ...
                            //this.GridView1.Columns[9].Name = "Col_txtRTF_remark";
                            ...
                            this.GridView1.Rows[index].Cells["Col_txtRTF_remark"].Value = dt2.Rows[j]["txtRTF_remark"].ToString();      //9
                            ...
                            //txtRTF_status==============================
                            if (dt2.Rows[j]["txtRTF_status"].ToString() == "0")
                            {
                                this.GridView1.Rows[index].Cells["Col_txtRTF_status"].Value = ""; //12
                            }
                            else if (dt2.Rows[j]["txtRTF_status"].ToString() == "1")
                            {
                                this.GridView1.Rows[index].Cells["Col_txtRTF_status"].Value = "ยกเลิก"; //12
                            }

                            //txtRTF_status==============================
                            if (dt2.Rows[j]["txtapprove_status"].ToString() == "0")
                            {
                                this.GridView1.Rows[index].Cells["Col_txtapprove_status"].Value = "รอ"; //12
                            }
                            else if (dt2.Rows[j]["txtapprove_status"].ToString() == "1")
                            {
                                this.GridView1.Rows[index].Cells["Col_txtapprove_status"].Value = "ยกเลิก"; //12
                            }
                            else if (dt2.Rows[j]["txtapprove_status"].ToString() == "2")
                            {
                                this.GridView1.Rows[index].Cells["Col_txtapprove_status"].Value = "อนุมัติ"; //12
                            }
        ...
        private void Show_GridView1()
        {
            ...
            this.GridView1.Columns[6].HeaderText = " คลังต้นทาง";
            this.GridView1.Columns[7].HeaderText = " คลังปลายทาง";
            this.GridView1.Columns[8].HeaderText = " ผู้บันทึก";
            this.GridView1.Columns[9].HeaderText = " หมายเหตุ";
            this.GridView1.Columns[10].HeaderText = " จำนวนเงิน";
            this.GridView1.Columns[11].HeaderText = " สถานะ";
            this.GridView1.Columns[12].HeaderText = " สถานะอนุมัติ";
            ...
            this.GridView1.Columns["Col_txtRTF_remark"].Visible = true;  //"Col_txtRTF_remark";
            this.GridView1.Columns["Col_txtRTF_remark"].Width = 180;
            this.GridView1.Columns["Col_txtRTF_remark"].ReadOnly = true;
            this.GridView1.Columns["Col_txtRTF_remark"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.GridView1.Columns["Col_txtRTF_remark"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
            ...
            this.GridView1.Columns["Col_txtRTF_status"].Visible = true;  //"Col_txtRTF_status";
            this.GridView1.Columns["Col_txtRTF_status"].Width = 100;
            this.GridView1.Columns["Col_txtRTF_status"].ReadOnly = true;
            this.GridView1.Columns["Col_txtRTF_status"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.GridView1.Columns["Col_txtRTF_status"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;

            this.GridView1.Columns["Col_txtapprove_status"].Visible = true;  //"Col_txtapprove_status";
            this.GridView1.Columns["Col_txtapprove_status"].Width = 100;
            ...
            this.GridView1.Columns["Col_txtapprove_id"].Visible = true;  //"Col_txtapprove_id";
            this.GridView1.Columns["Col_txtapprove_id"].Width = 140;
        ...
        private void GridView1_Color()
        {
            for (int i = 0; i < this.GridView1.Rows.Count - 0; i++)
            {
                ...
                if (this.GridView1.Rows[i].Cells["Col_txtapprove_id"].Value.ToString() == "")
                {
        ...
        private void GridView1_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                var cell = row.Cells["Col_txtRTF_id"].Value;
                if (cell != null)
                {
                    W_ID_Select.TRANS_ID = row.Cells["Col_txtRTF_id"].Value.ToString();
        ...
        private void GridView1_DoubleClick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                W_ID_Select.WORD_TOP = "ดูข้อมูลใบขอโอนสินค้า";
                kondate.soft.HOME04_Warehouse.HOME04_Warehouse_01request_sell_record_detail frm2 = new kondate.soft.HOME04_Warehouse.HOME04_Warehouse_01request_sell_record_detail();
                frm2.Show();
        ...
        private void btnApprove_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                W_ID_Select.LOG_ID = "1";
                W_ID_Select.LOG_NAME = "Login";
                W_ID_Select.WORD_TOP = "อนุมัติใบขอโอนสินค้า";
