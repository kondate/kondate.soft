...
{
    public partial class HOME04_Warehouse_01request_sell_record_print : Form
    {
        //Move Form ====================================
        ...
        public HOME04_Warehouse_01request_sell_record_print()
        {
            InitializeComponent();
        }

        private void HOME02_Purchasing_05RG_record_print_Load(object sender, EventArgs e)
        {
            ...
            rpt.Load("C:\\KD_ERP\\KD_REPORT\\Report_01request_sell_record.rpt");
            //rpt.Load("E:\\01_Project_ERP_Kondate.Soft\\kondate.soft\\kondate.soft\\KONDATE_REPORT\\Report_01request_sell_record.rpt");
