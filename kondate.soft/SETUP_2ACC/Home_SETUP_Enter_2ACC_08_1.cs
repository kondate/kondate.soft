...
{
    public partial class Home_SETUP_Enter_2ACC_08_1 : Form
    {
        //Move Form ====================================
        ...
        public Home_SETUP_Enter_2ACC_08_1()
        {
            InitializeComponent();
        }
        ...
        private void BtnNew_Click(object sender, EventArgs e)
        {
            ...
            this.Hide();
            var frm2 = new Home_SETUP_Enter_2ACC_08_1();
                    ...
                    if (this.iblword_status.Text.Trim() == "เพิ่มบัญชีใหม่")
                    {
                        ...
                        for (int i = 0; i < this.PANEL_FORM1_dataGridView1_acc.Rows.Count ; i++)
                        {
                            if (this.PANEL_FORM1_dataGridView1_acc.Rows[i].Cells[1].Value.ToString() != "")
                            {
                                ...
                                "'" + this.PANEL_FORM1_dataGridView1_acc.Rows[i].Cells[10].Value.ToString() + "'," +  //3
                                "'" + this.PANEL_FORM1_dataGridView1_acc.Rows[i].Cells[11].Value.ToString() + "'," +  //4
                                "'" + this.PANEL_FORM1_dataGridView1_acc.Rows[i].Cells[4].Value.ToString() + "'," +    //5
                                "'" + this.PANEL_FORM1_dataGridView1_acc.Rows[i].Cells[6].Value.ToString() + "'," +  //6
                                "'" + this.PANEL_FORM1_dataGridView1_acc.Rows[i].Cells[12].Value.ToString() + "'," +  //7
                                "'" + this.PANEL_FORM1_dataGridView1_acc.Rows[i].Cells[8].Value.ToString() + "'," +  //8
                                "'" + this.PANEL_FORM1_dataGridView1_acc.Rows[i].Cells[13].Value.ToString() + "'," +  //9
                                "'" + this.PANEL_FORM1_dataGridView1_acc.Rows[i].Cells[14].Value.ToString() + "'," +  //10
                                "'" + this.PANEL_FORM1_dataGridView1_acc.Rows[i].Cells[15].Value.ToString() + "'," +  //11
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            PANEL_FORM1_dataGridView1_acc.Rows[index].Cells["Col_txtacc_name2"].Value = dt2.Rows[j]["txtacc_name"].ToString();      //10
                            PANEL_FORM1_dataGridView1_acc.Rows[index].Cells["Col_txtacc_name_eng2"].Value = dt2.Rows[j]["txtacc_name_eng"].ToString();      //11
                            PANEL_FORM1_dataGridView1_acc.Rows[index].Cells["Col_txtacc_balance_type_id"].Value = dt2.Rows[j]["txtacc_balance_type_id"].ToString();      //12
                            PANEL_FORM1_dataGridView1_acc.Rows[index].Cells["Col_txtacc_id_control"].Value = dt2.Rows[j]["txtacc_id_control"].ToString();      //13
                            PANEL_FORM1_dataGridView1_acc.Rows[index].Cells["Col_txtacc_name_control"].Value = dt2.Rows[j]["txtacc_name_control"].ToString();      //14
                            PANEL_FORM1_dataGridView1_acc.Rows[index].Cells["Col_txttype_money_id"].Value = dt2.Rows[j]["txttype_money_id"].ToString();      //15
        ...
        {
            this.PANEL_FORM1_dataGridView1_acc.ColumnCount = 16;
            this.PANEL_FORM1_dataGridView1_acc.Columns[0].Name = "Col_Auto_num";
            this.PANEL_FORM1_dataGridView1_acc.Columns[1].Name = "Col_txtacc_id";
            this.PANEL_FORM1_dataGridView1_acc.Columns[2].Name = "Col_txtacc_name";
            this.PANEL_FORM1_dataGridView1_acc.Columns[3].Name = "Col_txtacc_name_eng";
            ...
            this.PANEL_FORM1_dataGridView1_acc.Columns[10].Visible = false;  //"Col_txtacc_name2";
            this.PANEL_FORM1_dataGridView1_acc.Columns[11].Visible = false;  //"Col_txtacc_name_eng2";
            this.PANEL_FORM1_dataGridView1_acc.Columns[12].Visible = false;  //"Col_txtacc_balance_type_id";
            this.PANEL_FORM1_dataGridView1_acc.Columns[13].Visible = false;  //"Col_txtacc_id_control";
            this.PANEL_FORM1_dataGridView1_acc.Columns[14].Visible = false;  //"Col_txtacc_name_control";
            this.PANEL_FORM1_dataGridView1_acc.Columns[15].Visible = false;  //"Col_txttype_money_id";
