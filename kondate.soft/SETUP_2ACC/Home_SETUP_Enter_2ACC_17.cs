...
namespace kondate.soft.SETUP_2ACC
{
    public partial class Home_SETUP_Enter_2ACC_17 : Form
    {
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            PANEL_FORM1_dataGridView1.Rows[index].Cells["Col_txtjob_no"].Value = dt2.Rows[j]["txtjob_no"].ToString();      //1
                            PANEL_FORM1_dataGridView1.Rows[index].Cells["Col_txtjob_id"].Value = dt2.Rows[j]["txtjob_id"].ToString();      //2
                            PANEL_FORM1_dataGridView1.Rows[index].Cells["Col_txtjob_name"].Value = dt2.Rows[j]["txtjob_name"].ToString();      //3
                            PANEL_FORM1_dataGridView1.Rows[index].Cells["Col_txtjob_name_eng"].Value = dt2.Rows[j]["txtjob_name_eng"].ToString();      //4
                            PANEL_FORM1_dataGridView1.Rows[index].Cells["Col_txtjob_remark"].Value = dt2.Rows[j]["txtjob_remark"].ToString();      //5
                            PANEL_FORM1_dataGridView1.Rows[index].Cells["Col_txtjob_status"].Value = dt2.Rows[j]["txtjob_status"].ToString();      //6
        ...
        private void PANEL_FORM1_GridView1()
        {
            ...
            this.PANEL_FORM1_dataGridView1.Columns[3].HeaderText = " ชื่อรหัสงาน";
            this.PANEL_FORM1_dataGridView1.Columns[4].HeaderText = "ชื่อรหัสงาน Eng";
            ...
            this.PANEL_FORM1_dataGridView1.Columns[1].Visible = true;  //"Col_txtjob_no";
            ...
            this.PANEL_FORM1_dataGridView1.Columns[2].Visible = true;  //"Col_txtjob_id";
            ...
            this.PANEL_FORM1_dataGridView1.Columns[3].Visible = true;  //"Col_txtjob_name";
            ...
            this.PANEL_FORM1_dataGridView1.Columns[4].Visible = true;  //"Col_txtjob_name_eng";
            ...
            this.PANEL_FORM1_dataGridView1.Columns[5].Visible = true;  //"Col_txtjob_name_remark";
            ...
            this.PANEL_FORM1_dataGridView1.Columns[6].Visible = false;  //"Col_txtjob_status";
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            PANEL_FORM1_dataGridView1.Rows[index].Cells["Col_txtjob_name"].Value = dt2.Rows[j]["txtjob_name"].ToString();      //3
                            PANEL_FORM1_dataGridView1.Rows[index].Cells["Col_txtjob_name_eng"].Value = dt2.Rows[j]["txtjob_name_eng"].ToString();      //4
                            PANEL_FORM1_dataGridView1.Rows[index].Cells["Col_txtjob_remark"].Value = dt2.Rows[j]["txtjob_remark"].ToString();      //6
                            PANEL_FORM1_dataGridView1.Rows[index].Cells["Col_txtjob_status"].Value = dt2.Rows[j]["txtjob_status"].ToString();      //7
