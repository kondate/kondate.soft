...
namespace kondate.soft.SETUP_2ACC
{
    public partial class Home_SETUP_Enter_2ACC_13 : Form
    {
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            PANEL_FORM1_dataGridView1.Rows[index].Cells["Col_txtacc_group_tax_no"].Value = dt2.Rows[j]["txtacc_group_tax_no"].ToString();      //1
                            PANEL_FORM1_dataGridView1.Rows[index].Cells["Col_txtacc_group_tax_id"].Value = dt2.Rows[j]["txtacc_group_tax_id"].ToString();      //2
                            PANEL_FORM1_dataGridView1.Rows[index].Cells["Col_txtacc_group_tax_name"].Value = dt2.Rows[j]["txtacc_group_tax_name"].ToString();      //3
                            PANEL_FORM1_dataGridView1.Rows[index].Cells["Col_txtacc_group_tax_name_eng"].Value = dt2.Rows[j]["txtacc_group_tax_name_eng"].ToString();      //4
                            PANEL_FORM1_dataGridView1.Rows[index].Cells["Col_txtacc_group_tax_vat_rate"].Value = Convert.ToSingle(dt2.Rows[j]["txtacc_group_tax_vat_rate"]).ToString("###,###.00");     //4
                        PANEL_FORM1_dataGridView1.Rows[index].Cells["Col_txtacc_group_tax_remark"].Value = dt2.Rows[j]["txtacc_group_tax_remark"].ToString();      //5
                            PANEL_FORM1_dataGridView1.Rows[index].Cells["Col_txtacc_group_tax_status"].Value = dt2.Rows[j]["txtacc_group_tax_status"].ToString();      //6
        ...
        private void PANEL_FORM1_GridView1()
        {
            ...
            this.PANEL_FORM1_dataGridView1.Columns[3].Name = "Col_txtacc_group_tax_name";
            this.PANEL_FORM1_dataGridView1.Columns[4].Name = "Col_txtacc_group_tax_name_eng";
            this.PANEL_FORM1_dataGridView1.Columns[5].Name = "Col_txtacc_group_tax_vat_rate";
            this.PANEL_FORM1_dataGridView1.Columns[6].Name = "Col_txtacc_group_tax_remark";
            this.PANEL_FORM1_dataGridView1.Columns[7].Name = "Col_txtacc_group_tax_status";
            ...
            this.PANEL_FORM1_dataGridView1.Columns[3].HeaderText = " ชื่อกลุ่มภาษี";
            this.PANEL_FORM1_dataGridView1.Columns[4].HeaderText = "ชื่อกลุ่มภาษี Eng";
            this.PANEL_FORM1_dataGridView1.Columns[5].HeaderText = " อัตราภาษี";
            this.PANEL_FORM1_dataGridView1.Columns[6].HeaderText = " หมายเหตุ";
            this.PANEL_FORM1_dataGridView1.Columns[7].HeaderText = " สถานะ";

            this.PANEL_FORM1_dataGridView1.Columns[0].Visible = false;  //"No";
            this.PANEL_FORM1_dataGridView1.Columns[1].Visible = true;  //"Col_txtacc_group_tax_no";
            ...
            this.PANEL_FORM1_dataGridView1.Columns[2].Visible = true;  //"Col_txtacc_group_tax_id";
            ...
            this.PANEL_FORM1_dataGridView1.Columns[3].Visible = true;  //"Col_txtacc_group_tax_name";
            ...
            this.PANEL_FORM1_dataGridView1.Columns[4].Visible = true;  //"Col_txtacc_group_tax_name_eng";
            ...
            this.PANEL_FORM1_dataGridView1.Columns[5].Visible = true;  //"Col_txtacc_group_tax_vat_rate";
            ...
            this.PANEL_FORM1_dataGridView1.Columns[6].Visible = true;  //"Col_txtacc_group_tax_name_remark";
            this.PANEL_FORM1_dataGridView1.Columns[6].Width = 250;
            ...
            this.PANEL_FORM1_dataGridView1.Columns[7].Visible = false;  //"Col_txtacc_group_tax_status";
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            PANEL_FORM1_dataGridView1.Rows[index].Cells["Col_txtacc_group_tax_name"].Value = dt2.Rows[j]["txtacc_group_tax_name"].ToString();      //3
                            PANEL_FORM1_dataGridView1.Rows[index].Cells["Col_txtacc_group_tax_name_eng"].Value = dt2.Rows[j]["txtacc_group_tax_name_eng"].ToString();      //4
                            PANEL_FORM1_dataGridView1.Rows[index].Cells["Col_txtacc_group_tax_vat_rate"].Value = dt2.Rows[j]["txtacc_group_tax_vat_rate"].ToString();      //5
                            PANEL_FORM1_dataGridView1.Rows[index].Cells["Col_txtacc_group_tax_remark"].Value = dt2.Rows[j]["txtacc_group_tax_remark"].ToString();      //6
                            PANEL_FORM1_dataGridView1.Rows[index].Cells["Col_txtacc_group_tax_status"].Value = dt2.Rows[j]["txtacc_group_tax_status"].ToString();      //7
