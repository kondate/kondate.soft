...
{
    public partial class Home_SETUP_Enter_2ACC_04 : Form
    {
        //Move Form ====================================
        ...
        public Home_SETUP_Enter_2ACC_04()
        {
            InitializeComponent();
        }
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            PANEL_FORM1_dataGridView1.Rows[index].Cells["Col_txtco_id"].Value = dt2.Rows[j]["txtco_id"].ToString();      //1
                            PANEL_FORM1_dataGridView1.Rows[index].Cells["Col_txtco_name"].Value = dt2.Rows[j]["txtco_name"].ToString();      //2
                            PANEL_FORM1_dataGridView1.Rows[index].Cells["Col_txtco_name_eng"].Value = dt2.Rows[j]["txtco_name_eng"].ToString();      //3
                            PANEL_FORM1_dataGridView1.Rows[index].Cells["Col_txtco_tax_id"].Value = dt2.Rows[j]["txtco_tax_id"].ToString();      //4
                            PANEL_FORM1_dataGridView1.Rows[index].Cells["Col_txtco_tel"].Value = dt2.Rows[j]["txtco_tel"].ToString();      //5
                            PANEL_FORM1_dataGridView1.Rows[index].Cells["Col_txthome_id_full"].Value = dt2.Rows[j]["txthome_id_full"].ToString();      //6
                            PANEL_FORM1_dataGridView1.Rows[index].Cells["Col_txtco_status"].Value = dt2.Rows[j]["txtco_status"].ToString();      //7
        ...
        private void PANEL_FORM1_GridView1()
        {
            ...
            this.PANEL_FORM1_dataGridView1.Columns[2].HeaderText = " ชื่อบริษัทฯ";
            this.PANEL_FORM1_dataGridView1.Columns[3].HeaderText = " ชื่อบริษัทฯ Eng";
            this.PANEL_FORM1_dataGridView1.Columns[4].HeaderText = "เลขประจำตัวภาษี";
            ...
            this.PANEL_FORM1_dataGridView1.Columns[1].Visible = true;  //"Col_txtco_id";
            this.PANEL_FORM1_dataGridView1.Columns[1].Width = 30;
            ...
            this.PANEL_FORM1_dataGridView1.Columns[2].Visible = true;  //"Col_txtco_name";
            this.PANEL_FORM1_dataGridView1.Columns[2].Width = 250;
            ...
            this.PANEL_FORM1_dataGridView1.Columns[3].Visible = true;  //"Col_txtco_name_eng";
            this.PANEL_FORM1_dataGridView1.Columns[3].Width = 250;
            ...
            this.PANEL_FORM1_dataGridView1.Columns[4].Visible = true;  //"Col_txtco_tax_id";
        ...
        private void PANEL_FORM1_dataGridView1_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                if (cell != null)
                {
                    ...
                    this.txtco_id.Text = row.Cells[1].Value.ToString();
                    this.txtco_name.Text = row.Cells[2].Value.ToString();
                    this.txtco_name_eng.Text = row.Cells[3].Value.ToString();
        ...
        private void BtnNew_Click(object sender, EventArgs e)
        {
            ...
            this.Hide();
            var frm2 = new Home_SETUP_Enter_2ACC_04();
