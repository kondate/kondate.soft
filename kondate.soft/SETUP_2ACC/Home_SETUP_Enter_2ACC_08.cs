...
{
    public partial class Home_SETUP_Enter_2ACC_08 : Form
    {
        //Move Form ====================================
        ...
        public Home_SETUP_Enter_2ACC_08()
        {
            InitializeComponent();
        }
        ...
        private void BtnNew_Click(object sender, EventArgs e)
        {
            ...
            W_ID_Select.LOG_ID = "3";
                        ...
                        this.Hide();
                        var frm2 = new Home_SETUP_Enter_2ACC_08();
                ...
                try
                {
                    ...
                    if (dialogResult == DialogResult.Yes)
                    {
                        ...
                        if (this.iblword_status.Text.Trim() == "แก้ไขบัญชี")
                        {
                            ...
                            PANEL_FORM1_dataGridView1_acc.Rows[selectedRowIndex].Cells["Col_txtacc_id"].Value = this.txtacc_id.Text.ToString();      //1
                            if (PANEL34_ACC_DEGREE_txtacc_degree_id.Text == "1")
                            {
                                PANEL_FORM1_dataGridView1_acc.Rows[selectedRowIndex].Cells["Col_txtacc_name"].Value = this.txtacc_name.Text.ToString();      //2
                                PANEL_FORM1_dataGridView1_acc.Rows[selectedRowIndex].Cells["Col_txtacc_name_eng"].Value = this.txtacc_name_eng.Text.ToString();      //3
                            }
                            ...
                            PANEL_FORM1_dataGridView1_acc.Rows[selectedRowIndex].Cells["Col_txtacc_type_id"].Value = this.PANEL32_ACC_TYPE_txtacc_type_id.Text.ToString();      //4
                            PANEL_FORM1_dataGridView1_acc.Rows[selectedRowIndex].Cells["Col_txtacc_type_name"].Value = this.PANEL32_ACC_TYPE_txtacc_type_name.Text.ToString();      //5
                            PANEL_FORM1_dataGridView1_acc.Rows[selectedRowIndex].Cells["Col_txtacc_work_type_id"].Value = this.PANEL33_ACC_WORK_TYPE_txtacc_work_type_id.Text.ToString();      //6
                            PANEL_FORM1_dataGridView1_acc.Rows[selectedRowIndex].Cells["Col_txtacc_work_type_name"].Value = this.PANEL33_ACC_WORK_TYPE_txtacc_work_type_name.Text.ToString();      //7
                            PANEL_FORM1_dataGridView1_acc.Rows[selectedRowIndex].Cells["Col_txtacc_degree_id"].Value = this.PANEL34_ACC_DEGREE_txtacc_degree_id.Text.ToString();      //8
                            PANEL_FORM1_dataGridView1_acc.Rows[selectedRowIndex].Cells["Col_txtacc_degree_name"].Value = this.PANEL34_ACC_DEGREE_txtacc_degree_name.Text.ToString();      //9
        ...
        private void BtnPrint_Click(object sender, EventArgs e)
        {
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                try
                {
                    ...
                    for (int i = 0; i < this.PANEL_FORM1_dataGridView1_acc.Rows.Count ; i++)
                    {
                        if (this.PANEL_FORM1_dataGridView1_acc.Rows[i].Cells[1].Value.ToString() != "")
                        {
                                ...
                                cmd2.CommandText = "INSERT INTO k013db_1acc_print(cdkey,txtco_id," +  //1
                                                   ...
                                                   "'" + this.PANEL_FORM1_dataGridView1_acc.Rows[i].Cells[1].Value.ToString() + "'," +  //2
                                                   "'" + this.PANEL_FORM1_dataGridView1_acc.Rows[i].Cells[2].Value.ToString() + "'," +  //3
                                                   "'" + this.PANEL_FORM1_dataGridView1_acc.Rows[i].Cells[3].Value.ToString() + "'," +  //4
                                                   "'" + this.PANEL_FORM1_dataGridView1_acc.Rows[i].Cells[5].Value.ToString() + "'," +  //5
                                                   "'" + this.PANEL_FORM1_dataGridView1_acc.Rows[i].Cells[7].Value.ToString() + "'," +  //6
                                                   "'" + this.PANEL_FORM1_dataGridView1_acc.Rows[i].Cells[9].Value.ToString()  + "')";  //7
        ...
        private void btnPreview_Click(object sender, EventArgs e)
        {
            ...
            kondate.soft.SETUP_2ACC.Home_SETUP_Enter_2ACC_08_Print frm2 = new kondate.soft.SETUP_2ACC.Home_SETUP_Enter_2ACC_08_Print();
            frm2.Show();
            frm2.BringToFront();
        ...
        private void btnEnter2ACC_Setup8_Set_Acount_Code_Click(object sender, EventArgs e)
        {
            ...
            kondate.soft.SETUP_2ACC.Home_SETUP_Enter_2ACC_08_1 frm2 = new kondate.soft.SETUP_2ACC.Home_SETUP_Enter_2ACC_08_1();
            frm2.Show();
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        ...
                        {
                            var index = PANEL_FORM1_dataGridView1_acc.Rows.Add();
                            PANEL_FORM1_dataGridView1_acc.Rows[index].Cells["Col_Auto_num"].Value = ""; //0
                            PANEL_FORM1_dataGridView1_acc.Rows[index].Cells["Col_txtacc_id"].Value = dt2.Rows[j]["txtacc_id"].ToString();      //1
                            if (dt2.Rows[j]["txtacc_degree_id"].ToString() == "1")
                            {
                                PANEL_FORM1_dataGridView1_acc.Rows[index].Cells["Col_txtacc_name"].Value = dt2.Rows[j]["txtacc_name"].ToString();      //2
                                PANEL_FORM1_dataGridView1_acc.Rows[index].Cells["Col_txtacc_name_eng"].Value = dt2.Rows[j]["txtacc_name_eng"].ToString();      //2
                            }
                            ...
                            PANEL_FORM1_dataGridView1_acc.Rows[index].Cells["Col_txtacc_type_id"].Value = dt2.Rows[j]["txtacc_type_id"].ToString();      //4
                            PANEL_FORM1_dataGridView1_acc.Rows[index].Cells["Col_txtacc_type_name"].Value = dt2.Rows[j]["txtacc_type_name"].ToString();      //5
                            PANEL_FORM1_dataGridView1_acc.Rows[index].Cells["Col_txtacc_work_type_id"].Value = dt2.Rows[j]["txtacc_work_type_id"].ToString();      //6
                            PANEL_FORM1_dataGridView1_acc.Rows[index].Cells["Col_txtacc_work_type_name"].Value = dt2.Rows[j]["txtacc_work_type_name"].ToString();      //7
                            PANEL_FORM1_dataGridView1_acc.Rows[index].Cells["Col_txtacc_degree_id"].Value = dt2.Rows[j]["txtacc_degree_id"].ToString();      //8
                            PANEL_FORM1_dataGridView1_acc.Rows[index].Cells["Col_txtacc_degree_name"].Value = dt2.Rows[j]["txtacc_degree_name"].ToString();      //9
                        }
                        //=======================================================
                    }
                    else
        ...
        {
            this.PANEL_FORM1_dataGridView1_acc.ColumnCount = 10;
            this.PANEL_FORM1_dataGridView1_acc.Columns[0].Name = "Col_Auto_num";
            this.PANEL_FORM1_dataGridView1_acc.Columns[1].Name = "Col_txtacc_id";
            this.PANEL_FORM1_dataGridView1_acc.Columns[2].Name = "Col_txtacc_name";
            this.PANEL_FORM1_dataGridView1_acc.Columns[3].Name = "Col_txtacc_name_eng";
            ...
            this.PANEL_FORM1_dataGridView1_acc.Columns[0].HeaderText = "No";
            this.PANEL_FORM1_dataGridView1_acc.Columns[1].HeaderText = "รหัส";
            this.PANEL_FORM1_dataGridView1_acc.Columns[2].HeaderText = " ชื่อบัญชี";
            this.PANEL_FORM1_dataGridView1_acc.Columns[3].HeaderText = " ชื่อบัญชี Eng";
            this.PANEL_FORM1_dataGridView1_acc.Columns[4].HeaderText = "รหัสหมวดบัญชี";
            this.PANEL_FORM1_dataGridView1_acc.Columns[5].HeaderText = " หมวดบัญชี";
            this.PANEL_FORM1_dataGridView1_acc.Columns[6].HeaderText = " รหัสประเภท";
            this.PANEL_FORM1_dataGridView1_acc.Columns[7].HeaderText = " ประเภท";
            this.PANEL_FORM1_dataGridView1_acc.Columns[8].HeaderText = " รหัสระดับ";
            this.PANEL_FORM1_dataGridView1_acc.Columns[9].HeaderText = " ระดับ";

            this.PANEL_FORM1_dataGridView1_acc.Columns[0].Visible = false;  //"No";
            this.PANEL_FORM1_dataGridView1_acc.Columns[1].Visible = true;  //"Col_txtacc_id";
            this.PANEL_FORM1_dataGridView1_acc.Columns[1].Width = 100;
            this.PANEL_FORM1_dataGridView1_acc.Columns[1].ReadOnly = true;
            this.PANEL_FORM1_dataGridView1_acc.Columns[1].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.PANEL_FORM1_dataGridView1_acc.Columns[1].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;

            this.PANEL_FORM1_dataGridView1_acc.Columns[2].Visible = true;  //"Col_txtacc_name";
            this.PANEL_FORM1_dataGridView1_acc.Columns[2].Width = 150;
            this.PANEL_FORM1_dataGridView1_acc.Columns[2].ReadOnly = true;
            this.PANEL_FORM1_dataGridView1_acc.Columns[2].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.PANEL_FORM1_dataGridView1_acc.Columns[2].AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;

            this.PANEL_FORM1_dataGridView1_acc.Columns[3].Visible = true;  //"Col_txtacc_name_eng";
            this.PANEL_FORM1_dataGridView1_acc.Columns[3].Width = 150;
            this.PANEL_FORM1_dataGridView1_acc.Columns[3].ReadOnly = true;
            this.PANEL_FORM1_dataGridView1_acc.Columns[3].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.PANEL_FORM1_dataGridView1_acc.Columns[3].AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;

            this.PANEL_FORM1_dataGridView1_acc.Columns[4].Visible = false;  //"Col_txtacc_type_id";
            this.PANEL_FORM1_dataGridView1_acc.Columns[5].Visible = true;  //"Col_txtacc_type_name";
            this.PANEL_FORM1_dataGridView1_acc.Columns[5].Width = 100;
            this.PANEL_FORM1_dataGridView1_acc.Columns[5].ReadOnly = true;
            this.PANEL_FORM1_dataGridView1_acc.Columns[5].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.PANEL_FORM1_dataGridView1_acc.Columns[5].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;

            this.PANEL_FORM1_dataGridView1_acc.Columns[6].Visible = false;  //"Col_txtacc_work_type_id";
            this.PANEL_FORM1_dataGridView1_acc.Columns[7].Visible = true;  //"Col_txtacc_work_type_name";
            this.PANEL_FORM1_dataGridView1_acc.Columns[7].Width = 100;
            this.PANEL_FORM1_dataGridView1_acc.Columns[7].ReadOnly = true;
            this.PANEL_FORM1_dataGridView1_acc.Columns[7].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.PANEL_FORM1_dataGridView1_acc.Columns[7].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;

            this.PANEL_FORM1_dataGridView1_acc.Columns[8].Visible = false;  //"Col_txtacc_degree_id";
            this.PANEL_FORM1_dataGridView1_acc.Columns[9].Visible = true;  //"Col_txtacc_degree_name";
            this.PANEL_FORM1_dataGridView1_acc.Columns[9].Width = 100;
            this.PANEL_FORM1_dataGridView1_acc.Columns[9].ReadOnly = true;
            this.PANEL_FORM1_dataGridView1_acc.Columns[9].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.PANEL_FORM1_dataGridView1_acc.Columns[9].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;

            this.PANEL_FORM1_dataGridView1_acc.DefaultCellStyle.Font = new Font("Tahoma", 8F);

            this.PANEL_FORM1_dataGridView1_acc.ColumnHeadersDefaultCellStyle.BackColor = Color.WhiteSmoke;
            this.PANEL_FORM1_dataGridView1_acc.ColumnHeadersDefaultCellStyle.ForeColor = Color.Black;
            this.PANEL_FORM1_dataGridView1_acc.ColumnHeadersDefaultCellStyle.Font = new Font(DataGridView.DefaultFont, FontStyle.Bold);
            this.PANEL_FORM1_dataGridView1_acc.ColumnHeadersDefaultCellStyle.Font = new Font("Tahoma", 9F, FontStyle.Bold, GraphicsUnit.Pixel); //Segoe UI, 11pt
            this.PANEL_FORM1_dataGridView1_acc.EnableHeadersVisualStyles = false;

        }
        private void PANEL_FORM1_Clear_GridView1_acc()
        {
            this.PANEL_FORM1_dataGridView1_acc.Rows.Clear();
            this.PANEL_FORM1_dataGridView1_acc.Refresh();
        }
        ...
        private void PANEL_FORM1_dataGridView1_acc_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                DataGridViewRow row = this.PANEL_FORM1_dataGridView1_acc.Rows[e.RowIndex];
