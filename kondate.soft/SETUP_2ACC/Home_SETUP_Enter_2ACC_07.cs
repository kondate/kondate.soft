...
namespace kondate.soft.SETUP_2ACC
{
    public partial class Home_SETUP_Enter_2ACC_07 : Form
    {
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            PANEL_FORM1_dataGridView1.Rows[index].Cells["Col_txtproject_no"].Value = dt2.Rows[j]["txtproject_no"].ToString();      //1
                            PANEL_FORM1_dataGridView1.Rows[index].Cells["Col_txtproject_id"].Value = dt2.Rows[j]["txtproject_id"].ToString();      //2
                            PANEL_FORM1_dataGridView1.Rows[index].Cells["Col_txtproject_name"].Value = dt2.Rows[j]["txtproject_name"].ToString();      //3
                            PANEL_FORM1_dataGridView1.Rows[index].Cells["Col_txtproject_name_eng"].Value = dt2.Rows[j]["txtproject_name_eng"].ToString();      //4
                            PANEL_FORM1_dataGridView1.Rows[index].Cells["Col_txtproject_remark"].Value = dt2.Rows[j]["txtproject_remark"].ToString();      //5
                            PANEL_FORM1_dataGridView1.Rows[index].Cells["Col_txtproject_status"].Value = dt2.Rows[j]["txtproject_status"].ToString();      //6
        ...
        private void PANEL_FORM1_GridView1()
        {
            ...
            this.PANEL_FORM1_dataGridView1.Columns[3].HeaderText = " ชื่อรหัสโครงการ";
            this.PANEL_FORM1_dataGridView1.Columns[4].HeaderText = "ชื่อรหัสโครงการ Eng";
            ...
            this.PANEL_FORM1_dataGridView1.Columns[1].Visible = true;  //"Col_txtproject_no";
            ...
            this.PANEL_FORM1_dataGridView1.Columns[2].Visible = true;  //"Col_txtproject_id";
            ...
            this.PANEL_FORM1_dataGridView1.Columns[3].Visible = true;  //"Col_txtproject_name";
            ...
            this.PANEL_FORM1_dataGridView1.Columns[4].Visible = true;  //"Col_txtproject_name_eng";
            ...
            this.PANEL_FORM1_dataGridView1.Columns[5].Visible = true;  //"Col_txtproject_name_remark";
            ...
            this.PANEL_FORM1_dataGridView1.Columns[6].Visible = false;  //"Col_txtproject_status";
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            PANEL_FORM1_dataGridView1.Rows[index].Cells["Col_txtproject_name"].Value = dt2.Rows[j]["txtproject_name"].ToString();      //3
                            PANEL_FORM1_dataGridView1.Rows[index].Cells["Col_txtproject_name_eng"].Value = dt2.Rows[j]["txtproject_name_eng"].ToString();      //4
                            PANEL_FORM1_dataGridView1.Rows[index].Cells["Col_txtproject_remark"].Value = dt2.Rows[j]["txtproject_remark"].ToString();      //6
                            PANEL_FORM1_dataGridView1.Rows[index].Cells["Col_txtproject_status"].Value = dt2.Rows[j]["txtproject_status"].ToString();      //7
