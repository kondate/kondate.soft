...
{
    public partial class HOME05_Sale_02cus_type : Form
    {
        //Move Form ====================================
        ...
        public HOME05_Sale_02cus_type()
        {
            InitializeComponent();
        }

        private void HOME05_Sale_02cus_type_Load(object sender, EventArgs e)
        {
            W_ID_Select.M_FORM_NUMBER = "H0502CT";
            CHECK_ADD_FORM();
            ...
            this.iblword_status.Text = "เพิ่มรหัสประเภทลูกค้าใหม่";
            this.txtcus_type_id.ReadOnly = false;

            this.ActiveControl = this.txtcus_type_id;
        ...
        private void Run_ID()
        {
            if (this.txtcus_type_no.Text == "")
            {
                this.txtcus_type_no.Text = "001";
            }
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            //this.PANEL_FORM1_dataGridView1.Columns[1].Name = "Col_txtcus_type_no";
                            //this.PANEL_FORM1_dataGridView1.Columns[2].Name = "Col_txtcus_type_id";
                            //this.PANEL_FORM1_dataGridView1.Columns[3].Name = "Col_txtcus_type_name";
                            //this.PANEL_FORM1_dataGridView1.Columns[4].Name = "Col_txtcus_type_name_eng";
                            //this.PANEL_FORM1_dataGridView1.Columns[5].Name = "Col_txtcus_type_remark";
                            //this.PANEL_FORM1_dataGridView1.Columns[6].Name = "Col_txtcus_type_status";

                            var index = GridView1.Rows.Add();
                            GridView1.Rows[index].Cells["Col_Auto_num"].Value = ""; //0
                            GridView1.Rows[index].Cells["Col_txtcus_type_no"].Value = dt2.Rows[j]["txtcus_type_no"].ToString();      //1
                            GridView1.Rows[index].Cells["Col_txtcus_type_id"].Value = dt2.Rows[j]["txtcus_type_id"].ToString();      //2
                            GridView1.Rows[index].Cells["Col_txtcus_type_name"].Value = dt2.Rows[j]["txtcus_type_name"].ToString();      //3
                            GridView1.Rows[index].Cells["Col_txtcus_type_name_eng"].Value = dt2.Rows[j]["txtcus_type_name_eng"].ToString();      //4
                            GridView1.Rows[index].Cells["Col_txtcus_type_remark"].Value = dt2.Rows[j]["txtcus_type_remark"].ToString();      //5
                            GridView1.Rows[index].Cells["Col_txtcus_type_status"].Value = dt2.Rows[j]["txtcus_type_status"].ToString();      //6
        ...
        private void PANEL_FORM1_GridView1()
        {
            ...
            this.GridView1.Columns[1].Name = "Col_txtcus_type_no";
            this.GridView1.Columns[2].Name = "Col_txtcus_type_id";
            this.GridView1.Columns[3].Name = "Col_txtcus_type_name";
            this.GridView1.Columns[4].Name = "Col_txtcus_type_name_eng";
            this.GridView1.Columns[5].Name = "Col_txtcus_type_remark";
            this.GridView1.Columns[6].Name = "Col_txtcus_type_status";

            this.GridView1.Columns[0].HeaderText = "No";
            this.GridView1.Columns[1].HeaderText = "ลำดับ";
            this.GridView1.Columns[2].HeaderText = " รหัส";
            this.GridView1.Columns[3].HeaderText = " ชื่อรหัสประเภทลูกค้า";
            this.GridView1.Columns[4].HeaderText = "ชื่อรหัสประเภทลูกค้า Eng";
            ...
            this.GridView1.Columns[1].Visible = true;  //"Col_txtcus_type_no";
            ...
            this.GridView1.Columns[2].Visible = true;  //"Col_txtcus_type_id";
            ...
            this.GridView1.Columns[3].Visible = true;  //"Col_txtcus_type_name";
            ...
            this.GridView1.Columns[4].Visible = true;  //"Col_txtcus_type_name_eng";
            ...
            this.GridView1.Columns[5].Visible = true;  //"Col_txtcus_type_name_remark";
            ...
            this.GridView1.Columns[6].Visible = false;  //"Col_txtcus_type_status";
        ...
        private void PANEL_FORM1_dataGridView1_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                if (cell != null)
                {
                    ...
                    this.txtcus_type_no.Text = row.Cells[1].Value.ToString();
                    this.txtcus_type_id.Text = row.Cells[2].Value.ToString();
                    this.txtcus_type_name.Text = row.Cells[3].Value.ToString();
                    ...
                    if (conn.State == System.Data.ConnectionState.Open)
                    {
                        ...
                        cmd2.CommandText = "SELECT *" +
                                            " FROM s001_02cus_type" +
                                             " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                             " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                             " AND (txtcus_type_id = '" + this.txtcus_type_id.Text.Trim() + "')" +
                                           " ORDER BY txtcus_type_no ASC";
                        ...
                        try
                        {
                            ...
                            if (dt2.Rows.Count > 0)
                            {
                                for (int j = 0; j < dt2.Rows.Count; j++)
                                {
                                    this.txtcus_type_no.Text = dt2.Rows[j]["txtcus_type_no"].ToString();      //1
                                    this.txtcus_type_id.Text = dt2.Rows[j]["txtcus_type_id"].ToString();      //2
                                    this.txtcus_type_name.Text = dt2.Rows[j]["txtcus_type_name"].ToString();      //3
                                    this.txtcus_type_name_eng.Text = dt2.Rows[j]["txtcus_type_name_eng"].ToString();      //4
                                    this.txtcus_type_remark.Text = dt2.Rows[j]["txtcus_type_remark"].ToString();      //6
                                }
                                this.iblword_status.Text = "แก้ไขรหัสประเภทลูกค้า";
                                this.txtcus_type_id.ReadOnly = true;
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                cmd2.CommandText = "SELECT *" +
                                    " FROM s001_02cus_type" +
                                     " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                     " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                     " AND (txtcus_type_name LIKE '%" + this.PANEL_FORM1_txtsearch.Text.Trim() + "%')" +
                                   " ORDER BY txtcus_type_no ASC";
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            GridView1.Rows[index].Cells["Col_txtcus_type_name"].Value = dt2.Rows[j]["txtcus_type_name"].ToString();      //3
                            GridView1.Rows[index].Cells["Col_txtcus_type_name_eng"].Value = dt2.Rows[j]["txtcus_type_name_eng"].ToString();      //4
                            GridView1.Rows[index].Cells["Col_txtcus_type_remark"].Value = dt2.Rows[j]["txtcus_type_remark"].ToString();      //6
                            GridView1.Rows[index].Cells["Col_txtcus_type_status"].Value = dt2.Rows[j]["txtcus_type_status"].ToString();      //7
        ...
        private void BtnNew_Click(object sender, EventArgs e)
        {
            ...
            this.Hide();
            var frm2 = new HOME05_Sale_02cus_type();
            frm2.Closed += (s, args) => this.Close();
            frm2.Show();

            this.iblword_status.Text = "เพิ่มประเภทลูกค้าใหม่";
            this.txtcus_type_id.ReadOnly = false;
        }
        ...
        private void BtnSave_Click(object sender, EventArgs e)
        {
            if (this.txtcus_type_no.Text == "")
            {
                ...
                this.txtcus_type_no.Focus();
                return;
            }
            else
            {
                if (this.txtcus_type_no.TextLength == 3)
                {
                }
                else
                {
            ...
            if (this.txtcus_type_id.Text == "")
            {
                MessageBox.Show("โปรดใส่รหัสประเภทลูกค้า ก่อน !", "ผลการทำงาน", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                this.txtcus_type_id.Focus();
                return;
            }
            if (this.txtcus_type_name.Text == "")
            {
                MessageBox.Show("โปรดใส่ชื่อรหัสประเภทลูกค้าก่อน !", "ผลการทำงาน", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                this.txtcus_type_name.Focus();
                return;
            }
            ...
            //END เชื่อมต่อฐานข้อมูล=======================================================
            Cursor.Current = Cursors.WaitCursor;
            if (this.iblword_status.Text.Trim() == "เพิ่มรหัสประเภทลูกค้าใหม่")
            {
                conn.Open();
                if (conn.State == System.Data.ConnectionState.Open)
                {
                    ...
                    cmd1.CommandText = "SELECT * FROM s001_02cus_type" +
                                        " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                       " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                       " AND (txtcus_type_id = '" + this.txtcus_type_id.Text.Trim() + "')";
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        MessageBox.Show("รหัสรหัสประเภทลูกค้า นี้ซ้ำ   : '" + this.txtcus_type_id.Text.Trim() + "' โปรดใส่ใหม่ ", "ผลการทำงาน", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                        this.txtcus_type_id.Focus();
                        conn.Close();
                        return;
                    }
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                try
                {
                    if (this.iblword_status.Text.Trim() == "เพิ่มรหัสประเภทลูกค้าใหม่")
                    {
                        cmd2.CommandText = "INSERT INTO s001_02cus_type(cdkey,txtco_id," +  //1
                                           "txtcus_type_no,txtcus_type_id," +  //2
                                           "txtcus_type_name,txtcus_type_name_eng," +  //3
                                          "txtcus_type_remark," +  //5
                                          "txtcus_type_status) " +  //6
                        ...
                        cmd2.Parameters.Add("@txtcus_type_no", SqlDbType.NVarChar).Value = this.txtcus_type_no.Text.ToString();
                        cmd2.Parameters.Add("@txtcus_type_id", SqlDbType.NVarChar).Value = this.txtcus_type_id.Text.ToString();
                        cmd2.Parameters.Add("@txtcus_type_name", SqlDbType.NVarChar).Value = this.txtcus_type_name.Text.ToString();
                        cmd2.Parameters.Add("@txtcus_type_name_eng", SqlDbType.NVarChar).Value = this.txtcus_type_name_eng.Text.ToString();
                        cmd2.Parameters.Add("@txtcus_type_remark", SqlDbType.NVarChar).Value = this.txtcus_type_remark.Text.ToString();
                        cmd2.Parameters.Add("@txtcus_type_status", SqlDbType.NChar).Value = "0";
                        //==============================

                        cmd2.ExecuteNonQuery();

                    }
                    if (this.iblword_status.Text.Trim() == "แก้ไขรหัสประเภทลูกค้า")
                    {
                        cmd2.CommandText = "UPDATE s001_02cus_type SET " +
                                                                     "txtcus_type_no = '" + this.txtcus_type_no.Text.Trim() + "'," +
                                                                     "txtcus_type_name = '" + this.txtcus_type_name.Text.Trim() + "'," +
                                                                     "txtcus_type_name_eng = '" + this.txtcus_type_name_eng.Text.Trim() + "'," +
                                                                     "txtcus_type_remark = '" + this.txtcus_type_remark.Text.ToString() + "'" +
                                                                    " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                                                   " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                                                   " AND (txtcus_type_id = '" + this.txtcus_type_id.Text.Trim() + "')";
                        cmd2.ExecuteNonQuery();
                    ...
                    if (dialogResult == DialogResult.Yes)
                    {
                        ...
                        this.txtcus_type_id.Text = "";
                        this.txtcus_type_name.Text = "";
                        this.txtcus_type_name_eng.Text = "";
                        this.txtcus_type_remark.Text = "";
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                try
                {
                    if (this.iblword_status.Text.Trim() == "ยกเลิกเอกสาร")
                    {
                        ...
                        cmd2.CommandText = "INSERT INTO s001_02cus_type_cancel(cdkey,txtco_id,txtbranch_id," +  //1
                                                                                                                  //"txttrans_date," +
                        ...
                        cmd2.CommandText = "INSERT INTO s001_02cus_type_cancel_detail(cdkey,txtco_id," +  //1
                                             "txtcus_type_no,txtcus_type_id," +  //2
                                             "txtcus_type_name,txtcus_type_name_eng," +  //3
                                             "txtcus_type_remark," +  //4
                                            "txtcus_type_status,cancel_id) " +  //5
                                             "VALUES (@cdkey2,@txtco_id2," +  //1
                                             "@txtcus_type_no,@txtcus_type_id," +  //2
                                             "@txtcus_type_name,@txtcus_type_name_eng," +  //3
                                             "@txtcus_type_remark," +  //4
                                            "@txtcus_type_status,@cancel_id2)";   //5
                        ...
                        cmd2.CommandText = "DELETE FROM s001_02cus_type" +
                                                                    " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                                                    " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                                                   " AND (txtcus_type_id = '" + this.txtcus_type_id.Text.Trim() + "')";
                        cmd2.ExecuteNonQuery();
                    ...
                    DialogResult dialogResult = MessageBox.Show("คุณต้องการ ยกเลิกเอกสาร รหัส  " + this.txtcus_type_id.Text.ToString() + " ใช่หรือไม่่ ?", "โปรดยืนยัน", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question);
                    if (dialogResult == DialogResult.Yes)
                    {
        ...
        private void txtcus_type_id_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            if (e.KeyChar == (char)Keys.Enter && this.txtcus_type_id.Text == "")
            {
                this.txtcus_type_id.Focus();
            }
            //========================================
            else if (e.KeyChar == (char)Keys.Enter && this.txtcus_type_id.Text.Trim() != "")
            {
                this.txtcus_type_no.Focus();
        ...
        private void txtcus_type_no_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == (char)Keys.Enter && this.txtcus_type_no.Text == "")
            {
                this.txtcus_type_no.Focus();
            }
            //========================================
            else if (e.KeyChar == (char)Keys.Enter && this.txtcus_type_no.Text.Trim() != "")
            {
                if (this.txtcus_type_no.TextLength == 3)
                {
                    this.txtcus_type_name.Focus();
            ...
            else if ((e.KeyChar > '9') && (e.KeyChar != '\b') && (e.KeyChar != '.') && txtcus_type_no.Text.Length == 0)
            {
                //e.KeyChar <= '0' || 
                e.Handled = true;
                return;
        ...
        private void txtcus_type_name_KeyDown(object sender, KeyEventArgs e)
        {

        }
        private void txtcus_type_name_eng_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
                this.txtcus_type_remark.Focus();

        }
        private void txtcus_type_name_remark_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
                this.BtnSave.Focus();
            ...
            if (OK.Trim() != "Y")
            {
                ...
                if (conn.State == System.Data.ConnectionState.Open)
                {
                    ...
                    try
                    {
                        ...
                        cmd2.Parameters.Add("@cdkey", SqlDbType.NVarChar).Value = W_ID_Select.CDKEY.Trim();
                        cmd2.Parameters.Add("@txtco_id", SqlDbType.NVarChar).Value = W_ID_Select.M_COID.Trim();
                        cmd2.Parameters.Add("@txtcus_type_no", SqlDbType.NVarChar).Value = "999";
                        cmd2.Parameters.Add("@txtcus_type_id", SqlDbType.NVarChar).Value = "";
                        cmd2.Parameters.Add("@txtcus_type_name", SqlDbType.NVarChar).Value = "";
                        cmd2.Parameters.Add("@txtcus_type_name_eng", SqlDbType.NVarChar).Value = "";
                        cmd2.Parameters.Add("@txtcus_type_remark", SqlDbType.NVarChar).Value = "";
                        cmd2.Parameters.Add("@txtcus_type_status", SqlDbType.NChar).Value = "0";
                        //==============================
