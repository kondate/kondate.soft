...
{
    public partial class HOME05_Sale_02sale_cash : Form
    {
        //Move Form ====================================
        ...
        public HOME05_Sale_02sale_cash()
        {
            InitializeComponent();
        }

        private void HOME05_Sale_02sale_cash_Load(object sender, EventArgs e)
        {
            ...
            W_ID_Select.M_FORM_NUMBER = "H0312FGGR";
            CHECK_ADD_FORM();

            CHECK_USER_RULE();

            this.iblword_top.Text = W_ID_Select.WORD_TOP.Trim();
            this.iblword_status.Text = "ระเบียนขายสด";
            ...
            //========================================
            this.cboSearch.Items.Add("เลขที่ขายสด");
            this.cboSearch.Items.Add("รหัสลูกค้า");
            this.cboSearch.Items.Add("ชื่อลูกค้า");
            //this.cboSearch.Items.Add("ค้างชำระ");
            //this.cboSearch.Text = "ชื่อลูกค้า";
            this.cboSearch.Text = "รหัสลูกค้า";
            //========================================
        ...
        private void Fill_Show_DATA_GridView1()
        {
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                cmd2.CommandText = "SELECT s001_01sale_cash_record.*," +
                                    "s001_03cus.*" +

                                   " FROM s001_01sale_cash_record" +

                                   " INNER JOIN s001_03cus" +
                                   " ON s001_01sale_cash_record.cdkey = s001_03cus.cdkey" +
                                   " AND s001_01sale_cash_record.txtco_id = s001_03cus.txtco_id" +
                                   " AND s001_01sale_cash_record.txtcus_id = s001_03cus.txtcus_id" +


                                   " WHERE (s001_01sale_cash_record.cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                   " AND (s001_01sale_cash_record.txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                  //" AND (s001_01sale_cash_record.txtbranch_id = '" + W_ID_Select.M_BRANCHID.Trim() + "')" +
                                  " AND (s001_01sale_cash_record.txttrans_date_server BETWEEN @datestart AND @dateend)" +
                                  //" AND (s001_01sale_cash_record.txtSC_id = '" + this.txtsearch.Text.Trim() + "')" +
                                  " ORDER BY s001_01sale_cash_record.txtSC_id ASC";
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        ...
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            this.GridView1.Rows[index].Cells["Col_txtSC_id"].Value = dt2.Rows[j]["txtSC_id"].ToString();      //3
                            ...
                            this.GridView1.Rows[index].Cells["Col_txtcus_id"].Value = dt2.Rows[j]["txtcus_id"].ToString();      //6
                            this.GridView1.Rows[index].Cells["Col_txtcus_name"].Value = dt2.Rows[j]["txtcus_name"].ToString();      //7

                            this.GridView1.Rows[index].Cells["Col_txtsum_qty_de"].Value = Convert.ToSingle(dt2.Rows[j]["txtsum_qty_de"]).ToString("###,###.00");      //8
                            this.GridView1.Rows[index].Cells["Col_txtmoney_tax_base"].Value = Convert.ToSingle(dt2.Rows[j]["txtmoney_tax_base"]).ToString("###,###.00");      //9
                            this.GridView1.Rows[index].Cells["Col_txtvat_money"].Value = Convert.ToSingle(dt2.Rows[j]["txtvat_money"]).ToString("###,###.00");      //10
                            this.GridView1.Rows[index].Cells["Col_txtmoney_after_vat"].Value = Convert.ToSingle(dt2.Rows[j]["txtmoney_after_vat"]).ToString("###,###.00");      //11

                            this.GridView1.Rows[index].Cells["Col_txtmoney_after_vat_creditor"].Value = Convert.ToSingle(dt2.Rows[j]["txtmoney_after_vat_creditor"]).ToString("###,###.00");      //12

                            //FG ==============================
                            if (dt2.Rows[j]["txtsc_status"].ToString() == "")
                            {
                                this.GridView1.Rows[index].Cells["Col_txtsc_status"].Value = ""; //8
                            }
                            else if (dt2.Rows[j]["txtsc_status"].ToString() == "0")
                            {
                                this.GridView1.Rows[index].Cells["Col_txtsc_status"].Value = ""; //8
                            }
                            else if (dt2.Rows[j]["txtsc_status"].ToString() == "1")
                            {
                                this.GridView1.Rows[index].Cells["Col_txtsc_status"].Value = "ยกเลิก"; //8
                            }
        ...
        private void Show_GridView1()
        {
            ...
            this.GridView1.Columns[3].Name = "Col_txtSC_id";
            this.GridView1.Columns[4].Name = "Col_txttrans_date_server";
            this.GridView1.Columns[5].Name = "Col_txttrans_time";

            this.GridView1.Columns[6].Name = "Col_txtcus_id";
            this.GridView1.Columns[7].Name = "Col_txtcus_name";

            this.GridView1.Columns[8].Name = "Col_txtsum_qty_de";
            this.GridView1.Columns[9].Name = "Col_txtmoney_tax_base";
            this.GridView1.Columns[10].Name = "Col_txtvat_money";
            this.GridView1.Columns[11].Name = "Col_txtmoney_after_vat";

            this.GridView1.Columns[12].Name = "Col_txtmoney_after_vat_creditor";
            this.GridView1.Columns[13].Name = "Col_txtsc_status";  //
            this.GridView1.Columns[14].Name = "Col_txtIV_id";
            ...
            this.GridView1.Columns[3].HeaderText = " เลขที่ขายสด";
            this.GridView1.Columns[4].HeaderText = " วันที่";
            this.GridView1.Columns[5].HeaderText = " เวลา";

            this.GridView1.Columns[6].HeaderText = " รหัสลูกค้า";
            this.GridView1.Columns[7].HeaderText = " ชื่อลูกค้า";

            this.GridView1.Columns[8].HeaderText = " จำนวน";
            this.GridView1.Columns[9].HeaderText = " ฐานภาษี";
            this.GridView1.Columns[10].HeaderText = " ภาษี";
            this.GridView1.Columns[11].HeaderText = " รวมทั้งสิ้น";

            this.GridView1.Columns[12].HeaderText = "  ";
            this.GridView1.Columns[13].HeaderText = " สถานะ";
            this.GridView1.Columns[14].HeaderText = "เลขที่ใบกำกับภาษี";
            ...
            this.GridView1.Columns["Col_txtSC_id"].Visible = true;  //"Col_txtSC_id";
            this.GridView1.Columns["Col_txtSC_id"].Width = 150;
            this.GridView1.Columns["Col_txtSC_id"].ReadOnly = true;
            this.GridView1.Columns["Col_txtSC_id"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.GridView1.Columns["Col_txtSC_id"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
            ...
            this.GridView1.Columns["Col_txtcus_id"].Visible = true;  //"Col_txtcus_id";
            this.GridView1.Columns["Col_txtcus_id"].Width = 120;
            this.GridView1.Columns["Col_txtcus_id"].ReadOnly = true;
            this.GridView1.Columns["Col_txtcus_id"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.GridView1.Columns["Col_txtcus_id"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;

            this.GridView1.Columns["Col_txtcus_name"].Visible = true;  //"Col_txtcus_name";
            this.GridView1.Columns["Col_txtcus_name"].Width = 250;
            this.GridView1.Columns["Col_txtcus_name"].ReadOnly = true;
            this.GridView1.Columns["Col_txtcus_name"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.GridView1.Columns["Col_txtcus_name"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;


            this.GridView1.Columns["Col_txtsum_qty_de"].Visible = true;  //"Col_txtsum_qty_de";
            this.GridView1.Columns["Col_txtsum_qty_de"].Width = 100;
            this.GridView1.Columns["Col_txtsum_qty_de"].ReadOnly = true;
            this.GridView1.Columns["Col_txtsum_qty_de"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.GridView1.Columns["Col_txtsum_qty_de"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;

            this.GridView1.Columns["Col_txtmoney_tax_base"].Visible = true;  //"Col_txtmoney_tax_base";
            this.GridView1.Columns["Col_txtmoney_tax_base"].Width = 100;
            this.GridView1.Columns["Col_txtmoney_tax_base"].ReadOnly = true;
            this.GridView1.Columns["Col_txtmoney_tax_base"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.GridView1.Columns["Col_txtmoney_tax_base"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;

            this.GridView1.Columns["Col_txtvat_money"].Visible = true;  //"Col_txtvat_money";
            this.GridView1.Columns["Col_txtvat_money"].Width = 100;
            this.GridView1.Columns["Col_txtvat_money"].ReadOnly = true;
            this.GridView1.Columns["Col_txtvat_money"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.GridView1.Columns["Col_txtvat_money"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;

            this.GridView1.Columns["Col_txtmoney_after_vat"].Visible = true;  //"Col_txtmoney_after_vat";
            this.GridView1.Columns["Col_txtmoney_after_vat"].Width = 100;
            ...
            this.GridView1.Columns["Col_txtmoney_after_vat_creditor"].Visible = false;  //"Col_txtmoney_after_vat_creditor";
            this.GridView1.Columns["Col_txtmoney_after_vat_creditor"].Width = 0;
            ...
            this.GridView1.Columns["Col_txtsc_status"].Visible = true;  //"Col_txtsc_status";
            this.GridView1.Columns["Col_txtsc_status"].Width = 70;
            this.GridView1.Columns["Col_txtsc_status"].ReadOnly = true;
            this.GridView1.Columns["Col_txtsc_status"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.GridView1.Columns["Col_txtsc_status"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;

            this.GridView1.Columns["Col_txtIV_id"].Visible = true;  //"Col_txtIV_id";
            this.GridView1.Columns["Col_txtIV_id"].Width = 150;
            this.GridView1.Columns["Col_txtIV_id"].ReadOnly = true;
            this.GridView1.Columns["Col_txtIV_id"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.GridView1.Columns["Col_txtIV_id"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
        ...
        private void GridView1_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                W_ID_Select.TRANS_ID = row.Cells["Col_txtSC_id"].Value.ToString();

                //this.cboSearch.Items.Add("เลขที่ขายสด");
                //this.cboSearch.Items.Add("ชื่อลูกค้า");

                var cell = row.Cells["Col_txtSC_id"].Value.ToString();
                if (cell != null)
                {
                    W_ID_Select.TRANS_ID = row.Cells["Col_txtSC_id"].Value.ToString();
                    this.cboSearch.Text = "เลขที่ขายสด";

                    if (this.cboSearch.Text == "เลขที่ขายสด")
                    {
                        this.txtsearch.Text = row.Cells["Col_txtSC_id"].Value.ToString();
                        W_ID_Select.TRANS_ID = row.Cells["Col_txtSC_id"].Value.ToString();

                    }
                    else if (this.cboSearch.Text == "รหัสลูกค้า")
                    {
                        this.txtsearch.Text = row.Cells["Col_txtcus_id"].Value.ToString();

                    }
                    else if (this.cboSearch.Text == "ชื่อลูกค้า")
                    {
                        this.txtsearch.Text = row.Cells["Col_txtcus_name"].Value.ToString();
        ...
        private void GridView1_DoubleClick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                W_ID_Select.WORD_TOP = "ดูข้อมูลขายสด";
                kondate.soft.HOME05_Sales.HOME05_Sale_01sale_record_detail frm2 = new kondate.soft.HOME05_Sales.HOME05_Sale_01sale_record_detail();
                frm2.Show();
        ...
        private void btnGo4_Click(object sender, EventArgs e)
        {
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                if (this.cboSearch.Text.Trim() == "เลขที่ขายสด")
                {
                    cmd2.CommandText = "SELECT s001_01sale_cash_record.*," +
                                        "s001_03cus.*" +
                ...
                else if (this.cboSearch.Text.Trim() == "รหัสลูกค้า")
                {
                    cmd2.CommandText = "SELECT s001_01sale_cash_record.*," +
                                        "s001_03cus.*" +
                                      ...
                                      //" AND (s001_01sale_cash_record.txtbranch_id = '" + W_ID_Select.M_BRANCHID.Trim() + "')" +
                                      //" AND (s001_01sale_cash_record.txttrans_date_server BETWEEN @datestart AND @dateend)" +
                                      " AND (s001_01sale_cash_record.txtcus_id = '" + this.txtsearch.Text.Trim() + "')" +
                                      " ORDER BY s001_01sale_cash_record.txtSC_id ASC";

                }
                else if (this.cboSearch.Text.Trim() == "ชื่อลูกค้า")
                {
                    cmd2.CommandText = "SELECT s001_01sale_cash_record.*," +
                                        "s001_03cus.*" +
                                      ...
                                      //" AND (s001_01sale_cash_record.txtbranch_id = '" + W_ID_Select.M_BRANCHID.Trim() + "')" +
                                      //" AND (s001_01sale_cash_record.txttrans_date_server BETWEEN @datestart AND @dateend)" +
                                      " AND (s001_03cus.txtcus_name LIKE '%" + this.txtsearch.Text.Trim() + "%')" +
                                      " ORDER BY s001_01sale_cash_record.txtSC_id ASC";
        ...
        private void btnopen_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                W_ID_Select.LOG_NAME = "เปิดแก้ไข";
                W_ID_Select.WORD_TOP = "ดูข้อมูลขายสด";
                kondate.soft.HOME05_Sales.HOME05_Sale_02sale_cash_record_detail frm2 = new kondate.soft.HOME05_Sales.HOME05_Sale_02sale_cash_record_detail();
                frm2.Show();
