...
{
    public partial class HOME05_Sale_01sale : Form
    {
        //Move Form ====================================
        ...
        public HOME05_Sale_01sale()
        {
            InitializeComponent();
        }

        private void HOME05_Sale_01sale_Load(object sender, EventArgs e)
        {
            ...
            this.iblword_status.Text = "ระเบียนใบส่งสินค้า";
            ...
            //========================================
            this.cboSearch.Items.Add("เลขที่ใบส่งสินค้า");
        ...
        private void Fill_Show_DATA_GridView1()
        {
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                cmd2.CommandText = "SELECT s001_01sale_record.*," +
                                  ...
                                  " AND (s001_01sale_record.txttrans_date_server BETWEEN @datestart AND @dateend)" +
                                  //" AND (s001_01sale_record.txtDE_id = '" + this.txtsearch.Text.Trim() + "')" +
                                  " ORDER BY s001_01sale_record.txtDE_id ASC";
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        ...
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            this.GridView1.Rows[index].Cells["Col_txtDE_id"].Value = dt2.Rows[j]["txtDE_id"].ToString();      //3
                            ...
                            //FG ==============================
                            if (dt2.Rows[j]["txtde_status"].ToString() == "")
                            {
                                this.GridView1.Rows[index].Cells["Col_txtde_status"].Value = ""; //8
                            }
                            else if (dt2.Rows[j]["txtde_status"].ToString() == "0")
                            {
                                this.GridView1.Rows[index].Cells["Col_txtde_status"].Value = ""; //8
                            }
                            else if (dt2.Rows[j]["txtde_status"].ToString() == "1")
                            {
                                this.GridView1.Rows[index].Cells["Col_txtde_status"].Value = "ยกเลิก"; //8
                            }
        ...
        private void Show_GridView1()
        {
            ...
            this.GridView1.Columns[3].Name = "Col_txtDE_id";
            ...
            this.GridView1.Columns[13].Name = "Col_txtde_status";  //
            ...
            this.GridView1.Columns[3].HeaderText = " เลขที่ใบส่งสินค้า";
            ...
            this.GridView1.Columns[12].HeaderText = " ค้างชำระ ";
            ...
            this.GridView1.Columns["Col_txtDE_id"].Visible = true;  //"Col_txtDE_id";
            this.GridView1.Columns["Col_txtDE_id"].Width = 150;
            this.GridView1.Columns["Col_txtDE_id"].ReadOnly = true;
            this.GridView1.Columns["Col_txtDE_id"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.GridView1.Columns["Col_txtDE_id"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
            ...
            this.GridView1.Columns["Col_txtmoney_after_vat_creditor"].Width = 100;
            ...
            this.GridView1.Columns["Col_txtde_status"].Visible = true;  //"Col_txtde_status";
            this.GridView1.Columns["Col_txtde_status"].Width = 70;
            this.GridView1.Columns["Col_txtde_status"].ReadOnly = true;
            this.GridView1.Columns["Col_txtde_status"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.GridView1.Columns["Col_txtde_status"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
        ...
        private void GridView1_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                W_ID_Select.TRANS_ID = row.Cells["Col_txtDE_id"].Value.ToString();

                //this.cboSearch.Items.Add("เลขที่ใบส่งสินค้า");
                //this.cboSearch.Items.Add("ชื่อลูกค้า");

                var cell = row.Cells["Col_txtDE_id"].Value.ToString();
                if (cell != null)
                {
                    W_ID_Select.TRANS_ID = row.Cells["Col_txtDE_id"].Value.ToString();
                    this.cboSearch.Text = "เลขที่ใบส่งสินค้า";

                    if (this.cboSearch.Text == "เลขที่ใบส่งสินค้า")
                    {
                        this.txtsearch.Text = row.Cells["Col_txtDE_id"].Value.ToString();
                        W_ID_Select.TRANS_ID = row.Cells["Col_txtDE_id"].Value.ToString();
        ...
        private void GridView1_DoubleClick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                W_ID_Select.WORD_TOP = "ดูข้อมูลใบส่งสินค้า";
        ...
        private void btnGo4_Click(object sender, EventArgs e)
        {
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                if (this.cboSearch.Text.Trim() == "เลขที่ใบส่งสินค้า")
                {
                    cmd2.CommandText = "SELECT s001_01sale_record.*," +
                                        "s001_03cus.*" +
                ...
                else if (this.cboSearch.Text.Trim() == "รหัสลูกค้า")
                {
                    cmd2.CommandText = "SELECT s001_01sale_record.*," +
                                      ...
                                      //" AND (s001_01sale_record.txtbranch_id = '" + W_ID_Select.M_BRANCHID.Trim() + "')" +
                                      //" AND (s001_01sale_record.txttrans_date_server BETWEEN @datestart AND @dateend)" +
                                      " AND (s001_01sale_record.txtcus_id = '" + this.txtsearch.Text.Trim() + "')" +
                                      " ORDER BY s001_01sale_record.txtDE_id ASC";
                ...
                //ค้างชำระ
                else if (this.cboSearch.Text.Trim() == "ค้างชำระ")
                {
                    cmd2.CommandText = "SELECT s001_01sale_record.*," +
                                        "s001_03cus.*" +
                                      ...
                                      //" AND (s001_01sale_record.txtbranch_id = '" + W_ID_Select.M_BRANCHID.Trim() + "')" +
                                      //" AND (s001_01sale_record.txttrans_date_server BETWEEN @datestart AND @dateend)" +
                                      " AND (s001_01sale_record.txtmoney_after_vat_creditor > 0)" +
                                      " ORDER BY s001_01sale_record.txtDE_id ASC";
        ...
        private void BtnNew_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                W_ID_Select.WORD_TOP = "บันทึกใบส่งสินค้า";
