...
{
    public partial class Form_c001_03berg_type : Form
    {
        //Move Form ====================================
        ...
        public Form_c001_03berg_type()
        {
            InitializeComponent();
        }

        private void Form_c001_03berg_type_Load(object sender, EventArgs e)
        {
        ...
        private void PANEL0103_BERG_TYPE_GridView1_berg_type()
        {
            ...
            this.PANEL0103_BERG_TYPE_dataGridView1_berg_type.Columns[3].HeaderText = " ชื่อรหัสประเภทเบิกคลัง";
            this.PANEL0103_BERG_TYPE_dataGridView1_berg_type.Columns[4].HeaderText = "ชื่อรหัสประเภทเบิกคลัง Eng";
