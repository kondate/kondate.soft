...
{
    public partial class Form_b001_05mat_unit1 : Form
    {
        //Move Form ====================================
        ...
        public Form_b001_05mat_unit1()
        {
            InitializeComponent();
        }

        private void Form_b001_05mat_unit1_Load(object sender, EventArgs e)
        {
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            PANEL105_MAT_UNIT1_dataGridView1_mat_unit.Rows[index].Cells["Col_txtmat_unit_id"].Value = dt2.Rows[j]["txtmat_unit1_id"].ToString();      //1
                            PANEL105_MAT_UNIT1_dataGridView1_mat_unit.Rows[index].Cells["Col_txtmat_unit_name"].Value = dt2.Rows[j]["txtmat_unit1_name"].ToString();      //2
                            PANEL105_MAT_UNIT1_dataGridView1_mat_unit.Rows[index].Cells["Col_txtmat_unit_name_eng"].Value = dt2.Rows[j]["txtmat_unit1_name_eng"].ToString();      //3
                        }
                        //=======================================================
                    }
                    else
        ...
        private void PANEL105_MAT_UNIT1_GridView1_mat_unit()
        {
            ...
            this.PANEL105_MAT_UNIT1_dataGridView1_mat_unit.Columns[1].Name = "Col_txtmat_unit_id";
            this.PANEL105_MAT_UNIT1_dataGridView1_mat_unit.Columns[2].Name = "Col_txtmat_unit_name";
            this.PANEL105_MAT_UNIT1_dataGridView1_mat_unit.Columns[3].Name = "Col_txtmat_unit_name_eng";
            ...
            this.PANEL105_MAT_UNIT1_dataGridView1_mat_unit.Columns[1].Visible = true;  //"Col_txt mat_unit_id";
            ...
            this.PANEL105_MAT_UNIT1_dataGridView1_mat_unit.Columns[2].Visible = true;  //"Col_txt mat_unit_name";
            ...
            this.PANEL105_MAT_UNIT1_dataGridView1_mat_unit.Columns[3].Visible = true;  //"Col_txt mat_unit_name_eng";
        ...
        private void PANEL105_MAT_UNIT1_txtmat_unit_name_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
                ...
                if (this.PANEL105_MAT_UNIT1.Visible == false)
                {
                    ...
                    this.PANEL105_MAT_UNIT1.Location = new Point(this.PANEL105_MAT_UNIT1_txtmat_unit_name.Location.X, this.PANEL105_MAT_UNIT1_txtmat_unit_name.Location.Y + 22);
        ...
        private void PANEL105_MAT_UNIT1_dataGridView1_mat_unit_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                if (cell != null)
                {
                    this.PANEL105_MAT_UNIT1_txtmat_unit_id.Text = row.Cells[1].Value.ToString();
                    this.PANEL105_MAT_UNIT1_txtmat_unit_name.Text = row.Cells[2].Value.ToString();
                }
            }
        }
        private void PANEL105_MAT_UNIT1_dataGridView1_mat_unit_PreviewKeyDown(object sender, PreviewKeyDownEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                ...
                this.PANEL105_MAT_UNIT1_txtmat_unit_id.Text = PANEL105_MAT_UNIT1_dataGridView1_mat_unit.CurrentRow.Cells[1].Value.ToString();
                this.PANEL105_MAT_UNIT1_txtmat_unit_name.Text = PANEL105_MAT_UNIT1_dataGridView1_mat_unit.CurrentRow.Cells[2].Value.ToString();
                this.PANEL105_MAT_UNIT1_txtmat_unit_name.Focus();
                this.PANEL105_MAT_UNIT1.Visible = false;
            }
        }
        ...
        private void PANEL105_MAT_UNIT1_btn_search_Click(object sender, EventArgs e)
        {
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                cmd2.CommandText = "SELECT *" +
                                  " FROM b001_05mat_unit1" +
                                   " WHERE (txt mat_unit_name LIKE '%" + this.PANEL105_MAT_UNIT1_txtsearch.Text + "%')" +
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            var index = PANEL105_MAT_UNIT1_dataGridView1_mat_unit.Rows.Add();
                            PANEL105_MAT_UNIT1_dataGridView1_mat_unit.Rows[index].Cells["Col_Auto_num"].Value = ""; //0
                            PANEL105_MAT_UNIT1_dataGridView1_mat_unit.Rows[index].Cells["Col_txt mat_unit_id"].Value = dt2.Rows[j]["txt mat_unit_id"].ToString();      //1
                            PANEL105_MAT_UNIT1_dataGridView1_mat_unit.Rows[index].Cells["Col_txt mat_unit_name"].Value = dt2.Rows[j]["txt mat_unit_name"].ToString();      //2
                            PANEL105_MAT_UNIT1_dataGridView1_mat_unit.Rows[index].Cells["Col_txt mat_unit_name_eng"].Value = dt2.Rows[j]["txt mat_unit_name_eng"].ToString();      //3
                        }
                        //=======================================================
                    }
                    else
