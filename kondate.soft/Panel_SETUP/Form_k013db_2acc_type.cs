...
{
    public partial class Form_k013db_2acc_type : Form
    {
        //Move Form ====================================
        ...
        public Form_k013db_2acc_type()
        {
            InitializeComponent();
        }

        private void Form_k013db_2acc_type_Load(object sender, EventArgs e)
        {
        ...
        private void PANEL32_ACC_TYPE_GridView1_acc_type()
        {
            ...
            this.PANEL32_ACC_TYPE_dataGridView1_acc_type.Columns[1].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            ...
            this.PANEL32_ACC_TYPE_dataGridView1_acc_type.Columns[2].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            ...
            this.PANEL32_ACC_TYPE_dataGridView1_acc_type.Columns[3].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
        ...
        private void PANEL32_ACC_TYPE_dataGridView1_acc_type_CellMouseClick_1(object sender, DataGridViewCellMouseEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                DataGridViewRow row = this.PANEL32_ACC_TYPE_dataGridView1_acc_type.Rows[e.RowIndex];
