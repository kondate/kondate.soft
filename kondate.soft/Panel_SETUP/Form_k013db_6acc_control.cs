...
{
    public partial class Form_k013db_6acc_control : Form
    {
        //Move Form ====================================
        ...
        public Form_k013db_6acc_control()
        {
            InitializeComponent();
        }

        private void Form_k013db_6acc_control_Load(object sender, EventArgs e)
        {
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            PANEL36_ACC_CONTROL_dataGridView1_acc_control.Rows[index].Cells["Col_txtdegree_id"].Value = dt2.Rows[j]["txtdegree_id"].ToString();      //3
                        }
                        //=======================================================
                    }
                    else
        ...
        private void PANEL36_ACC_CONTROL_GridView1_acc_control()
        {
            ...
            this.PANEL36_ACC_CONTROL_dataGridView1_acc_control.Columns[4].Name = "Col_txtdegree_id";
            ...
            this.PANEL36_ACC_CONTROL_dataGridView1_acc_control.Columns[1].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            ...
            this.PANEL36_ACC_CONTROL_dataGridView1_acc_control.Columns[2].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            ...
            this.PANEL36_ACC_CONTROL_dataGridView1_acc_control.Columns[3].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            ...
            this.PANEL36_ACC_CONTROL_dataGridView1_acc_control.Columns[4].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
        ...
        private void PANEL36_ACC_CONTROL_txtacc_name_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
                ...
                if (this.PANEL36_ACC_CONTROL.Visible == false)
                {
                    ...
                    this.PANEL36_ACC_CONTROL.Location = new Point(116, this.PANEL36_ACC_CONTROL_txtacc_name.Location.Y + 22);
