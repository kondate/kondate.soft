...
{
    public partial class Form_c001_04produce_type : Form
    {
        //Move Form ====================================
        ...
        public Form_c001_04produce_type()
        {
            InitializeComponent();
        }

        private void Form_c001_04produce_type_Load(object sender, EventArgs e)
        {
        ...
        //txtproduce_type ประเภทผลิตเสร็จ  =======================================================================
        ...
        private void PANEL0104_PRODUCE_TYPE_GridView1_produce_type()
        {
            ...
            this.PANEL0104_PRODUCE_TYPE_dataGridView1_produce_type.Columns[3].HeaderText = " ชื่อรหัสประเภทผลิตเสร็จ";
            this.PANEL0104_PRODUCE_TYPE_dataGridView1_produce_type.Columns[4].HeaderText = "ชื่อรหัสประเภทผลิตเสร็จ Eng";
        ...
        //END txtproduce_type ประเภทผลิตเสร็จ  =======================================================================
