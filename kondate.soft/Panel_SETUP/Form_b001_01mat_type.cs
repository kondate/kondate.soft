...
{
    public partial class Form_b001_01mat_type : Form
    {
        //Move Form ====================================
        ...
        public Form_b001_01mat_type()
        {
            InitializeComponent();
        }

        private void Form_b001_01mat_type_Load(object sender, EventArgs e)
        {
        ...
        private void PANEL101_MAT_TYPE_txtmat_type_name_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
                ...
                if (this.PANEL101_MAT_TYPE.Visible == false)
                {
                    ...
                    this.PANEL101_MAT_TYPE.Location = new Point(this.PANEL101_MAT_TYPE_txtmat_type_name.Location.X, this.PANEL101_MAT_TYPE_txtmat_type_name.Location.Y + 22);
