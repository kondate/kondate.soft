...
{
    public partial class Form_k013_1db_acc_10code_bank_branch : Form
    {
        //Move Form ====================================
        ...
        public Form_k013_1db_acc_10code_bank_branch()
        {
            InitializeComponent();
        }

        private void Form_k013_1db_acc_10code_bank_branch_Load(object sender, EventArgs e)
        {
        ...
        private void PANEL1310_CODE_BANK_BRANCH_txtcode_bank_branch_name_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
                ...
                if (this.PANEL1310_CODE_BANK_BRANCH.Visible == false)
                {
                    ...
                    this.PANEL1310_CODE_BANK_BRANCH.Location = new Point(this.PANEL1310_CODE_BANK_BRANCH_txtcode_bank_branch_name.Location.X, this.PANEL1310_CODE_BANK_BRANCH_txtcode_bank_branch_name.Location.Y + 22);
                    this.PANEL1310_CODE_BANK_BRANCH_dataGridView1_code_bank_branch.Focus();
                }
                else
                {
