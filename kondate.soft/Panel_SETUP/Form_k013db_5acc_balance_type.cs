...
{
    public partial class Form_k013db_5acc_balance_type : Form
    {
        //Move Form ====================================
        ...
        public Form_k013db_5acc_balance_type()
        {
            InitializeComponent();
        }

        private void Form_k013db_5acc_balance_type_Load(object sender, EventArgs e)
        {
        ...
        private void PANEL35_ACC_BALANCE_TYPE_GridView1_acc_balance_type()
        {
            ...
            this.PANEL35_ACC_BALANCE_TYPE_dataGridView1_acc_balance_type.Columns[1].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            ...
            this.PANEL35_ACC_BALANCE_TYPE_dataGridView1_acc_balance_type.Columns[2].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
        ...
        private void PANEL35_ACC_BALANCE_TYPE_txtacc_balance_type_name_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
                ...
                if (this.PANEL35_ACC_BALANCE_TYPE.Visible == false)
                {
                    ...
                    this.PANEL35_ACC_BALANCE_TYPE.Location = new Point(116, this.PANEL35_ACC_BALANCE_TYPE_txtacc_balance_type_name.Location.Y + 22);
