...
{
    public partial class HOME12_Set_license_02_user_type : Form
    {
        //Move Form ====================================
        ...
        public HOME12_Set_license_02_user_type()
        {
            InitializeComponent();
        }

        private void HOME12_Set_license_02_Load(object sender, EventArgs e)
        {
            ...
            W_ID_Select.M_FORM_NUMBER = "1202";
            CHECK_ADD_FORM();
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            PANEL_FORM1_dataGridView1.Rows[index].Cells["Col_txtuser_type_id"].Value = dt2.Rows[j]["txtuser_type_id"].ToString();      //1
                            PANEL_FORM1_dataGridView1.Rows[index].Cells["Col_txtuser_type_name"].Value = dt2.Rows[j]["txtuser_type_name"].ToString();      //2
                        }
                        //=======================================================
                    }
                    else
        ...
        {
            this.PANEL_FORM1_dataGridView1.ColumnCount = 3;
            this.PANEL_FORM1_dataGridView1.Columns[0].Name = "Col_Auto_num";
            this.PANEL_FORM1_dataGridView1.Columns[1].Name = "Col_txtuser_type_id";
            this.PANEL_FORM1_dataGridView1.Columns[2].Name = "Col_txtuser_type_name";

            this.PANEL_FORM1_dataGridView1.Columns[0].HeaderText = "No";
            this.PANEL_FORM1_dataGridView1.Columns[1].HeaderText = "รหัส";
            this.PANEL_FORM1_dataGridView1.Columns[2].HeaderText = " ประเภทผู้ใช้";

            this.PANEL_FORM1_dataGridView1.Columns[0].Visible = false;  //"No";
            this.PANEL_FORM1_dataGridView1.Columns[1].Visible = true;  //"Col_txtuser_type_id";
            ...
            this.PANEL_FORM1_dataGridView1.Columns[2].Visible = true;  //"Col_txtuser_type_name";
            ...
            this.PANEL_FORM1_dataGridView1.Columns[2].AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
