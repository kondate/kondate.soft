...
{
    public partial class Home_SETUP_Enter_4WH_09 : Form
    {
        //Move Form ====================================
        ...
        public Home_SETUP_Enter_4WH_09()
        {
            InitializeComponent();
        }
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            PANEL_FORM1_dataGridView1.Rows[index].Cells["Col_txtbom_no"].Value = dt2.Rows[j]["txtbom_no"].ToString();      //1
                            PANEL_FORM1_dataGridView1.Rows[index].Cells["Col_txtbom_id"].Value = dt2.Rows[j]["txtbom_id"].ToString();      //2
                            PANEL_FORM1_dataGridView1.Rows[index].Cells["Col_txtbom_name"].Value = dt2.Rows[j]["txtbom_name"].ToString();      //3
                            PANEL_FORM1_dataGridView1.Rows[index].Cells["Col_txtbom_name_eng"].Value = dt2.Rows[j]["txtbom_name_eng"].ToString();      //4
                            PANEL_FORM1_dataGridView1.Rows[index].Cells["Col_txtbom_remark"].Value = dt2.Rows[j]["txtbom_remark"].ToString();      //5
                            PANEL_FORM1_dataGridView1.Rows[index].Cells["Col_txtbom_status"].Value = dt2.Rows[j]["txtbom_status"].ToString();      //6
        ...
        private void PANEL_FORM1_GridView1()
        {
            ...
            this.PANEL_FORM1_dataGridView1.Columns[3].HeaderText = " ชื่อBOM";
            this.PANEL_FORM1_dataGridView1.Columns[4].HeaderText = "ชื่อBOM Eng";
            ...
            this.PANEL_FORM1_dataGridView1.Columns[1].Visible = true;  //"Col_txtbom_no";
            ...
            this.PANEL_FORM1_dataGridView1.Columns[2].Visible = true;  //"Col_txtbom_id";
            ...
            this.PANEL_FORM1_dataGridView1.Columns[3].Visible = true;  //"Col_txtbom_name";
            ...
            this.PANEL_FORM1_dataGridView1.Columns[4].Visible = true;  //"Col_txtbom_name_eng";
            ...
            this.PANEL_FORM1_dataGridView1.Columns[5].Visible = true;  //"Col_txtbom_remark";
            ...
            this.PANEL_FORM1_dataGridView1.Columns[6].Visible = false;  //"Col_txtbom_status";
        ...
        private void BtnNew_Click(object sender, EventArgs e)
        {
            ...
            this.Hide();
            var frm2 = new Home_SETUP_Enter_4WH_09();
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                try
                {
                    if (this.iblword_status.Text.Trim() == "เพิ่มBOMใหม่")
                    {
                        ...
                        {
                            if (this.Mat_dataGridView1.Rows[i].Cells[2].Value.ToString() != "")
                            {
                                if (this.Mat_dataGridView1.Rows[i].Cells[5].Value.ToString() == "")
                                {
        ...
        private void PANEL_MAT_GridView1_Cal_Sum()
        {
            ...
            for (int i = 0; i < this.PANEL_MAT_GridView1.Rows.Count - 0; i++)
            {
                ...
                if (valu != "")
                {
                    if (this.PANEL_MAT_GridView1.Rows[i].Cells[0].Value.ToString() == "")
                    {
                        this.PANEL_MAT_GridView1.Rows[i].Cells[0].Value = k.ToString();
                    }
                    if (this.PANEL_MAT_GridView1.Rows[i].Cells[5].Value.ToString() == "")
                    {
                        this.PANEL_MAT_GridView1.Rows[i].Cells[5].Value = "0";
                    }
                    if (this.PANEL_MAT_GridView1.Rows[i].Cells[6].Value.ToString() == "")
                    {
                        this.PANEL_MAT_GridView1.Rows[i].Cells[6].Value = "0";
                    }
                    if (this.PANEL_MAT_GridView1.Rows[i].Cells[7].Value.ToString() == "")
                    {
                        this.PANEL_MAT_GridView1.Rows[i].Cells[7].Value = "0";
                    }
                    if (this.PANEL_MAT_GridView1.Rows[i].Cells[8].Value.ToString() == "")
                    {
