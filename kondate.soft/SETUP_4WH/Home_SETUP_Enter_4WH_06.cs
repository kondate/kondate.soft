...
namespace kondate.soft.SETUP_4WH
{
    public partial class Home_SETUP_Enter_4WH_06 : Form
    {
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            PANEL_FORM1_dataGridView1.Rows[index].Cells["Col_txtmat_unit2_no"].Value = dt2.Rows[j]["txtmat_unit2_no"].ToString();      //1
                            PANEL_FORM1_dataGridView1.Rows[index].Cells["Col_txtmat_unit2_id"].Value = dt2.Rows[j]["txtmat_unit2_id"].ToString();      //2
                            PANEL_FORM1_dataGridView1.Rows[index].Cells["Col_txtmat_unit2_name"].Value = dt2.Rows[j]["txtmat_unit2_name"].ToString();      //3
                            PANEL_FORM1_dataGridView1.Rows[index].Cells["Col_txtmat_unit2_name_eng"].Value = dt2.Rows[j]["txtmat_unit2_name_eng"].ToString();      //4
                            PANEL_FORM1_dataGridView1.Rows[index].Cells["Col_txtmat_unit2_name_remark"].Value = dt2.Rows[j]["txtmat_unit2_name_remark"].ToString();      //5
                            PANEL_FORM1_dataGridView1.Rows[index].Cells["Col_txtmat_unit2_status"].Value = dt2.Rows[j]["txtmat_unit2_status"].ToString();      //6
        ...
        private void PANEL_FORM1_GridView1()
        {
            ...
            this.PANEL_FORM1_dataGridView1.Columns[3].HeaderText = " ชื่อหน่วยนับสินค้า";
            this.PANEL_FORM1_dataGridView1.Columns[4].HeaderText = "ชื่อหน่วยนับสินค้า Eng";
            ...
            this.PANEL_FORM1_dataGridView1.Columns[1].Visible = true;  //"Col_txtmat_unit2_no";
            ...
            this.PANEL_FORM1_dataGridView1.Columns[2].Visible = true;  //"Col_txtmat_unit2_id";
            ...
            this.PANEL_FORM1_dataGridView1.Columns[3].Visible = true;  //"Col_txtmat_unit2_name";
            ...
            this.PANEL_FORM1_dataGridView1.Columns[4].Visible = true;  //"Col_txtmat_unit2_name_eng";
            ...
            this.PANEL_FORM1_dataGridView1.Columns[5].Visible = true;  //"Col_txtmat_unit2_name_remark";
            ...
            this.PANEL_FORM1_dataGridView1.Columns[6].Visible = false;  //"Col_txtmat_unit2_status";
