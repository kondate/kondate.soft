...
{
    public partial class Home_SETUP_Enter_4WH_07 : Form
    {
        //Move Form ====================================
        ...
        public Home_SETUP_Enter_4WH_07()
        {
            InitializeComponent();
        }
        ...
        private void BtnNew_Click(object sender, EventArgs e)
        {
            ...
            this.Hide();
            var frm2 = new Home_SETUP_Enter_4WH_07();
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                try
                {
                    if (this.iblword_status.Text.Trim() == "เพิ่มรหัสสินค้าใหม่")
                    {
                        ...
                        cmd2.Parameters.Add("@txtmat_unit2_qty", SqlDbType.Float).Value = Convert.ToDouble(string.Format("{0:n0}", this.txtmat_unit2_qty.Text.ToString()));
                        ...
                        {
                            if (this.PANEL161_SUP_dataGridView2.Rows[i].Cells[1].Value.ToString() != "")
                            {
                    ...
                    if (this.iblword_status.Text.Trim() == "แก้ไขรหัสสินค้า")
                    {
                        ...
                        cmd2.CommandText = "UPDATE b001mat_02detail SET " +
                                                                     ...
                                                                     "txtmat_unit2_qty = '" + Convert.ToDouble(string.Format("{0:n0}", this.txtmat_unit2_qty.Text.ToString())) + "'," +
                    ...
                    if (dialogResult == DialogResult.Yes)
                    {
                        ...
                        if (this.iblword_status.Text.Trim() == "แก้ไขรหัสสินค้า")
                        {
                            ...
                            PANEL_FORM1_dataGridView1.Rows[selectedRowIndex].Cells["Col_txtmat_no"].Value = this.txtmat_no.Text.ToString();      //1
                            PANEL_FORM1_dataGridView1.Rows[selectedRowIndex].Cells["Col_txtmat_id"].Value = this.txtmat_id.Text.ToString();      //2
                            PANEL_FORM1_dataGridView1.Rows[selectedRowIndex].Cells["Col_txtmat_name"].Value = this.txtmat_name.Text.ToString();      //3
                            PANEL_FORM1_dataGridView1.Rows[selectedRowIndex].Cells["Col_txtmat_name_eng"].Value = this.txtmat_name_eng.Text.ToString();      //4
                            PANEL_FORM1_dataGridView1.Rows[selectedRowIndex].Cells["Col_txtmat_name_market"].Value = this.txtmat_name_market.Text.ToString();      //5
                            PANEL_FORM1_dataGridView1.Rows[selectedRowIndex].Cells["Col_txtmat_name_bill"].Value = this.txtmat_name_bill.Text.ToString();      //6
                            PANEL_FORM1_dataGridView1.Rows[selectedRowIndex].Cells["Col_txtmat_remark"].Value = this.txtmat_remark.Text.ToString();      //7
                            if (this.check_mat_status.Checked == true)
                            {
                                PANEL_FORM1_dataGridView1.Rows[selectedRowIndex].Cells["Col_txtmat_status"].Value = true;      //8
                            }
                            else
                            {
                                PANEL_FORM1_dataGridView1.Rows[selectedRowIndex].Cells["Col_txtmat_status"].Value = false;      //8
                            }
        ...
        private void btnPreview_Click(object sender, EventArgs e)
        {
            ...
            TRANS_LOG();
            //======================================================
            kondate.soft.SETUP_4WH.Home_SETUP_Enter_4WH_07_Print frm2 = new kondate.soft.SETUP_4WH.Home_SETUP_Enter_4WH_07_Print();
            frm2.Show();
            frm2.BringToFront();
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            PANEL_FORM1_dataGridView1.Rows[index].Cells["Col_txtmat_no"].Value = dt2.Rows[j]["txtmat_no"].ToString();      //1
                            PANEL_FORM1_dataGridView1.Rows[index].Cells["Col_txtmat_id"].Value = dt2.Rows[j]["txtmat_id"].ToString();      //2
                            PANEL_FORM1_dataGridView1.Rows[index].Cells["Col_txtmat_name"].Value = dt2.Rows[j]["txtmat_name"].ToString();      //3
                            PANEL_FORM1_dataGridView1.Rows[index].Cells["Col_txtmat_name_eng"].Value = dt2.Rows[j]["txtmat_name_eng"].ToString();      //4
                            PANEL_FORM1_dataGridView1.Rows[index].Cells["Col_txtmat_name_market"].Value = dt2.Rows[j]["txtmat_name_market"].ToString();      //5
                            PANEL_FORM1_dataGridView1.Rows[index].Cells["Col_txtmat_name_bill"].Value = dt2.Rows[j]["txtmat_name_bill"].ToString();      //6
                            PANEL_FORM1_dataGridView1.Rows[index].Cells["Col_txtmat_remark"].Value = dt2.Rows[j]["txtmat_remark"].ToString();      //7
                            PANEL_FORM1_dataGridView1.Rows[index].Cells["Col_txtmat_status"].Value = dt2.Rows[j]["txtmat_status"].ToString();      //8
                        }
                        //=======================================================
                        Cursor.Current = Cursors.Default;
        ...
        private void PANEL_FORM1_GridView1()
        {
            ...
            this.PANEL_FORM1_dataGridView1.Columns[3].HeaderText = " ชื่อสินค้า";
            this.PANEL_FORM1_dataGridView1.Columns[4].HeaderText = " ชื่อสินค้า Eng";
            this.PANEL_FORM1_dataGridView1.Columns[5].HeaderText = " ชื่อสินค้าทางการตลาด";
            this.PANEL_FORM1_dataGridView1.Columns[6].HeaderText = " ชื่อใช้ในการออกบิล";
            ...
            this.PANEL_FORM1_dataGridView1.Columns[1].Visible = true;  //"Col_txtmat_no";
            ...
            this.PANEL_FORM1_dataGridView1.Columns[2].Visible = true;  //"Col_txtmat_id";
            ...
            this.PANEL_FORM1_dataGridView1.Columns[3].Visible = true;  //"Col_txtmat_name";
            ...
            this.PANEL_FORM1_dataGridView1.Columns[4].Visible = false;  //"Col_txtmat_name_eng";
            ...
            this.PANEL_FORM1_dataGridView1.Columns[5].Visible = true;  //"Col_txtmat_name_market";
            ...
            this.PANEL_FORM1_dataGridView1.Columns[6].Visible = false;  //"Col_txtmat_name_bill";
            ...
            this.PANEL_FORM1_dataGridView1.Columns[7].Visible = true;  //"Col_txtmat_remark";
            ...
            this.PANEL_FORM1_dataGridView1.Columns[8].Visible = false;  //"Col_txtmat_status";
                        ...
                        try
                        {
                            ...
                            if (dt2.Rows.Count > 0)
                            {
                                for (int j = 0; j < dt2.Rows.Count; j++)
                                {
                                    ...
                                    if (dt2.Rows[j]["chmat_unit_status"].ToString() == "0") //17
                                    {
                                    ...
                                    this.txtmat_unit2_qty.Text = Convert.ToSingle(dt2.Rows[j]["txtmat_unit2_qty"]).ToString("###,###.00");     //20
