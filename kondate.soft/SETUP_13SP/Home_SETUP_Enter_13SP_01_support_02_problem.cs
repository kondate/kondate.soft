...
{
    public partial class Home_SETUP_Enter_13SP_01_support_02_problem : Form
    {
        //Move Form ====================================
        ...
        public Home_SETUP_Enter_13SP_01_support_02_problem()
        {
            InitializeComponent();
        }

        private void Home_SETUP_Enter_13SP_01_Load(object sender, EventArgs e)
        {
            ...
            this.iblword_status.Text = "เพิ่มรหัสแจ้งปัญหาใหม่";
            this.txtproblem_id.ReadOnly = false;

            this.ActiveControl = this.txtproblem_id;
        ...
        private void Run_ID()
        {
            if (this.txtproblem_no.Text == "")
            {
                this.txtproblem_no.Text = "001";
            }
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            //this.PANEL_FORM1_dataGridView1.Columns[5].Name = "Col_txtproblem_remark";
                            ...
                            GridView1.Rows[index].Cells["Col_txtproblem_no"].Value = dt2.Rows[j]["txtproblem_no"].ToString();      //1
                            GridView1.Rows[index].Cells["Col_txtproblem_id"].Value = dt2.Rows[j]["txtproblem_id"].ToString();      //2
                            GridView1.Rows[index].Cells["Col_txtproblem_name"].Value = dt2.Rows[j]["txtproblem_name"].ToString();      //3
                            GridView1.Rows[index].Cells["Col_txtproblem_name_eng"].Value = dt2.Rows[j]["txtproblem_name_eng"].ToString();      //4
                            GridView1.Rows[index].Cells["Col_txtproblem_remark"].Value = dt2.Rows[j]["txtproblem_remark"].ToString();      //5
                            GridView1.Rows[index].Cells["Col_txtproblem_status"].Value = dt2.Rows[j]["txtproblem_status"].ToString();      //6
        ...
        private void PANEL_FORM1_GridView1()
        {
            ...
            this.GridView1.Columns[1].Name = "Col_txtproblem_no";
            this.GridView1.Columns[2].Name = "Col_txtproblem_id";
            this.GridView1.Columns[3].Name = "Col_txtproblem_name";
            this.GridView1.Columns[4].Name = "Col_txtproblem_name_eng";
            this.GridView1.Columns[5].Name = "Col_txtproblem_remark";
            this.GridView1.Columns[6].Name = "Col_txtproblem_status";
            ...
            this.GridView1.Columns[3].HeaderText = " ชื่อรหัสแจ้งปัญหา";
            this.GridView1.Columns[4].HeaderText = "ชื่อรหัสแจ้งปัญหา Eng";
            ...
            this.GridView1.Columns[1].Visible = true;  //"Col_txtproblem_no";
            ...
            this.GridView1.Columns[2].Visible = true;  //"Col_txtproblem_id";
            ...
            this.GridView1.Columns[3].Visible = true;  //"Col_txtproblem_name";
            ...
            this.GridView1.Columns[4].Visible = true;  //"Col_txtproblem_name_eng";
            ...
            this.GridView1.Columns[5].Visible = true;  //"Col_txtproblem_remark";
            ...
            this.GridView1.Columns[6].Visible = false;  //"Col_txtproblem_status";
        ...
        private void PANEL_FORM1_dataGridView1_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                if (cell != null)
                {
                    ...
                    this.txtproblem_no.Text = row.Cells[1].Value.ToString();
                    this.txtproblem_id.Text = row.Cells[2].Value.ToString();
                    this.txtproblem_name.Text = row.Cells[3].Value.ToString();
                    ...
                    if (conn.State == System.Data.ConnectionState.Open)
                    {
                        ...
                        cmd2.CommandText = "SELECT *" +
                                            ...
                                            " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                            " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                             " AND (txtproblem_id = '" + this.txtproblem_id.Text.Trim() + "')" +
                                           " ORDER BY txtproblem_no ASC";
                        ...
                        try
                        {
                            ...
                            if (dt2.Rows.Count > 0)
                            {
                                for (int j = 0; j < dt2.Rows.Count; j++)
                                {
                                    this.txtproblem_no.Text = dt2.Rows[j]["txtproblem_no"].ToString();      //1
                                    this.txtproblem_id.Text = dt2.Rows[j]["txtproblem_id"].ToString();      //2
                                    this.txtproblem_name.Text = dt2.Rows[j]["txtproblem_name"].ToString();      //3
                                    this.txtproblem_name_eng.Text = dt2.Rows[j]["txtproblem_name_eng"].ToString();      //4
                                    this.txtproblem_remark.Text = dt2.Rows[j]["txtproblem_remark"].ToString();      //5
                                }
                                this.iblword_status.Text = "แก้ไขรหัสแจ้งปัญหา";
                                this.txtproblem_id.ReadOnly = true;
        ...
        private void PANEL_FORM1_btnsearch_Click(object sender, EventArgs e)
        {
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                cmd2.CommandText = "SELECT *" +
                                    ...
                                    " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                    " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                     " AND (txtproblem_name LIKE '%" + this.PANEL_FORM1_txtsearch.Text.Trim() + "%')" +
                                   " ORDER BY txtproblem_no ASC";
        ...
        private void BtnNew_Click(object sender, EventArgs e)
        {
            ...
            this.Hide();
            var frm2 = new HOME13_Set_Support();
        ...
        private void BtnSave_Click(object sender, EventArgs e)
        {
            if (this.txtproblem_no.Text == "")
            {
                ...
                this.txtproblem_no.Focus();
                return;
            }
            else
            {
                if (this.txtproblem_no.TextLength == 3)
                {
                }
                else
                {
            ...
            if (this.txtproblem_id.Text == "")
            {
                ...
                this.txtproblem_id.Focus();
                return;
            }
            if (this.txtproblem_name.Text == "")
            {
                MessageBox.Show("โปรดใส่ชื่อรหัสแจ้งปัญหาก่อน !", "ผลการทำงาน", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                this.txtproblem_name.Focus();
                return;
            }
            //======================================================
            //เชื่อมต่อฐานข้อมูล=======================================================
            ...
            //END เชื่อมต่อฐานข้อมูล=======================================================
            Cursor.Current = Cursors.WaitCursor;
            if (this.iblword_status.Text.Trim() == "เพิ่มรหัสแจ้งปัญหาใหม่")
            {
                conn.Open();
                if (conn.State == System.Data.ConnectionState.Open)
                {
                    ...
                    cmd1.CommandText = "SELECT * FROM h013support_02_problem" +
                                       " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                      " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                       " AND (txtproblem_id = '" + this.txtproblem_id.Text.Trim() + "')";
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        MessageBox.Show("รหัสรหัสแจ้งปัญหา นี้ซ้ำ   : '" + this.txtproblem_id.Text.Trim() + "' โปรดใส่ใหม่ ", "ผลการทำงาน", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                        this.txtproblem_id.Focus();
                        conn.Close();
                        return;
                    }
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                try
                {
                    if (this.iblword_status.Text.Trim() == "เพิ่มรหัสแจ้งปัญหาใหม่")
                    {
                        cmd2.CommandText = "INSERT INTO h013support_02_problem(cdkey,txtco_id," +  //1
                                           "txtproblem_no,txtproblem_id," +  //2
                                           "txtproblem_name,txtproblem_name_eng," +  //3
                                           "txtproblem_remark," +  //4
                                          "txtproblem_status) " +  //5
                        ...
                        cmd2.Parameters.Add("@txtproblem_no", SqlDbType.NVarChar).Value = this.txtproblem_no.Text.ToString();
                        cmd2.Parameters.Add("@txtproblem_id", SqlDbType.NVarChar).Value = this.txtproblem_id.Text.ToString();
                        cmd2.Parameters.Add("@txtproblem_name", SqlDbType.NVarChar).Value = this.txtproblem_name.Text.ToString();
                        cmd2.Parameters.Add("@txtproblem_name_eng", SqlDbType.NVarChar).Value = this.txtproblem_name_eng.Text.ToString();
                        cmd2.Parameters.Add("@txtproblem_remark", SqlDbType.NVarChar).Value = this.txtproblem_remark.Text.ToString();
                        cmd2.Parameters.Add("@txtproblem_status", SqlDbType.NChar).Value = "0";
                        //==============================

                        cmd2.ExecuteNonQuery();

                    }
                    if (this.iblword_status.Text.Trim() == "แก้ไขรหัสแจ้งปัญหา")
                    {
                        cmd2.CommandText = "UPDATE h013support_02_problem SET " +
                                                                     "txtproblem_no = '" + this.txtproblem_no.Text.Trim() + "'," +
                                                                     "txtproblem_name = '" + this.txtproblem_name.Text.Trim() + "'," +
                                                                     "txtproblem_name_eng = '" + this.txtproblem_name_eng.Text.Trim() + "'," +
                                                                     "txtproblem_remark = '" + this.txtproblem_remark.Text.ToString() + "'" +
                                                                    " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                                                   " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                                                   " AND (txtproblem_id = '" + this.txtproblem_id.Text.Trim() + "')";
                        cmd2.ExecuteNonQuery();
                    ...
                    if (dialogResult == DialogResult.Yes)
                    {
                        ...
                        this.txtproblem_id.Text = "";
                        this.txtproblem_name.Text = "";
                        this.txtproblem_name_eng.Text = "";
                        this.txtproblem_remark.Text = "";
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                try
                {
                    if (this.iblword_status.Text.Trim() == "ยกเลิกเอกสาร")
                    {
                        ...
                        cmd2.CommandText = "INSERT INTO h013support_02_problem_cancel(cdkey,txtco_id,txtbranch_id," +  //1
                                                                                                                //"txttrans_date," +
                        ...
                        cmd2.CommandText = "INSERT INTO h013support_02_problem_cancel_detail(cdkey,txtco_id," +  //1
                                             "txtproblem_no,txtproblem_id," +  //2
                                             "txtproblem_name,txtproblem_name_eng," +  //3
                                             "txtproblem_remark," +  //4
                                            "txtproblem_status,cancel_id) " +  //5
                                             "VALUES (@cdkey2,@txtco_id2," +  //1
                                             "@txtproblem_no,@txtproblem_id," +  //2
                                             "@txtproblem_name,@txtproblem_name_eng," +  //3
                                             "@txtproblem_remark," +  //4
                                            "@txtproblem_status,@cancel_id2)";   //5
                        ...
                        cmd2.CommandText = "DELETE FROM h013support_02_problem" +
                                                                    " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                                                    " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                                                   " AND (txtproblem_id = '" + this.txtproblem_id.Text.Trim() + "')";
                        cmd2.ExecuteNonQuery();
                    ...
                    DialogResult dialogResult = MessageBox.Show("คุณต้องการ ยกเลิกเอกสาร รหัส  " + this.txtproblem_id.Text.ToString() + " ใช่หรือไม่่ ?", "โปรดยืนยัน", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question);
                    if (dialogResult == DialogResult.Yes)
                    {
        ...
        private void txtproblem_id_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            if (e.KeyChar == (char)Keys.Enter && this.txtproblem_id.Text == "")
            {
                this.txtproblem_id.Focus();
            }
            //========================================
            else if (e.KeyChar == (char)Keys.Enter && this.txtproblem_id.Text.Trim() != "")
            {
                this.txtproblem_no.Focus();
        ...
        private void txtproblem_no_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == (char)Keys.Enter && this.txtproblem_no.Text == "")
            {
                this.txtproblem_no.Focus();
            }
            //========================================
            else if (e.KeyChar == (char)Keys.Enter && this.txtproblem_no.Text.Trim() != "")
            {
                if (this.txtproblem_no.TextLength == 3)
                {
                    this.txtproblem_name.Focus();
            ...
            else if ((e.KeyChar > '9') && (e.KeyChar != '\b') && (e.KeyChar != '.') && txtproblem_no.Text.Length == 0)
            {
                //e.KeyChar <= '0' || 
                e.Handled = true;
                return;
        ...
        private void txtproblem_name_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
                this.txtproblem_name_eng.Focus();

        }

        private void txtproblem_name_eng_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
                this.txtproblem_remark.Focus();

        }

        private void txtproblem_remark_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
                this.BtnSave.Focus();
            ...
            if (OK.Trim() != "Y")
            {
                ...
                if (conn.State == System.Data.ConnectionState.Open)
                {
                    ...
                    try
                    {
                        ...
                        cmd2.Parameters.Add("@cdkey", SqlDbType.NVarChar).Value = W_ID_Select.CDKEY.Trim();
                        cmd2.Parameters.Add("@txtco_id", SqlDbType.NVarChar).Value = W_ID_Select.M_COID.Trim();
                        cmd2.Parameters.Add("@txtproblem_no", SqlDbType.NVarChar).Value = "999";
                        cmd2.Parameters.Add("@txtproblem_id", SqlDbType.NVarChar).Value = "";
                        cmd2.Parameters.Add("@txtproblem_name", SqlDbType.NVarChar).Value = "";
                        cmd2.Parameters.Add("@txtproblem_name_eng", SqlDbType.NVarChar).Value = "";
                        cmd2.Parameters.Add("@txtproblem_remark", SqlDbType.NVarChar).Value = "";
                        cmd2.Parameters.Add("@txtproblem_status", SqlDbType.NChar).Value = "0";
                        //==============================
