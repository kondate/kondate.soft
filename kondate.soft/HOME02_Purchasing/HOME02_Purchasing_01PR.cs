...
{
    public partial class HOME02_Purchasing_01PR : Form
    {
        //Move Form ====================================
        ...
        public HOME02_Purchasing_01PR()
        {
            InitializeComponent();
        }

        private void HOME02_Purchasing_01PR_Load(object sender, EventArgs e)
        {
            this.WindowState = FormWindowState.Maximized;
            this.btnmaximize.Visible = false;
            this.btnmaximize_full.Visible = true;

            W_ID_Select.M_FORM_NUMBER = "H0201PRGR";
            CHECK_ADD_FORM();

            CHECK_USER_RULE();

            this.iblword_top.Text = W_ID_Select.WORD_TOP.Trim();
            this.iblword_status.Text = "ระเบียนใบขอสั่งซื้อ PR";
            ...
            //========================================
            this.cboSearch.Items.Add("เลขที่ PR");
            this.cboSearch.Items.Add("ชื่อผู้บันทึก PR");
            this.cboSearch.Text = "เลขที่ PR";
            //========================================
        ...
        private void Fill_Show_DATA_GridView1()
        {
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                cmd2.CommandText = "SELECT k017db_pr_record.*," +
                                   ...
                                   " AND (k017db_pr_record.txtbranch_id = '" + W_ID_Select.M_BRANCHID.Trim() + "')" +
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        ...
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            //this.GridView1.Columns[3].Name = "Col_txtPr_id";
                            //this.GridView1.Columns[4].Name = "Col_txttrans_date_server";
                            //this.GridView1.Columns[5].Name = "Col_txttrans_time";
                            //this.GridView1.Columns[6].Name = "Col_txtdepartment_id";
                            //this.GridView1.Columns[7].Name = "Col_txtdepartment_name";
                            //this.GridView1.Columns[8].Name = "Col_txtemp_office_name";
                            //this.GridView1.Columns[9].Name = "Col_txtPo_id";
                            //this.GridView1.Columns[10].Name = "Col_txtpo_date";
                            //this.GridView1.Columns[11].Name = "Col_txtapprove_id";
                            //this.GridView1.Columns[12].Name = "Col_txtapprove_date";
                            ...
                            this.GridView1.Rows[index].Cells["Col_txtPr_id"].Value = dt2.Rows[j]["txtPr_id"].ToString();      //3
                            ...
                            this.GridView1.Rows[index].Cells["Col_txtdepartment_id"].Value = dt2.Rows[j]["txtdepartment_id"].ToString();      //6
                            this.GridView1.Rows[index].Cells["Col_txtdepartment_name"].Value = dt2.Rows[j]["txtdepartment_name"].ToString();      //7
                            ...
                            this.GridView1.Rows[index].Cells["Col_txtapprove_id"].Value = dt2.Rows[j]["txtapprove_id"].ToString();      //11
                            this.GridView1.Rows[index].Cells["Col_txtapprove_date"].Value = dt2.Rows[j]["txtapprove_date"].ToString();      //12
                            this.GridView1.Rows[index].Cells["Col_txtRG_id"].Value = dt2.Rows[j]["txtRG_id"].ToString();      //13
                            this.GridView1.Rows[index].Cells["Col_txtRG_date"].Value = dt2.Rows[j]["txtRG_date"].ToString();      //14
                            this.GridView1.Rows[index].Cells["Col_txtReceive_id"].Value = dt2.Rows[j]["txtReceive_id"].ToString();      //15
                            this.GridView1.Rows[index].Cells["Col_txtReceive_date"].Value = dt2.Rows[j]["txtReceive_date"].ToString();      //16

                            this.GridView1.Rows[index].Cells["Col_txtmoney_after_vat"].Value = Convert.ToSingle(dt2.Rows[j]["txtmoney_after_vat"]).ToString("###,###.00");      //17
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                if (this.ch_all_branch.Checked == true)
                {
                    cmd2.CommandText = "SELECT k017db_pr_record.*," +
                                       ...
                                       " AND (k017db_pr_record.txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                       " AND (k017db_pr_record.txttrans_date_server BETWEEN @datestart AND @dateend)" +
                                       //" AND (k017db_pr_record.txtbranch_id = '" + this.txtbranch_id.Text.Trim() + "')" +
                                      " ORDER BY k017db_pr_record.txtPr_id ASC";
               }
                else
                {
        ...
        private void Show_GridView1()
        {
            ...
            this.GridView1.Columns[3].HeaderText = " PR ID";
            this.GridView1.Columns[4].HeaderText = " วันที่";
            this.GridView1.Columns[5].HeaderText = " เวลา";
            this.GridView1.Columns[6].HeaderText = " รหัสฝ่าย";
            this.GridView1.Columns[7].HeaderText = " ฝ่าย";
            this.GridView1.Columns[8].HeaderText = " ผู้บันทึก";
            this.GridView1.Columns[9].HeaderText = " PO ID";
            this.GridView1.Columns[10].HeaderText = " วันที่ PO";
            this.GridView1.Columns[11].HeaderText = " Approve ID";
            this.GridView1.Columns[12].HeaderText = " วันที่ Approve";
            ...
            this.GridView1.Columns[3].Visible = true;  //"Col_txtPr_id";
            ...
            this.GridView1.Columns[7].Width = 250;
            ...
            this.GridView1.Columns[9].Visible = true;  //"Col_txtPo_id";
            ...
            this.GridView1.Columns[10].Visible = false;  //"Col_txtpo_date";
            ...
            this.GridView1.Columns[11].Visible = true;  //"Col_txtApprove_id";
            ...
            this.GridView1.Columns[12].Visible = false;  //"Col_txtApprove_date";
            ...
            this.GridView1.Columns[13].Visible = false;  //"Col_txtRG_id";
            ...
            this.GridView1.Columns[18].Visible = true;  //"Col_txtpr_status";
            this.GridView1.Columns[18].Width = 100;
            ...
            this.GridView1.Columns[19].Visible = true;  //"Col_txtpo_status";
            this.GridView1.Columns[19].Width = 100;
            ...
            this.GridView1.Columns[21].Visible = false;  //"Col_txtRG_status";
        ...
        private void GridView1_Color()
        {
            for (int i = 0; i < this.GridView1.Rows.Count - 0; i++)
            {
                ...
                if (GridView1.Rows[i].Cells["Col_txtPo_id"].Value == null)
                {
        ...
        private void GridView1_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            if (e.RowIndex > -1)
            {
                ...
                if (cell != null)
                {
                    ...
                    if (this.cboSearch.Text == "เลขที่ PR")
                    {
                        this.txtsearch.Text = row.Cells[3].Value.ToString();
                        W_ID_Select.TRANS_ID = row.Cells[3].Value.ToString();

                    }
                    else if (this.cboSearch.Text == "ชื่อผู้บันทึก PR")
                    {
        ...
        private void GridView1_DoubleClick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                W_ID_Select.WORD_TOP = "ดูข้อมูลใบขอสั่งซื้อ (PR)";
                kondate.soft.HOME02_Purchasing.HOME02_Purchasing_01PR_record_detail frm2 = new kondate.soft.HOME02_Purchasing.HOME02_Purchasing_01PR_record_detail();
                frm2.Show();
        ...
        private void BtnNew_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                W_ID_Select.WORD_TOP = "เพิ่มใบขอสั่งซื้อ (PR)";
        ...
        private void BtnCancel_Doc_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                W_ID_Select.WORD_TOP = "ยกเลิกใบขอสั่งซื้อ (PR)";
                kondate.soft.HOME02_Purchasing.HOME02_Purchasing_01PR_record_detail frm2 = new kondate.soft.HOME02_Purchasing.HOME02_Purchasing_01PR_record_detail();
                frm2.Show();
            }
        }
                 ...
                 if (this.cboSearch.Text == "เลขที่ PR")
                  {
                        cmd2.CommandText = "SELECT k017db_pr_record.*," +
                                          ...
                                          " AND (k017db_pr_record.txtbranch_id = '" + W_ID_Select.M_BRANCHID.Trim() + "')" +
                                          " AND (k017db_pr_record.txttrans_date_server BETWEEN @datestart AND @dateend)" +
                                          " AND (k017db_pr_record.txtPr_id = '" + this.txtsearch.Text.Trim() + "')" +
                                          " ORDER BY k017db_pr_record.txtPr_id ASC";

                  }
                if (this.cboSearch.Text == "ชื่อผู้บันทึก PR")
                {
                    cmd2.CommandText = "SELECT k017db_pr_record.*," +
                                       "k013_1db_acc_16department.*" +
                                      ...
                                      " AND (k017db_pr_record.txtbranch_id = '" + W_ID_Select.M_BRANCHID.Trim() + "')" +
                                      " AND (k017db_pr_record.txttrans_date_server BETWEEN @datestart AND @dateend)" +
                                      " AND (k017db_pr_record.txtemp_office_name LIKE '%"  + this.txtsearch.Text.Trim()+ "%')" +
                                       " ORDER BY k017db_pr_record.txtPr_id ASC";
