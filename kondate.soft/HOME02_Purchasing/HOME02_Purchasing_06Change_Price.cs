...
{
    public partial class HOME02_Purchasing_06Change_Price : Form
    {
        //Move Form ====================================
        ...
        public HOME02_Purchasing_06Change_Price()
        {
            InitializeComponent();
        }
        private void HOME02_Purchasing_06Change_Price_Load(object sender, EventArgs e)
        {
            this.WindowState = FormWindowState.Maximized;
            this.btnmaximize.Visible = false;
            this.btnmaximize_full.Visible = true;

            W_ID_Select.M_FORM_NUMBER = "H0206CPRGR";
            CHECK_ADD_FORM();

            CHECK_USER_RULE();

            this.iblword_top.Text = W_ID_Select.WORD_TOP.Trim();
            this.iblword_status.Text = "ระเบียนตั้งราคาขาย";
        ...
        private void Fill_Show_DATA_GridView1()
        {
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                cmd2.CommandText = "SELECT *" +
                                   " FROM b001mat_62change_price" +

                                   " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                   " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                   " AND (txtbranch_id = '" + W_ID_Select.M_BRANCHID.Trim() + "')" +
                                   " AND (txttrans_date_client BETWEEN @datestart AND @dateend)" +
                                  " ORDER BY txtCPR_id ASC";
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        ...
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            //this.GridView1.Columns[3].Name = "Col_txtCPR_id";
                            //this.GridView1.Columns[4].Name = "Col_txttrans_date_client";
                            //this.GridView1.Columns[5].Name = "Col_txtmat_price_sale_select";
                            //this.GridView1.Columns[6].Name = "Col_txtapprove_status";
                            ...
                            this.GridView1.Rows[index].Cells["Col_txtCPR_id"].Value = dt2.Rows[j]["txtCPR_id"].ToString();      //3
                            ...
                            this.GridView1.Rows[index].Cells["Col_txtmat_price_sale_select"].Value = dt2.Rows[j]["txtmat_price_sale_select"].ToString();      //6
                            this.GridView1.Rows[index].Cells["Col_txtemp_office_name"].Value = dt2.Rows[j]["txtemp_office_name"].ToString();      //9

                            //RG==============================
                            if (dt2.Rows[j]["txtapprove_status"].ToString() == "0")
                            {
                                this.GridView1.Rows[index].Cells["Col_txtapprove_status"].Value = ""; //12
                            }
        ...
        private void Show_GridView1()
        {
            ...
            this.GridView1.Columns[5].HeaderText = " ราคาขาย";
            this.GridView1.Columns[6].HeaderText = " สถานะ";
            this.GridView1.Columns[7].HeaderText = " ผู้บันทึก";
            ...
            this.GridView1.Columns["Col_txtCPR_id"].Visible = true;  //"Col_txtCPR_id";
            this.GridView1.Columns["Col_txtCPR_id"].Width = 140;
            this.GridView1.Columns["Col_txtCPR_id"].ReadOnly = true;
            this.GridView1.Columns["Col_txtCPR_id"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.GridView1.Columns["Col_txtCPR_id"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;

            this.GridView1.Columns["Col_txttrans_date_client"].Visible = true;  //"Col_txttrans_date_client";
            this.GridView1.Columns["Col_txttrans_date_client"].Width = 140;
            ...
            this.GridView1.Columns["Col_txtmat_price_sale_select"].Visible = true;  //"Col_txtmat_price_sale_select";
            this.GridView1.Columns["Col_txtmat_price_sale_select"].Width = 140;
            this.GridView1.Columns["Col_txtmat_price_sale_select"].ReadOnly = true;
            this.GridView1.Columns["Col_txtmat_price_sale_select"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.GridView1.Columns["Col_txtmat_price_sale_select"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
            ...
            this.GridView1.Columns["Col_txtemp_office_name"].Width =250;
        ...
        private void GridView1_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                var cell = row.Cells["Col_txtCPR_id"].Value;
                if (cell != null)
                {
                    W_ID_Select.TRANS_ID = row.Cells["Col_txtCPR_id"].Value.ToString();
                }
                //=====================
            }
        }
        ...
        private void GridView1_DoubleClick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                W_ID_Select.WORD_TOP = "ดูข้อมูลใบตั้งราคาขาย";
                kondate.soft.HOME02_Purchasing.HOME02_Purchasing_06Change_Price_record_detail frm2 = new kondate.soft.HOME02_Purchasing.HOME02_Purchasing_06Change_Price_record_detail();
                frm2.Show();
