...
{
    public partial class HOME02_Purchasing_02PO_record_detail : Form
    {
        //Move Form ====================================
        ...
        public HOME02_Purchasing_02PO_record_detail()
        {
            InitializeComponent();
        }

        private void HOME02_Purchasing_02PO_record_detail_Load(object sender, EventArgs e)
        {
        ...
        private void Fill_DATA_TO_GridView1()
        {
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                cmd2.CommandText = "SELECT k018db_po_record.*," +
                                   ...
                                   " AND (k018db_po_record.txtPo_id = '" + W_ID_Select.TRANS_ID.Trim() + "')" +
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        ...
                        this.PANEL1316_DEPARTMENT_txtdepartment_name2.Text = dt2.Rows[0]["txtdepartment_name"].ToString();
                        this.PANEL1316_DEPARTMENT_txtdepartment_id2.Text = dt2.Rows[0]["txtdepartment_id"].ToString();
        ...
        private void Show_GridView1()
        {
            ...
            this.GridView1.Columns[10].HeaderText = "ค้างรับ"; // "Col_txtqty_after_cut";
        ...
        private void BtnCancel_Doc_Click(object sender, EventArgs e)
        {
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    MessageBox.Show("เอกสารนี้   : '" + this.txtPO_id.Text.Trim() + "' ยกเลิกไปแล้ว ", "ผลการทำงาน", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                    conn.Close();
                    return;
                }
            }
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    MessageBox.Show("เอกสารนี้   : '" + this.txtPO_id.Text.Trim() + "' อนุมัติ ไปแล้ว ", "ผลการทำงาน", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                    conn.Close();
                    return;
                }
            }
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                try
                {
                    if (this.iblword_status.Text.Trim() == "ยกเลิกเอกสาร")
                    {
                        ...
                        cmd2.CommandText = "INSERT INTO k018db_po_record_cancel(cdkey,txtco_id,txtbranch_id," +  //1
                                                                                                                 //"txttrans_date," +
                        ...
                        //cmd2.CommandText = "UPDATE k018db_po_record_detail" +
                        //                                            " SET txtqtyDE_want = '" + Convert.ToDouble(string.Format("{0:n4}", 0)) + "'," +
                        //                                            "txtqtyDE_balance = '" + Convert.ToDouble(string.Format("{0:n4}", 0)) + "'" +
                        //                                            " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                        //                                            " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                        //                                           " AND (txtPo_id = '" + this.txtPO_id.Text.Trim() + "')";
                        //cmd2.ExecuteNonQuery();
                        ...
                        //4
                        //cmd2.CommandText = "UPDATE k017db_pr_all SET txtPo_id = ''," +
                        //                  "txtpo_date = ''," +
                        //                   "txtsupplier_id = ''," +
                        //                   "txtsupplier_name = ''," +
                        //                   "txtpo_status = ''" +
        ...
        private void UPDATE_PRINT_BY()
        {
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                try
                {
                    ...
                    cmd2.CommandText = "UPDATE k018db_po_record SET " +
