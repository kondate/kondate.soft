...
{
    public partial class HOME02_Purchasing_04AP : Form
    {
        //Move Form ====================================
        ...
        public HOME02_Purchasing_04AP()
        {
            InitializeComponent();
        }

        private void HOME02_Purchasing_04AP_Load(object sender, EventArgs e)
        {
            ...
            this.iblword_status.Text = "ระเบียนอนุมัติใบสั่งซื้อ AP";
            ...
            //========================================
            this.cboSearch.Items.Add("เลขที่ Approve");
            this.cboSearch.Items.Add("ชื่อผู้บันทึก Approve");
            this.cboSearch.Text = "เลขที่ Approve";
        ...
        private void Fill_Show_DATA_GridView1()
        {
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                cmd2.CommandText = "SELECT k019db_approve_record.*,k016db_1supplier.*," +
                                   "k018db_po_record.txtsum_qty," +
                                   "k018db_po_record.txtsum_qty_receive," +
                                   "k018db_po_record.txtsum_qty_balance" +

                                   " FROM k019db_approve_record" +

                                   " INNER JOIN k016db_1supplier" +
                                   " ON k019db_approve_record.cdkey = k016db_1supplier.cdkey" +
                                   " AND k019db_approve_record.txtco_id = k016db_1supplier.txtco_id" +
                                   " AND k019db_approve_record.txtsupplier_id = k016db_1supplier.txtsupplier_id" +

                                   " INNER JOIN k018db_po_record" +
                                   " ON k019db_approve_record.cdkey = k018db_po_record.cdkey" +
                                   " AND k019db_approve_record.txtco_id = k018db_po_record.txtco_id" +
                                   " AND k019db_approve_record.txtPo_id = k018db_po_record.txtPo_id" +


                                   " WHERE (k019db_approve_record.cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                   " AND (k019db_approve_record.txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                   " AND (k019db_approve_record.txtbranch_id = '" + W_ID_Select.M_BRANCHID.Trim() + "')" +
                                   " AND (k019db_approve_record.txttrans_date_server BETWEEN @datestart AND @dateend)" +
                                  " ORDER BY k019db_approve_record.txtPr_id ASC";
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        ...
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            //this.GridView1.Columns[3].Name = "Col_txtapprove_id";
                            ...
                            //this.GridView1.Columns[9].Name = "Col_txtPr_id";
                            //this.GridView1.Columns[10].Name = "Col_txtpr_date";
                            //this.GridView1.Columns[11].Name = "Col_txtPo_id";
                            //this.GridView1.Columns[12].Name = "Col_txtPo_date";
                            //this.GridView1.Columns[13].Name = "Col_txtRG_id";
                            //this.GridView1.Columns[14].Name = "Col_txtRG_date";
                            //this.GridView1.Columns[15].Name = "Col_txtReceive_id";
                            //this.GridView1.Columns[16].Name = "Col_txtReceive_date";
                            //this.GridView1.Columns[17].Name = "Col_txtmoney_after_vat";
                            //this.GridView1.Columns[18].Name = "Col_txtpr_status";
                            //this.GridView1.Columns[19].Name = "Col_txtpo_status";
                            //this.GridView1.Columns[20].Name = "Col_txtapprove_status";
                            //this.GridView1.Columns[21].Name = "Col_txtRG_status";
                            //this.GridView1.Columns[22].Name = "Col_txtreceive_status";
                            //this.GridView1.Columns[23].Name = "Col_txtsum_qty";
                            //this.GridView1.Columns[24].Name = "Col_txtsum_qty_receive";
                            //this.GridView1.Columns[25].Name = "Col_txtsum_qty_balance";
                            ...
                            this.GridView1.Rows[index].Cells["Col_txtApprove_id"].Value = dt2.Rows[j]["txtApprove_id"].ToString();      //3
                            ...
                            this.GridView1.Rows[index].Cells["Col_txtPr_id"].Value = dt2.Rows[j]["txtPr_id"].ToString();      //9
                            this.GridView1.Rows[index].Cells["Col_txtPr_date"].Value = dt2.Rows[j]["txtPr_date"].ToString();      //10
                            this.GridView1.Rows[index].Cells["Col_txtPo_id"].Value = dt2.Rows[j]["txtPo_id"].ToString();      //9
                            this.GridView1.Rows[index].Cells["Col_txtPo_date"].Value = dt2.Rows[j]["txtPo_date"].ToString();      //10
                            ...
                            {
                                this.GridView1.Rows[index].Cells["Col_txtpr_status"].Value = "ออก PR"; //18
                            }
                            else if (dt2.Rows[j]["txtpr_status"].ToString() == "1")
                            {
                                this.GridView1.Rows[index].Cells["Col_txtpr_status"].Value = "ยกเลิก PR"; //18
                            }

                            //PO==============================
                            if (dt2.Rows[j]["txtpo_status"].ToString() == "")
                            {
                                this.GridView1.Rows[index].Cells["Col_txtpo_status"].Value = ""; //19
                            }
                            else if (dt2.Rows[j]["txtpo_status"].ToString() == "0")
                            {
                                this.GridView1.Rows[index].Cells["Col_txtpo_status"].Value = "ออก PO"; //19
                            }
                            else if (dt2.Rows[j]["txtpo_status"].ToString() == "1")
                            {
                                this.GridView1.Rows[index].Cells["Col_txtpo_status"].Value = "ยกเลิก PO"; //19
                            }
                            ...
                            {
                                this.GridView1.Rows[index].Cells["Col_txtRG_status"].Value = "ออก RG"; //21
                            }
                            else if (dt2.Rows[j]["txtRG_status"].ToString() == "1")
                            {
                                this.GridView1.Rows[index].Cells["Col_txtRG_status"].Value = "ยกเลิก RG"; //21
                            }
                            ...
                            {
                                this.GridView1.Rows[index].Cells["Col_txtreceive_status"].Value = ""; //22
                            }
                            else if (dt2.Rows[j]["txtreceive_status"].ToString() == "0")
                            {
                                this.GridView1.Rows[index].Cells["Col_txtreceive_status"].Value = "รับเข้าคลัง"; //22
                            }
                            else if (dt2.Rows[j]["txtreceive_status"].ToString() == "1")
                            {
                                this.GridView1.Rows[index].Cells["Col_txtreceive_status"].Value = "ยกเลิกรับเข้าคลัง"; //22
                            }
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                else
                {
                    cmd2.CommandText = "SELECT k019db_approve_record.*,k016db_1supplier.*," +
                                   ...
                                   " WHERE (k019db_approve_record.cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                   " AND (k019db_approve_record.txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                    " AND (k019db_approve_record.txtbranch_id = '" + this.txtbranch_id.Text.Trim() + "')" +
                                  " AND (k019db_approve_record.txttrans_date_server BETWEEN @datestart AND @dateend)" +
                                  " ORDER BY k019db_approve_record.txtPr_id ASC";
        ...
        private void Show_GridView1()
        {
            ...
            this.GridView1.Columns[3].HeaderText = " Approve ID";
            ...
            this.GridView1.Columns[9].HeaderText = " Pr ID";
            this.GridView1.Columns[10].HeaderText = " วันที่ Pr";
            this.GridView1.Columns[11].HeaderText = " PO ID";
            this.GridView1.Columns[12].HeaderText = " วันที่ PO";
            this.GridView1.Columns[13].HeaderText = " RG ID";
            this.GridView1.Columns[14].HeaderText = " วันที่ RG";
            this.GridView1.Columns[15].HeaderText = " ID รับเข้าคลัง";
            this.GridView1.Columns[16].HeaderText = " วันที่ รับเข้าคลัง";

            this.GridView1.Columns[17].HeaderText = " จำนวนเงิน(บาท)";
            this.GridView1.Columns[18].HeaderText = " สถานะ PR";
            this.GridView1.Columns[19].HeaderText = " สถานะ PO";
            this.GridView1.Columns[20].HeaderText = " สถานะ ผลอนุมัติ";
            this.GridView1.Columns[21].HeaderText = "สถานะ RG";
            this.GridView1.Columns[22].HeaderText = " สถานะ รับเข้าคลัง";
            this.GridView1.Columns[23].HeaderText = "Qty สั่งซื้อ";
            this.GridView1.Columns[24].HeaderText = "Qty รับแล้ว";
            this.GridView1.Columns[25].HeaderText = "Qty ค้างรับ";
            ...
            this.GridView1.Columns[3].Visible = true;  //"Col_txtapprove_id";
            ...
            this.GridView1.Columns[7].Visible = true;  //"Col_txtdepartment_name";
            ...
            this.GridView1.Columns[9].Visible = false;  //"Col_txtPr_id";
            ...
            this.GridView1.Columns[10].Visible = false;  //"Col_txtpr_date";
            ...
            this.GridView1.Columns[11].Visible = true;  //"Col_txtpo_id";
            this.GridView1.Columns[11].Width = 120;
            ...
            this.GridView1.Columns[12].Visible = false;  //"Col_txtpo_date";
            this.GridView1.Columns[12].Width = 0;
            ...
            this.GridView1.Columns[13].Visible = true;  //"Col_txtRG_id";
            this.GridView1.Columns[13].Width = 120;
            ...
            this.GridView1.Columns[14].Visible = false;  //"Col_txtRG_date";
            ...
            this.GridView1.Columns[15].Visible = false;  //"Col_txtReceive_id";
            this.GridView1.Columns[15].Width = 0;
            ...
            this.GridView1.Columns[16].Visible = false;  //"Col_txtReceive_date";
            ...
            this.GridView1.Columns[17].Visible = true;  //"Col_txtmoney_after_vat";
            this.GridView1.Columns[17].Width = 130;
            ...
            this.GridView1.Columns[17].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;

            this.GridView1.Columns[18].Visible = false;  //"Col_txtpr_status";
            ...
            this.GridView1.Columns[19].Visible = false;  //"Col_txtpo_status";
            ...
            this.GridView1.Columns[20].Visible = true;  //"Col_txtapprove_status";
            this.GridView1.Columns[20].Width = 100;
            ...
            this.GridView1.Columns[21].Visible = true;  //"Col_txtRG_status";
            this.GridView1.Columns[21].Width = 100;
            ...
            this.GridView1.Columns[22].Visible = false;  //"Col_txtreceive_status";
            this.GridView1.Columns[22].Width = 0;
            ...
            this.GridView1.Columns[22].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;

            this.GridView1.Columns[23].Visible = true;  //"Col_txtreceive_status";
            this.GridView1.Columns[23].Width = 100;
            ...
            this.GridView1.Columns[23].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;


            this.GridView1.Columns[24].Visible = true;  //"Col_txtreceive_status";
            ...
            this.GridView1.Columns[24].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;

            this.GridView1.Columns[25].Visible = true;  //"Col_txtreceive_status";
            ...
            this.GridView1.Columns[25].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
        ...
        private void GridView1_Color()
        {
            for (int i = 0; i < this.GridView1.Rows.Count - 0; i++)
            {
                ...
                if (Convert.ToDouble(string.Format("{0:n4}", this.GridView1.Rows[i].Cells["Col_txtsum_qty_receive"].Value.ToString())) == 0)
                {
        ...
        private void GridView1_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                if (cell != null)
                {
                    ...
                    if (this.cboSearch.Text == "เลขที่ Approve")
                    {
                        this.txtsearch.Text = row.Cells[3].Value.ToString();
                        W_ID_Select.TRANS_ID = row.Cells[3].Value.ToString();

                    }
                    else if (this.cboSearch.Text == "ชื่อผู้ Approve")
                    {
       ...
       private void GridView1_DoubleClick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                W_ID_Select.WORD_TOP = "ดูข้อมูลอนุมัติ PO";
                kondate.soft.HOME02_Purchasing.HOME02_Purchasing_04AP_record_detail frm2 = new kondate.soft.HOME02_Purchasing.HOME02_Purchasing_04AP_record_detail();
                frm2.Show();
        ...
        private void BtnNew_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                W_ID_Select.WORD_TOP = "อนุมัติใบสั่งซื้อ";
                ...
                if (this.cboSearch.Text == "เลขที่ PO")
                {
                    cmd2.CommandText = "SELECT k019db_approve_record.*,k016db_1supplier.*," +
                                   ...
                                   " AND k019db_approve_record.txtPo_id = k018db_po_record.txtPo_id" +
                                    ...
                                    " AND (k019db_approve_record.txtbranch_id = '" + W_ID_Select.M_BRANCHID.Trim() + "')" +
                                      " AND (k019db_approve_record.txttrans_date_server BETWEEN @datestart AND @dateend)" +
                                      " AND (k019db_approve_record.txtPr_id = '" + this.txtsearch.Text.Trim() + "')" +
                                      " ORDER BY k019db_approve_record.txtPr_id ASC";

                }
                if (this.cboSearch.Text == "ชื่อผู้บันทึก PO")
                {
                    cmd2.CommandText = "SELECT k019db_approve_record.*,k016db_1supplier.*," +
                                       "k018db_po_record.txtsum_qty," +
                                       "k018db_po_record.txtsum_qty_receive," +
                                   ...
                                   " AND k019db_approve_record.txtPo_id = k018db_po_record.txtPo_id" +
                                      ...
                                      " AND (k019db_approve_record.txtbranch_id = '" + W_ID_Select.M_BRANCHID.Trim() + "')" +
                                       " AND (k019db_approve_record.txttrans_date_server BETWEEN @datestart AND @dateend)" +
                                       " AND (k019db_approve_record.txtemp_office_name LIKE '%" + this.txtsearch.Text.Trim() + "%')" +
                                      " ORDER BY k019db_approve_record.txtPr_id ASC";
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                cmd2.CommandText = "SELECT k019db_approve_record.*,k016db_1supplier.*," +
                                   ...
                                   " AND (k019db_approve_record.txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                    " AND (k019db_approve_record.txtbranch_id = '" + W_ID_Select.M_BRANCHID.Trim() + "')" +
                                  " AND (k019db_approve_record.txttrans_date_server BETWEEN @datestart AND @dateend)" +
                                    " AND (k019db_approve_record.txtsupplier_id = '" + this.PANEL161_SUP_txtsupplier_id.Text.Trim() + "')" +
                                   " ORDER BY k019db_approve_record.txtPr_id ASC";
