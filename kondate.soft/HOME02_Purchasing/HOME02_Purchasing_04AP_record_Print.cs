...
{
    public partial class HOME02_Purchasing_04AP_record_Print : Form
    {
        //Move Form ====================================
        ...
        public HOME02_Purchasing_04AP_record_Print()
        {
            InitializeComponent();
        }

        private void HOME02_Purchasing_04AP_record_Print_Load(object sender, EventArgs e)
        {
           ...
           // rpt.Load("E:\\01_Project_ERP_Kondate.Soft\\kondate.soft\\kondate.soft\\KONDATE_REPORT\\Report_k019db_approve_record.rpt");
