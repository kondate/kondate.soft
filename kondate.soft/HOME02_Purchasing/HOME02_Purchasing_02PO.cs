...
{
    public partial class HOME02_Purchasing_02PO : Form
    {
        //Move Form ====================================
        ...
        public HOME02_Purchasing_02PO()
        {
            InitializeComponent();
        }

        private void HOME02_Purchasing_02PO_Load(object sender, EventArgs e)
        {
            this.WindowState = FormWindowState.Maximized;
            this.btnmaximize.Visible = false;
            this.btnmaximize_full.Visible = true;

            W_ID_Select.M_FORM_NUMBER = "H0202PRGR";
            CHECK_ADD_FORM();

            CHECK_USER_RULE();

            this.iblword_top.Text = W_ID_Select.WORD_TOP.Trim();
            this.iblword_status.Text = "ระเบียนใบสั่งซื้อ PO";
            ...
            this.cboSearch.Items.Add("ชื่อผู้บันทึก PO");
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                else
                {
                    cmd2.CommandText = "SELECT k018db_po_record.*," +
                                   ...
                                   " WHERE (k018db_po_record.cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                   " AND (k018db_po_record.txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                    " AND (k018db_po_record.txtbranch_id = '" + this.txtbranch_id.Text.Trim() + "')" +
                                  " AND (k018db_po_record.txttrans_date_server BETWEEN @datestart AND @dateend)" +
                                  " ORDER BY k018db_po_record.txtPr_id ASC";
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        ...
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            //this.GridView1.Columns[13].Name = "Col_txtmoney_after_vat";
                            //this.GridView1.Columns[14].Name = "Col_txtpo_status";
        ...
        private void Show_GridView1()
        {
            ...
            this.GridView1.Columns[9].Visible = true;  //"Col_txtPr_id";
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                if (this.cboSearch.Text == "เลขที่ PO")
                {
                    cmd2.CommandText = "SELECT k018db_po_record.*," +
                                    ...
                                    " AND (k018db_po_record.txtbranch_id = '" + W_ID_Select.M_BRANCHID.Trim() + "')" +
                                      " AND (k018db_po_record.txttrans_date_server BETWEEN @datestart AND @dateend)" +
                                      " AND (k018db_po_record.txtPr_id = '" + this.txtsearch.Text.Trim() + "')" +
                                      " ORDER BY k018db_po_record.txtPr_id ASC";
                ...
                if (this.cboSearch.Text == "ชื่อผู้บันทึก PO")
                {
                    cmd2.CommandText = "SELECT k018db_po_record.*," +
                                      ...
                                      " AND (k018db_po_record.txtbranch_id = '" + W_ID_Select.M_BRANCHID.Trim() + "')" +
                                       " AND (k018db_po_record.txttrans_date_server BETWEEN @datestart AND @dateend)" +
                                       " AND (k018db_po_record.txtemp_office_name LIKE '%" + this.txtsearch.Text.Trim() + "%')" +
                                      " ORDER BY k018db_po_record.txtPr_id ASC";
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        ...
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            //this.GridView1.Columns[12].Name = "Col_txtRG_date";
                            //this.GridView1.Columns[13].Name = "Col_txtmoney_after_vat";
                            //this.GridView1.Columns[14].Name = "Col_txtpr_status";
                            //this.GridView1.Columns[15].Name = "Col_txtpo_status";
                            //this.GridView1.Columns[16].Name = "Col_txtRG_status";
                            //    Convert.ToDateTime(dt.Rows[i]["txtreceipt_date"]).ToString("dd-MM-yyyy", UsaCulture)
                            var index = this.GridView1.Rows.Add();
                            this.GridView1.Rows[index].Cells["Col_Auto_num"].Value = ""; //0
                            this.GridView1.Rows[index].Cells["Col_txtco_id"].Value = dt2.Rows[j]["txtco_id"].ToString();      //1
