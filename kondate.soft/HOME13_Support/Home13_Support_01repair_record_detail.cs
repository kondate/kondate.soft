...
{
    public partial class Home13_Support_01repair_record_detail : Form
    {
        //Move Form ====================================
        ...
        public Home13_Support_01repair_record_detail()
        {
            InitializeComponent();
        }

        private void Home13_Support_01repair_record_detail_Load(object sender, EventArgs e)
        {
            W_ID_Select.M_FORM_NUMBER = "H1301SPDL";
            CHECK_ADD_FORM();
            ...
            this.iblword_status.Text = "ดูข้อมูลใบแจ้งซ่อมฮาร์ดแวร์และซอฟท์แวร์";
