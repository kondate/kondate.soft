...
{
    public partial class Home13_Support_03get_repair_1approve : Form
    {
        //Move Form ====================================
        ...
        public Home13_Support_03get_repair_1approve()
        {
            InitializeComponent();
        }

        private void Home13_Support_03get_repair_1approve_Load(object sender, EventArgs e)
        {
            ...
            this.iblword_status.Text = "ระเบียนอนุมัติ แจ้งซ่อมฮาร์ดแวร์และซอฟท์แวร์";
            ...
            //========================================
            this.cboSearch.Items.Add("เลขที่ใบอนุมัติแจ้งซ่อมฮาร์ดแวร์และซอฟท์แวร์");
            this.cboSearch.Items.Add("ชื่อผู้อนุมัติซ่อม");
        ...
        private void Fill_Show_DATA_GridView1()
        {
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                cmd2.CommandText = "SELECT h013support_01repair_2noti_approve.*," +
                                   "h013support_01repair_1noti_record.*," +
                                   "h013support_02_problem.*," +
                                   "k013_1db_acc_16department.*" +

                                   " FROM h013support_01repair_2noti_approve" +

                                   " INNER JOIN h013support_01repair_1noti_record" +
                                   " ON h013support_01repair_1noti_record.cdkey = h013support_01repair_1noti_record.cdkey" +
                                   " AND h013support_01repair_1noti_record.txtco_id = h013support_01repair_1noti_record.txtco_id" +
                                   " AND h013support_01repair_1noti_record.txtapprove_notic_id = h013support_01repair_1noti_record.txtapprove_notic_id" +
                                   ...
                                   " WHERE (h013support_01repair_2noti_approve.cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                   " AND (h013support_01repair_2noti_approve.txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                   " AND (h013support_01repair_2noti_approve.txtbranch_id = '" + W_ID_Select.M_BRANCHID.Trim() + "')" +
                                   " AND (h013support_01repair_2noti_approve.txttrans_date_server BETWEEN @datestart AND @dateend)" +
                                   " ORDER BY h013support_01repair_2noti_approve.txtapprove_notic_id ASC";
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        ...
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            this.GridView1.Rows[index].Cells["Col_txtapprove_notic_id"].Value = dt2.Rows[j]["txtapprove_notic_id"].ToString();      //3
                            this.GridView1.Rows[index].Cells["Col_txtnoti_id"].Value = dt2.Rows[j]["txtnoti_id"].ToString();      //4
                            this.GridView1.Rows[index].Cells["Col_txttrans_date_server"].Value = Convert.ToDateTime(dt2.Rows[j]["txttrans_date_server"]).ToString("dd-MM-yyyy", UsaCulture);     //5
                            this.GridView1.Rows[index].Cells["Col_txttrans_time"].Value = dt2.Rows[j]["txttrans_time"].ToString();      //6
                            this.GridView1.Rows[index].Cells["Col_txtdepartment_name"].Value = dt2.Rows[j]["txtdepartment_name"].ToString();      //7
                            this.GridView1.Rows[index].Cells["Col_txtmachine_number"].Value = dt2.Rows[j]["txtmachine_number"].ToString();      //8
                            this.GridView1.Rows[index].Cells["Col_txtproblem_name"].Value = dt2.Rows[j]["txtproblem_name"].ToString();      //9
                            this.GridView1.Rows[index].Cells["Col_txtproblem_detail"].Value = dt2.Rows[j]["txtproblem_detail"].ToString();      //10
                            this.GridView1.Rows[index].Cells["Col_txtemp_noti"].Value = dt2.Rows[j]["txtemp_noti"].ToString();      //11
                            this.GridView1.Rows[index].Cells["Col_txtemp_noti_apporve"].Value = dt2.Rows[j]["txtemp_noti_apporve"].ToString();      //12

                            this.GridView1.Rows[index].Cells["Col_txtapprove_status_id"].Value = dt2.Rows[j]["txtapprove_status_id"].ToString();      //13
                            this.GridView1.Rows[index].Cells["Col_txtremark"].Value = dt2.Rows[j]["txtremark"].ToString();      //14

                            this.GridView1.Rows[index].Cells["Col_txtrepair_status"].Value = dt2.Rows[j]["txtrepair_status"].ToString();  //15
                            this.GridView1.Rows[index].Cells["Col_txtapprove_get_notic_id"].Value = dt2.Rows[j]["txtapprove_get_notic_id"].ToString();  //16
        ...
        private void Show_GridView1()
        {
            ...
            this.GridView1.Columns[3].Name = "Col_txtapprove_notic_id";
            this.GridView1.Columns[4].Name = "Col_txtnoti_id";
            ...
            this.GridView1.Columns[8].Name = "Col_txtmachine_number";
            this.GridView1.Columns[9].Name = "Col_txtproblem_name";
            this.GridView1.Columns[10].Name = "Col_txtproblem_detail";
            this.GridView1.Columns[11].Name = "Col_txtemp_noti";
            this.GridView1.Columns[12].Name = "Col_txtemp_noti_apporve";
            this.GridView1.Columns[13].Name = "Col_txtapprove_status_id";
            this.GridView1.Columns[14].Name = "Col_txtremark";
            this.GridView1.Columns[15].Name = "Col_txtrepair_status";
            this.GridView1.Columns[16].Name = "Col_txtapprove_get_notic_id";
            ...
            this.GridView1.Columns[4].HeaderText = " เลขที่แจ้ง";
            this.GridView1.Columns[5].HeaderText = " วันที่";
            this.GridView1.Columns[6].HeaderText = " เวลา";
            this.GridView1.Columns[7].HeaderText = "ฝ่ายที่แจ้ง";
            this.GridView1.Columns[8].HeaderText = "หมายเลขเครื่อง";
            this.GridView1.Columns[9].HeaderText = "แจ้งปัญหา";
            this.GridView1.Columns[10].HeaderText = "รายละเอียดปัญหา/อาการที่เสีย";
            this.GridView1.Columns[11].HeaderText = "ผู้แจ้ง";
            this.GridView1.Columns[12].HeaderText = "ผู้อนุมัติ";
            this.GridView1.Columns[13].HeaderText = "ผลอนุมัติ";
            this.GridView1.Columns[14].HeaderText = "หมายเหตุ";
            this.GridView1.Columns[15].HeaderText = "สถานะซ่อม";
            this.GridView1.Columns[16].HeaderText = "เลขที่ซ่อม";
            ...
            this.GridView1.Columns["Col_txtapprove_notic_id"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
            ...
            this.GridView1.Columns["Col_txtproblem_detail"].Width = 200;
            ...
            this.GridView1.Columns["Col_txtapprove_status_id"].Visible = false;  //"Col_txtapprove_status_id";
            this.GridView1.Columns["Col_txtapprove_status_id"].Width = 0;
            this.GridView1.Columns["Col_txtapprove_status_id"].ReadOnly = true;
            this.GridView1.Columns["Col_txtapprove_status_id"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.GridView1.Columns["Col_txtapprove_status_id"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;

            this.GridView1.Columns["Col_txtremark"].Visible = true;  //"Col_txtremark";
            this.GridView1.Columns["Col_txtremark"].Width = 200;
            this.GridView1.Columns["Col_txtremark"].ReadOnly = true;
            ...
            this.GridView1.Columns["Col_txtapprove_get_notic_id"].Width = 120;
        ...
        private void GridView1_Color()
        {
            for (int i = 0; i < this.GridView1.Rows.Count - 0; i++)
            {
                ...
                {
                    GridView1.Rows[i].DefaultCellStyle.BackColor = Color.FromArgb(0, 120, 215);  //0, 120, 215
                    GridView1.Rows[i].DefaultCellStyle.ForeColor = Color.White;
                    GridView1.Rows[i].DefaultCellStyle.Font = new Font("Tahoma", 8F);
        ...
        private void GridView1_DoubleClick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                W_ID_Select.WORD_TOP = "ดูข้อมูลใบแจ้งซ่อมฮาร์ดแวร์และซอฟท์แวร์";
                kondate.soft.HOME13_Support.Home13_Support_03get_repair_record frm2 = new kondate.soft.HOME13_Support.Home13_Support_03get_repair_record();
                frm2.Show();
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                if (this.cboSearch.Text == "เลขที่ใบแจ้งซ่อมฮาร์ดแวร์และซอฟท์แวร์")
                {
                    cmd2.CommandText = "SELECT h013support_01repair_2noti_approve.*," +
                                       ...
                                       " AND (h013support_01repair_2noti_approve.txtbranch_id = '" + W_ID_Select.M_BRANCHID.Trim() + "')" +
                                       " AND (h013support_01repair_2noti_approve.txttrans_date_server BETWEEN @datestart AND @dateend)" +
                                       " AND (h013support_01repair_2noti_approve.txtapprove_notic_id = '" + this.txtsearch.Text.Trim() + "')" +
                                       " ORDER BY h013support_01repair_2noti_approve.txtapprove_notic_id ASC";
                ...
                if (this.cboSearch.Text == "ชื่อผู้แจ้งซ่อม")
                {
                    cmd2.CommandText = "SELECT h013support_01repair_2noti_approve.*," +
                                       ...
                                       " AND (h013support_01repair_2noti_approve.txtbranch_id = '" + W_ID_Select.M_BRANCHID.Trim() + "')" +
                                       " AND (h013support_01repair_2noti_approve.txttrans_date_server BETWEEN @datestart AND @dateend)" +
                                       " AND (h013support_01repair_2noti_approve.txtemp_office_name LIKE '%" + this.txtsearch.Text.Trim() + "%')" +
                                       " ORDER BY h013support_01repair_2noti_approve.txtapprove_notic_id ASC";
