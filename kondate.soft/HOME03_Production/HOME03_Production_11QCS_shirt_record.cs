...
{
    public partial class HOME03_Production_11QCS_shirt_record : Form
    {
        //Move Form ====================================
        ...
        public HOME03_Production_11QCS_shirt_record()
        {
            InitializeComponent();
        }

        private void HOME03_Production_11QCS_shirt_record_Load(object sender, EventArgs e)
        {
            this.WindowState = FormWindowState.Maximized;
            this.btnmaximize.Visible = false;
            this.btnmaximize_full.Visible = true;

            W_ID_Select.M_FORM_NUMBER = "H0311QCSRD";
            CHECK_ADD_FORM();
            ...
            this.iblword_status.Text = "บันทึกใบจัดเก็บจำนวน คิวซี";
        ...
        private void PANEL_SEW_GridView1_Color()
        {
            ...
            {
                if (this.PANEL_SEW_GridView1.Rows[i].Cells["Col_txtqcs_id"].Value.ToString() != "")
                {
        ...
        private void PANEL_SEW_GridView1_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                if (cell != null)
                {
                    if (row.Cells["Col_txtqcs_id"].Value.ToString() != "")
                    {
                        //MessageBox.Show(" " + row.Cells["Col_txtqcs_id"].Value.ToString() + " ");
        ...
        private void BtnNew_Click(object sender, EventArgs e)
        {
            ...
            this.Hide();
            var frm2 = new HOME03_Production.HOME03_Production_11QCS_shirt_record();
        ...
        private void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                try
                {
                    ...
                    {
                        cmd2.CommandText = "UPDATE c002_11QCS_shirt_record_trans SET txttrans_id = '" + this.txtQCS_id.Text.Trim() + "'" +
                                           " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                           " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                           " AND (txtbranch_id = '" + W_ID_Select.M_BRANCHID.Trim() + "')";
                    ...
                    //2 c002_11QCS_shirt_record
                    cmd2.CommandText = "INSERT INTO c002_11QCS_shirt_record(cdkey,txtco_id,txtbranch_id," +  //1
                    ...
                    cmd2.Parameters.Add("@txtQCS_id", SqlDbType.NVarChar).Value = this.txtQCS_id.Text.Trim();  //7
                    ...
                    cmd2.Parameters.Add("@txtqcs_remark", SqlDbType.NVarChar).Value = this.txtqcs_remark.Text.Trim();  //11
                    ...
                    cmd2.Parameters.Add("@txtsum_qty_qcs", SqlDbType.Float).Value = Convert.ToDouble(string.Format("{0:n0}", this.txtsum_qty_qcs.Text.ToString()));  //16
                    ...
                    //3 c002_11QCS_shirt_record_detail
                    ...
                    for (int i = 0; i < this.GridView1.Rows.Count; i++)
                    {
                        ...
                        if (this.GridView1.Rows[i].Cells["Col_txtSEW_id"].Value != null)
                        {
                            ...
                            cmd2.CommandText = "INSERT INTO c002_11QCS_shirt_record_detail(cdkey,txtco_id,txtbranch_id," +  //1
                          ...
                          "txtnumber_color_id," +  //11
                           ...
                           "'" + myDateTime.ToString("yyyy", UsaCulture) + "','" + myDateTime.ToString("MM", UsaCulture) + "','" + myDateTime.ToString("dd", UsaCulture) + "'," +
                            ...
                            "'" + this.txtQCS_id.Text.Trim() + "'," +  //  "txtQCS_id," +  //6
                            ...
                            cmd2.CommandText = "UPDATE c002_09Sew_shirt_record SET " +
                                               "txtqcs_status = '0'," +
                                               "txtqcs_id = '" + this.txtQCS_id.Text.Trim() + "'" +
                                               " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                               " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                    ...
                    //        "'CS'," +  //9 txtbill_type
                    //        "'เบิกคิวซี " + this.txtshirt_cut_remark.Text.Trim() + "'," +  //9 txtbill_remark
                    ...
                    if (dialogResult == DialogResult.Yes)
                    {
                        ...
                        if (this.iblword_status.Text.Trim() == "บันทึกใบจัดเก็บจำนวน คิวซี")
                        {
        ...
        private void BtnPrint_Click(object sender, EventArgs e)
        {
            ...
            if (printDialog.ShowDialog() == DialogResult.OK)
            {
                ...
                rpt.SetParameterValue("txqcs_id", W_ID_Select.TRANS_ID.Trim());
        ...
        private void AUTO_BILL_TRANS_ID()
        {
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                cmd1.CommandText = "SELECT *" +
                                  " FROM c002_11QCS_shirt_record_trans" +
                                  " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                  " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                  " AND (txtbranch_id = '" + W_ID_Select.M_BRANCHID.Trim() + "')" +
                ...
                try
                {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        {
                            TMP = "QCS" + W_ID_Select.M_BRANCHNAME_SHORT.Trim() + "-" + year_now2.Trim() + "" + month_now.Trim() + "" + day_now.Trim() + "-" + trans.Trim();
                        }
                        else
                        {
                            TMP = "QCS" + W_ID_Select.M_BRANCHNAME_SHORT.Trim() + "-" + year_now2.Trim() + "" + month_now.Trim() + "" + day_now.Trim() + "-" + "000001";
                        }
        ...
        {
            W_ID_Select.WORD_TOP = "ระเบียนใบคิวซีผ้าเย็บ";
            kondate.soft.HOME03_Production.HOME03_Production_11QCS_shirt frm2 = new kondate.soft.HOME03_Production.HOME03_Production_11QCS_shirt();
            frm2.Show();
