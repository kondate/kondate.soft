...
{
    public partial class HOME03_Production_07Send_Cut_shirt_record : Form
    {
        //Move Form ====================================
        ...
        public HOME03_Production_07Send_Cut_shirt_record()
        {
            InitializeComponent();
        ...
        private void HOME03_Production_05Send_Dye_record_Load(object sender, EventArgs e)
        {
            ...
            this.iblword_status.Text = "บันทึกใบส่งตัด";

            this.ActiveControl = this.txtSPT_record_remark;
        ...
        {
            this.GridView1.ColumnCount = 44;
            this.GridView1.Columns[0].Name = "Col_Auto_num";
            this.GridView1.Columns[1].Name = "Col_txtnumber_dyed";
            this.GridView1.Columns[2].Name = "Col_txtnumber_in_year";
            this.GridView1.Columns[3].Name = "Col_txtwherehouse_id";
            this.GridView1.Columns[4].Name = "Col_txtnumber_mat_id";
            this.GridView1.Columns[5].Name = "Col_txtnumber_color_id";
            this.GridView1.Columns[6].Name = "Col_txtface_baking_id";


            this.GridView1.Columns[7].Name = "Col_txtlot_no";
            ...
            this.GridView1.Columns[34].Name = "Col_txtsum_qty_pub";
            this.GridView1.Columns[35].Name = "Col_date";
            this.GridView1.Columns[36].Name = "Col_qty_Cal";  //
            this.GridView1.Columns[37].Name = "Col_txtsum_qty_rib";
            this.GridView1.Columns[38].Name = "Col_txtsum_qty_pub_kg";
            this.GridView1.Columns[39].Name = "Col_txtsum_qty_rib_kg";

            this.GridView1.Columns[40].Name = "Col_txtqty_after_cut";
            this.GridView1.Columns[41].Name = "Col_txtqty_cut_yokma";
            this.GridView1.Columns[42].Name = "Col_txtqty_cut_yokpai";
            this.GridView1.Columns[43].Name = "Col_txtqty_after_cut_yokpai";
            ...
            this.GridView1.Columns[1].HeaderText = "เบอร์กอง";
            this.GridView1.Columns[2].HeaderText = "ชุดที่";
            this.GridView1.Columns[3].HeaderText = "คลัง";
            this.GridView1.Columns[4].HeaderText = "รหัสผ้า";
            this.GridView1.Columns[5].HeaderText = "รหัสสี";
            this.GridView1.Columns[6].HeaderText = "อบหน้า";


            this.GridView1.Columns[7].HeaderText = "Lot No";
            this.GridView1.Columns[8].HeaderText = "พับที่";

            this.GridView1.Columns[10].HeaderText = "ส่งตัด (กก.)";
            ...
            this.GridView1.Columns[14].HeaderText = " หน่วยหลัก";
            this.GridView1.Columns[15].HeaderText = " หน่วย";
            this.GridView1.Columns[16].HeaderText = "แปลง";
            this.GridView1.Columns[17].HeaderText = " หน่วย(ปอนด์)";
            this.GridView1.Columns[18].HeaderText = " หน่วย";

            this.GridView1.Columns[19].HeaderText = "ส่งตัด(ปอนด์)";
            ...
            this.GridView1.Columns[32].HeaderText = "item_no";
            this.GridView1.Columns[33].HeaderText = "txtqc_id";
            this.GridView1.Columns[34].HeaderText = "Col_txtsum_qty_pub";
            this.GridView1.Columns[35].HeaderText = " วันที่ต้องการ";
            this.GridView1.Columns[36].HeaderText = "Col_qty_Cal";
            this.GridView1.Columns[37].HeaderText = "Col_txtsum_qty_rib";
            this.GridView1.Columns[38].HeaderText = "Col_txtsum_qty_pub_kg";
            this.GridView1.Columns[39].HeaderText = "Col_txtsum_qty_rib_kg";

            this.GridView1.Columns[40].HeaderText = "Col_txtqty_after_cut ยกมา";
            this.GridView1.Columns[41].HeaderText = "รวมจำนวนรับคืนแล้วยกมา";
            this.GridView1.Columns[42].HeaderText = "รวมจำนวนรับคืนแล้วยกไป";
            this.GridView1.Columns[43].HeaderText = "เหลือรอรับอีก กก.";
            ...
            for (int i = 0; i < this.GridView1.Rows.Count; i++)
            {
                ...
                if (Convert.ToBoolean(this.GridView1.Rows[i].Cells["Col_Chk_SELECT"].Value) == true)
                {
                    ...
                    if (this.GridView1.Rows[i].Cells["Col_txtfold_number"].Value.ToString() == "RIB")
                   {
                    ...
                    //GridView1.Rows[index].Cells["Col_txtqty_after_cut"].Value = Convert.ToDouble(string.Format("{0:n4}", this.GridView66.Rows[selectedRowIndex].Cells["Col_txtqty_after_cut"].Value.ToString()));       //21
                    //GridView1.Rows[index].Cells["Col_txtqty_cut_yokma"].Value = Convert.ToDouble(string.Format("{0:n4}", this.GridView66.Rows[selectedRowIndex].Cells["Col_txtqty_cut"].Value.ToString()));     //36
        ...
        private void Show_Qty_Yokma()
        {
            ...
            for (int i = 0; i < this.GridView1.Rows.Count; i++)
            {
                ...
                if (conn.State == System.Data.ConnectionState.Open)
                {
                    ...
                    cmd2.CommandText = "SELECT *" +
                                       " FROM c002_07Receive_Send_dye_record_detail" +
                                       " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                       " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
        ...
        private void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                try
                {
                    ...
                    {
                        cmd2.CommandText = "UPDATE c002_07Send_Cut_shirt_record_trans SET txttrans_id = '" + this.txtSPT_id.Text.Trim() + "'" +
                                           " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                           " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                    ...
                    //2 c002_07Send_Cut_shirt_record
                    cmd2.CommandText = "INSERT INTO c002_07Send_Cut_shirt_record(cdkey,txtco_id,txtbranch_id," +  //1
                    ...
                    cmd2.Parameters.Add("@txtSPT_id", SqlDbType.NVarChar).Value = this.txtSPT_id.Text.Trim();  //7
                    ...
                    cmd2.Parameters.Add("@txtCS_id", SqlDbType.NVarChar).Value = "";  //10
                    cmd2.Parameters.Add("@txtCS_date", SqlDbType.NVarChar).Value = "";  //11
                    ...
                    cmd2.Parameters.Add("@txtSPT_record_remark", SqlDbType.NVarChar).Value = this.txtSPT_record_remark.Text.Trim();  //20
                    ...
                    cmd2.Parameters.Add("@txtSPT_status", SqlDbType.NVarChar).Value = "0";  //49
                    cmd2.Parameters.Add("@txtapprove_status", SqlDbType.NVarChar).Value = "";  //50
                    cmd2.Parameters.Add("@txtCS_status", SqlDbType.NVarChar).Value = "";  //51
                    ...
                    //3 c002_07Send_Cut_shirt_record_detail
                        ...
                        if (this.GridView1.Rows[i].Cells["Col_txtmat_id"].Value != null)
                        {
                            ...
                            // {
                                ...
                                //3 c002_07Send_Cut_shirt_record_detail
                                 ...
                                 cmd2.CommandText = "INSERT INTO c002_07Send_Cut_shirt_record_detail(cdkey,txtco_id,txtbranch_id," +  //1
                               ...
                               "txtqty_balance," +  //26
                                ...
                                "'" + Convert.ToDouble(string.Format("{0:n4}", this.GridView1.Rows[i].Cells["Col_txtqty2"].Value.ToString())) + "'," +  //25
                                 ...
                                 "'" + Convert.ToDouble(string.Format("{0:n4}", this.GridView1.Rows[i].Cells["Col_txtsum_qty_pub"].Value.ToString())) + "'," +  //27
                                ...
                                "'" + Convert.ToDouble(string.Format("{0:n4}", this.GridView1.Rows[i].Cells["Col_txtsum_qty_pub"].Value.ToString())) + "'," +  //29
                                 ...
                                 "'" + Convert.ToDouble(string.Format("{0:n4}", this.GridView1.Rows[i].Cells["Col_txtsum_qty_rib"].Value.ToString())) + "'," +  //27
                                 "'" + Convert.ToDouble(string.Format("{0:n4}", 0)) + "'," +  //28
                           ...
                           "'" + Convert.ToDouble(string.Format("{0:n4}", this.GridView1.Rows[i].Cells["Col_txtqty"].Value.ToString())) + "'," +  //53
                            ...
                            "'')";   //54
                                ...
                                cmd2.CommandText = "UPDATE c002_07Receive_Send_dye_record_detail SET " +
                                                   //"txtSPT_status = '0'," +
                                                   "txtcut_id = '" + this.txtSPT_id.Text.ToString() + "'," +
                                ...
                                //" AND (c002_03QC_record_detail.txtSPT_id = '')" +
                    ...
                    cmd2.CommandText = "INSERT INTO k021_mat_average_balance(cdkey,txtco_id,txtbranch_id," +  //1
                            ...
                            "'" + this.txtSPT_id.Text.Trim() + "'," +  //7 txtbill_id
                            "'SPT'," +  //9 txtbill_type
                            "'ส่งตัด " + this.txtSPT_record_remark.Text.Trim() + "'," +  //9 txtbill_remark
                    ...
                    if (dialogResult == DialogResult.Yes)
                    {
                        ...
                        if (this.iblword_status.Text.Trim() == "บันทึกใบส่งตัด")
                        {
        ...
        private void btnPreview_Click(object sender, EventArgs e)
        {
            ...
            UPDATE_PRINT_BY();
            W_ID_Select.TRANS_ID = this.txtSPT_id.Text.Trim();
        ...
        private void BtnPrint_Click(object sender, EventArgs e)
        {
            ...
            if (printDialog.ShowDialog() == DialogResult.OK)
            {
                ...
                rpt.Load("C:\\KD_ERP\\KD_REPORT\\Report_c002_07Send_Cut_shirt_record.rpt");
                ...
                cmd2.CommandText = "SELECT c002_07Receive_Send_dye_record.*," +
                                   ...
                                   //" AND c002_07Receive_Send_dye_record.txtdepartment_id = k013_1db_acc_16department.txtdepartment_id" +
                                    ...
                                    " AND (c002_07Receive_Send_dye_record.txtrg_status = '0')" +
                                      ...
                                      //" AND (c002_07Receive_Send_dye_record_detail.txtface_baking_id = '" + this.PANEL0105_FACE_BAKING_txtface_baking_id.Text.Trim() + "')" +
                      ...
                      for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            this.GridView66.Rows[index].Cells["Col_txtnumber_dyed"].Value = dt2.Rows[j]["txtnumber_dyed"].ToString();      //2
                            ...
                            this.GridView66.Rows[index].Cells["Col_txtqty_want"].Value = Convert.ToSingle(dt2.Rows[j]["txtqty_want"]).ToString("###,###.00");     //8
                            this.GridView66.Rows[index].Cells["Col_txtqty_balance"].Value = Convert.ToSingle(dt2.Rows[j]["txtqty"]).ToString("###,###.00");     //9
                            this.GridView66.Rows[index].Cells["Col_txtqty"].Value = Convert.ToSingle(dt2.Rows[j]["txtqty"]).ToString("###,###.00");   //11

                            this.GridView66.Rows[index].Cells["Col_txtmat_no"].Value = dt2.Rows[j]["txtmat_no"].ToString();      //12
                            this.GridView66.Rows[index].Cells["Col_txtmat_id"].Value = dt2.Rows[j]["txtmat_id"].ToString();      //13
                            this.GridView66.Rows[index].Cells["Col_txtmat_name"].Value = dt2.Rows[j]["txtmat_name"].ToString();      //14

                            this.GridView66.Rows[index].Cells["Col_txtmat_unit1_name"].Value = dt2.Rows[j]["txtmat_unit1_name"].ToString();      //15
                            this.GridView66.Rows[index].Cells["Col_txtmat_unit1_qty"].Value = Convert.ToSingle(dt2.Rows[j]["txtmat_unit1_qty"]).ToString("###,###.00");      //16

                            this.GridView66.Rows[index].Cells["Col_chmat_unit_status"].Value = dt2.Rows[j]["chmat_unit_status"].ToString();      //17

                            this.GridView66.Rows[index].Cells["Col_txtmat_unit2_name"].Value = dt2.Rows[j]["txtmat_unit2_name"].ToString();      //18
                            this.GridView66.Rows[index].Cells["Col_txtmat_unit2_qty"].Value = Convert.ToSingle(dt2.Rows[j]["txtmat_unit2_qty"]).ToString("###,###.0000");      //19

                            this.GridView66.Rows[index].Cells["Col_txtqty2"].Value = Convert.ToSingle(dt2.Rows[j]["txtqty2"]).ToString("###,###.00");     //20


                            this.GridView66.Rows[index].Cells["Col_txtprice"].Value = Convert.ToSingle(dt2.Rows[j]["txtprice"]).ToString("###,###.00");        //21
                            this.GridView66.Rows[index].Cells["Col_txtdiscount_rate"].Value = Convert.ToSingle(dt2.Rows[j]["txtdiscount_rate"]).ToString("###,###.00");      //22
                            this.GridView66.Rows[index].Cells["Col_txtdiscount_money"].Value = Convert.ToSingle(dt2.Rows[j]["txtdiscount_money"]).ToString("###,###.00");      //23
                            this.GridView66.Rows[index].Cells["Col_txtsum_total"].Value = Convert.ToSingle(dt2.Rows[j]["txtsum_total"]).ToString("###,###.00");      //24

                            this.GridView66.Rows[index].Cells["Col_txtcost_qty_balance_yokma"].Value = ".00";      //25
                            this.GridView66.Rows[index].Cells["Col_txtcost_qty_price_average_yokma"].Value = ".00";       //26
                            this.GridView66.Rows[index].Cells["Col_txtcost_money_sum_yokma"].Value = ".00";       //27

                            this.GridView66.Rows[index].Cells["Col_txtcost_qty_balance_yokpai"].Value = ".00";       //28
                            this.GridView66.Rows[index].Cells["Col_txtcost_qty_price_average_yokpai"].Value = ".00";        //29
                            this.GridView66.Rows[index].Cells["Col_txtcost_money_sum_yokpai"].Value = ".00";       //30

                            this.GridView66.Rows[index].Cells["Col_txtcost_qty2_balance_yokma"].Value = ".00";        //31
                            this.GridView66.Rows[index].Cells["Col_txtcost_qty2_balance_yokpai"].Value = ".00";        //32

                            this.GridView66.Rows[index].Cells["Col_txtitem_no"].Value = dt2.Rows[j]["txtitem_no"].ToString();      //33

                            this.GridView66.Rows[index].Cells["Col_txtqc_id"].Value = dt2.Rows[j]["txtqc_id"].ToString();      //34


                            this.GridView66.Rows[index].Cells["Col_txtqty_want_pub"].Value = Convert.ToSingle(dt2.Rows[j]["txtqty_want_pub"]).ToString("###,###.00");      //35
                            this.GridView66.Rows[index].Cells["Col_txtqty_balance_pub"].Value = Convert.ToSingle(dt2.Rows[j]["txtqty_pub"]).ToString("###,###.00");     //36
                            this.GridView66.Rows[index].Cells["Col_txtsum_qty_pub"].Value = "0";   //37

                            this.GridView66.Rows[index].Cells["Col_txtqty_want_rib"].Value = Convert.ToSingle(dt2.Rows[j]["txtqty_want_rib"]).ToString("###,###.00");      //38
                            this.GridView66.Rows[index].Cells["Col_txtqty_balance_rib"].Value = Convert.ToSingle(dt2.Rows[j]["txtqty_rib"]).ToString("###,###.00");     //39
                            this.GridView66.Rows[index].Cells["Col_txtsum_qty_rib"].Value = "0";   //40


                            this.GridView66.Rows[index].Cells["Col_date"].Value = dt2.Rows[j]["txtwant_receive_date"].ToString();     //41
                            this.GridView66.Rows[index].Cells["Col_mat_status"].Value = "0";     //42

                            this.GridView66.Rows[index].Cells["Col_txtqty_balance_yokpai"].Value = "0";     //43
                            this.GridView66.Rows[index].Cells["Col_txtsum_qty_pub_yokpai"].Value = "0";     //44
                            this.GridView66.Rows[index].Cells["Col_txtsum_qty_rib_yokpai"].Value = "0";     //45
                            this.GridView66.Rows[index].Cells["Col_qty_Cal"].Value = "0";     //46
                            this.GridView66.Rows[index].Cells["Col_txtsum_qty_pub_kg"].Value = "0";     //47
                            this.GridView66.Rows[index].Cells["Col_txtsum_qty_rib_kg"].Value = "0";     //48
                            this.GridView66.Rows[index].Cells["Col_txtqty_berg_cut_shirt_balance"].Value = Convert.ToSingle(dt2.Rows[j]["txtqty_berg_cut_shirt_balance"]).ToString("###,###.00");     //49
        ...
        {
            this.GridView66.ColumnCount = 54;
            this.GridView66.Columns[0].Name = "Col_Auto_num";
            this.GridView66.Columns[1].Name = "Col_txtnumber_dyed";
            this.GridView66.Columns[2].Name = "Col_txtnumber_in_year";
            this.GridView66.Columns[3].Name = "Col_txtwherehouse_id";
            this.GridView66.Columns[4].Name = "Col_txtnumber_mat_id";
            this.GridView66.Columns[5].Name = "Col_txtnumber_color_id";
            this.GridView66.Columns[6].Name = "Col_txtface_baking_id";


            this.GridView66.Columns[7].Name = "Col_txtlot_no";
            this.GridView66.Columns[8].Name = "Col_txtfold_number";

            this.GridView66.Columns[9].Name = "Col_txtqty_want";
            this.GridView66.Columns[11].Name = "Col_txtqty_balance";
            ...
            this.GridView66.Columns[36].Name = "Col_txtqty_want_pub";
            this.GridView66.Columns[37].Name = "Col_txtqty_balance_pub";
            this.GridView66.Columns[38].Name = "Col_txtsum_qty_pub";

            this.GridView66.Columns[39].Name = "Col_txtqty_want_rib";
            this.GridView66.Columns[40].Name = "Col_txtqty_balance_rib";
            this.GridView66.Columns[41].Name = "Col_txtsum_qty_rib";

            this.GridView66.Columns[42].Name = "Col_date";
            //Col_mat_status
            this.GridView66.Columns[43].Name = "Col_mat_status";

            this.GridView66.Columns[44].Name = "Col_txtqty_balance_yokpai";
            this.GridView66.Columns[45].Name = "Col_txtsum_qty_pub_yokpai";
            this.GridView66.Columns[46].Name = "Col_txtsum_qty_rib_yokpai";

            this.GridView66.Columns[47].Name = "Col_qty_Cal";  //
            this.GridView66.Columns[48].Name = "Col_txtsum_qty_pub_kg";
            this.GridView66.Columns[49].Name = "Col_txtsum_qty_rib_kg";
            this.GridView66.Columns[50].Name = "Col_txtqty_berg_cut_shirt_balance";

            this.GridView66.Columns[51].Name = "Col_txtqty_cut";
            this.GridView66.Columns[52].Name = "Col_txtqty_after_cut";
            this.GridView66.Columns[53].Name = "Col_txtcut_id";


            this.GridView66.Columns[0].HeaderText = "No";
            this.GridView66.Columns[1].HeaderText = "เบอร์กอง";
            this.GridView66.Columns[2].HeaderText = "ชุดที่";
            this.GridView66.Columns[3].HeaderText = "คลัง";
            this.GridView66.Columns[4].HeaderText = "รหัสผ้า";
            this.GridView66.Columns[5].HeaderText = "รหัสสี";
            this.GridView66.Columns[6].HeaderText = "อบหน้า";

            this.GridView66.Columns[7].HeaderText = "Lot No";
            this.GridView66.Columns[8].HeaderText = "พับที่";

            this.GridView66.Columns[9].HeaderText = "ส่งย้อม (กก.)";
            this.GridView66.Columns[11].HeaderText = "ส่งย้อมค้างรับ (กก.)";
            this.GridView66.Columns[12].HeaderText = "รับ (กก.)";
            ...
            this.GridView66.Columns[21].HeaderText = "รับ(ปอนด์)";
            ...
            this.GridView66.Columns[36].HeaderText = "Col_txtqty_want_pub";
            this.GridView66.Columns[37].HeaderText = "Col_txtqty_balance_pub";
            this.GridView66.Columns[38].HeaderText = "Col_txtsum_qty_pub";

            this.GridView66.Columns[39].HeaderText = "Col_txtqty_want_rib";
            this.GridView66.Columns[40].HeaderText = "Col_txtqty_balance_rib";
            this.GridView66.Columns[41].HeaderText = "Col_txtsum_qty_rib";

            this.GridView66.Columns[42].HeaderText = " วันที่ต้องการ";
            this.GridView66.Columns[43].HeaderText = " Col_mat_status";

            this.GridView66.Columns[44].HeaderText = "Col_txtqty_balance_yokpai";
            this.GridView66.Columns[45].HeaderText = "Col_txtsum_qty_pub_yokpai";
            this.GridView66.Columns[46].HeaderText = "Col_txtsum_qty_rib_yokpai";

            this.GridView66.Columns[47].HeaderText = "Col_qty_Cal";
            this.GridView66.Columns[48].HeaderText = "Col_txtsum_qty_pub_kg";
            this.GridView66.Columns[49].HeaderText = "Col_txtsum_qty_rib_kg";
            this.GridView66.Columns[50].HeaderText = "รอสั่งตัด";  //Col_txtqty_berg_cut_shirt_balance

            this.GridView66.Columns[51].HeaderText = "จำนวนส่งตัด";  //กก
            this.GridView66.Columns[52].HeaderText = "จำนวนเหลือ";  //กก
            this.GridView66.Columns[53].HeaderText = "เลขที่ส่งตัด";  //
            ...
            this.GridView66.Columns["Col_txtnumber_dyed"].Width = 80;
            ...
            this.GridView66.Columns["Col_txtnumber_dyed"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;


            this.GridView66.Columns["Col_txtnumber_in_year"].Visible = true;  //"Col_txtnumber_in_year";
            this.GridView66.Columns["Col_txtnumber_in_year"].Width = 80;
            ...
            this.GridView66.Columns["Col_txtnumber_color_id"].Width = 80;
            ...
            this.GridView66.Columns["Col_txtlot_no"].Width = 160;
            ...
            this.GridView66.Columns["Col_txtqty_want"].Visible = false;  //"Col_txtqty_want";
            this.GridView66.Columns["Col_txtqty_want"].Width = 0;
            this.GridView66.Columns["Col_txtqty_want"].ReadOnly = true;
            this.GridView66.Columns["Col_txtqty_want"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.GridView66.Columns["Col_txtqty_want"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;

            this.GridView66.Columns["Col_txtqty_balance"].Visible = false;  //"Col_txtqty_balance";
            this.GridView66.Columns["Col_txtqty_balance"].Width = 0;
            this.GridView66.Columns["Col_txtqty_balance"].ReadOnly = true;
            this.GridView66.Columns["Col_txtqty_balance"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.GridView66.Columns["Col_txtqty_balance"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;

            this.GridView66.Columns[10].Visible = false;
            DataGridViewCheckBoxColumn dgvCmb_SELECT = new DataGridViewCheckBoxColumn();
            dgvCmb_SELECT.Name = "Col_Chk_SELECT";
            ...
            this.GridView66.Columns["Col_txtqty_want_pub"].Visible = false;  //"Col_txtqty_want_pub";
            this.GridView66.Columns["Col_txtqty_want_pub"].Width = 0;
            this.GridView66.Columns["Col_txtqty_want_pub"].ReadOnly = true;
            this.GridView66.Columns["Col_txtqty_want_pub"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.GridView66.Columns["Col_txtqty_want_pub"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;

            this.GridView66.Columns["Col_txtqty_balance_pub"].Visible = false;  //"Col_txtqty_balance_pub";
            this.GridView66.Columns["Col_txtqty_balance_pub"].Width = 0;
            this.GridView66.Columns["Col_txtqty_balance_pub"].ReadOnly = true;
            this.GridView66.Columns["Col_txtqty_balance_pub"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.GridView66.Columns["Col_txtqty_balance_pub"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
            ...
            this.GridView66.Columns["Col_txtsum_qty_pub"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;


            this.GridView66.Columns["Col_txtqty_want_rib"].Visible = false;  //"Col_txtqty_want_rib";
            this.GridView66.Columns["Col_txtqty_want_rib"].Width = 0;
            this.GridView66.Columns["Col_txtqty_want_rib"].ReadOnly = true;
            this.GridView66.Columns["Col_txtqty_want_rib"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.GridView66.Columns["Col_txtqty_want_rib"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;

            this.GridView66.Columns["Col_txtqty_balance_rib"].Visible = false;  //"Col_txtqty_balance_rib";
            this.GridView66.Columns["Col_txtqty_balance_rib"].Width = 0;
            this.GridView66.Columns["Col_txtqty_balance_rib"].ReadOnly = true;
            this.GridView66.Columns["Col_txtqty_balance_rib"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.GridView66.Columns["Col_txtqty_balance_rib"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
            ...
            this.GridView66.Columns["Col_txtsum_qty_rib"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
            ...
            this.GridView66.Columns["Col_mat_status"].ReadOnly = false;
            this.GridView66.Columns["Col_mat_status"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.GridView66.Columns["Col_mat_status"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;

            //this.GridView66.Columns[40].HeaderText = "Col_txtqty_balance_yokpai";
            //this.GridView66.Columns[41].HeaderText = "Col_txtsum_qty_pub_yokpai";

            this.GridView66.Columns["Col_txtqty_balance_yokpai"].Visible = false;  //"Col_txtqty_balance_yokpai";
            this.GridView66.Columns["Col_txtqty_balance_yokpai"].Width = 0;
            this.GridView66.Columns["Col_txtqty_balance_yokpai"].ReadOnly = false;
            this.GridView66.Columns["Col_txtqty_balance_yokpai"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.GridView66.Columns["Col_txtqty_balance_yokpai"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;

            this.GridView66.Columns["Col_txtsum_qty_pub_yokpai"].Visible = false;  //"Col_txtsum_qty_pub_yokpai";
            this.GridView66.Columns["Col_txtsum_qty_pub_yokpai"].Width = 0;
            this.GridView66.Columns["Col_txtsum_qty_pub_yokpai"].ReadOnly = false;
            this.GridView66.Columns["Col_txtsum_qty_pub_yokpai"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.GridView66.Columns["Col_txtsum_qty_pub_yokpai"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;

            this.GridView66.Columns["Col_txtsum_qty_rib_yokpai"].Visible = false;  //"Col_txtsum_qty_rib_yokpai";
            this.GridView66.Columns["Col_txtsum_qty_rib_yokpai"].Width = 0;
            this.GridView66.Columns["Col_txtsum_qty_rib_yokpai"].ReadOnly = false;
            this.GridView66.Columns["Col_txtsum_qty_rib_yokpai"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.GridView66.Columns["Col_txtsum_qty_rib_yokpai"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            ...
            this.GridView66.Columns["Col_qty_Cal"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            ...
            this.GridView66.Columns["Col_txtsum_qty_pub_kg"].ReadOnly = false;
            this.GridView66.Columns["Col_txtsum_qty_pub_kg"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.GridView66.Columns["Col_txtsum_qty_pub_kg"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            ...
            this.GridView66.Columns["Col_txtsum_qty_rib_kg"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;

            this.GridView66.Columns["Col_txtqty_berg_cut_shirt_balance"].Visible = false;  //"Col_txtqty_berg_cut_shirt_balance";
            this.GridView66.Columns["Col_txtqty_berg_cut_shirt_balance"].Width = 0;
            this.GridView66.Columns["Col_txtqty_berg_cut_shirt_balance"].ReadOnly = false;
            this.GridView66.Columns["Col_txtqty_berg_cut_shirt_balance"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.GridView66.Columns["Col_txtqty_berg_cut_shirt_balance"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;

            this.GridView66.Columns["Col_txtqty_cut"].Visible = true;  //"Col_txtqty_cut";
            this.GridView66.Columns["Col_txtqty_cut"].Width = 140;
            ...
            this.GridView66.Columns["Col_txtqty_after_cut"].Width = 140;
            ...
            this.GridView66.Columns["Col_txtcut_id"].Width = 140;
            ...
            this.GridView66.Columns["Col_txtcut_id"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
        ...
        private void GridView66_DoubleClick(object sender, EventArgs e)
        {
            ...
            this.GridView1.Rows[index].Cells["Col_txtnumber_dyed"].Value = this.GridView66.Rows[selectedRowIndex].Cells["Col_txtnumber_dyed"].Value.ToString();        //5
            this.GridView1.Rows[index].Cells["Col_txtnumber_in_year"].Value = this.GridView66.Rows[selectedRowIndex].Cells["Col_txtnumber_in_year"].Value.ToString();        //5
        ...
        private void AUTO_BILL_TRANS_ID()
        {
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                cmd1.CommandText = "SELECT *" +
                                  " FROM c002_07Send_Cut_shirt_record_trans" +
                                  " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                  " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                  " AND (txtbranch_id = '" + W_ID_Select.M_BRANCHID.Trim() + "')" +
                ...
                try
                {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        {
                            TMP = "SPT" + W_ID_Select.M_BRANCHNAME_SHORT.Trim() + "-" + year_now2.Trim() + "" + month_now.Trim() + "" + day_now.Trim() + "-" + trans.Trim();
                        }
                        else
                        {
                            TMP = "SPT" + W_ID_Select.M_BRANCHNAME_SHORT.Trim() + "-" + year_now2.Trim() + "" + month_now.Trim() + "" + day_now.Trim() + "-" + "000001";
                        }
        ...
        private void UPDATE_PRINT_BY()
        {
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                try
                {
                    ...
                    cmd2.CommandText = "UPDATE c002_07Send_Cut_shirt_record SET " +
                                                                ...
                                                                " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                                               " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                                               " AND (txtSPT_id = '" + this.txtSPT_id.Text.Trim() + "')";
                    cmd2.ExecuteNonQuery();
