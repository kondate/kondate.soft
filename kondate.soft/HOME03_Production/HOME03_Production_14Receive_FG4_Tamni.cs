...
{
    public partial class HOME03_Production_14Receive_FG4_Tamni : Form
    {
        //Move Form ====================================
        ...
        public HOME03_Production_14Receive_FG4_Tamni()
        {
            InitializeComponent();
        }

        private void HOME03_Production_14Receive_FG4_Tamni_Load(object sender, EventArgs e)
        {
            ...
            W_ID_Select.M_FORM_NUMBER = "H0314FG4TNGR";
            CHECK_ADD_FORM();

            CHECK_USER_RULE();

            this.iblword_top.Text = W_ID_Select.WORD_TOP.Trim();
            this.iblword_status.Text = "ระเบียนใบรับเสื้อยืดสำเร็จรูป FG4 มีตำหนิ";
            ...
            //========================================
            this.cboSearch.Items.Add("เลขที่ใบรับเสื้อยืดสำเร็จรูป FG4 มีตำหนิ");
            this.cboSearch.Items.Add("ชื่อผู้บันทึกใบรับเสื้อยืดสำเร็จรูป FG4 มีตำหนิ");
        ...
        private void Fill_Show_DATA_GridView1()
        {
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                cmd2.CommandText = "SELECT c002_14Receive_FG4_Tamni_record.*," +
                                   ...
                                   " AND (c002_14Receive_FG4_Tamni_record.txtbranch_id = '" + W_ID_Select.M_BRANCHID.Trim() + "')" +
                                   " AND (c002_14Receive_FG4_Tamni_record.txttrans_date_client BETWEEN @datestart AND @dateend)" +
                                  " ORDER BY c002_14Receive_FG4_Tamni_record.txtFG4TN_id ASC";
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        ...
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            this.GridView1.Rows[index].Cells["Col_txtFG4TN_id"].Value = dt2.Rows[j]["txtFG4TN_id"].ToString();      //3
                            this.GridView1.Rows[index].Cells["Col_txtFG4_id"].Value = "";     //3
                            ...
                            //RG ==============================
                            if (dt2.Rows[j]["txtFG4TN_status"].ToString() == "")
                            {
                                this.GridView1.Rows[index].Cells["Col_txtFG4TN_status"].Value = ""; //21
                            }
                            else if (dt2.Rows[j]["txtFG4TN_status"].ToString() == "0")
                            {
                                this.GridView1.Rows[index].Cells["Col_txtFG4TN_status"].Value = ""; //21
                            }
                            else if (dt2.Rows[j]["txtFG4TN_status"].ToString() == "1")
                            {
                                this.GridView1.Rows[index].Cells["Col_txtFG4TN_status"].Value = "ยกเลิก"; //21
                            }
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                else
                {
                    cmd2.CommandText = "SELECT c002_14Receive_FG4_Tamni_record.*," +
                                   ...
                                   " WHERE (c002_14Receive_FG4_Tamni_record.cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                   " AND (c002_14Receive_FG4_Tamni_record.txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                    " AND (c002_14Receive_FG4_Tamni_record.txtbranch_id = '" + this.txtbranch_id.Text.Trim() + "')" +
                                  " AND (c002_14Receive_FG4_Tamni_record.txttrans_date_client BETWEEN @datestart AND @dateend)" +
                                  " ORDER BY c002_14Receive_FG4_Tamni_record.txtFG4TN_id ASC";
        ...
        private void Show_GridView1()
        {
            ...
            this.GridView1.Columns[3].Name = "Col_txtFG4TN_id";
            this.GridView1.Columns[4].Name = "Col_txtFG4_id";
            ...
            this.GridView1.Columns[11].Name = "Col_txtFG4TN_status";
            ...
            this.GridView1.Columns["Col_txtFG4TN_id"].Visible = true;  //"Col_txtFG4TN_id";
            this.GridView1.Columns["Col_txtFG4TN_id"].Width = 180;
            this.GridView1.Columns["Col_txtFG4TN_id"].ReadOnly = true;
            this.GridView1.Columns["Col_txtFG4TN_id"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.GridView1.Columns["Col_txtFG4TN_id"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
            ...
            this.GridView1.Columns["Col_txtsupplier_name"].Visible = false;  //"Col_txtsupplier_name";
            ...
            this.GridView1.Columns["Col_txtFG4TN_status"].Visible = true;  //"Col_txtFG4TN_status";
            this.GridView1.Columns["Col_txtFG4TN_status"].Width = 100;
            this.GridView1.Columns["Col_txtFG4TN_status"].ReadOnly = true;
            this.GridView1.Columns["Col_txtFG4TN_status"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.GridView1.Columns["Col_txtFG4TN_status"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
        ...
        private void GridView1_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                if (cell != null)
                {
                    ...
                    this.cboSearch.Text = "เลขที่ใบรับเสื้อยืดสำเร็จรูป FG4 มีตำหนิ";

                    if (this.cboSearch.Text == "เลขที่ใบรับเสื้อยืดสำเร็จรูป FG4 มีตำหนิ")
                    {
                        this.txtsearch.Text = row.Cells[3].Value.ToString();
                        W_ID_Select.TRANS_ID = row.Cells[3].Value.ToString();

                    }
                    else if (this.cboSearch.Text == "ชื่อผู้บันทึกใบรับเสื้อยืดสำเร็จรูป FG4 มีตำหนิ")
                    {
        ...
        private void GridView1_DoubleClick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                W_ID_Select.WORD_TOP = "ดูข้อมูลใบรับเสื้อยืดสำเร็จรูป FG4 มีตำหนิ";
                kondate.soft.HOME03_Production.HOME03_Production_14Receive_FG4_Tamni_record_detail frm2 = new kondate.soft.HOME03_Production.HOME03_Production_14Receive_FG4_Tamni_record_detail();
                frm2.Show();
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                cmd2.Connection = conn;
                    ...
                    cmd2.CommandText = "SELECT c002_14Receive_FG4_Tamni_record.*," +
                                   ...
                                   //" AND (c002_14Receive_FG4_Tamni_record.txtbranch_id = '" + W_ID_Select.M_BRANCHID.Trim() + "')" +
                                   " AND (c002_14Receive_FG4_Tamni_record.txttrans_date_client BETWEEN @datestart AND @dateend)" +
                                   " AND (c002_14Receive_FG4_Tamni_record.txtsupplier_id = '" + this.PANEL161_SUP_txtsupplier_id.Text.Trim() + "')" +
                                   " ORDER BY c002_14Receive_FG4_Tamni_record.txtFG4TN_id ASC";
        ...
        private void btnGo4_Click(object sender, EventArgs e)
        {
                ...
                if (this.cboSearch.Text.Trim()  == "เลขที่ใบรับเสื้อยืดสำเร็จรูป FG4 มีตำหนิ")
                {
                        cmd2.CommandText = "SELECT c002_14Receive_FG4_Tamni_record.*," +
                                       "k016db_1supplier.*" +
                                       ...
                                       " AND (c002_14Receive_FG4_Tamni_record.txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                       " AND (c002_14Receive_FG4_Tamni_record.txttrans_date_client BETWEEN @datestart AND @dateend)" +
                                       " AND (c002_14Receive_FG4_Tamni_record.txtFG4TN_id = '" + this.txtsearch.Text.Trim() + "')" +
                                      " ORDER BY c002_14Receive_FG4_Tamni_record.txtFG4TN_id ASC";
                }
                else if (this.cboSearch.Text.Trim() == "ชื่อผู้บันทึกใบรับเสื้อยืดสำเร็จรูป FG4 มีตำหนิ")
                {
                        cmd2.CommandText = "SELECT c002_14Receive_FG4_Tamni_record.*," +
                                        "k016db_1supplier.*" +
                                        ...
                                        " AND (c002_14Receive_FG4_Tamni_record.txtbranch_id = '" + this.txtbranch_id.Text.Trim() + "')" +
                                        " AND (c002_14Receive_FG4_Tamni_record.txttrans_date_client BETWEEN @datestart AND @dateend)" +
                                        " AND (c002_14Receive_FG4_Tamni_record.txtemp_office_name LIKE '%" + this.txtsearch.Text.Trim() + "%')" +
                                        " ORDER BY c002_14Receive_FG4_Tamni_record.txtFG4TN_id ASC";
                }
                    cmd2.Parameters.Add("@datestart", SqlDbType.Date).Value = this.dtpstart.Value;
                    cmd2.Parameters.Add("@dateend", SqlDbType.Date).Value = this.dtpend.Value;
