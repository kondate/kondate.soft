...
namespace kondate.soft.HOME03_Production
{
    public partial class HOME03_Production_02Berg_Produce_record_detail : Form
    {
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        ...
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            GridView1.Rows[index].Cells["Col_txtnumber_mat_id"].Value = dt2.Rows[j]["txtnumber_mat_id"].ToString();      //15
                            ...
                            GridView1.Rows[index].Cells["Col_txtLot_no"].Value = dt2.Rows[j]["txtLot_no"].ToString();      //18
                            ...
                            GridView1.Rows[index].Cells["Col_1"].Value = "0";      //37
        ...
        private void Show_GridView1()
        {
            ...
            this.GridView1.Columns[19].Name = "Col_txtqty_after_cut_";
            ...
            this.GridView1.Columns[39].Visible = true;
            ...
            this.GridView1.Columns[19].HeaderText = "เหลือ กก.";
            ...
            this.GridView1.Columns[38].HeaderText = "Col_txtqty_after_cut_yokpai";
            this.GridView1.Columns[39].HeaderText = "1";
            ...
            for (int i = 0; i < this.GridView1.Rows.Count; i++)
            {
                ...
                if (valu != "")
                {
                    ...
                    if (Convert.ToDouble(string.Format("{0:n4}", this.GridView1.Rows[i].Cells["Col_txtqty"].Value.ToString())) > 0)
                    {
                        ...
                        {
                            this.GridView1.Rows[i].Cells["Col_1"].Value = "1";
                        }
                        else
                        {
                            this.GridView1.Rows[i].Cells["Col_1"].Value = "0";
                        }
            ...
            for (int i = 0; i < this.GridView1.Rows.Count; i++)
            {
                ...
                if (valu != "")
                {
                    ...
                    if (Convert.ToDouble(string.Format("{0:n4}", this.GridView1.Rows[i].Cells["Col_txtqty"].Value.ToString())) > 0)
                    {
                        ...
                        //แล้ว เท่าไร = 0 ยกเลิกต้อง ลบ=================================================
                        Sum_Qty_CUT_Yokpai = Convert.ToDouble(string.Format("{0:n4}", this.GridView1.Rows[i].Cells["Col_txtqty_cut_yokma"].Value.ToString())) - Convert.ToDouble(string.Format("{0:n4}", this.GridView1.Rows[i].Cells["Col_txtqty"].Value.ToString()));
                        this.GridView1.Rows[i].Cells["Col_txtqty_cut_yokpai"].Value = Sum_Qty_CUT_Yokpai.ToString("N", new CultureInfo("en-US"));

                        //เหลืออีก เท่าไร ยกเลืก ต้องบวก =================================================
                        Sum_Qty_AF_CUT_Yokpai = Convert.ToDouble(string.Format("{0:n4}", this.GridView1.Rows[i].Cells["Col_txtqty_after_cut"].Value.ToString())) + Convert.ToDouble(string.Format("{0:n4}", this.GridView1.Rows[i].Cells["Col_txtqty"].Value.ToString()));
                        this.GridView1.Rows[i].Cells["Col_txtqty_after_cut_yokpai"].Value = Sum_Qty_AF_CUT_Yokpai.ToString("N", new CultureInfo("en-US"));
            ...
            for (int i = 0; i < this.GridView1.Rows.Count; i++)
            {
                ...
                if (conn.State == System.Data.ConnectionState.Open)
                {
                    ...
                    cmd2.CommandText = "SELECT c002_02produce_record.*," +
                                       ...
                                       " AND (c002_02produce_record_detail.txtLot_no = '" + this.GridView1.Rows[i].Cells["Col_txtlot_no"].Value.ToString() + "')" +
                                       " AND (c002_02produce_record_detail.txtmat_id = '" + this.GridView1.Rows[i].Cells["Col_txtmat_id"].Value.ToString() + "')" +
                                       " ORDER BY c002_02produce_record_detail.txtmat_no ASC";
                    ...
                    try
                    {
                        ...
                        if (dt2.Rows.Count > 0)
                        {
                            ...
                            for (int j = 0; j < dt2.Rows.Count; j++)
                            {
                                ...
                                MessageBox.Show("Lot no :   " + dt2.Rows[j]["txtLot_no"].ToString() + "    นี้ มีการบันทึกผ้าดิบ ไปแล้ว ไม่สามารถยกเลิกรายการได้ !!! ");
                                return;
                            }
                            //=======================================================
                            //=======================================================
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                try
                {
                    ...
                    cmd2.CommandText = "INSERT INTO k021_mat_average_balance(cdkey,txtco_id,txtbranch_id," +  //1
                            ...
                            "'IC'," +  //9 txtbill_type
                            "'ยกเลิกเบิกด้าย " + this.PANEL0103_BERG_TYPE_txtberg_type_name.Text.Trim() + "'," +  //9 txtbill_remark
