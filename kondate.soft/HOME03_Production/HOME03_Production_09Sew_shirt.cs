...
{
    public partial class HOME03_Production_09Sew_shirt : Form
    {
        //Move Form ====================================
        ...
        public HOME03_Production_09Sew_shirt()
        {
            InitializeComponent();
        }

        private void HOME03_Production_09Sew_shirt_Load(object sender, EventArgs e)
        {
            ...
            W_ID_Select.M_FORM_NUMBER = "H0309SEWGR";
            CHECK_ADD_FORM();

            CHECK_USER_RULE();

            this.iblword_top.Text = W_ID_Select.WORD_TOP.Trim();
            this.iblword_status.Text = "ระเบียนใบสั่งเย็บ";
            ...
            //========================================
            this.cboSearch.Items.Add("เลขที่ใบสั่งเย็บ");
            this.cboSearch.Items.Add("ชื่อผู้บันทึกใบสั่งเย็บ");
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        ...
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            this.GridView1.Rows[index].Cells["Col_txtSEW_id"].Value = dt2.Rows[j]["txtSEW_id"].ToString();      //3
                            ...
                            this.GridView1.Rows[index].Cells["Col_txtsew_remark"].Value = dt2.Rows[j]["txtsew_remark"].ToString();      //6

                            this.GridView1.Rows[index].Cells["Col_txtsum_qty_amount"].Value = Convert.ToSingle(dt2.Rows[j]["txtsum_qty_amount"]).ToString("###,###.00");      //7
                            this.GridView1.Rows[index].Cells["Col_txtsum_qty_amount_all"].Value = Convert.ToSingle(dt2.Rows[j]["txtsum_qty_amount_all"]).ToString("###,###.00");      //8
                            this.GridView1.Rows[index].Cells["Col_txtsum_qty_amount_Difference"].Value = Convert.ToSingle(dt2.Rows[j]["txtsum_qty_amount_Difference"]).ToString("###,###.00");      //9

                            //SEW ==============================
                            if (dt2.Rows[j]["txtsew_status"].ToString() == "")
                            {
                                this.GridView1.Rows[index].Cells["Col_txtsew_status"].Value = ""; //10
                            }
                            ...
                            {
                                this.GridView1.Rows[index].Cells["Col_txtsew_status"].Value = "ยกเลิก"; //10
                            }
                            this.GridView1.Rows[index].Cells["Col_txtrol_id"].Value = ""; //11
                            this.GridView1.Rows[index].Cells["Col_txtqcs_id"].Value = ""; //12
                            this.GridView1.Rows[index].Cells["Col_txtfg_id"].Value = ""; //13
        ...
        private void Show_GridView1()
        {
            ...
            this.GridView1.Columns[3].Name = "Col_txtSEW_id";
            this.GridView1.Columns[4].Name = "Col_txttrans_date_server";
            this.GridView1.Columns[5].Name = "Col_txttrans_time";
            this.GridView1.Columns[6].Name = "Col_txtsew_remark";     
            this.GridView1.Columns[7].Name = "Col_txtsum_qty_amount";    
            this.GridView1.Columns[8].Name = "Col_txtsum_qty_amount_all";

            this.GridView1.Columns[9].Name = "Col_txtsum_qty_amount_Difference";  
            this.GridView1.Columns[10].Name = "Col_txtsew_status";

            this.GridView1.Columns[11].Name = "Col_txtrol_id";  //
            this.GridView1.Columns[12].Name = "Col_txtqcs_id";
            this.GridView1.Columns[13].Name = "Col_txtfg_id";   //
            ...
            this.GridView1.Columns[3].HeaderText = " เลขที่ใบสั่งเย็บ";
            ...
            this.GridView1.Columns[7].HeaderText = "จำนวนสั่งตัด";
            this.GridView1.Columns[8].HeaderText = "จำนวนสั่งเย็บ"; 
            this.GridView1.Columns[9].HeaderText = "จำนวนผลตาง";

            this.GridView1.Columns[10].HeaderText = " สถานะ";
            this.GridView1.Columns[11].HeaderText = " เลขที่ รีด";
            this.GridView1.Columns[12].HeaderText = " เลขที่ QC";
            this.GridView1.Columns[13].HeaderText = " เลขที่ FG";
            ...
            this.GridView1.Columns["Col_txtSEW_id"].Width = 140;
            ...
            this.GridView1.Columns["Col_txtsew_remark"].Visible = true;  //"Col_txtsew_remark";
            this.GridView1.Columns["Col_txtsew_remark"].Width = 300;
            this.GridView1.Columns["Col_txtsew_remark"].ReadOnly = true;
            this.GridView1.Columns["Col_txtsew_remark"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.GridView1.Columns["Col_txtsew_remark"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;


            this.GridView1.Columns["Col_txtsum_qty_amount"].Visible = true;  //"Col_txtsum_qty_amount";
            this.GridView1.Columns["Col_txtsum_qty_amount"].Width = 120;
            this.GridView1.Columns["Col_txtsum_qty_amount"].ReadOnly = true;
            this.GridView1.Columns["Col_txtsum_qty_amount"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.GridView1.Columns["Col_txtsum_qty_amount"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;

            this.GridView1.Columns["Col_txtsum_qty_amount_all"].Visible = true;  //"Col_txtsum_qty_amount_all";
            this.GridView1.Columns["Col_txtsum_qty_amount_all"].Width = 120;
            ...
            this.GridView1.Columns["Col_txtsum_qty_amount_Difference"].Visible = true;  //"Col_txtsum_qty_amount_Difference";
            this.GridView1.Columns["Col_txtsum_qty_amount_Difference"].Width = 120;
            this.GridView1.Columns["Col_txtsum_qty_amount_Difference"].ReadOnly = true;
            this.GridView1.Columns["Col_txtsum_qty_amount_Difference"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.GridView1.Columns["Col_txtsum_qty_amount_Difference"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;

            this.GridView1.Columns["Col_txtsew_status"].Visible = true;  //"Col_txtsew_status";
            this.GridView1.Columns["Col_txtsew_status"].Width = 70;
            this.GridView1.Columns["Col_txtsew_status"].ReadOnly = true;
            this.GridView1.Columns["Col_txtsew_status"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.GridView1.Columns["Col_txtsew_status"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;

            this.GridView1.Columns["Col_txtrol_id"].Visible = true;  //"Col_txtrol_id";
            this.GridView1.Columns["Col_txtrol_id"].Width = 140;
        ...
        private void GridView1_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                if (cell != null)
                {
                    ...
                    this.cboSearch.Text = "เลขที่ใบสั่งเย็บ";

                    if (this.cboSearch.Text == "เลขที่ใบสั่งเย็บ")
                    {
                        this.txtsearch.Text = row.Cells[3].Value.ToString();
                        W_ID_Select.TRANS_ID = row.Cells[3].Value.ToString();

                    }
                    else if (this.cboSearch.Text == "ชื่อผู้บันทึกใบสั่งเย็บ")
                    {
        ...
        private void GridView1_DoubleClick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                W_ID_Select.WORD_TOP = "ดูข้อมูลใบสั่งเย็บ";
                kondate.soft.HOME03_Production.HOME03_Production_09Sew_shirt_record_detail frm2 = new kondate.soft.HOME03_Production.HOME03_Production_09Sew_shirt_record_detail();
                frm2.Show();
        ...
        private void btnGo4_Click(object sender, EventArgs e)
        {
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                if (this.cboSearch.Text.Trim() == "เลขที่ใบสั่งเย็บ")
                {
                    cmd2.CommandText = "SELECT *" +
                                       " FROM c002_09Sew_shirt_record" +
                                      ...
                                      //" AND (txtbranch_id = '" + W_ID_Select.M_BRANCHID.Trim() + "')" +
                                      //" AND (txttrans_date_server BETWEEN @datestart AND @dateend)" +
                                      " AND (txtSEW_id = '" + this.txtsearch.Text.Trim() + "')" +
                                      " ORDER BY txtSEW_id ASC";

                }
                else if (this.cboSearch.Text.Trim() == "ชื่อผู้บันทึกใบสั่งเย็บ")
                {
                    cmd2.CommandText = "SELECT *" +
                                       " FROM c002_09Sew_shirt_record" +
        ...
        private void BtnNew_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                W_ID_Select.WORD_TOP = "บันทึกใบสั่งเย็บ";
