...
{
    public partial class HOME03_Production_21room_collect : Form
    {
        //Move Form ====================================
        ...
        public HOME03_Production_21room_collect()
        {
            InitializeComponent();
        }

        private void HOME03_Production_21room_collect_Load(object sender, EventArgs e)
        {
            W_ID_Select.M_FORM_NUMBER = "H0321RC";
            CHECK_ADD_FORM();
            ...
            this.iblword_status.Text = "เพิ่มรหัสห้องเก็บใหม่";
            this.txtroom_collect_id.ReadOnly = false;

            this.ActiveControl = this.txtroom_collect_id;
        ...
        private void Run_ID()
        {
            if (this.txtroom_collect_no.Text == "")
            {
                this.txtroom_collect_no.Text = "001";
            }
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                cmd2.CommandText = "SELECT *" +
                                    ...
                                    " ORDER BY txtroom_collect_no DESC";
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            //this.PANEL_FORM1_dataGridView1.Columns[5].Name = "Col_txtroom_collect_remark";
                            ...
                            GridView1.Rows[index].Cells["Col_txtroom_collect_no"].Value = dt2.Rows[j]["txtroom_collect_no"].ToString();      //1
                            GridView1.Rows[index].Cells["Col_txtroom_collect_id"].Value = dt2.Rows[j]["txtroom_collect_id"].ToString();      //2
                            GridView1.Rows[index].Cells["Col_txtroom_collect_name"].Value = dt2.Rows[j]["txtroom_collect_name"].ToString();      //3
                            GridView1.Rows[index].Cells["Col_txtroom_collect_name_eng"].Value = dt2.Rows[j]["txtroom_collect_name_eng"].ToString();      //4
                            GridView1.Rows[index].Cells["Col_txtroom_collect_remark"].Value = dt2.Rows[j]["txtroom_collect_remark"].ToString();      //5
                            GridView1.Rows[index].Cells["Col_txtroom_collect_status"].Value = dt2.Rows[j]["txtroom_collect_status"].ToString();      //6
        ...
        private void PANEL_FORM1_GridView1()
        {
            ...
            this.GridView1.Columns[1].Name = "Col_txtroom_collect_no";
            this.GridView1.Columns[2].Name = "Col_txtroom_collect_id";
            this.GridView1.Columns[3].Name = "Col_txtroom_collect_name";
            this.GridView1.Columns[4].Name = "Col_txtroom_collect_name_eng";
            this.GridView1.Columns[5].Name = "Col_txtroom_collect_remark";
            this.GridView1.Columns[6].Name = "Col_txtroom_collect_status";

            this.GridView1.Columns[0].HeaderText = "No";
            this.GridView1.Columns[1].HeaderText = "ลำดับ";
            this.GridView1.Columns[2].HeaderText = " รหัส";
            this.GridView1.Columns[3].HeaderText = " ชื่อรหัสห้องเก็บ";
            this.GridView1.Columns[4].HeaderText = "ชื่อรหัสห้องเก็บ Eng";
            ...
            this.GridView1.Columns[1].Visible = true;  //"Col_txtroom_collect_no";
            ...
            this.GridView1.Columns[2].Visible = true;  //"Col_txtroom_collect_id";
            ...
            this.GridView1.Columns[3].Visible = true;  //"Col_txtroom_collect_name";
            ...
            this.GridView1.Columns[4].Visible = true;  //"Col_txtroom_collect_name_eng";
            ...
            this.GridView1.Columns[5].Visible = true;  //"Col_txtroom_collect_name_remark";
            ...
            this.GridView1.Columns[6].Visible = false;  //"Col_txtroom_collect_status";
        ...
        private void PANEL_FORM1_dataGridView1_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                if (cell != null)
                {
                    ...
                    this.txtroom_collect_no.Text = row.Cells[1].Value.ToString();
                    this.txtroom_collect_id.Text = row.Cells[2].Value.ToString();
                    this.txtroom_collect_name.Text = row.Cells[3].Value.ToString();
                    ...
                    if (conn.State == System.Data.ConnectionState.Open)
                    {
                        ...
                        cmd2.CommandText = "SELECT *" +
                                            " FROM c001_10room_collect" +
                                             " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                             " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                             " AND (txtroom_collect_id = '" + this.txtroom_collect_id.Text.Trim() + "')" +
                                           " ORDER BY txtroom_collect_no ASC";
                        ...
                        try
                        {
                            ...
                            if (dt2.Rows.Count > 0)
                            {
                                for (int j = 0; j < dt2.Rows.Count; j++)
                                {
                                    this.txtroom_collect_no.Text = dt2.Rows[j]["txtroom_collect_no"].ToString();      //1
                                    this.txtroom_collect_id.Text = dt2.Rows[j]["txtroom_collect_id"].ToString();      //2
                                    this.txtroom_collect_name.Text = dt2.Rows[j]["txtroom_collect_name"].ToString();      //3
                                    this.txtroom_collect_name_eng.Text = dt2.Rows[j]["txtroom_collect_name_eng"].ToString();      //4
                                    this.txtroom_collect_remark.Text = dt2.Rows[j]["txtroom_collect_remark"].ToString();      //6
                                }
                                this.iblword_status.Text = "แก้ไขรหัสห้องเก็บ";
                                this.txtroom_collect_id.ReadOnly = true;
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                cmd2.CommandText = "SELECT *" +
                                    " FROM c001_10room_collect" +
                                     " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                     " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                     " AND (txtroom_collect_name LIKE '%" + this.PANEL_FORM1_txtsearch.Text.Trim() + "%')" +
                                   " ORDER BY txtroom_collect_no ASC";
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            GridView1.Rows[index].Cells["Col_txtroom_collect_name"].Value = dt2.Rows[j]["txtroom_collect_name"].ToString();      //3
                            GridView1.Rows[index].Cells["Col_txtroom_collect_name_eng"].Value = dt2.Rows[j]["txtroom_collect_name_eng"].ToString();      //4
                            GridView1.Rows[index].Cells["Col_txtroom_collect_remark"].Value = dt2.Rows[j]["txtroom_collect_remark"].ToString();      //6
                            GridView1.Rows[index].Cells["Col_txtroom_collect_status"].Value = dt2.Rows[j]["txtroom_collect_status"].ToString();      //7
        ...
        private void BtnNew_Click(object sender, EventArgs e)
        {
            ...
            this.Hide();
            var frm2 = new HOME03_Production_21room_collect();
        ...
        private void btnopen_Click(object sender, EventArgs e)
        {
            ...
            if (this.txtroom_collect_id.Text != "")
            {
                this.iblword_status.Text = "แก้ไขรหัสห้องเก็บ";
                this.txtroom_collect_id.ReadOnly = true;
            }
        ...
        private void BtnSave_Click(object sender, EventArgs e)
        {
            if (this.txtroom_collect_no.Text == "")
            {
                ...
                this.txtroom_collect_no.Focus();
                return;
            }
            else
            {
                if (this.txtroom_collect_no.TextLength == 3)
                {
                }
                else
                {
            ...
            if (this.txtroom_collect_id.Text == "")
            {
                MessageBox.Show("โปรดใส่รหัสห้องเก็บ ก่อน !", "ผลการทำงาน", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                this.txtroom_collect_id.Focus();
                return;
            }
            if (this.txtroom_collect_name.Text == "")
            {
                MessageBox.Show("โปรดใส่ชื่อรหัสห้องเก็บก่อน !", "ผลการทำงาน", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                this.txtroom_collect_name.Focus();
                return;
            }
            ...
            //END เชื่อมต่อฐานข้อมูล=======================================================
            Cursor.Current = Cursors.WaitCursor;
            if (this.iblword_status.Text.Trim() == "เพิ่มรหัสห้องเก็บใหม่")
            {
                conn.Open();
                if (conn.State == System.Data.ConnectionState.Open)
                {
                    ...
                    cmd1.CommandText = "SELECT * FROM c001_10room_collect" +
                                        " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                       " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                       " AND (txtroom_collect_id = '" + this.txtroom_collect_id.Text.Trim() + "')";
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        MessageBox.Show("รหัสรหัสห้องเก็บ นี้ซ้ำ   : '" + this.txtroom_collect_id.Text.Trim() + "' โปรดใส่ใหม่ ", "ผลการทำงาน", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                        this.txtroom_collect_id.Focus();
                        conn.Close();
                        return;
                    }
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                try
                {
                    if (this.iblword_status.Text.Trim() == "เพิ่มรหัสห้องเก็บใหม่")
                    {
                        cmd2.CommandText = "INSERT INTO c001_10room_collect(cdkey,txtco_id," +  //1
                                           "txtroom_collect_no,txtroom_collect_id," +  //2
                                           "txtroom_collect_name,txtroom_collect_name_eng," +  //3
                                          "txtroom_collect_remark," +  //5
                                          "txtroom_collect_status) " +  //6
                        ...
                        cmd2.Parameters.Add("@txtroom_collect_no", SqlDbType.NVarChar).Value = this.txtroom_collect_no.Text.ToString();
                        cmd2.Parameters.Add("@txtroom_collect_id", SqlDbType.NVarChar).Value = this.txtroom_collect_id.Text.ToString();
                        cmd2.Parameters.Add("@txtroom_collect_name", SqlDbType.NVarChar).Value = this.txtroom_collect_name.Text.ToString();
                        cmd2.Parameters.Add("@txtroom_collect_name_eng", SqlDbType.NVarChar).Value = this.txtroom_collect_name_eng.Text.ToString();
                        cmd2.Parameters.Add("@txtroom_collect_remark", SqlDbType.NVarChar).Value = this.txtroom_collect_remark.Text.ToString();
                        cmd2.Parameters.Add("@txtroom_collect_status", SqlDbType.NChar).Value = "0";
                        //==============================

                        cmd2.ExecuteNonQuery();

                    }
                    if (this.iblword_status.Text.Trim() == "แก้ไขรหัสห้องเก็บ")
                    {
                        cmd2.CommandText = "UPDATE c001_10room_collect SET " +
                                                                     "txtroom_collect_no = '" + this.txtroom_collect_no.Text.Trim() + "'," +
                                                                     "txtroom_collect_name = '" + this.txtroom_collect_name.Text.Trim() + "'," +
                                                                     "txtroom_collect_name_eng = '" + this.txtroom_collect_name_eng.Text.Trim() + "'," +
                                                                     "txtroom_collect_remark = '" + this.txtroom_collect_remark.Text.ToString() + "'" +
                                                                    " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                                                   " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                                                   " AND (txtroom_collect_id = '" + this.txtroom_collect_id.Text.Trim() + "')";
                        cmd2.ExecuteNonQuery();
                    ...
                    if (dialogResult == DialogResult.Yes)
                    {
                        ...
                        this.txtroom_collect_id.Text = "";
                        this.txtroom_collect_name.Text = "";
                        this.txtroom_collect_name_eng.Text = "";
                        this.txtroom_collect_remark.Text = "";
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                try
                {
                    if (this.iblword_status.Text.Trim() == "ยกเลิกเอกสาร")
                    {
                        ...
                        cmd2.CommandText = "INSERT INTO c001_10room_collect_cancel(cdkey,txtco_id,txtbranch_id," +  //1
                                                                                                                  //"txttrans_date," +
                        ...
                        cmd2.CommandText = "INSERT INTO c001_10room_collect_cancel_detail(cdkey,txtco_id," +  //1
                                             "txtroom_collect_no,txtroom_collect_id," +  //2
                                             "txtroom_collect_name,txtroom_collect_name_eng," +  //3
                                             "txtroom_collect_remark," +  //4
                                            "txtroom_collect_status,cancel_id) " +  //5
                                             "VALUES (@cdkey2,@txtco_id2," +  //1
                                             "@txtroom_collect_no,@txtroom_collect_id," +  //2
                                             "@txtroom_collect_name,@txtroom_collect_name_eng," +  //3
                                             "@txtroom_collect_remark," +  //4
                                            "@txtroom_collect_status,@cancel_id2)";   //5
                        ...
                        cmd2.CommandText = "DELETE FROM c001_10room_collect" +
                                                                    " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                                                    " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                                                   " AND (txtroom_collect_id = '" + this.txtroom_collect_id.Text.Trim() + "')";
                        cmd2.ExecuteNonQuery();
                    ...
                    DialogResult dialogResult = MessageBox.Show("คุณต้องการ ยกเลิกเอกสาร รหัส  " + this.txtroom_collect_id.Text.ToString() + " ใช่หรือไม่่ ?", "โปรดยืนยัน", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question);
                    if (dialogResult == DialogResult.Yes)
                    {
        ...
        private void txtroom_collect_id_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            if (e.KeyChar == (char)Keys.Enter && this.txtroom_collect_id.Text == "")
            {
                this.txtroom_collect_id.Focus();
            }
            //========================================
            else if (e.KeyChar == (char)Keys.Enter && this.txtroom_collect_id.Text.Trim() != "")
            {
                this.txtroom_collect_no.Focus();
        ...
        private void txtroom_collect_no_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == (char)Keys.Enter && this.txtroom_collect_no.Text == "")
            {
                this.txtroom_collect_no.Focus();
            }
            //========================================
            else if (e.KeyChar == (char)Keys.Enter && this.txtroom_collect_no.Text.Trim() != "")
            {
                if (this.txtroom_collect_no.TextLength == 3)
                {
                    this.txtroom_collect_name.Focus();
            ...
            else if ((e.KeyChar > '9') && (e.KeyChar != '\b') && (e.KeyChar != '.') && txtroom_collect_no.Text.Length == 0)
            {
                //e.KeyChar <= '0' || 
                e.Handled = true;
                return;
        ...
        private void txtroom_collect_name_KeyDown(object sender, KeyEventArgs e)
        {

        }
        private void txtroom_collect_name_eng_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
                this.txtroom_collect_remark.Focus();

        }
        private void txtroom_collect_name_remark_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
                this.BtnSave.Focus();
        ...
        private void txtroom_collect_remark_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
                this.BtnSave.Focus();
            ...
            if (OK.Trim() != "Y")
            {
                ...
                if (conn.State == System.Data.ConnectionState.Open)
                {
                    ...
                    try
                    {
                        ...
                        cmd2.Parameters.Add("@cdkey", SqlDbType.NVarChar).Value = W_ID_Select.CDKEY.Trim();
                        cmd2.Parameters.Add("@txtco_id", SqlDbType.NVarChar).Value = W_ID_Select.M_COID.Trim();
                        cmd2.Parameters.Add("@txtroom_collect_no", SqlDbType.NVarChar).Value = "999";
                        cmd2.Parameters.Add("@txtroom_collect_id", SqlDbType.NVarChar).Value = "";
                        cmd2.Parameters.Add("@txtroom_collect_name", SqlDbType.NVarChar).Value = "";
                        cmd2.Parameters.Add("@txtroom_collect_name_eng", SqlDbType.NVarChar).Value = "";
                        cmd2.Parameters.Add("@txtroom_collect_remark", SqlDbType.NVarChar).Value = "";
                        cmd2.Parameters.Add("@txtroom_collect_status", SqlDbType.NChar).Value = "0";
                        //==============================
