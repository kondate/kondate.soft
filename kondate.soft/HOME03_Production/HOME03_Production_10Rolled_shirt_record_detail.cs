...
{
    public partial class HOME03_Production_10Rolled_shirt_record_detail : Form
    {
        //Move Form ====================================
        ...
        public HOME03_Production_10Rolled_shirt_record_detail()
        {
            InitializeComponent();
        }

        private void HOME03_Production_10Rolled_shirt_record_detail_Load(object sender, EventArgs e)
        {
            this.WindowState = FormWindowState.Maximized;
            this.btnmaximize.Visible = false;
            this.btnmaximize_full.Visible = true;

            W_ID_Select.M_FORM_NUMBER = "H0310ROLDL";
            CHECK_ADD_FORM();
            ...
            this.iblword_status.Text = "ดูข้อมูลใบจัดเก็บจำนวนรีด";

            this.ActiveControl = this.txtrol_remark;
        ...
        private void Fill_DATA_TO_GridView1()
        {
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                cmd2.CommandText = "SELECT c002_10Rolled_shirt_record.*," +
                                   ...
                                   " ON c002_10Rolled_shirt_record.cdkey = c002_09Sew_shirt_record.cdkey" +
                                   " AND c002_10Rolled_shirt_record.txtco_id = c002_09Sew_shirt_record.txtco_id" +
                                   " AND c002_10Rolled_shirt_record.txtROL_id = c002_09Sew_shirt_record.txtROL_id" +
                                   ...
                                   " WHERE (c002_10Rolled_shirt_record.cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                   " AND (c002_10Rolled_shirt_record.txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                   " AND (c002_10Rolled_shirt_record.txtROL_id = '" + W_ID_Select.TRANS_ID.Trim() + "')" +
                                   " ORDER BY c002_10Rolled_shirt_record.txtROL_id ASC";
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        ...
                        this.txtROL_id.Text = dt2.Rows[0]["txtROL_id"].ToString();
                        ...
                        this.txtrol_remark.Text = dt2.Rows[0]["txtrol_remark"].ToString();
        ...
        private void BtnCancel_Doc_Click(object sender, EventArgs e)
        {
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                cmd1.CommandText = "SELECT * FROM c002_10Rolled_shirt_record" +
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    MessageBox.Show("เอกสารนี้   : '" + this.txtROL_id.Text.Trim() + "' ยกเลิกไปแล้ว ", "ผลการทำงาน", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                    conn.Close();
                    return;
                }
            }
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                try
                {
                    ...
                    if (this.iblword_status.Text.Trim() == "ยกเลิกเอกสาร")
                    {
                        ...
                        cmd2.CommandText = "INSERT INTO c002_10Rolled_shirt_record_cancel(cdkey,txtco_id,txtbranch_id," +  //1
                                                                                                                        //"txttrans_date," +
                        ...
                        //2
                        cmd2.CommandText = "UPDATE c002_10Rolled_shirt_record" +
                                                                    " SET txtrol_status = '1'" +
                                                                     " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                                                     " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
