...
{
    public partial class HOME03_Production_09Send_Sew : Form
    {
        //Move Form ====================================
        ...
        public HOME03_Production_09Send_Sew()
        {
            InitializeComponent();
        }
        ...
        private void HOME03_Production_05Send_Dye_Load(object sender, EventArgs e)
        {
            ...
            W_ID_Select.M_FORM_NUMBER = "H0309SWGR";
            CHECK_ADD_FORM();

            CHECK_USER_RULE();

            this.iblword_top.Text = W_ID_Select.WORD_TOP.Trim();
            this.iblword_status.Text = "ระเบียนใบส่งผ้าเย็บ";
            ...
            //========================================
            this.cboSearch.Items.Add("เลขที่ใบส่งผ้าเย็บ");
            this.cboSearch.Items.Add("ชื่อผู้บันทึกใบส่งผ้าเย็บ");
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        ...
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            //PPT==============================
                            if (dt2.Rows[j]["txtSWT_status"].ToString() == "")
                            {
                                this.GridView1.Rows[index].Cells["Col_txtSWT_status"].Value = ""; //19
                            }
                            else if (dt2.Rows[j]["txtSWT_status"].ToString() == "0")
                            {
                                this.GridView1.Rows[index].Cells["Col_txtSWT_status"].Value = ""; //19
                            }
                            else if (dt2.Rows[j]["txtSWT_status"].ToString() == "1")
                            {
                                this.GridView1.Rows[index].Cells["Col_txtSWT_status"].Value = "ยกเลิก"; //19
                            }
        ...
        private void Show_GridView1()
        {
            ...
            this.GridView1.Columns["Col_txtSWT_status"].Visible = true;  //"Col_txtSWT_status";
            this.GridView1.Columns["Col_txtSWT_status"].Width = 100;
            this.GridView1.Columns["Col_txtSWT_status"].ReadOnly = true;
            this.GridView1.Columns["Col_txtSWT_status"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.GridView1.Columns["Col_txtSWT_status"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
        ...
        private void GridView1_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                if (cell != null)
                {
                    ...
                    this.cboSearch.Text = "เลขที่ใบส่งผ้าเย็บ";

                    if (this.cboSearch.Text == "เลขที่ใบส่งผ้าเย็บ")
                    {
                        this.txtsearch.Text = row.Cells[3].Value.ToString();
                        W_ID_Select.TRANS_ID = row.Cells[3].Value.ToString();

                    }
                    else if (this.cboSearch.Text == "ชื่อผู้บันทึกใบส่งผ้าเย็บ")
                    {
        ...
        private void GridView1_DoubleClick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                W_ID_Select.WORD_TOP = "ดูข้อมูลใบส่งผ้าเย็บ";
                kondate.soft.HOME03_Production.HOME03_Production_09Send_Sew_record_detail frm2 = new kondate.soft.HOME03_Production.HOME03_Production_09Send_Sew_record_detail();
                frm2.Show();
        ...
        private void BtnNew_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                W_ID_Select.WORD_TOP = "บันทึกใบส่งผ้าเย็บ";
        ...
        private void btnGo4_Click(object sender, EventArgs e)
        {
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                if (this.cboSearch.Text == "ชื่อผู้บันทึกใบส่งผ้าเย็บ")
                {
                    cmd2.CommandText = "SELECT c002_09Send_Sew_shirt_record.*," +
                                       "k016db_1supplier.*" +
