...
{
    public partial class HOME03_Production_20shirt_size : Form
    {
        //Move Form ====================================
        ...
        public HOME03_Production_20shirt_size()
        {
            InitializeComponent();
        }

        private void HOME03_Production_20shirt_size_Load(object sender, EventArgs e)
        {
            W_ID_Select.M_FORM_NUMBER = "H0320SS";
            CHECK_ADD_FORM();
            ...
            this.iblword_status.Text = "เพิ่มรหัสไซส์เสื้อใหม่";
            this.txtshirt_size_id.ReadOnly = false;

            this.ActiveControl = this.txtshirt_size_id;
        ...
        private void Run_ID()
        {
            if (this.txtshirt_size_no.Text == "")
            {
                this.txtshirt_size_no.Text = "001";
            }
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                cmd2.CommandText = "SELECT *" +
                                    ...
                                    " ORDER BY txtshirt_size_no DESC";
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            //this.PANEL_FORM1_dataGridView1.Columns[5].Name = "Col_txtshirt_size_remark";
                            ...
                            GridView1.Rows[index].Cells["Col_txtshirt_size_no"].Value = dt2.Rows[j]["txtshirt_size_no"].ToString();      //1
                            GridView1.Rows[index].Cells["Col_txtshirt_size_id"].Value = dt2.Rows[j]["txtshirt_size_id"].ToString();      //2
                            GridView1.Rows[index].Cells["Col_txtshirt_size_name"].Value = dt2.Rows[j]["txtshirt_size_name"].ToString();      //3
                            GridView1.Rows[index].Cells["Col_txtshirt_size_name_eng"].Value = dt2.Rows[j]["txtshirt_size_name_eng"].ToString();      //4
                            GridView1.Rows[index].Cells["Col_txtshirt_size_remark"].Value = dt2.Rows[j]["txtshirt_size_remark"].ToString();      //5
                            GridView1.Rows[index].Cells["Col_txtshirt_size_status"].Value = dt2.Rows[j]["txtshirt_size_status"].ToString();      //6
        ...
        private void PANEL_FORM1_GridView1()
        {
            ...
            this.GridView1.Columns[1].Name = "Col_txtshirt_size_no";
            this.GridView1.Columns[2].Name = "Col_txtshirt_size_id";
            this.GridView1.Columns[3].Name = "Col_txtshirt_size_name";
            this.GridView1.Columns[4].Name = "Col_txtshirt_size_name_eng";
            this.GridView1.Columns[5].Name = "Col_txtshirt_size_remark";
            this.GridView1.Columns[6].Name = "Col_txtshirt_size_status";

            this.GridView1.Columns[0].HeaderText = "No";
            this.GridView1.Columns[1].HeaderText = "ลำดับ";
            this.GridView1.Columns[2].HeaderText = " รหัส";
            this.GridView1.Columns[3].HeaderText = " ชื่อรหัสไซส์เสื้อ";
            this.GridView1.Columns[4].HeaderText = "ชื่อรหัสไซส์เสื้อ Eng";
            ...
            this.GridView1.Columns[1].Visible = true;  //"Col_txtshirt_size_no";
            ...
            this.GridView1.Columns[2].Visible = true;  //"Col_txtshirt_size_id";
            ...
            this.GridView1.Columns[3].Visible = true;  //"Col_txtshirt_size_name";
            ...
            this.GridView1.Columns[4].Visible = true;  //"Col_txtshirt_size_name_eng";
            ...
            this.GridView1.Columns[5].Visible = true;  //"Col_txtshirt_size_name_remark";
            ...
            this.GridView1.Columns[6].Visible = false;  //"Col_txtshirt_size_status";
        ...
        private void PANEL_FORM1_dataGridView1_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                if (cell != null)
                {
                    ...
                    this.txtshirt_size_no.Text = row.Cells[1].Value.ToString();
                    this.txtshirt_size_id.Text = row.Cells[2].Value.ToString();
                    this.txtshirt_size_name.Text = row.Cells[3].Value.ToString();
                    ...
                    if (conn.State == System.Data.ConnectionState.Open)
                    {
                        ...
                        cmd2.CommandText = "SELECT *" +
                                            " FROM c001_09shirt_size" +
                                             " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                             " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                             " AND (txtshirt_size_id = '" + this.txtshirt_size_id.Text.Trim() + "')" +
                                           " ORDER BY txtshirt_size_no ASC";
                        ...
                        try
                        {
                            ...
                            if (dt2.Rows.Count > 0)
                            {
                                for (int j = 0; j < dt2.Rows.Count; j++)
                                {
                                    this.txtshirt_size_no.Text = dt2.Rows[j]["txtshirt_size_no"].ToString();      //1
                                    this.txtshirt_size_id.Text = dt2.Rows[j]["txtshirt_size_id"].ToString();      //2
                                    this.txtshirt_size_name.Text = dt2.Rows[j]["txtshirt_size_name"].ToString();      //3
                                    this.txtshirt_size_name_eng.Text = dt2.Rows[j]["txtshirt_size_name_eng"].ToString();      //4
                                    this.txtshirt_size_remark.Text = dt2.Rows[j]["txtshirt_size_remark"].ToString();      //6
                                }
                                this.iblword_status.Text = "แก้ไขรหัสไซส์เสื้อ";
                                this.txtshirt_size_id.ReadOnly = true;
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                cmd2.CommandText = "SELECT *" +
                                    " FROM c001_09shirt_size" +
                                     " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                     " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                     " AND (txtshirt_size_name LIKE '%" + this.PANEL_FORM1_txtsearch.Text.Trim() + "%')" +
                                   " ORDER BY txtshirt_size_no ASC";
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            GridView1.Rows[index].Cells["Col_txtshirt_size_name"].Value = dt2.Rows[j]["txtshirt_size_name"].ToString();      //3
                            GridView1.Rows[index].Cells["Col_txtshirt_size_name_eng"].Value = dt2.Rows[j]["txtshirt_size_name_eng"].ToString();      //4
                            GridView1.Rows[index].Cells["Col_txtshirt_size_remark"].Value = dt2.Rows[j]["txtshirt_size_remark"].ToString();      //6
                            GridView1.Rows[index].Cells["Col_txtshirt_size_status"].Value = dt2.Rows[j]["txtshirt_size_status"].ToString();      //7
        ...
        private void BtnNew_Click(object sender, EventArgs e)
        {
            ...
            this.Hide();
            var frm2 = new HOME03_Production_20shirt_size();
        ...
        private void BtnSave_Click(object sender, EventArgs e)
        {
            if (this.txtshirt_size_no.Text == "")
            {
                ...
                this.txtshirt_size_no.Focus();
                return;
            }
            else
            {
                if (this.txtshirt_size_no.TextLength == 3)
                {
                }
                else
                {
            ...
            if (this.txtshirt_size_id.Text == "")
            {
                MessageBox.Show("โปรดใส่รหัสไซส์เสื้อ ก่อน !", "ผลการทำงาน", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                this.txtshirt_size_id.Focus();
                return;
            }
            if (this.txtshirt_size_name.Text == "")
            {
                MessageBox.Show("โปรดใส่ชื่อรหัสไซส์เสื้อก่อน !", "ผลการทำงาน", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                this.txtshirt_size_name.Focus();
                return;
            }
            ...
            //END เชื่อมต่อฐานข้อมูล=======================================================
            Cursor.Current = Cursors.WaitCursor;
            if (this.iblword_status.Text.Trim() == "เพิ่มรหัสไซส์เสื้อใหม่")
            {
                conn.Open();
                if (conn.State == System.Data.ConnectionState.Open)
                {
                    ...
                    cmd1.CommandText = "SELECT * FROM c001_09shirt_size" +
                                        " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                       " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                       " AND (txtshirt_size_id = '" + this.txtshirt_size_id.Text.Trim() + "')";
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        MessageBox.Show("รหัสรหัสไซส์เสื้อ นี้ซ้ำ   : '" + this.txtshirt_size_id.Text.Trim() + "' โปรดใส่ใหม่ ", "ผลการทำงาน", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                        this.txtshirt_size_id.Focus();
                        conn.Close();
                        return;
                    }
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                try
                {
                    if (this.iblword_status.Text.Trim() == "เพิ่มรหัสไซส์เสื้อใหม่")
                    {
                        cmd2.CommandText = "INSERT INTO c001_09shirt_size(cdkey,txtco_id," +  //1
                                           "txtshirt_size_no,txtshirt_size_id," +  //2
                                           "txtshirt_size_name,txtshirt_size_name_eng," +  //3
                                          "txtshirt_size_remark," +  //5
                                          "txtshirt_size_status) " +  //6
                        ...
                        cmd2.Parameters.Add("@txtshirt_size_no", SqlDbType.NVarChar).Value = this.txtshirt_size_no.Text.ToString();
                        cmd2.Parameters.Add("@txtshirt_size_id", SqlDbType.NVarChar).Value = this.txtshirt_size_id.Text.ToString();
                        cmd2.Parameters.Add("@txtshirt_size_name", SqlDbType.NVarChar).Value = this.txtshirt_size_name.Text.ToString();
                        cmd2.Parameters.Add("@txtshirt_size_name_eng", SqlDbType.NVarChar).Value = this.txtshirt_size_name_eng.Text.ToString();
                        cmd2.Parameters.Add("@txtshirt_size_remark", SqlDbType.NVarChar).Value = this.txtshirt_size_remark.Text.ToString();
                        cmd2.Parameters.Add("@txtshirt_size_status", SqlDbType.NChar).Value = "0";
                        //==============================

                        cmd2.ExecuteNonQuery();

                    }
                    if (this.iblword_status.Text.Trim() == "แก้ไขรหัสไซส์เสื้อ")
                    {
                        cmd2.CommandText = "UPDATE c001_09shirt_size SET " +
                                                                     "txtshirt_size_no = '" + this.txtshirt_size_no.Text.Trim() + "'," +
                                                                     "txtshirt_size_name = '" + this.txtshirt_size_name.Text.Trim() + "'," +
                                                                     "txtshirt_size_name_eng = '" + this.txtshirt_size_name_eng.Text.Trim() + "'," +
                                                                     "txtshirt_size_remark = '" + this.txtshirt_size_remark.Text.ToString() + "'" +
                                                                    " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                                                   " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                                                   " AND (txtshirt_size_id = '" + this.txtshirt_size_id.Text.Trim() + "')";
                        cmd2.ExecuteNonQuery();
                    ...
                    if (dialogResult == DialogResult.Yes)
                    {
                        ...
                        this.txtshirt_size_id.Text = "";
                        this.txtshirt_size_name.Text = "";
                        this.txtshirt_size_name_eng.Text = "";
                        this.txtshirt_size_remark.Text = "";
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                try
                {
                    if (this.iblword_status.Text.Trim() == "ยกเลิกเอกสาร")
                    {
                        ...
                        cmd2.CommandText = "INSERT INTO c001_09shirt_size_cancel(cdkey,txtco_id,txtbranch_id," +  //1
                                                                                                                  //"txttrans_date," +
                        ...
                        cmd2.CommandText = "INSERT INTO c001_09shirt_size_cancel_detail(cdkey,txtco_id," +  //1
                                             "txtshirt_size_no,txtshirt_size_id," +  //2
                                             "txtshirt_size_name,txtshirt_size_name_eng," +  //3
                                             "txtshirt_size_remark," +  //4
                                            "txtshirt_size_status,cancel_id) " +  //5
                                             "VALUES (@cdkey2,@txtco_id2," +  //1
                                             "@txtshirt_size_no,@txtshirt_size_id," +  //2
                                             "@txtshirt_size_name,@txtshirt_size_name_eng," +  //3
                                             "@txtshirt_size_remark," +  //4
                                            "@txtshirt_size_status,@cancel_id2)";   //5
                        ...
                        cmd2.CommandText = "DELETE FROM c001_09shirt_size" +
                                                                    " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                                                    " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                                                   " AND (txtshirt_size_id = '" + this.txtshirt_size_id.Text.Trim() + "')";
                        cmd2.ExecuteNonQuery();
                    ...
                    DialogResult dialogResult = MessageBox.Show("คุณต้องการ ยกเลิกเอกสาร รหัส  " + this.txtshirt_size_id.Text.ToString() + " ใช่หรือไม่่ ?", "โปรดยืนยัน", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question);
                    if (dialogResult == DialogResult.Yes)
                    {
        ...
        private void txtshirt_size_id_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            if (e.KeyChar == (char)Keys.Enter && this.txtshirt_size_id.Text == "")
            {
                this.txtshirt_size_id.Focus();
            }
            //========================================
            else if (e.KeyChar == (char)Keys.Enter && this.txtshirt_size_id.Text.Trim() != "")
            {
                this.txtshirt_size_no.Focus();
        ...
        private void txtshirt_size_no_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == (char)Keys.Enter && this.txtshirt_size_no.Text == "")
            {
                this.txtshirt_size_no.Focus();
            }
            //========================================
            else if (e.KeyChar == (char)Keys.Enter && this.txtshirt_size_no.Text.Trim() != "")
            {
                if (this.txtshirt_size_no.TextLength == 3)
                {
                    this.txtshirt_size_name.Focus();
            ...
            else if ((e.KeyChar > '9') && (e.KeyChar != '\b') && (e.KeyChar != '.') && txtshirt_size_no.Text.Length == 0)
            {
                //e.KeyChar <= '0' || 
                e.Handled = true;
                return;
        ...
        private void txtshirt_size_name_KeyDown(object sender, KeyEventArgs e)
        {

        }
        private void txtshirt_size_name_eng_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
                this.txtshirt_size_remark.Focus();

        }
        private void txtshirt_size_name_remark_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
                this.BtnSave.Focus();
        ...
        private void txtshirt_size_remark_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
                this.BtnSave.Focus();
            ...
            if (OK.Trim() != "Y")
            {
                ...
                if (conn.State == System.Data.ConnectionState.Open)
                {
                    ...
                    try
                    {
                        ...
                        cmd2.Parameters.Add("@cdkey", SqlDbType.NVarChar).Value = W_ID_Select.CDKEY.Trim();
                        cmd2.Parameters.Add("@txtco_id", SqlDbType.NVarChar).Value = W_ID_Select.M_COID.Trim();
                        cmd2.Parameters.Add("@txtshirt_size_no", SqlDbType.NVarChar).Value = "999";
                        cmd2.Parameters.Add("@txtshirt_size_id", SqlDbType.NVarChar).Value = "";
                        cmd2.Parameters.Add("@txtshirt_size_name", SqlDbType.NVarChar).Value = "";
                        cmd2.Parameters.Add("@txtshirt_size_name_eng", SqlDbType.NVarChar).Value = "";
                        cmd2.Parameters.Add("@txtshirt_size_remark", SqlDbType.NVarChar).Value = "";
                        cmd2.Parameters.Add("@txtshirt_size_status", SqlDbType.NChar).Value = "0";
                        //==============================
