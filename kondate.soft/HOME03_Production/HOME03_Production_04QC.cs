...
{
    public partial class HOME03_Production_04QC : Form
    {
        //Move Form ====================================
        ...
        public HOME03_Production_04QC()
        {
            InitializeComponent();
        }

        private void HOME03_Production_04QC_Load(object sender, EventArgs e)
        {
            ...
            this.iblword_status.Text = "ระเบียนใบตรวจผ้า";
            ...
            //========================================
            this.cboSearch.Items.Add("เลขที่ใบตรวจผ้า");
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        ...
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            this.GridView1.Rows[index].Cells["Col_txtqc_id"].Value = dt2.Rows[j]["txtqc_id"].ToString();      //3
                            this.GridView1.Rows[index].Cells["Col_txtnumber_in_year"].Value = dt2.Rows[j]["txtnumber_in_year"].ToString();      //4
                            this.GridView1.Rows[index].Cells["Col_txtface_baking_name"].Value = dt2.Rows[j]["txtface_baking_name"].ToString();      //5
                            this.GridView1.Rows[index].Cells["Col_txtmat_name"].Value = dt2.Rows[j]["txtmat_name"].ToString();      //6
                            this.GridView1.Rows[index].Cells["Col_txtwherehouse_name"].Value = dt2.Rows[j]["txtwherehouse_name"].ToString();      //7

                            this.GridView1.Rows[index].Cells["Col_txttrans_date_server"].Value = Convert.ToDateTime(dt2.Rows[j]["txttrans_date_server"]).ToString("dd-MM-yyyy", UsaCulture);     //8
                            this.GridView1.Rows[index].Cells["Col_txttrans_time"].Value = dt2.Rows[j]["txttrans_time"].ToString();      //9
                            this.GridView1.Rows[index].Cells["Col_txqc_record_remark"].Value = dt2.Rows[j]["txqc_record_remark"].ToString();      //10

                            this.GridView1.Rows[index].Cells["Col_txtmat_id"].Value = dt2.Rows[j]["txtmat_id"].ToString();      //11
                            this.GridView1.Rows[index].Cells["Col_txtnumber_mat_name"].Value = dt2.Rows[j]["txtnumber_mat_name"].ToString();      //12
                            ...
                            {
                                this.GridView1.Rows[index].Cells["Col_txtqc_status"].Value = ""; //15
                            }
                            else if (dt2.Rows[j]["txtqc_status"].ToString() == "1")
                            {
                                this.GridView1.Rows[index].Cells["Col_txtqc_status"].Value = "ยกเลิก"; //15
                            }
        ...
        private void Show_GridView1()
        {
            ...
            this.GridView1.Columns[3].Name = "Col_txtqc_id";
            this.GridView1.Columns[4].Name = "Col_txtnumber_in_year";  //เลยที่
            this.GridView1.Columns[5].Name = "Col_txtface_baking_name";  //อบหน้า
            this.GridView1.Columns[6].Name = "Col_txtmat_name";   //เส้นด้าย
            this.GridView1.Columns[7].Name = "Col_txtwherehouse_name";
            this.GridView1.Columns[8].Name = "Col_txttrans_date_server";
            this.GridView1.Columns[9].Name = "Col_txttrans_time";
            this.GridView1.Columns[10].Name = "Col_txqc_record_remark";
            this.GridView1.Columns[11].Name = "Col_txtmat_id";
            this.GridView1.Columns[12].Name = "Col_txtnumber_mat_name";
            this.GridView1.Columns[13].Name = "Col_txtsum_qty";
            this.GridView1.Columns[14].Name = "Col_txtsum2_qty";
            this.GridView1.Columns[15].Name = "Col_txtqc_status";
            ...
            this.GridView1.Columns[4].HeaderText = " ชุดที่";
            this.GridView1.Columns[5].HeaderText = "อบหน้า";
            this.GridView1.Columns[6].HeaderText = "เส้นด้าย";
            this.GridView1.Columns[7].HeaderText = " คลัง";
            this.GridView1.Columns[8].HeaderText = "วันที่";
            this.GridView1.Columns[9].HeaderText = "เวลา";
            this.GridView1.Columns[10].HeaderText = "หมายเหตุ";
            this.GridView1.Columns[11].HeaderText = "รหัสสินค้า";
            this.GridView1.Columns[12].HeaderText = "เบอร์ด้าย";
            ...
            this.GridView1.Columns["Col_txtnumber_in_year"].Width = 60;
            ...
            this.GridView1.Columns["Col_txtface_baking_name"].Width = 60;
            ...
            this.GridView1.Columns["Col_txtmat_name"].Width = 80;
            ...
            this.GridView1.Columns["Col_txqc_record_remark"].Visible = true;  //"Col_txqc_record_remark";
            this.GridView1.Columns["Col_txqc_record_remark"].Width = 200;
            this.GridView1.Columns["Col_txqc_record_remark"].ReadOnly = true;
            this.GridView1.Columns["Col_txqc_record_remark"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.GridView1.Columns["Col_txqc_record_remark"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
            ...
            this.GridView1.Columns["Col_txtqc_status"].Width = 100;
        ...
        private void GridView1_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                if (cell != null)
                {
                    W_ID_Select.TRANS_ID = row.Cells["Col_txtqc_id"].Value.ToString();
                    this.cboSearch.Text = "เลขที่ใบตรวจผ้า";

                    if (this.cboSearch.Text == "เลขที่ใบตรวจผ้า")
                    {
                        this.txtsearch.Text = row.Cells["Col_txtnumber_in_year"].Value.ToString();
                        W_ID_Select.TRANS_ID = row.Cells["Col_txtqc_id"].Value.ToString();
        ...
        private void GridView1_DoubleClick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                W_ID_Select.WORD_TOP = "ดูข้อมูลใบตรวจผ้า";
                kondate.soft.HOME03_Production.HOME03_Production_04QC_record_detail frm2 = new kondate.soft.HOME03_Production.HOME03_Production_04QC_record_detail();
                frm2.Show();
        ...
        private void BtnNew_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                W_ID_Select.WORD_TOP = "บันทึกใบตรวจผ้า";
        ...
        private void btnGo3_Click(object sender, EventArgs e)
        {
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                //this.cboSearch.Items.Add("เลขที่ใบตรวจผ้า");
                //this.cboSearch.Items.Add("Lot No");

                if (this.cboSearch.Text.Trim() == "เลขที่ใบตรวจผ้า")
                {
                    cmd2.CommandText = "SELECT c002_03QC_record.*," +
                                       "c001_05face_baking.*," +
                                       "c001_06number_mat.*," +
                                       ...
                                       " AND (c002_03QC_record.txtbranch_id = '" + W_ID_Select.M_BRANCHID.Trim() + "')" +
                                       " AND (c002_03QC_record.txttrans_date_server BETWEEN @datestart AND @dateend)" +
                                       " AND (c002_03QC_record.txtnumber_in_year = '" + this.txtsearch.Text.Trim() + "')" +
                                      " ORDER BY c002_03QC_record.txtqc_id ASC";
