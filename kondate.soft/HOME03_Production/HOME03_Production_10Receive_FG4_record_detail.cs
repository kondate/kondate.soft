...
{
    public partial class HOME03_Production_10Receive_FG4_record_detail : Form
    {
        //Move Form ====================================
        ...
        public HOME03_Production_10Receive_FG4_record_detail()
        {
            InitializeComponent();
        }
        ...
        private void HOME03_Production_07Receive_Send_Dye_record_detail_Load(object sender, EventArgs e)
        {
            ...
            this.iblword_status.Text = "ดูข้อมูลใบรับเสื้อยึดสำเร็จรูป FG4";
        ...
        private void Fill_DATA_TO_GridView1()
        {
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                cmd2.CommandText = "SELECT c002_10Receive_FG4_record.*," +
                                   ...
                                   " AND (c002_10Receive_FG4_record.txtFG4_id = '" + W_ID_Select.TRANS_ID.Trim() + "')" +
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        this.txtFG4_id.Text = dt2.Rows[0]["txtFG4_id"].ToString();

                        this.txtFG4_type_id.Text = dt2.Rows[0]["txtFG4_type_id"].ToString();

                        if (this.txtFG4_type_id.Text == "01")
                        {
                            this.cbotxtFG4_type_name.Text = "รับตามใบส่งเย็บ";
                        }
                        else
                        {
                            this.cbotxtFG4_type_name.Text = "รับไม่มีใบส่งเย็บ";
                        ...
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            this.GridView1.Rows[index].Cells["Col_txtSWT_id"].Value = dt2.Rows[j]["txtSWT_id"].ToString();         //1
                            this.GridView1.Rows[index].Cells["Col_txtwherehouse_id"].Value = dt2.Rows[j]["txtwherehouse_id"].ToString();      //2

                            this.GridView1.Rows[index].Cells["Col_txtsum_qty_body"].Value = Convert.ToSingle(dt2.Rows[j]["txtsum_qty_body"]).ToString("###,###.0");     //3
                            this.GridView1.Rows[index].Cells["Col_txtqty_receive"].Value = Convert.ToSingle(dt2.Rows[j]["txtqty_receive"]).ToString("###,###.0");       //4
                            this.GridView1.Rows[index].Cells["Col_txtqty_tamni"].Value = Convert.ToSingle(dt2.Rows[j]["txtqty_tamni"]).ToString("###,###.0");      //5
                            this.GridView1.Rows[index].Cells["Col_txtqty_soonsear"].Value = Convert.ToSingle(dt2.Rows[j]["txtqty_soonsear"]).ToString("###,###.0");      //6
        ...
        private void Show_Qty_Yokma2()
        {
            ...
            for (int i = 0; i < this.GridView1.Rows.Count; i++)
            {
                ...
                //else
                //{
                //    MessageBox.Show("ระบบจะให้ส่งเย็บเสื้อยึดสำเร็จรูป FG4 ได้ที่ละ 1 รหัสเสื้อยึดสำเร็จรูป FG4 ต่อ 1 ใบส่งเย็บ เท่านั้น !! ");
                //    return;
                //}
                conn.Open();
                if (conn.State == System.Data.ConnectionState.Open)
                    ...
                    try
                    {
                        ...
                        if (dt2.Rows.Count > 0)
                        {
                            ...
                            for (int j = 0; j < dt2.Rows.Count; j++)
                            {
                                ...
                                GridView1.Rows[i].Cells["Col_txtqty_tamni_cut_yokma"].Value = "0";    //36
                                GridView1.Rows[i].Cells["Col_txtqty_tamni_after_cut"].Value = "0";           //21

                                GridView1.Rows[i].Cells["Col_txtqty_soonsear_cut_yokma"].Value = "0";    //36
                                GridView1.Rows[i].Cells["Col_txtqty_soonsear_after_cut"].Value = "0";           //21
        ...
        private void BtnCancel_Doc_Click(object sender, EventArgs e)
        {
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                cmd1.CommandText = "SELECT * FROM c002_10Receive_FG4_record" +
                                    " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                    " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    MessageBox.Show("เอกสารนี้   : '" + this.txtFG4_id.Text.Trim() + "' ยกเลิกไปแล้ว ", "ผลการทำงาน", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                    conn.Close();
                    return;
                }
            }
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                try
                {
                    ...
                    //{
                        ...
                        cmd2.CommandText = "INSERT INTO c002_10Receive_FG4_record_cancel(cdkey,txtco_id,txtbranch_id," +  //1
                                                                                                                       //"txttrans_date," +
                        ...
                        //2
                        cmd2.CommandText = "UPDATE c002_10Receive_FG4_record" +
                                                                    " SET txtFG4_status = '1'," +
                        ...
                        if (this.GridView1.Rows[i].Cells["Col_txtmat_id"].Value != null)
                        {
                            ...
                            cmd2.CommandText = "UPDATE c002_09Send_Sew_shirt_record_detail SET " +
                                                   ...
                                                   "txtqty_tamni_after_cut = '" + Convert.ToDouble(string.Format("{0:n4}", this.GridView1.Rows[i].Cells["Col_txtqty_tamni_after_cut_yokpai"].Value.ToString())) + "'," +
                                                    ...
                                                    "txtcut_id3 = ''," +
                                                    "txtqty_soonsear_cut = '" + Convert.ToDouble(string.Format("{0:n4}", this.GridView1.Rows[i].Cells["Col_txtqty_soonsear_cut_yokpai"].Value.ToString())) + "'," +
                                                   "txtqty_soonsear_after_cut = '" + Convert.ToDouble(string.Format("{0:n4}", this.GridView1.Rows[i].Cells["Col_txtqty_soonsear_after_cut_yokpai"].Value.ToString())) + "'" +
                        ...
                        if (valu != "")
                        {
                            if (Convert.ToDouble(string.Format("{0:n4}", this.GridView2.Rows[i].Cells["Col_txtsum_qty"].Value.ToString())) > 0)
                            {
                                ...
                                cmd2.CommandText = "INSERT INTO k021_mat_average_balance(cdkey,txtco_id,txtbranch_id," +  //1
                                        ...
                                        "'FG4'," +  //9 txtbill_type
                                        "'ยกเลิกรับเสื้อยึดสำเร็จรูป FG4 " + this.txtrg_remark.Text.Trim() + "'," +  //9 txtbill_remark
                    ...
                    DialogResult dialogResult = MessageBox.Show("คุณต้องการ ยกเลิกเอกสาร รหัส  " + this.txtFG4_id.Text.ToString() + " ใช่หรือไม่่ ?", "โปรดยืนยัน", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question);
                    if (dialogResult == DialogResult.Yes)
                    {
