...
namespace kondate.soft.HOME03_Production
{
    public partial class HOME03_Production_03Produce : Form
    {
        ...
        private void HOME03_Production_03Produce_Load(object sender, EventArgs e)
        {
            ...
            this.iblword_status.Text = "ระเบียนใบผลิต";
            ...
            //========================================
            this.cboSearch.Items.Add("เลขที่ใบผลิต");
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        ...
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            this.GridView1.Rows[index].Cells["Col_txtnumber_mat_name"].Value = dt2.Rows[j]["txtnumber_mat_name"].ToString();      //10
                            this.GridView1.Rows[index].Cells["Col_txtmachine_name"].Value = dt2.Rows[j]["txtmachine_name"].ToString();      //11
        ...
        private void Show_GridView1()
        {
            ...
            this.GridView1.Columns["Col_txtmachine_name"].Visible = true;  //"Col_txtmachine_name";
            this.GridView1.Columns["Col_txtmachine_name"].Width = 120;
            this.GridView1.Columns["Col_txtmachine_name"].ReadOnly = true;
            this.GridView1.Columns["Col_txtmachine_name"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.GridView1.Columns["Col_txtmachine_name"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
        ...
        private void GridView1_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                if (cell != null)
                {
                    ...
                    this.cboSearch.Text = "เลขที่ใบผลิต";

                    if (this.cboSearch.Text == "เลขที่ใบผลิต")
                    {
        ...
        private void GridView1_DoubleClick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                W_ID_Select.WORD_TOP = "ดูข้อมูลใบผลิต";
        ...
        private void BtnNew_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                W_ID_Select.WORD_TOP = "บันทึกใบผลิต";
        ...
        private void btnGo3_Click(object sender, EventArgs e)
        {
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                if (this.cboSearch.Text.Trim() == "เลขที่ใบผลิต")
                {
                    cmd2.CommandText = "SELECT c002_02produce_record.*," +
                                       "c001_04produce_type.*," +
                                       "c001_02machine.*," +
