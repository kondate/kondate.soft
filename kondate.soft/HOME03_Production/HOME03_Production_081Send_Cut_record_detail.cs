...
namespace kondate.soft.HOME03_Production
{
    public partial class HOME03_Production_081Send_Cut_record_detail : Form
    {
        ...
        private void HOME03_Production_05Send_Dye_record_detail_Load(object sender, EventArgs e)
        {
            ...
            this.iblword_status.Text = "ดูข้อมูลใบส่งผ้าตัด";
        ...
        private void BtnNew_Click(object sender, EventArgs e)
        {
            ...
            this.iblword_status.Text = "บันทึกใบส่งผ้าตัด";
                        ...
                        if (valu != "")
                        {
                            if (Convert.ToDouble(string.Format("{0:n4}", this.GridView2.Rows[i].Cells["Col_txtsum_qty"].Value.ToString())) > 0)
                            {
                                ...
                                cmd2.CommandText = "INSERT INTO k021_mat_average_balance(cdkey,txtco_id,txtbranch_id," +  //1
                                        ...
                                        "'SPT'," +  //9 txtbill_type
                                        "'ยกเลิก ส่งตัด " + this.txtSPT_record_remark.Text.Trim() + "'," +  //9 txtbill_remark
