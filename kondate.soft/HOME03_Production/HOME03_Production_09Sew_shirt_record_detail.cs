...
{
    public partial class HOME03_Production_09Sew_shirt_record_detail : Form
    {
        //Move Form ====================================
        ...
        public HOME03_Production_09Sew_shirt_record_detail()
        {
            InitializeComponent();
        }

        private void HOME03_Production_09Sew_shirt_record_detail_Load(object sender, EventArgs e)
        {
            this.WindowState = FormWindowState.Maximized;
            this.btnmaximize.Visible = false;
            this.btnmaximize_full.Visible = true;

            W_ID_Select.M_FORM_NUMBER = "H0309SEWDL";
            CHECK_ADD_FORM();
            ...
            this.iblword_status.Text = "ดูข้อมูลใบสั่งเย็บ";
        ...
        private void Fill_DATA_TO_GridView1()
        {
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                cmd2.CommandText = "SELECT c002_09Sew_shirt_record.*," +
                                   ...
                                   " WHERE (c002_09Sew_shirt_record.cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                   " AND (c002_09Sew_shirt_record.txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                   " AND (c002_09Sew_shirt_record.txtSEW_id = '" + W_ID_Select.TRANS_ID.Trim() + "')" +
                                   " ORDER BY c002_09Sew_shirt_record.txtSEW_id ASC";
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        ...
                        this.txtsew_remark.Text = dt2.Rows[0]["txtsew_remark"].ToString();
                        ...
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            GridView1.Rows[index].Cells["Col_txtCS_id"].Value = dt2.Rows[j]["txtCS_id"].ToString();      //1
                            ...
                            GridView1.Rows[index].Cells["Col_txtqty_amount"].Value = Convert.ToSingle(dt2.Rows[j]["txtqty_amount"]).ToString("###,###.00");     //7
                            GridView1.Rows[index].Cells["Col_Col_txtsum_qty_amount_all"].Value = Convert.ToSingle(dt2.Rows[j]["txtsum_qty_amount_all"]).ToString("###,###.00");     //8
                            GridView1.Rows[index].Cells["Col_txtqty_Difference"].Value = Convert.ToSingle(dt2.Rows[j]["txtqty_Difference"]).ToString("###,###.00");     //9
        ...
        private void GridView1_Cal_Sum()
        {
            ...
            for (int i = 0; i < this.GridView1.Rows.Count; i++)
            {
                ...
                Sum_Qty = Convert.ToDouble(string.Format("{0:n4}", Sum_Qty)) + Convert.ToDouble(string.Format("{0:n4}", this.GridView1.Rows[i].Cells["Col_Col_txtsum_qty_amount_all"].Value.ToString()));
                this.txtsum_qty_amount_all.Text = Sum_Qty.ToString("N", new CultureInfo("en-US"));
        ...
        private void BtnCancel_Doc_Click(object sender, EventArgs e)
        {
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                cmd1.CommandText = "SELECT * FROM c002_09Sew_shirt_record" +
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    MessageBox.Show("เอกสารนี้   : '" + this.txtSEW_id.Text.Trim() + "' ยกเลิกไปแล้ว ", "ผลการทำงาน", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                    conn.Close();
                    return;
                }
            }
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                try
                {
                    ...
                    if (this.iblword_status.Text.Trim() == "ยกเลิกเอกสาร")
                    {
                        ...
                        cmd2.CommandText = "INSERT INTO c002_09Sew_shirt_record_cancel(cdkey,txtco_id,txtbranch_id," +  //1
                                                                                                                        //"txttrans_date," +
                        ...
                        //2
                        cmd2.CommandText = "UPDATE c002_09Sew_shirt_record" +
                                                                    " SET txtsew_status = '1'" +
                                                                     " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                                                     " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                                                     " AND (txtSEW_id = '" + this.txtSEW_id.Text.Trim() + "')";
                    ...
                    DialogResult dialogResult = MessageBox.Show("คุณต้องการ ยกเลิกเอกสาร รหัส  " + this.txtSEW_id.Text.ToString() + " ใช่หรือไม่่ ?", "โปรดยืนยัน", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question);
