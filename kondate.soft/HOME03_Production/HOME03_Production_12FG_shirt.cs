...
{
    public partial class HOME03_Production_12FG_shirt : Form
    {
        //Move Form ====================================
        ...
        public HOME03_Production_12FG_shirt()
        {
            InitializeComponent();
        }

        private void HOME03_Production_12FG_shirt_Load(object sender, EventArgs e)
        {
            ...
            this.iblword_status.Text = "ระเบียนใบผลิตเสร็จ FG";
            ...
            //========================================
            this.cboSearch.Items.Add("เลขที่ใบผลิตเสร็จ FG");
            this.cboSearch.Items.Add("ชื่อผู้บันทึกใบผลิตเสร็จ FG");
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        ...
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            this.GridView1.Rows[index].Cells["Col_txtFG_id"].Value = dt2.Rows[j]["txtFG_id"].ToString();      //3
                            ...
                            this.GridView1.Rows[index].Cells["Col_txtFG_remark"].Value = dt2.Rows[j]["txtFG_remark"].ToString();      //6

                            this.GridView1.Rows[index].Cells["Col_txtsum_qty_fg"].Value = Convert.ToSingle(dt2.Rows[j]["txtsum_qty_fg"]).ToString("###,###.00");      //7

                            //FG ==============================
                            if (dt2.Rows[j]["txtfg_status"].ToString() == "")
                            {
                                this.GridView1.Rows[index].Cells["Col_txtfg_status"].Value = ""; //8
                            }
                            else if (dt2.Rows[j]["txtfg_status"].ToString() == "0")
                            {
                                this.GridView1.Rows[index].Cells["Col_txtfg_status"].Value = ""; //8
                            }
                            else if (dt2.Rows[j]["txtfg_status"].ToString() == "1")
                            {
                                this.GridView1.Rows[index].Cells["Col_txtfg_status"].Value = "ยกเลิก"; //8
                            }
        ...
        private void Show_GridView1()
        {
            ...
            this.GridView1.Columns[3].Name = "Col_txtFG_id";
            this.GridView1.Columns[4].Name = "Col_txttrans_date_server";
            this.GridView1.Columns[5].Name = "Col_txttrans_time";
            this.GridView1.Columns[6].Name = "Col_txtFG_remark";
            this.GridView1.Columns[7].Name = "Col_txtsum_qty_fg";
            this.GridView1.Columns[8].Name = "Col_txtfg_status";  //
            ...
            this.GridView1.Columns[3].HeaderText = " เลขที่ใบผลิตเสร็จ FG";
            ...
            this.GridView1.Columns[7].HeaderText = "จำนวนผลิตเสร็จ FG";
            ...
            this.GridView1.Columns["Col_txtFG_remark"].Visible = true;  //"Col_txtFG_remark";
            this.GridView1.Columns["Col_txtFG_remark"].Width = 300;
            this.GridView1.Columns["Col_txtFG_remark"].ReadOnly = true;
            this.GridView1.Columns["Col_txtFG_remark"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.GridView1.Columns["Col_txtFG_remark"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;



            this.GridView1.Columns["Col_txtsum_qty_fg"].Visible = true;  //"Col_txtsum_qty_fg";
            this.GridView1.Columns["Col_txtsum_qty_fg"].Width = 120;
            this.GridView1.Columns["Col_txtsum_qty_fg"].ReadOnly = true;
            this.GridView1.Columns["Col_txtsum_qty_fg"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.GridView1.Columns["Col_txtsum_qty_fg"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;


            this.GridView1.Columns["Col_txtfg_status"].Visible = true;  //"Col_txtfg_status";
            this.GridView1.Columns["Col_txtfg_status"].Width = 70;
            this.GridView1.Columns["Col_txtfg_status"].ReadOnly = true;
            this.GridView1.Columns["Col_txtfg_status"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.GridView1.Columns["Col_txtfg_status"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
        ...
        private void GridView1_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                if (cell != null)
                {
                    ...
                    this.cboSearch.Text = "เลขที่ใบผลิตเสร็จ FG";

                    if (this.cboSearch.Text == "เลขที่ใบผลิตเสร็จ FG")
                    {
                        this.txtsearch.Text = row.Cells[3].Value.ToString();
                        W_ID_Select.TRANS_ID = row.Cells[3].Value.ToString();

                    }
                    else if (this.cboSearch.Text == "ชื่อผู้บันทึกใบผลิตเสร็จ FG")
                    {
        ...
        private void GridView1_DoubleClick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                W_ID_Select.WORD_TOP = "ดูข้อมูลใบผลิตเสร็จ FG";
                kondate.soft.HOME03_Production.HOME03_Production_12FG_shirt_record_detail frm2 = new kondate.soft.HOME03_Production.HOME03_Production_12FG_shirt_record_detail();
                frm2.Show();
        ...
        private void btnGo4_Click(object sender, EventArgs e)
        {
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                if (this.cboSearch.Text.Trim() == "เลขที่ใบผลิตเสร็จ FG")
                {
                    cmd2.CommandText = "SELECT *" +
                                       " FROM c002_12FG_shirt_record" +
                                      ...
                                      //" AND (txtbranch_id = '" + W_ID_Select.M_BRANCHID.Trim() + "')" +
                                      //" AND (txttrans_date_server BETWEEN @datestart AND @dateend)" +
                                      " AND (txtFG_id = '" + this.txtsearch.Text.Trim() + "')" +
                                      " ORDER BY txtFG_id ASC";

                }
                else if (this.cboSearch.Text.Trim() == "ชื่อผู้บันทึกใบผลิตเสร็จ FG")
                {
                    cmd2.CommandText = "SELECT *" +
                                       " FROM c002_12FG_shirt_record" +
        ...
        private void BtnNew_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                W_ID_Select.WORD_TOP = "บันทึกใบผลิตเสร็จ FG";
