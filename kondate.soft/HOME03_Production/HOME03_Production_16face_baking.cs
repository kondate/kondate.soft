...
{
    public partial class HOME03_Production_16face_baking : Form
    {
        //Move Form ====================================
        ...
        public HOME03_Production_16face_baking()
        {
            InitializeComponent();
        }
        private void HOME03_Production_16face_baking_Load(object sender, EventArgs e)
        {
            ...
            this.iblword_status.Text = "เพิ่มรหัสอบหน้าใหม่";
            this.txtface_baking_id.ReadOnly = false;

            this.ActiveControl = this.txtface_baking_id;
        ...
        private void Run_ID()
        {
            if (this.txtface_baking_no.Text == "")
            {
                this.txtface_baking_no.Text = "001";
            }
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                cmd2.CommandText = "SELECT *" +
                                    ...
                                    " ORDER BY txtface_baking_no DESC";
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            GridView1.Rows[index].Cells["Col_txtface_baking_no"].Value = dt2.Rows[j]["txtface_baking_no"].ToString();      //1
                            GridView1.Rows[index].Cells["Col_txtface_baking_id"].Value = dt2.Rows[j]["txtface_baking_id"].ToString();      //2
                            GridView1.Rows[index].Cells["Col_txtface_baking_name"].Value = dt2.Rows[j]["txtface_baking_name"].ToString();      //3
                            GridView1.Rows[index].Cells["Col_txtface_baking_name_eng"].Value = dt2.Rows[j]["txtface_baking_name_eng"].ToString();      //4
                            GridView1.Rows[index].Cells["Col_txtface_baking_remark"].Value = dt2.Rows[j]["txtface_baking_remark"].ToString();      //5
                            GridView1.Rows[index].Cells["Col_txtface_baking_status"].Value = dt2.Rows[j]["txtface_baking_status"].ToString();      //6
        ...
        private void PANEL_FORM1_GridView1()
        {
            ...
            this.GridView1.Columns[1].Name = "Col_txtface_baking_no";
            this.GridView1.Columns[2].Name = "Col_txtface_baking_id";
            this.GridView1.Columns[3].Name = "Col_txtface_baking_name";
            this.GridView1.Columns[4].Name = "Col_txtface_baking_name_eng";
            this.GridView1.Columns[5].Name = "Col_txtface_baking_remark";
            this.GridView1.Columns[6].Name = "Col_txtface_baking_status";

            this.GridView1.Columns[0].HeaderText = "No";
            this.GridView1.Columns[1].HeaderText = "ลำดับ";
            this.GridView1.Columns[2].HeaderText = " รหัส";
            this.GridView1.Columns[3].HeaderText = " ชื่อรหัสอบหน้า";
            this.GridView1.Columns[4].HeaderText = "ชื่อรหัสอบหน้า Eng";
            ...
            this.GridView1.Columns[1].Visible = true;  //"Col_txtface_baking_no";
            ...
            this.GridView1.Columns[2].Visible = true;  //"Col_txtface_baking_id";
            ...
            this.GridView1.Columns[3].Visible = true;  //"Col_txtface_baking_name";
            ...
            this.GridView1.Columns[4].Visible = true;  //"Col_txtface_baking_name_eng";
            ...
            this.GridView1.Columns[5].Visible = true;  //"Col_txtface_baking_name_remark";
            ...
            this.GridView1.Columns[6].Visible = false;  //"Col_txtface_baking_status";
        ...
        private void PANEL_FORM1_dataGridView1_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                if (cell != null)
                {
                    ...
                    this.txtface_baking_no.Text = row.Cells[1].Value.ToString();
                    this.txtface_baking_id.Text = row.Cells[2].Value.ToString();
                    this.txtface_baking_name.Text = row.Cells[3].Value.ToString();
                    ...
                    if (conn.State == System.Data.ConnectionState.Open)
                    {
                        ...
                        cmd2.CommandText = "SELECT *" +
                                            " FROM c001_05face_baking" +
                                             " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                             " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                             " AND (txtface_baking_id = '" + this.txtface_baking_id.Text.Trim() + "')" +
                                           " ORDER BY txtface_baking_no ASC";
                        ...
                        try
                        {
                            ...
                            if (dt2.Rows.Count > 0)
                            {
                                for (int j = 0; j < dt2.Rows.Count; j++)
                                {
                                    this.txtface_baking_no.Text = dt2.Rows[j]["txtface_baking_no"].ToString();      //1
                                    this.txtface_baking_id.Text = dt2.Rows[j]["txtface_baking_id"].ToString();      //2
                                    this.txtface_baking_name.Text = dt2.Rows[j]["txtface_baking_name"].ToString();      //3
                                    this.txtface_baking_name_eng.Text = dt2.Rows[j]["txtface_baking_name_eng"].ToString();      //4
                                    this.txtface_baking_remark.Text = dt2.Rows[j]["txtface_baking_remark"].ToString();      //6
                                }
                                this.iblword_status.Text = "แก้ไขรหัสอบหน้า";
                                this.txtface_baking_id.ReadOnly = true;
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                cmd2.CommandText = "SELECT *" +
                                    " FROM c001_05face_baking" +
                                     " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                     " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                     " AND (txtface_baking_name LIKE '%" + this.PANEL_FORM1_txtsearch.Text.Trim() + "%')" +
                                   " ORDER BY txtface_baking_no ASC";
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            GridView1.Rows[index].Cells["Col_txtface_baking_name"].Value = dt2.Rows[j]["txtface_baking_name"].ToString();      //3
                            GridView1.Rows[index].Cells["Col_txtface_baking_name_eng"].Value = dt2.Rows[j]["txtface_baking_name_eng"].ToString();      //4
                            GridView1.Rows[index].Cells["Col_txtface_baking_remark"].Value = dt2.Rows[j]["txtface_baking_remark"].ToString();      //6
                            GridView1.Rows[index].Cells["Col_txtface_baking_status"].Value = dt2.Rows[j]["txtface_baking_status"].ToString();      //7
        ...
        private void BtnNew_Click(object sender, EventArgs e)
        {
            ...
            this.Hide();
            var frm2 = new HOME03_Production_16face_baking();
        ...
        private void btnopen_Click(object sender, EventArgs e)
        {
            ...
            if (this.txtface_baking_id.Text != "")
            {
                this.iblword_status.Text = "แก้ไขรหัสอบหน้า";
                this.txtface_baking_id.ReadOnly = true;
            }
        ...
        private void BtnSave_Click(object sender, EventArgs e)
        {
            if (this.txtface_baking_no.Text == "")
            {
                ...
                this.txtface_baking_no.Focus();
                return;
            }
            else
            {
                if (this.txtface_baking_no.TextLength == 3)
                {
                }
                else
                {
            ...
            if (this.txtface_baking_id.Text == "")
            {
                MessageBox.Show("โปรดใส่รหัสอบหน้า ก่อน !", "ผลการทำงาน", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                this.txtface_baking_id.Focus();
                return;
            }
            if (this.txtface_baking_name.Text == "")
            {
                MessageBox.Show("โปรดใส่ชื่อรหัสอบหน้าก่อน !", "ผลการทำงาน", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                this.txtface_baking_name.Focus();
                return;
            }
            ...
            //END เชื่อมต่อฐานข้อมูล=======================================================
            Cursor.Current = Cursors.WaitCursor;
            if (this.iblword_status.Text.Trim() == "เพิ่มรหัสอบหน้าใหม่")
            {
                conn.Open();
                if (conn.State == System.Data.ConnectionState.Open)
                {
                    ...
                    cmd1.CommandText = "SELECT * FROM c001_05face_baking" +
                                        " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                       " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                       " AND (txtface_baking_id = '" + this.txtface_baking_id.Text.Trim() + "')";
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        MessageBox.Show("รหัสรหัสอบหน้า นี้ซ้ำ   : '" + this.txtface_baking_id.Text.Trim() + "' โปรดใส่ใหม่ ", "ผลการทำงาน", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                        this.txtface_baking_id.Focus();
                        conn.Close();
                        return;
                    }
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                try
                {
                    if (this.iblword_status.Text.Trim() == "เพิ่มรหัสอบหน้าใหม่")
                    {
                        cmd2.CommandText = "INSERT INTO c001_05face_baking(cdkey,txtco_id," +  //1
                                           "txtface_baking_no,txtface_baking_id," +  //2
                                           "txtface_baking_name,txtface_baking_name_eng," +  //3
                                          "txtface_baking_remark," +  //5
                                          "txtface_baking_status) " +  //6
                        ...
                        cmd2.Parameters.Add("@txtface_baking_no", SqlDbType.NVarChar).Value = this.txtface_baking_no.Text.ToString();
                        cmd2.Parameters.Add("@txtface_baking_id", SqlDbType.NVarChar).Value = this.txtface_baking_id.Text.ToString();
                        cmd2.Parameters.Add("@txtface_baking_name", SqlDbType.NVarChar).Value = this.txtface_baking_name.Text.ToString();
                        cmd2.Parameters.Add("@txtface_baking_name_eng", SqlDbType.NVarChar).Value = this.txtface_baking_name_eng.Text.ToString();
                        cmd2.Parameters.Add("@txtface_baking_remark", SqlDbType.NVarChar).Value = this.txtface_baking_remark.Text.ToString();
                        cmd2.Parameters.Add("@txtface_baking_status", SqlDbType.NChar).Value = "0";
                        //==============================

                        cmd2.ExecuteNonQuery();

                    }
                    if (this.iblword_status.Text.Trim() == "แก้ไขรหัสอบหน้า")
                    {
                        cmd2.CommandText = "UPDATE c001_05face_baking SET " +
                                                                     "txtface_baking_no = '" + this.txtface_baking_no.Text.Trim() + "'," +
                                                                     "txtface_baking_name = '" + this.txtface_baking_name.Text.Trim() + "'," +
                                                                     "txtface_baking_name_eng = '" + this.txtface_baking_name_eng.Text.Trim() + "'," +
                                                                     "txtface_baking_remark = '" + this.txtface_baking_remark.Text.ToString() + "'" +
                                                                    " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                                                   " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                                                   " AND (txtface_baking_id = '" + this.txtface_baking_id.Text.Trim() + "')";
                        cmd2.ExecuteNonQuery();
                    ...
                    if (dialogResult == DialogResult.Yes)
                    {
                        ...
                        this.txtface_baking_id.Text = "";
                        this.txtface_baking_name.Text = "";
                        this.txtface_baking_name_eng.Text = "";
                        this.txtface_baking_remark.Text = "";
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                try
                {
                    if (this.iblword_status.Text.Trim() == "ยกเลิกเอกสาร")
                    {
                        ...
                        cmd2.CommandText = "INSERT INTO c001_05face_baking_cancel(cdkey,txtco_id,txtbranch_id," +  //1
                                                                                                             //"txttrans_date," +
                        ...
                        cmd2.CommandText = "INSERT INTO c001_05face_baking_cancel_detail(cdkey,txtco_id," +  //1
                                             "txtface_baking_no,txtface_baking_id," +  //2
                                             "txtface_baking_name,txtface_baking_name_eng," +  //3
                                             "txtface_baking_remark," +  //4
                                            "txtface_baking_status,cancel_id) " +  //5
                                             "VALUES (@cdkey2,@txtco_id2," +  //1
                                             "@txtface_baking_no,@txtface_baking_id," +  //2
                                             "@txtface_baking_name,@txtface_baking_name_eng," +  //3
                                             "@txtface_baking_remark," +  //4
                                            "@txtface_baking_status,@cancel_id2)";   //5
                        ...
                        cmd2.CommandText = "DELETE FROM c001_05face_baking" +
                                                                    " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                                                    " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                                                   " AND (txtface_baking_id = '" + this.txtface_baking_id.Text.Trim() + "')";
                        cmd2.ExecuteNonQuery();
                    ...
                    DialogResult dialogResult = MessageBox.Show("คุณต้องการ ยกเลิกเอกสาร รหัส  " + this.txtface_baking_id.Text.ToString() + " ใช่หรือไม่่ ?", "โปรดยืนยัน", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question);
                    if (dialogResult == DialogResult.Yes)
                    {
        ...
        private void txtface_baking_id_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            if (e.KeyChar == (char)Keys.Enter && this.txtface_baking_id.Text == "")
            {
                this.txtface_baking_id.Focus();
            }
            //========================================
            else if (e.KeyChar == (char)Keys.Enter && this.txtface_baking_id.Text.Trim() != "")
            {
                this.txtface_baking_no.Focus();
        ...
        private void txtface_baking_no_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == (char)Keys.Enter && this.txtface_baking_no.Text == "")
            {
                this.txtface_baking_no.Focus();
            }
            //========================================
            else if (e.KeyChar == (char)Keys.Enter && this.txtface_baking_no.Text.Trim() != "")
            {
                if (this.txtface_baking_no.TextLength == 3)
                {
                    this.txtface_baking_name.Focus();
            ...
            else if ((e.KeyChar > '9') && (e.KeyChar != '\b') && (e.KeyChar != '.') && txtface_baking_no.Text.Length == 0)
            {
                //e.KeyChar <= '0' || 
                e.Handled = true;
                return;
        ...
        private void txtface_baking_name_KeyDown(object sender, KeyEventArgs e)
        {

        }
        private void txtface_baking_name_eng_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
                this.txtface_baking_remark.Focus();

        }
        private void txtface_baking_name_remark_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
                this.BtnSave.Focus();
            ...
            if (OK.Trim() != "Y")
            {
                ...
                if (conn.State == System.Data.ConnectionState.Open)
                {
                    ...
                    try
                    {
                        ...
                        cmd2.Parameters.Add("@cdkey", SqlDbType.NVarChar).Value = W_ID_Select.CDKEY.Trim();
                        cmd2.Parameters.Add("@txtco_id", SqlDbType.NVarChar).Value = W_ID_Select.M_COID.Trim();
                        cmd2.Parameters.Add("@txtface_baking_no", SqlDbType.NVarChar).Value = "999";
                        cmd2.Parameters.Add("@txtface_baking_id", SqlDbType.NVarChar).Value = "";
                        cmd2.Parameters.Add("@txtface_baking_name", SqlDbType.NVarChar).Value = "";
                        cmd2.Parameters.Add("@txtface_baking_name_eng", SqlDbType.NVarChar).Value = "";
                        cmd2.Parameters.Add("@txtface_baking_remark", SqlDbType.NVarChar).Value = "";
                        cmd2.Parameters.Add("@txtface_baking_status", SqlDbType.NChar).Value = "0";
                        //==============================
