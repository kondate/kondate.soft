...
namespace kondate.soft.HOME03_Production
{
    public partial class HOME03_Production_03Produce_record_detail : Form
    {
        ...
        private void HOME03_Production_03Produce_record_detail_Load(object sender, EventArgs e)
        {
            ...
            this.iblword_status.Text = "ดูข้อมูลFG1 ผ้าดิบ";
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        ...
                        //this.txtsum_qty_ic.Text = Convert.ToSingle(dt2.Rows[0]["txtsum_qty_ic"]).ToString("###,###.00");
                        //this.txtsum_qty_yes.Text = Convert.ToSingle(dt2.Rows[0]["txtsum_qty"]).ToString("###,###.00");
                        //this.txtsum_qty_change.Text = Convert.ToSingle(dt2.Rows[0]["txtsum_qty_change"]).ToString("###,###.00");
                        //this.txtsum_qty_change_rate.Text = Convert.ToSingle(dt2.Rows[0]["txtsum_qty_change_rate"]).ToString("###,###.00");
                        ...
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                           ...
                           GridView1.Rows[index].Cells["Col_mat_status"].Value = "0";
                            ...
                            GridView1.Rows[index].Cells["Col_txtic_id"].Value = dt2.Rows[j]["txtic_id"].ToString();      //37

                            GridView1.Rows[index].Cells["Col_2"].Value = "0";
        ...
        private void Show_GridView1()
        {
            ...
            this.GridView1.Columns[50].Visible = true;
        ...
        private void GridView1_Color_Column()
        {
            ...
            for (int i = 0; i < this.GridView1.Rows.Count - 0; i++)
            {
                ...
                GridView1.Rows[i].Cells["Col_txtqty"].Style.BackColor = Color.LightGreen;
                GridView1.Rows[i].Cells["Col_txtitem_no"].Style.BackColor = Color.LightSkyBlue;

                GridView1.Rows[i].Cells["Col_txtlot_no"].Style.BackColor = Color.LightGoldenrodYellow;
                GridView1.Rows[i].Cells["Col_txtqty_cut"].Style.BackColor = Color.LightGreen;
                GridView1.Rows[i].Cells["Col_txtqty_after_cut"].Style.BackColor = Color.LightSkyBlue;
                GridView1.Rows[i].Cells["Col_txtcut_id"].Style.BackColor = Color.LightGreen;
            ...
            for (int i = 0; i < this.GridView1.Rows.Count; i++)
            {
                ...
                if (conn.State == System.Data.ConnectionState.Open)
                {
                    ...
                    cmd2.CommandText = "SELECT c002_05Send_dye_record.*," +
                                       ...
                                       " AND (c002_05Send_dye_record_detail.txtLot_no = '" + this.GridView1.Rows[i].Cells["Col_txtlot_no"].Value.ToString() + "')" +
                                       " AND (c002_05Send_dye_record_detail.txtmat_id = '" + this.GridView1.Rows[i].Cells["Col_txtmat_id"].Value.ToString() + "')" +
                    ...
                    try
                    {
                        ...
                        if (dt2.Rows.Count > 0)
                        {
                            ...
                            for (int j = 0; j < dt2.Rows.Count; j++)
                            {
                                ...
                                MessageBox.Show("Lot no :   " + dt2.Rows[j]["txtLot_no"].ToString() + "    นี้ มีการเบิก ส่งย้อม ไปแล้ว ไม่สามารถยกเลิกรายการได้ !!! ");
                                return;
        ...
        cmd2.CommandText = "UPDATE k021_mat_average SET " +
                    ...
                    cmd2.CommandText = "INSERT INTO k021_mat_average_balance(cdkey,txtco_id,txtbranch_id," +  //1
                            ...
                            "'ICRF'," +  //9 txtbill_type
                            "'ยกเลิก FG1 " + this.PANEL0104_PRODUCE_TYPE_txtproduce_type_name.Text.Trim() + "'," +  //9 txtbill_remark
