...
{
    public partial class HOME03_Production_03Produce_record_detail : Form
    {
        //Move Form ====================================
        ...
        public HOME03_Production_03Produce_record_detail()
        {
            InitializeComponent();
        }

        private void HOME03_Production_03Produce_record_detail_Load(object sender, EventArgs e)
        {
            this.WindowState = FormWindowState.Maximized;
            this.btnmaximize.Visible = false;
            this.btnmaximize_full.Visible = true;

            W_ID_Select.M_FORM_NUMBER = "H0303ICRFDL";
            CHECK_ADD_FORM();
            ...
            this.iblword_status.Text = "ดูข้อมูลใบผลิต";
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        ...
                        this.txticrf_id.Text = dt2.Rows[0]["txticrf_id"].ToString();
                        ...
                        this.PANEL0104_PRODUCE_TYPE_txtproduce_type_id.Text = dt2.Rows[0]["txtproduce_type_id"].ToString();
                        this.PANEL0104_PRODUCE_TYPE_txtproduce_type_name.Text = dt2.Rows[0]["txtproduce_type_name"].ToString();
                        ...
                        this.txticrf_remark.Text = dt2.Rows[0]["txticrf1_remark"].ToString();
                        ...
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            GridView1.Rows[index].Cells["Col_txttrans_time_start"].Value = dt2.Rows[j]["txttrans_time_start"].ToString();      //5
                            GridView1.Rows[index].Cells["Col_txttrans_time_end"].Value = dt2.Rows[j]["txttrans_time_end"].ToString();      //6

                            GridView1.Rows[index].Cells["Col_Problem1"].Value = Convert.ToSingle(dt2.Rows[j]["Problem1"]).ToString("###,##0");      //7
                            GridView1.Rows[index].Cells["Col_Problem2"].Value = Convert.ToSingle(dt2.Rows[j]["Problem2"]).ToString("###,##0");      //8
                            GridView1.Rows[index].Cells["Col_Problem3"].Value = Convert.ToSingle(dt2.Rows[j]["Problem3"]).ToString("###,##0");      //9
                            GridView1.Rows[index].Cells["Col_Problem4"].Value = Convert.ToSingle(dt2.Rows[j]["Problem4"]).ToString("###,##0");      //10

                            GridView1.Rows[index].Cells["Col_txtemp_id"].Value = dt2.Rows[j]["txtemp_id"].ToString();      //11
                            GridView1.Rows[index].Cells["Col_txtemp_name"].Value = dt2.Rows[j]["txtemp_name"].ToString();      //12
                            GridView1.Rows[index].Cells["Col_txtshift_name"].Value = dt2.Rows[j]["txtshift_name"].ToString();      //13


                            GridView1.Rows[index].Cells["Col_txticrf_remark"].Value = dt2.Rows[j]["txticrf_remark"].ToString();      //14
                            ...
                            GridView1.Rows[index].Cells["Col_txtnumber_mat_name"].Value = dt2.Rows[j]["txtnumber_mat_name"].ToString();      //18
                            ...
                            GridView1.Rows[index].Cells["Col_txtcost_qty_balance_yokma"].Value = Convert.ToSingle(dt2.Rows[j]["txtcost_qty_balance_yokma"]).ToString("###,###.00");      //29
                            GridView1.Rows[index].Cells["Col_txtcost_qty_price_average_yokma"].Value = Convert.ToSingle(dt2.Rows[j]["txtcost_qty_price_average_yokma"]).ToString("###,###.00");      //30
                            GridView1.Rows[index].Cells["Col_txtcost_money_sum_yokma"].Value = Convert.ToSingle(dt2.Rows[j]["txtcost_money_sum_yokma"]).ToString("###,###.00");      //31

                            GridView1.Rows[index].Cells["Col_txtcost_qty_balance_yokpai"].Value = Convert.ToSingle(dt2.Rows[j]["txtcost_qty_balance_yokpai"]).ToString("###,###.00");      //32
                            GridView1.Rows[index].Cells["Col_txtcost_qty_price_average_yokpai"].Value = Convert.ToSingle(dt2.Rows[j]["txtcost_qty_price_average_yokpai"]).ToString("###,###.00");      //33
                            GridView1.Rows[index].Cells["Col_txtcost_money_sum_yokpai"].Value = Convert.ToSingle(dt2.Rows[j]["txtcost_money_sum_yokpai"]).ToString("###,###.00");      //34

                            GridView1.Rows[index].Cells["Col_txtcost_qty2_balance_yokma"].Value = Convert.ToSingle(dt2.Rows[j]["txtcost_qty2_balance_yokma"]).ToString("###,###.00");      //35
                            GridView1.Rows[index].Cells["Col_txtcost_qty2_balance_yokpai"].Value = Convert.ToSingle(dt2.Rows[j]["txtcost_qty2_balance_yokpai"]).ToString("###,###.00");      //36

                            GridView1.Rows[index].Cells["Col_txtitem_no"].Value = dt2.Rows[j]["txtitem_no"].ToString();      //37

                            //GridView1.Rows[index].Cells["Col_txtqc_status"].Value = dt2.Rows[j]["txtqc_status"].ToString();     //38
                            if (dt2.Rows[j]["txtqc_status"].ToString() == "0")
                            {
                                GridView1.Rows[index].Cells["Col_txtqc_status"].Value = "QC แล้ว";
                            }
                            GridView1.Rows[index].Cells["Col_txtqc_id"].Value = dt2.Rows[j]["txtqc_id"].ToString();     //39

                            //GridView1.Rows[index].Cells["Col_txtppt_status"].Value = dt2.Rows[j]["txtppt_status"].ToString();     //40
                            if (dt2.Rows[j]["txtppt_status"].ToString() == "0")
                            {
                                GridView1.Rows[index].Cells["Col_txtppt_status"].Value = "ส่งย้อม แล้ว";
                            }
                            GridView1.Rows[index].Cells["Col_txtppt_id"].Value = dt2.Rows[j]["txtppt_id"].ToString();     //41
        ...
        private void Show_GridView1()
        {
            ...
            this.GridView1.Columns[18].Name = "Col_txtnumber_mat_name";
            ...
            this.GridView1.Columns[38].HeaderText = "QC สถานะ";
            this.GridView1.Columns[39].HeaderText = "QC ID";
            this.GridView1.Columns[40].HeaderText = "ส่งย้อมสถานะ";
            this.GridView1.Columns[41].HeaderText = "ส่งย้อม ID";
            this.GridView1.Columns[42].HeaderText = "Lot No";
            ...
            this.GridView1.Columns["Col_txttrans_time_end"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            ...
            this.GridView1.Columns["Col_Problem1"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            ...
            this.GridView1.Columns["Col_Problem2"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            ...
            this.GridView1.Columns["Col_Problem3"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            ...
            this.GridView1.Columns["Col_Problem4"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            ...
            this.GridView1.Columns["Col_txtmat_name"].Visible = false;  //"Col_txtmat_name";
            this.GridView1.Columns["Col_txtmat_name"].Width = 0;
            ...
            this.GridView1.Columns["Col_txtqty2"].Width = 120;
            ...
            this.GridView1.Columns["Col_txtqc_status"].Visible = true;  //"Col_txtqc_status";
            this.GridView1.Columns["Col_txtqc_status"].Width = 80;
            this.GridView1.Columns["Col_txtqc_status"].ReadOnly = true;
            this.GridView1.Columns["Col_txtqc_status"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.GridView1.Columns["Col_txtqc_status"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;

            this.GridView1.Columns["Col_txtqc_id"].Visible = true;  //"Col_txtqc_id";
            this.GridView1.Columns["Col_txtqc_id"].Width = 120;
            ...
            this.GridView1.Columns["Col_txtppt_id"].Width = 120;
        ...
        private void BtnCancel_Doc_Click(object sender, EventArgs e)
        {
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                cmd1.CommandText = "SELECT * FROM c002_02produce_record" +
                                    " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                    " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                    " AND (txticrf_id = '" + this.txticrf_id.Text.Trim() + "')" +
                                    " AND (txticrf_status = '1')";
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    MessageBox.Show("เอกสารนี้   : '" + this.txticrf_id.Text.Trim() + "' ยกเลิกไปแล้ว ", "ผลการทำงาน", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                    conn.Close();
                    return;
                }
            }
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                try
                {
                    ...
                    if (this.iblword_status.Text.Trim() == "ยกเลิกเอกสาร")
                    {
                        ...
                        cmd2.CommandText = "INSERT INTO c002_02produce_record_cancel(cdkey,txtco_id,txtbranch_id," +  //1
                                                                                                                           //"txttrans_date," +
                        ...
                        //2
                        cmd2.CommandText = "UPDATE c002_02produce_record" +
                                                                    " SET txticrf_status = '1'" +
                                                                    " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                                                    " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                                                   " AND (txticrf_id = '" + this.txticrf_id.Text.Trim() + "')";
                        cmd2.ExecuteNonQuery();
                    ...
                    DialogResult dialogResult = MessageBox.Show("คุณต้องการ ยกเลิกเอกสาร รหัส  " + this.txticrf_id.Text.ToString() + " ใช่หรือไม่่ ?", "โปรดยืนยัน", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question);
