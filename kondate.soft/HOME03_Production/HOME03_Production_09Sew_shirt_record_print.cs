...
{
    public partial class HOME03_Production_09Sew_shirt_record_print : Form
    {
        //Move Form ====================================
        ...
        public HOME03_Production_09Sew_shirt_record_print()
        {
            InitializeComponent();
        }

        private void HOME03_Production_09Sew_shirt_record_print_Load(object sender, EventArgs e)
        {
            ...
            rpt.SetParameterValue("txtsew_id", W_ID_Select.TRANS_ID.Trim());
