...
{
    public partial class HOME03_Production_14Machine : Form
    {
        //Move Form ====================================
        ...
        public HOME03_Production_14Machine()
        {
            InitializeComponent();
        }

        private void HOME03_Production_14Machine_Load(object sender, EventArgs e)
        {
            W_ID_Select.M_FORM_NUMBER = "H0314SP";
            CHECK_ADD_FORM();
            ...
            this.iblword_status.Text = "เพิ่มรหัสเครื่องจักรใหม่";
            this.txtmachine_id.ReadOnly = false;

            this.ActiveControl = this.txtmachine_id;
        ...
        private void Run_ID()
        {
            if (this.txtmachine_no.Text == "")
            {
                this.txtmachine_no.Text = "001";
            }
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            GridView1.Rows[index].Cells["Col_txtmachine_no"].Value = dt2.Rows[j]["txtmachine_no"].ToString();      //1
                            GridView1.Rows[index].Cells["Col_txtmachine_id"].Value = dt2.Rows[j]["txtmachine_id"].ToString();      //2
                            GridView1.Rows[index].Cells["Col_txtmachine_name"].Value = dt2.Rows[j]["txtmachine_name"].ToString();      //3
                            GridView1.Rows[index].Cells["Col_txtmachine_name_eng"].Value = dt2.Rows[j]["txtmachine_name_eng"].ToString();      //4
                            GridView1.Rows[index].Cells["Col_txtmachine_remark"].Value = dt2.Rows[j]["txtmachine_remark"].ToString();      //5
                            GridView1.Rows[index].Cells["Col_txtmachine_type_id"].Value = dt2.Rows[j]["txtmachine_type_id"].ToString();      //6
                            GridView1.Rows[index].Cells["Col_txtmachine_type_name"].Value = dt2.Rows[j]["txtmachine_type_name"].ToString();      //7
                            GridView1.Rows[index].Cells["Col_txtmachine_status"].Value = dt2.Rows[j]["txtmachine_status"].ToString();      //8
        ...
        private void PANEL_FORM1_GridView1()
        {
            ...
            this.GridView1.Columns[1].Name = "Col_txtmachine_no";
            this.GridView1.Columns[2].Name = "Col_txtmachine_id";
            this.GridView1.Columns[3].Name = "Col_txtmachine_name";
            this.GridView1.Columns[4].Name = "Col_txtmachine_name_eng";
            this.GridView1.Columns[5].Name = "Col_txtmachine_remark";
            this.GridView1.Columns[6].Name = "Col_txtmachine_type_id";
            this.GridView1.Columns[7].Name = "Col_txtmachine_type_name";
            this.GridView1.Columns[8].Name = "Col_txtmachine_status";

            this.GridView1.Columns[0].HeaderText = "No";
            this.GridView1.Columns[1].HeaderText = "ลำดับ";
            this.GridView1.Columns[2].HeaderText = " รหัส";
            this.GridView1.Columns[3].HeaderText = " ชื่อรหัสเครื่องจักร";
            this.GridView1.Columns[4].HeaderText = "ชื่อรหัสเครื่องจักร Eng";
            this.GridView1.Columns[5].HeaderText = " หมายเหตุ";
            this.GridView1.Columns[6].HeaderText = " รหัสประเภทเครื่องจักร";
            this.GridView1.Columns[7].HeaderText = " ชื่อประเภทเครื่องจักร";
            this.GridView1.Columns[8].HeaderText = " สถานะ";

            this.GridView1.Columns[0].Visible = false;  //"No";
            this.GridView1.Columns[1].Visible = true;  //"Col_txtmachine_no";
            ...
            this.GridView1.Columns[2].Visible = true;  //"Col_txtmachine_id";
            ...
            this.GridView1.Columns[3].Visible = true;  //"Col_txtmachine_name";
            ...
            this.GridView1.Columns[4].Visible = true;  //"Col_txtmachine_name_eng";
            ...
            this.GridView1.Columns[5].Visible = true;  //"Col_txtmachine_name_remark";
            ...
            this.GridView1.Columns[6].Visible = true;  //"Col_txtmachine_type_id";
            ...
            this.GridView1.Columns[7].Visible = true;  //"Col_txtmachine_type_name";
            ...
            this.GridView1.Columns[8].Visible = false;  //"Col_txtmachine_status";
        ...
        private void PANEL_FORM1_dataGridView1_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                if (cell != null)
                {
                    ...
                    this.txtmachine_no.Text = row.Cells[1].Value.ToString();
                    this.txtmachine_id.Text = row.Cells[2].Value.ToString();
                    this.txtmachine_name.Text = row.Cells[3].Value.ToString();
                    ...
                    if (conn.State == System.Data.ConnectionState.Open)
                    {
                        ...
                        cmd2.CommandText = "SELECT c001_02machine.*," +
                                            ...
                                            " WHERE (c001_02machine.cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                            " AND (c001_02machine.txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                            " AND (c001_02machine.txtmachine_id = '" + this.txtmachine_id.Text.Trim() + "')" +
                                            " ORDER BY c001_02machine.txtmachine_no ASC";
                        ...
                        try
                        {
                            ...
                            if (dt2.Rows.Count > 0)
                            {
                                for (int j = 0; j < dt2.Rows.Count; j++)
                                {
                                    this.txtmachine_no.Text = dt2.Rows[j]["txtmachine_no"].ToString();      //1
                                    this.txtmachine_id.Text = dt2.Rows[j]["txtmachine_id"].ToString();      //2
                                    this.PANEL0101_MACHINE_TYPE_txtmachine_type_id.Text = dt2.Rows[j]["txtmachine_type_id"].ToString();      //3
                                    this.PANEL0101_MACHINE_TYPE_txtmachine_type_name.Text = dt2.Rows[j]["txtmachine_type_name"].ToString();      //4
                                    this.txtmachine_name.Text = dt2.Rows[j]["txtmachine_name"].ToString();      //5
                                    this.txtmachine_name_eng.Text = dt2.Rows[j]["txtmachine_name_eng"].ToString();      //6
                                    this.txtmachine_remark.Text = dt2.Rows[j]["txtmachine_remark"].ToString();      //7
                                }
                                this.iblword_status.Text = "แก้ไขรหัสเครื่องจักร";
        ...
        private void PANEL_FORM1_btnsearch_Click(object sender, EventArgs e)
        {
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                cmd2.CommandText = "SELECT c001_02machine.*," +
                                    ...
                                    " WHERE (c001_02machine.cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                    " AND (c001_02machine.txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                    " AND (c001_02machine.txtmachine_name LIKE '%" + this.PANEL_FORM1_txtsearch.Text.Trim() + "%')" +
                                    " ORDER BY c001_02machine.txtmachine_no ASC";
        ...
        private void BtnNew_Click(object sender, EventArgs e)
        {
            ...
            this.Hide();
            var frm2 = new HOME03_Production_14Machine();
        ...
        private void BtnSave_Click(object sender, EventArgs e)
        {
            if (this.txtmachine_no.Text == "")
            {
                ...
                this.txtmachine_no.Focus();
                return;
            }
            else
            {
                if (this.txtmachine_no.TextLength == 3)
                {
                }
                else
                {
            ...
            if (this.txtmachine_id.Text == "")
            {
                MessageBox.Show("โปรดใส่รหัสเครื่องจักร ก่อน !", "ผลการทำงาน", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                this.txtmachine_id.Focus();
                return;
            }
            if (this.txtmachine_name.Text == "")
            {
                MessageBox.Show("โปรดใส่ชื่อเครื่องจักรก่อน !", "ผลการทำงาน", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                this.txtmachine_name.Focus();
                return;
            }

            if (this.PANEL0101_MACHINE_TYPE_txtmachine_type_id.Text == "")
            {
                MessageBox.Show("โปรดใส่รหัสประเภทเครื่องจักร ก่อน !", "ผลการทำงาน", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                this.PANEL0101_MACHINE_TYPE_txtmachine_type_id.Focus();
                return;
            }
            if (this.PANEL0101_MACHINE_TYPE_txtmachine_type_name.Text == "")
            {
                MessageBox.Show("โปรดใส่ชื่อประเภทเครื่องจักรก่อน !", "ผลการทำงาน", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            ...
            //END เชื่อมต่อฐานข้อมูล=======================================================
            Cursor.Current = Cursors.WaitCursor;
            if (this.iblword_status.Text.Trim() == "เพิ่มรหัสเครื่องจักรใหม่")
            {
                conn.Open();
                if (conn.State == System.Data.ConnectionState.Open)
                {
                    ...
                    cmd1.CommandText = "SELECT * FROM c001_02machine" +
                                        " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                       " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                       " AND (txtmachine_id = '" + this.txtmachine_id.Text.Trim() + "')";
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        MessageBox.Show("รหัสเครื่องจักร นี้ซ้ำ   : '" + this.txtmachine_id.Text.Trim() + "' โปรดใส่ใหม่ ", "ผลการทำงาน", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                        this.txtmachine_id.Focus();
                        conn.Close();
                        return;
                    }
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                try
                {
                    if (this.iblword_status.Text.Trim() == "เพิ่มรหัสเครื่องจักรใหม่")
                    {
                        cmd2.CommandText = "INSERT INTO c001_02machine(cdkey,txtco_id," +  //1
                                           "txtmachine_no,txtmachine_id," +  //2
                                           "txtmachine_name,txtmachine_name_eng," +  //3
                                          "txtmachine_remark," +  //5
                                          "txtmachine_status,txtmachine_type_id) " +  //6
                        ...
                        cmd2.Parameters.Add("@txtmachine_no", SqlDbType.NVarChar).Value = this.txtmachine_no.Text.ToString();
                        cmd2.Parameters.Add("@txtmachine_id", SqlDbType.NVarChar).Value = this.txtmachine_id.Text.ToString();
                        cmd2.Parameters.Add("@txtmachine_name", SqlDbType.NVarChar).Value = this.txtmachine_name.Text.ToString();
                        cmd2.Parameters.Add("@txtmachine_name_eng", SqlDbType.NVarChar).Value = this.txtmachine_name_eng.Text.ToString();
                        cmd2.Parameters.Add("@txtmachine_remark", SqlDbType.NVarChar).Value = this.txtmachine_remark.Text.ToString();
                        cmd2.Parameters.Add("@txtmachine_status", SqlDbType.NChar).Value = "0";
                        cmd2.Parameters.Add("@txtmachine_type_id", SqlDbType.NVarChar).Value = this.PANEL0101_MACHINE_TYPE_txtmachine_type_id.Text.ToString();
                        //==============================

                        cmd2.ExecuteNonQuery();

                    }
                    if (this.iblword_status.Text.Trim() == "แก้ไขรหัสเครื่องจักร")
                    {
                        cmd2.CommandText = "UPDATE c001_02machine SET " +
                                                                     "txtmachine_no = '" + this.txtmachine_no.Text.Trim() + "'," +
                                                                     "txtmachine_type_id = '" + this.PANEL0101_MACHINE_TYPE_txtmachine_type_id.Text.Trim() + "'," +
                                                                     "txtmachine_name = '" + this.txtmachine_name.Text.Trim() + "'," +
                                                                     "txtmachine_name_eng = '" + this.txtmachine_name_eng.Text.Trim() + "'," +
                                                                     "txtmachine_remark = '" + this.txtmachine_remark.Text.ToString() + "'" +
                                                                    " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                                                   //" AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                                                   " AND (txtmachine_id = '" + this.txtmachine_id.Text.Trim() + "')";
                        cmd2.ExecuteNonQuery();
                    ...
                    if (dialogResult == DialogResult.Yes)
                    {
                        ...
                        this.txtmachine_id.Text = "";
                        this.PANEL0101_MACHINE_TYPE_txtmachine_type_id.Text = "";
                        this.PANEL0101_MACHINE_TYPE_txtmachine_type_name.Text = "";
                        this.txtmachine_name.Text = "";
                        this.txtmachine_name_eng.Text = "";
                        this.txtmachine_remark.Text = "";
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                try
                {
                    if (this.iblword_status.Text.Trim() == "ยกเลิกเอกสาร")
                    {
                        ...
                        cmd2.CommandText = "INSERT INTO c001_02machine_cancel(cdkey,txtco_id,txtbranch_id," +  //1
                                                                                                                          //"txttrans_date," +
                        ...
                        cmd2.CommandText = "INSERT INTO c001_02machine_cancel_detail(cdkey,txtco_id," +  //1
                                             "txtmachine_no,txtmachine_id," +  //2
                                             "txtmachine_name,txtmachine_name_eng," +  //3
                                             "txtmachine_remark," +  //4
                                            "txtmachine_status,txtmachine_type_id,cancel_id) " +  //5
                                             "VALUES (@cdkey2,@txtco_id2," +  //1
                                             "@txtmachine_no,@txtmachine_id," +  //2
                                             "@txtmachine_name,@txtmachine_name_eng," +  //3
                                             "@txtmachine_remark," +  //4
                                            "@txtmachine_status,@txtmachine_type_id,@cancel_id2)";   //5
                        ...
                        cmd2.CommandText = "DELETE FROM c001_02machine" +
                                                                    " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                                                    " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                                                   " AND (txtmachine_id = '" + this.txtmachine_id.Text.Trim() + "')";
                        cmd2.ExecuteNonQuery();
                    ...
                    DialogResult dialogResult = MessageBox.Show("คุณต้องการ ยกเลิกเอกสาร รหัส  " + this.txtmachine_id.Text.ToString() + " ใช่หรือไม่่ ?", "โปรดยืนยัน", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question);
                    if (dialogResult == DialogResult.Yes)
                    {
        ...
        private void txtmachine_id_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            if (e.KeyChar == (char)Keys.Enter && this.txtmachine_id.Text == "")
            {
                this.txtmachine_id.Focus();
            }
            //========================================
            else if (e.KeyChar == (char)Keys.Enter && this.txtmachine_id.Text.Trim() != "")
            {
                this.txtmachine_no.Focus();
        ...
        private void txtmachine_no_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == (char)Keys.Enter && this.txtmachine_no.Text == "")
            {
                this.txtmachine_no.Focus();
            }
            //========================================
            else if (e.KeyChar == (char)Keys.Enter && this.txtmachine_no.Text.Trim() != "")
            {
                if (this.txtmachine_no.TextLength == 3)
                {
                    this.txtmachine_name.Focus();
            ...
            else if ((e.KeyChar > '9') && (e.KeyChar != '\b') && (e.KeyChar != '.') && txtmachine_no.Text.Length == 0)
            {
                //e.KeyChar <= '0' || 
                e.Handled = true;
                return;
        ...
        private void txtmachine_name_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
                this.txtmachine_name_eng.Focus();

        }
        private void txtmachine_name_eng_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
                this.txtmachine_remark.Focus();

        }
        private void txtmachine_name_remark_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
                this.BtnSave.Focus();
        ...
        private void CHECK_UP_NO999()
        {
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                cmd1.CommandText = "SELECT c001_02machine.*," +
                                    "c001_01machine_type.*" +
                                    " FROM c001_02machine" +
                                    " INNER JOIN c001_01machine_type" +
                                    " ON c001_02machine.cdkey = c001_01machine_type.cdkey" +
            ...
            if (OK.Trim() != "Y")
            {
                ...
                if (conn.State == System.Data.ConnectionState.Open)
                {
                    ...
                    try
                    {
                        ...
                        cmd2.Parameters.Add("@cdkey", SqlDbType.NVarChar).Value = W_ID_Select.CDKEY.Trim();
                        cmd2.Parameters.Add("@txtco_id", SqlDbType.NVarChar).Value = W_ID_Select.M_COID.Trim();
                        cmd2.Parameters.Add("@txtmachine_no", SqlDbType.NVarChar).Value = "999";
                        cmd2.Parameters.Add("@txtmachine_id", SqlDbType.NVarChar).Value = "";
                        cmd2.Parameters.Add("@txtmachine_name", SqlDbType.NVarChar).Value = "";
                        cmd2.Parameters.Add("@txtmachine_name_eng", SqlDbType.NVarChar).Value = "";
                        cmd2.Parameters.Add("@txtmachine_remark", SqlDbType.NVarChar).Value = "";
                        cmd2.Parameters.Add("@txtmachine_status", SqlDbType.NChar).Value = "0";
                        cmd2.Parameters.Add("@txtmachine_type_id", SqlDbType.NVarChar).Value = "";
