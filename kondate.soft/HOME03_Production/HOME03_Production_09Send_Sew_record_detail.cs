            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        ...
                        this.cbotxtsend_sew_cut_type_name.Text = dt2.Rows[0]["txtsend_sew_cut_type_name"].ToString();
                        ...
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            GridView1.Rows[index].Cells["Col_txtFG3_id"].Value = dt2.Rows[j]["txtqc_id"].ToString();      //1
