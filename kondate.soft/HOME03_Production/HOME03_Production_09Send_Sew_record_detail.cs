...
{
    public partial class HOME03_Production_09Send_Sew_record_detail : Form
    {
        //Move Form ====================================
        ...
        public HOME03_Production_09Send_Sew_record_detail()
        {
            InitializeComponent();
        }
        ...
        private void HOME03_Production_05Send_Dye_record_detail_Load(object sender, EventArgs e)
        {
            ...
            W_ID_Select.M_FORM_NUMBER = "H039SWDL";
            CHECK_ADD_FORM();
            ...
            this.iblword_status.Text = "ดูข้อมูลใบส่งผ้าเย็บ";
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        ...
                        this.txtSWT_id.Text = dt2.Rows[0]["txtSWT_id"].ToString();
                        this.txtsend_sew_cut_type_id.Text = dt2.Rows[0]["txtsend_sew_cut_type_id"].ToString();

                        if (this.txtsend_sew_cut_type_id.Text == "01")
                        {
                            this.cbotxtsend_sew_cut_type_name.Text = "โรงงานเย็บเอง";
                        }
                        else
                        {
                            this.cbotxtsend_sew_cut_type_name.Text = "จ้าง Supplier เย็บ";
                        ...
                        this.txtSWT_record_remark.Text = dt2.Rows[0]["txtSWT_record_remark"].ToString();
                        ...
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            this.GridView1.Rows[index].Cells["Col_txtFG3_id"].Value = dt2.Rows[j]["txtqc_id"].ToString();      //1

                            this.GridView1.Rows[index].Cells["Col_txtsum_qty_tier"].Value = Convert.ToSingle(dt2.Rows[j]["txtsum_qty_tier"]).ToString("###,###.0");//dt2.Rows[j]["txtsum_qty_tier"].ToString();      //16
                            this.GridView1.Rows[index].Cells["Col_txtsum_qty_body_per_tier"].Value = Convert.ToSingle(dt2.Rows[j]["txtsum_qty_body_per_tier"]).ToString("###,###.0");//dt2.Rows[j]["txtsum_qty_body_per_tier"].ToString();       //16
                            this.GridView1.Rows[index].Cells["Col_txtqty"].Value = Convert.ToSingle(dt2.Rows[j]["txtsum_qty_body"]).ToString("###,###.0");//dt2.Rows[j]["txtsum_qty_body"].ToString();       //16

                            this.GridView1.Rows[index].Cells["Col_txtsupplier_id"].Value = dt2.Rows[j]["txtsupplier_id"].ToString();     //7
                            ...
                            this.GridView1.Rows[index].Cells["Col_txtnumber_color_id"].Value = dt2.Rows[j]["txtnumber_color_id"].ToString();         //3
                            this.GridView1.Rows[index].Cells["Col_txtnumber_sup_color_id"].Value = dt2.Rows[j]["txtnumber_sup_color_id"].ToString();        //3
                            this.GridView1.Rows[index].Cells["Col_txtnumber_dyed"].Value = dt2.Rows[j]["txtnumber_dyed"].ToString();        //3
                            this.GridView1.Rows[index].Cells["Col_txtnumber_mat_id"].Value = dt2.Rows[j]["txtnumber_mat_id"].ToString();        //3

                            this.GridView1.Rows[index].Cells["Col_txtmat_no"].Value = dt2.Rows[j]["txtmat_no"].ToString();      //15
                            this.GridView1.Rows[index].Cells["Col_txtmat_id"].Value = dt2.Rows[j]["txtmat_id"].ToString();      //16
                            this.GridView1.Rows[index].Cells["Col_txtmat_name"].Value = dt2.Rows[j]["txtmat_name"].ToString();      //17

                            this.GridView1.Rows[index].Cells["Col_txtmat_unit1_name"].Value = dt2.Rows[j]["txtmat_unit1_name"].ToString();      //19
                            this.GridView1.Rows[index].Cells["Col_txtmat_unit1_qty"].Value = Convert.ToSingle(dt2.Rows[j]["txtmat_unit1_qty"]).ToString("###,###.00");      //20
                            this.GridView1.Rows[index].Cells["Col_chmat_unit_status"].Value = dt2.Rows[j]["chmat_unit_status"].ToString();      //21
                            this.GridView1.Rows[index].Cells["Col_txtmat_unit2_name"].Value = dt2.Rows[j]["txtmat_unit2_name"].ToString();      //22
                            this.GridView1.Rows[index].Cells["Col_txtmat_unit2_qty"].Value = Convert.ToSingle(dt2.Rows[j]["txtmat_unit2_qty"]).ToString("###,###.0000");      //23
        ...
        private void Show_GridView1()
        {
            ...
            this.GridView1.Columns[1].HeaderText = "เลขที่ ส่งเย็บ";
        ...
        private void GridView1_Color_Column()
        {
            ...
            for (int i = 0; i < this.GridView1.Rows.Count - 0; i++)
            {
                ...
                GridView1.Rows[i].Cells["Col_txtqty"].Style.BackColor = Color.GreenYellow;
        ...
        private void BtnNew_Click(object sender, EventArgs e)
        {
            ...
            this.iblword_status.Text = "บันทึกใบส่งผ้าเย็บ";
        ...
        private void BtnCancel_Doc_Click(object sender, EventArgs e)
        {
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                cmd1.CommandText = "SELECT * FROM c002_09Send_Sew_shirt_record" +
                                    " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                    " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    MessageBox.Show("เอกสารนี้   : '" + this.txtSWT_id.Text.Trim() + "' ยกเลิกไปแล้ว ", "ผลการทำงาน", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                    conn.Close();
                    return;
                }
            }
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                try
                {
                    ...
                    if (this.iblword_status.Text.Trim() == "ยกเลิกเอกสาร")
                    {
                        ...
                        cmd2.CommandText = "INSERT INTO c002_09Send_Sew_shirt_record_cancel(cdkey,txtco_id,txtbranch_id," +  //1
                                                                                                                           //"txttrans_date," +
                        ...
                        //2
                        cmd2.CommandText = "UPDATE c002_09Send_Sew_shirt_record" +
                                                                    " SET txtSWT_status = '1'," +
                        ...
                        if (valu != "")
                        {
                            if (Convert.ToDouble(string.Format("{0:n4}", this.GridView2.Rows[i].Cells["Col_txtsum_qty"].Value.ToString())) > 0)
                            {
                                ...
                                cmd2.CommandText = "INSERT INTO k021_mat_average_balance(cdkey,txtco_id,txtbranch_id," +  //1
                                        ...
                                        "'SWT'," +  //9 txtbill_type
                                        "'ยกเลิก ส่งเย็บ " + this.txtSWT_record_remark.Text.Trim() + "'," +  //9 txtbill_remark
                    ...
                    DialogResult dialogResult = MessageBox.Show("คุณต้องการ ยกเลิกเอกสาร รหัส  " + this.txtSWT_id.Text.ToString() + " ใช่หรือไม่่ ?", "โปรดยืนยัน", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question);
