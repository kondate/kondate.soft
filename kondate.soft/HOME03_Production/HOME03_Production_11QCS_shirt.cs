...
{
    public partial class HOME03_Production_11QCS_shirt : Form
    {
        //Move Form ====================================
        ...
        public HOME03_Production_11QCS_shirt()
        {
            InitializeComponent();
        }

        private void HOME03_Production_11QCS_shirt_Load(object sender, EventArgs e)
        {
            ...
            this.iblword_status.Text = "ระเบียนใบจัดเก็บจำนวน คิวซี";
            ...
            //========================================
            this.cboSearch.Items.Add("เลขที่ใบจัดเก็บจำนวน คิวซี");
            this.cboSearch.Items.Add("ชื่อผู้บันทึกใบจัดเก็บจำนวน คิวซี");
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        ...
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            this.GridView1.Rows[index].Cells["Col_txtQCS_id"].Value = dt2.Rows[j]["txtQCS_id"].ToString();      //3
                            ...
                            this.GridView1.Rows[index].Cells["Col_txtqcs_remark"].Value = dt2.Rows[j]["txtqcs_remark"].ToString();      //6

                            this.GridView1.Rows[index].Cells["Col_txtsum_qty_qcs"].Value = Convert.ToSingle(dt2.Rows[j]["txtsum_qty_qcs"]).ToString("###,###.00");      //7

                            //SEW ==============================
                            if (dt2.Rows[j]["txtqcs_status"].ToString() == "")
                            {
                                this.GridView1.Rows[index].Cells["Col_txtqcs_status"].Value = ""; //8
                            }
                            else if (dt2.Rows[j]["txtqcs_status"].ToString() == "0")
                            {
                                this.GridView1.Rows[index].Cells["Col_txtqcs_status"].Value = ""; //8
                            }
                            else if (dt2.Rows[j]["txtqcs_status"].ToString() == "1")
                            {
                                this.GridView1.Rows[index].Cells["Col_txtqcs_status"].Value = "ยกเลิก"; //8
                            }
        ...
        private void Show_GridView1()
        {
            ...
            this.GridView1.Columns[3].Name = "Col_txtQCS_id";
            this.GridView1.Columns[4].Name = "Col_txttrans_date_server";
            this.GridView1.Columns[5].Name = "Col_txttrans_time";
            this.GridView1.Columns[6].Name = "Col_txtqcs_remark";
            this.GridView1.Columns[7].Name = "Col_txtsum_qty_qcs";

            this.GridView1.Columns[8].Name = "Col_txtqcs_status";  //
            this.GridView1.Columns[9].Name = "Col_txtfg_id";   //
            ...
            this.GridView1.Columns[3].HeaderText = " เลขที่ใบจัดเก็บจำนวน คิวซี";
            ...
            this.GridView1.Columns[7].HeaderText = "จำนวนคิวซี";
            this.GridView1.Columns[9].HeaderText = "จำนวนผลตาง";

            this.GridView1.Columns[8].HeaderText = " สถานะ";
            this.GridView1.Columns[9].HeaderText = " เลขที่ FG";
            ...
            this.GridView1.Columns["Col_txtQCS_id"].Width = 190;
            ...
            this.GridView1.Columns["Col_txtqcs_remark"].Visible = true;  //"Col_txtqcs_remark";
            this.GridView1.Columns["Col_txtqcs_remark"].Width = 350;
            this.GridView1.Columns["Col_txtqcs_remark"].ReadOnly = true;
            this.GridView1.Columns["Col_txtqcs_remark"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.GridView1.Columns["Col_txtqcs_remark"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;



            this.GridView1.Columns["Col_txtsum_qty_qcs"].Visible = true;  //"Col_txtsum_qty_qcs";
            this.GridView1.Columns["Col_txtsum_qty_qcs"].Width = 120;
            this.GridView1.Columns["Col_txtsum_qty_qcs"].ReadOnly = true;
            this.GridView1.Columns["Col_txtsum_qty_qcs"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.GridView1.Columns["Col_txtsum_qty_qcs"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;


            this.GridView1.Columns["Col_txtqcs_status"].Visible = true;  //"Col_txtqcs_status";
            this.GridView1.Columns["Col_txtqcs_status"].Width = 100;
            this.GridView1.Columns["Col_txtqcs_status"].ReadOnly = true;
            this.GridView1.Columns["Col_txtqcs_status"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.GridView1.Columns["Col_txtqcs_status"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;

            this.GridView1.Columns["Col_txtfg_id"].Visible = true;  //"Col_txtfg_id";
            this.GridView1.Columns["Col_txtfg_id"].Width = 160;
        ...
        private void GridView1_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                if (cell != null)
                {
                    ...
                    this.cboSearch.Text = "เลขที่ใบจัดเก็บจำนวน คิวซี";

                    if (this.cboSearch.Text == "เลขที่ใบจัดเก็บจำนวน คิวซี")
                    {
                        this.txtsearch.Text = row.Cells[3].Value.ToString();
                        W_ID_Select.TRANS_ID = row.Cells[3].Value.ToString();

                    }
                    else if (this.cboSearch.Text == "ชื่อผู้บันทึกใบจัดเก็บจำนวน คิวซี")
                    {
        ...
        private void GridView1_DoubleClick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                W_ID_Select.WORD_TOP = "ดูข้อมูลใบจัดเก็บจำนวน คิวซี";
                kondate.soft.HOME03_Production.HOME03_Production_11QCS_shirt_record_detail frm2 = new kondate.soft.HOME03_Production.HOME03_Production_11QCS_shirt_record_detail();
                frm2.Show();
        ...
        private void btnGo4_Click(object sender, EventArgs e)
        {
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                if (this.cboSearch.Text.Trim() == "เลขที่ใบจัดเก็บจำนวน คิวซี")
                {
                    cmd2.CommandText = "SELECT *" +
                                       " FROM c002_11QCS_shirt_record" +
                                      ...
                                      //" AND (txtbranch_id = '" + W_ID_Select.M_BRANCHID.Trim() + "')" +
                                      //" AND (txttrans_date_server BETWEEN @datestart AND @dateend)" +
                                      " AND (txtQCS_id = '" + this.txtsearch.Text.Trim() + "')" +
                                      " ORDER BY txtQCS_id ASC";

                }
                else if (this.cboSearch.Text.Trim() == "ชื่อผู้บันทึกใบจัดเก็บจำนวน คิวซี")
                {
                    cmd2.CommandText = "SELECT *" +
                                       " FROM c002_11QCS_shirt_record" +
        ...
        private void BtnNew_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                W_ID_Select.WORD_TOP = "บันทึกใบจัดเก็บจำนวน คิวซี";
