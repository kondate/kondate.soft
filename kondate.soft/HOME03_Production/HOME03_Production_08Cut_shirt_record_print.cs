...
{
    public partial class HOME03_Production_08Cut_shirt_record_print : Form
    {
        //Move Form ====================================
        ...
        public HOME03_Production_08Cut_shirt_record_print()
        {
            InitializeComponent();
        }

        private void HOME03_Production_08Cut_shirt_record_print_Load(object sender, EventArgs e)
        {
            ...
            //rpt.Load("E:\\01_Project_ERP_Kondate.Soft\\kondate.soft\\kondate.soft\\KONDATE_REPORT\\Report_c002_08Cut_shirt_record.rpt");
            ...
            rpt.SetParameterValue("txtcs_id", W_ID_Select.TRANS_ID.Trim());
