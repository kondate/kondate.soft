...
{
    public partial class HOME03_Production_06Send_Dye : Form
    {
        //Move Form ====================================
        ...
        public HOME03_Production_06Send_Dye()
        {
            InitializeComponent();
        }
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        ...
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            //this.GridView1.Columns[11].Name = "Col_txtRG_id";
                            //this.GridView1.Columns[12].Name = "Col_txtRG_date";
                            ...
                            //this.GridView1.Columns[18].Name = "Col_txtRG_status";
                            ...
                            this.GridView1.Rows[index].Cells["Col_txtsum_qty_pub_want"].Value = Convert.ToSingle(dt2.Rows[j]["txtsum_qty_pub_want"]).ToString("###,###.00");      //20
        ...
        private void Show_GridView1()
        {
            ...
            this.GridView1.Columns[22].HeaderText = "คงเหลือ(พับ)";
            this.GridView1.Columns[23].HeaderText = "ส่งย้อม(Kg)";
            this.GridView1.Columns[24].HeaderText = "รับแล้ว(Kg)";
            this.GridView1.Columns[25].HeaderText = "คงเหลือ(Kg)";
            ...
            this.GridView1.Columns["Col_txtRG_date"].Visible = false;  //"Col_txtRG_date";
            this.GridView1.Columns["Col_txtRG_date"].Width = 0;
            this.GridView1.Columns["Col_txtRG_date"].ReadOnly = true;
            this.GridView1.Columns["Col_txtRG_date"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.GridView1.Columns["Col_txtRG_date"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
            ...
            this.GridView1.Columns["Col_txtmoney_after_vat"].Width = 130;
        ...
        private void GridView1_Color()
        {
            for (int i = 0; i < this.GridView1.Rows.Count - 0; i++)
            {
                ...
                if (GridView1.Rows[i].Cells["Col_txtapprove_id"].Value == null)
                {
        ...
        private void GridView1_DoubleClick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                kondate.soft.HOME03_Production.HOME03_Production_06Send_Dye_record_detail frm2 = new kondate.soft.HOME03_Production.HOME03_Production_06Send_Dye_record_detail();
                frm2.Show();
        ...
        private void BtnNew_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                kondate.soft.HOME03_Production.HOME03_Production_06Send_Dye_record frm2 = new kondate.soft.HOME03_Production.HOME03_Production_06Send_Dye_record();
                frm2.Show();
                //this.Close();
            }
