...
{
    public partial class HOME03_Production_18Number_Sup_Color : Form
    {
        //Move Form ====================================
        ...
        public HOME03_Production_18Number_Sup_Color()
        {
            InitializeComponent();
        }

        private void HOME03_Production_18Number_Color_Load(object sender, EventArgs e)
        {
            W_ID_Select.M_FORM_NUMBER = "H0318NC";
            CHECK_ADD_FORM();
            ...
            this.iblword_status.Text = "เพิ่มรหัสสี supplierใหม่";
            this.txtnumber_sup_color_id.ReadOnly = false;

            this.ActiveControl = this.txtnumber_sup_color_id;
        ...
        private void Run_ID()
        {
            if (this.txtnumber_sup_color_no.Text == "")
            {
                this.txtnumber_sup_color_no.Text = "001";
            }
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                cmd2.CommandText = "SELECT *" +
                                    ...
                                    " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                      ...
                                      " AND (txtnumber_sup_color_id <> '')" +
                                    " ORDER BY txtnumber_sup_color_no DESC";
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                cmd2.CommandText = "SELECT c001_07number_sup_color.*," +
                                   ...
                                   " INNER JOIN c001_07number_color" +
                                    ...
                                    " AND (c001_07number_sup_color.txtnumber_sup_color_id <> '')" +
                                    " ORDER BY c001_07number_sup_color.txtsupplier_id,c001_07number_sup_color.txtnumber_sup_color_no ASC";
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            GridView1.Rows[index].Cells["Col_txtnumber_color_id"].Value = dt2.Rows[j]["txtnumber_color_id"].ToString();      //1
                            GridView1.Rows[index].Cells["Col_txtsupplier_id"].Value = dt2.Rows[j]["txtsupplier_id"].ToString();      //1
                            GridView1.Rows[index].Cells["Col_txtnumber_sup_color_no"].Value = dt2.Rows[j]["txtnumber_sup_color_no"].ToString();      //1
                            GridView1.Rows[index].Cells["Col_txtnumber_sup_color_id"].Value = dt2.Rows[j]["txtnumber_sup_color_id"].ToString();      //2
                            GridView1.Rows[index].Cells["Col_txtnumber_sup_color_name"].Value = dt2.Rows[j]["txtnumber_sup_color_name"].ToString();      //3
                            GridView1.Rows[index].Cells["Col_txtnumber_sup_color_name_eng"].Value = dt2.Rows[j]["txtnumber_sup_color_name_eng"].ToString();      //4
                            GridView1.Rows[index].Cells["Col_txtnumber_sup_color_remark"].Value = dt2.Rows[j]["txtnumber_sup_color_remark"].ToString();      //5
                            GridView1.Rows[index].Cells["Col_txtnumber_sup_color_status"].Value = dt2.Rows[j]["txtnumber_sup_color_status"].ToString();      //6
        ...
        private void PANEL_FORM1_GridView1()
        {
            ...
            this.GridView1.Columns[1].Name = "Col_txtnumber_color_id";
            this.GridView1.Columns[2].Name = "Col_txtsupplier_id";
            this.GridView1.Columns[3].Name = "Col_txtnumber_sup_color_no";
            this.GridView1.Columns[4].Name = "Col_txtnumber_sup_color_id";
            this.GridView1.Columns[5].Name = "Col_txtnumber_sup_color_name";
            this.GridView1.Columns[6].Name = "Col_txtnumber_sup_color_name_eng";
            this.GridView1.Columns[7].Name = "Col_txtnumber_sup_color_remark";
            this.GridView1.Columns[8].Name = "Col_txtnumber_sup_color_status";

            this.GridView1.Columns[0].HeaderText = "No";
            this.GridView1.Columns[1].HeaderText = "รหัสสีบริษัทฯ";
            this.GridView1.Columns[2].HeaderText = "รหัส Supplier";
            this.GridView1.Columns[3].HeaderText = "ลำดับ";
            this.GridView1.Columns[4].HeaderText = " รหัส";
            this.GridView1.Columns[5].HeaderText = " ชื่อรหัสสี supplier";
            this.GridView1.Columns[6].HeaderText = "ชื่อรหัสสี supplier Eng";
            ...
            this.GridView1.Columns["Col_txtsupplier_id"].Width = 120;
            ...
            this.GridView1.Columns["Col_txtnumber_sup_color_no"].Visible = true;  //"Col_txtnumber_sup_color_no";
            this.GridView1.Columns["Col_txtnumber_sup_color_no"].Width = 90;
            this.GridView1.Columns["Col_txtnumber_sup_color_no"].ReadOnly = true;
            this.GridView1.Columns["Col_txtnumber_sup_color_no"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.GridView1.Columns["Col_txtnumber_sup_color_no"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
            ...
            this.GridView1.Columns["Col_txtnumber_sup_color_name"].Visible = true;  //"Col_txtnumber_sup_color_name";
            this.GridView1.Columns["Col_txtnumber_sup_color_name"].Width = 200;
            this.GridView1.Columns["Col_txtnumber_sup_color_name"].ReadOnly = true;
            this.GridView1.Columns["Col_txtnumber_sup_color_name"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.GridView1.Columns["Col_txtnumber_sup_color_name"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;

            this.GridView1.Columns["Col_txtnumber_sup_color_name_eng"].Visible = true;  //"Col_txtnumber_sup_color_name_eng";
            this.GridView1.Columns["Col_txtnumber_sup_color_name_eng"].Width = 200;
            this.GridView1.Columns["Col_txtnumber_sup_color_name_eng"].ReadOnly = true;
            this.GridView1.Columns["Col_txtnumber_sup_color_name_eng"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.GridView1.Columns["Col_txtnumber_sup_color_name_eng"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;

            this.GridView1.Columns["Col_txtnumber_sup_color_remark"].Visible = true;  //"Col_txtnumber_sup_color_name_remark";
            this.GridView1.Columns["Col_txtnumber_sup_color_remark"].Width = 250;
            this.GridView1.Columns["Col_txtnumber_sup_color_remark"].ReadOnly = true;
            this.GridView1.Columns["Col_txtnumber_sup_color_remark"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.GridView1.Columns["Col_txtnumber_sup_color_remark"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;

            this.GridView1.Columns["Col_txtnumber_sup_color_status"].Visible = false;  //"Col_txtnumber_sup_color_status";
            this.GridView1.Columns["Col_txtnumber_sup_color_status"].Width = 0;
            this.GridView1.Columns["Col_txtnumber_sup_color_status"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
        ...
        private void PANEL_FORM1_Clear_GridView1_Up_Status()
        {
            ...
            {
                if (this.GridView1.Rows[i].Cells["Col_txtnumber_sup_color_status"].Value.ToString() == "0")  //Active
                {
                    this.GridView1.Rows[i].Cells["Col_Chk"].Value = true;
                }
                else
                {
                    this.GridView1.Rows[i].Cells["Col_Chk"].Value = false;
        ...
        private void PANEL_FORM1_dataGridView1_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                var cell = row.Cells["Col_txtnumber_sup_color_id"].Value;
                if (cell != null)
                {

                    this.txtnumber_sup_color_no.Text = row.Cells["Col_txtnumber_sup_color_no"].Value.ToString();
                    this.txtnumber_sup_color_id.Text = row.Cells["Col_txtnumber_sup_color_id"].Value.ToString();
                    this.txtnumber_sup_color_name.Text = row.Cells["Col_txtnumber_sup_color_name"].Value.ToString();
                    ...
                    if (conn.State == System.Data.ConnectionState.Open)
                    {
                        ...
                        cmd2.CommandText = "SELECT c001_07number_sup_color.*," +
                                           ...
                                           " INNER JOIN c001_07number_color" +
                                            ...
                                            " WHERE (c001_07number_sup_color.cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                             " AND (c001_07number_sup_color.txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                             " AND (c001_07number_sup_color.txtnumber_sup_color_id = '" + this.txtnumber_sup_color_id.Text.Trim() + "')" +
                        ...
                        try
                        {
                            ...
                            if (dt2.Rows.Count > 0)
                            {
                                for (int j = 0; j < dt2.Rows.Count; j++)
                                {
                                    ...
                                    this.txtnumber_sup_color_id.Text = dt2.Rows[j]["txtnumber_sup_color_id"].ToString();      //2
                                    this.txtnumber_sup_color_name.Text = dt2.Rows[j]["txtnumber_sup_color_name"].ToString();      //3
                                ...
                                this.iblword_status.Text = "แก้ไขรหัสสี supplier";
                                this.txtnumber_sup_color_id.ReadOnly = true;
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                cmd2.CommandText = "SELECT *" +
                                    " FROM c001_07number_sup_color" +
                                     " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                     " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                     " AND (txtnumber_sup_color_name LIKE '%" + this.PANEL_FORM1_txtsearch.Text.Trim() + "%')" +
                                   " ORDER BY txtnumber_sup_color_no ASC";
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            //this.PANEL_FORM1_dataGridView1.Columns[1].Name = "Col_txtnumber_sup_color_no";
                            //this.PANEL_FORM1_dataGridView1.Columns[2].Name = "Col_txtnumber_sup_color_id";
                            //this.PANEL_FORM1_dataGridView1.Columns[3].Name = "Col_txtnumber_sup_color_name";
                            //this.PANEL_FORM1_dataGridView1.Columns[4].Name = "Col_txtnumber_sup_color_name_eng";
                            //this.PANEL_FORM1_dataGridView1.Columns[5].Name = "Col_txtnumber_sup_color_remark";
                            //this.PANEL_FORM1_dataGridView1.Columns[6].Name = "Col_txtnumber_sup_color_status";
                            ...
                            GridView1.Rows[index].Cells["Col_txtnumber_sup_color_name"].Value = dt2.Rows[j]["txtnumber_sup_color_name"].ToString();      //3
                            GridView1.Rows[index].Cells["Col_txtnumber_sup_color_name_eng"].Value = dt2.Rows[j]["txtnumber_sup_color_name_eng"].ToString();      //4
                            GridView1.Rows[index].Cells["Col_txtnumber_sup_color_remark"].Value = dt2.Rows[j]["txtnumber_sup_color_remark"].ToString();      //6
                            GridView1.Rows[index].Cells["Col_txtnumber_sup_color_status"].Value = dt2.Rows[j]["txtnumber_sup_color_status"].ToString();      //7
        ...
        private void BtnNew_Click(object sender, EventArgs e)
        {
            ...
            this.Hide();
            var frm2 = new HOME03_Production_18Number_Color();
        ...
        private void btnopen_Click(object sender, EventArgs e)
        {
            ...
            if (this.txtnumber_sup_color_id.Text != "")
            {
                this.iblword_status.Text = "แก้ไขรหัสสี supplier";
                this.txtnumber_sup_color_id.ReadOnly = true;
            }
        ...
        private void BtnSave_Click(object sender, EventArgs e)
        {
            if (this.txtnumber_sup_color_no.Text == "")
            {
                ...
                this.txtnumber_sup_color_no.Focus();
                return;
            }
            else
            {
                if (this.txtnumber_sup_color_no.TextLength == 3)
                {
                }
                else
                {
            ...
            if (this.txtnumber_sup_color_id.Text == "")
            {
                MessageBox.Show("โปรดใส่รหัสสี supplier ก่อน !", "ผลการทำงาน", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                this.txtnumber_sup_color_id.Focus();
                return;
            }
            if (this.txtnumber_sup_color_name.Text == "")
            {
                MessageBox.Show("โปรดใส่ชื่อรหัสสี supplierก่อน !", "ผลการทำงาน", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                this.txtnumber_sup_color_name.Focus();
                return;
            }
            ...
            //END เชื่อมต่อฐานข้อมูล=======================================================
            Cursor.Current = Cursors.WaitCursor;
            if (this.iblword_status.Text.Trim() == "เพิ่มรหัสสี supplierใหม่")
            {
                conn.Open();
                if (conn.State == System.Data.ConnectionState.Open)
                {
                    ...
                    cmd1.CommandText = "SELECT * FROM c001_07number_sup_color" +
                                        " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                       " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                       " AND (txtsupplier_id = '" + this.PANEL161_SUP_txtsupplier_id.Text.Trim() + "')" +
                                       " AND (txtnumber_sup_color_id = '" + this.txtnumber_sup_color_id.Text.Trim() + "')";
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        MessageBox.Show("รหัสรหัสสี supplier นี้ซ้ำ   : '" + this.txtnumber_sup_color_id.Text.Trim() + "' โปรดใส่ใหม่ ", "ผลการทำงาน", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                        this.txtnumber_sup_color_id.Focus();
                        conn.Close();
                        return;
                    }
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                try
                {
                    if (this.iblword_status.Text.Trim() == "เพิ่มรหัสสี supplierใหม่")
                    {
                        cmd2.CommandText = "INSERT INTO c001_07number_sup_color(cdkey,txtco_id," +  //1
                                           "txtnumber_color_id,txtsupplier_id," +  //2
                                           "txtnumber_sup_color_no,txtnumber_sup_color_id," +  //2
                                           "txtnumber_sup_color_name,txtnumber_sup_color_name_eng," +  //3
                                          "txtnumber_sup_color_remark," +  //5
                                          "txtnumber_sup_color_status) " +  //6
                        ...
                        cmd2.Parameters.Add("@txtnumber_color_id", SqlDbType.NVarChar).Value = this.PANEL0107_NUMBER_COLOR_txtnumber_color_id.Text.ToString();
                        cmd2.Parameters.Add("@txtsupplier_id", SqlDbType.NVarChar).Value = this.PANEL161_SUP_txtsupplier_id.Text.ToString();
                        cmd2.Parameters.Add("@txtnumber_sup_color_no", SqlDbType.NVarChar).Value = this.txtnumber_sup_color_no.Text.ToString();
                        cmd2.Parameters.Add("@txtnumber_sup_color_id", SqlDbType.NVarChar).Value = this.txtnumber_sup_color_id.Text.ToString();
                        cmd2.Parameters.Add("@txtnumber_sup_color_name", SqlDbType.NVarChar).Value = this.txtnumber_sup_color_name.Text.ToString();
                        cmd2.Parameters.Add("@txtnumber_sup_color_name_eng", SqlDbType.NVarChar).Value = this.txtnumber_sup_color_name_eng.Text.ToString();
                        cmd2.Parameters.Add("@txtnumber_sup_color_remark", SqlDbType.NVarChar).Value = this.txtnumber_sup_color_remark.Text.ToString();
                        cmd2.Parameters.Add("@txtnumber_sup_color_status", SqlDbType.NChar).Value = "0";
                        //==============================

                        cmd2.ExecuteNonQuery();

                    }
                    if (this.iblword_status.Text.Trim() == "แก้ไขรหัสสี supplier")
                    {
                        cmd2.CommandText = "UPDATE c001_07number_sup_color SET " +
                                                                   "txtnumber_color_id = '" + this.PANEL0107_NUMBER_COLOR_txtnumber_color_id.Text.Trim() + "'," +
                                                                   "txtsupplier_id = '" + this.PANEL161_SUP_txtsupplier_id.Text.Trim() + "'," +
                                                                   "txtnumber_sup_color_no = '" + this.txtnumber_sup_color_no.Text.Trim() + "'," +
                                                                   "txtnumber_sup_color_name = '" + this.txtnumber_sup_color_name.Text.Trim() + "'," +
                                                                   "txtnumber_sup_color_name_eng = '" + this.txtnumber_sup_color_name_eng.Text.Trim() + "'," +
                                                                  "txtnumber_sup_color_remark = '" + this.txtnumber_sup_color_remark.Text.ToString() + "'" +
                                                                   " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                                                   " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                                                   " AND (txtsupplier_id = '" + this.PANEL161_SUP_txtsupplier_id.Text.Trim() + "')" +
                                                                   " AND (txtnumber_sup_color_id = '" + this.txtnumber_sup_color_id.Text.Trim() + "')";
                    ...
                    if (dialogResult == DialogResult.Yes)
                    {
                        ...
                        this.txtnumber_sup_color_id.Text = "";
                        this.txtnumber_sup_color_name.Text = "";
                        this.txtnumber_sup_color_name_eng.Text = "";
                        this.txtnumber_sup_color_remark.Text = "";
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                try
                {
                    if (this.iblword_status.Text.Trim() == "ยกเลิกเอกสาร")
                    {
                        ...
                        cmd2.CommandText = "INSERT INTO c001_07number_sup_color_cancel(cdkey,txtco_id,txtbranch_id," +  //1
                                                                                                            //"txttrans_date," +
                        ...
                        cmd2.CommandText = "INSERT INTO c001_07number_sup_color_cancel_detail(cdkey,txtco_id," +  //1
                                             "txtnumber_sup_color_no,txtnumber_sup_color_id," +  //2
                                             "txtnumber_sup_color_name,txtnumber_sup_color_name_eng," +  //3
                                             "txtnumber_sup_color_remark," +  //4
                                            "txtnumber_sup_color_status,cancel_id) " +  //5
                                             "VALUES (@cdkey2,@txtco_id2," +  //1
                                             "@txtnumber_sup_color_no,@txtnumber_sup_color_id," +  //2
                                             "@txtnumber_sup_color_name,@txtnumber_sup_color_name_eng," +  //3
                                             "@txtnumber_sup_color_remark," +  //4
                                            "@txtnumber_sup_color_status,@cancel_id2)";   //5
                        ...
                        cmd2.CommandText = "DELETE FROM c001_07number_sup_color" +
                                                                    " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                                                    " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                                                   " AND (txtnumber_sup_color_id = '" + this.txtnumber_sup_color_id.Text.Trim() + "')";
                        cmd2.ExecuteNonQuery();
                    ...
                    DialogResult dialogResult = MessageBox.Show("คุณต้องการ ยกเลิกเอกสาร รหัส  " + this.txtnumber_sup_color_id.Text.ToString() + " ใช่หรือไม่่ ?", "โปรดยืนยัน", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question);
                    if (dialogResult == DialogResult.Yes)
                    {
        ...
        private void txtnumber_sup_color_id_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            if (e.KeyChar == (char)Keys.Enter && this.txtnumber_sup_color_id.Text == "")
            {
                this.txtnumber_sup_color_id.Focus();
            }
            //========================================
            else if (e.KeyChar == (char)Keys.Enter && this.txtnumber_sup_color_id.Text.Trim() != "")
            {
                this.txtnumber_sup_color_no.Focus();
        ...
        private void txtnumber_sup_color_no_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == (char)Keys.Enter && this.txtnumber_sup_color_no.Text == "")
            {
                this.txtnumber_sup_color_no.Focus();
            }
            //========================================
            else if (e.KeyChar == (char)Keys.Enter && this.txtnumber_sup_color_no.Text.Trim() != "")
            {
                if (this.txtnumber_sup_color_no.TextLength == 3)
                {
                    this.txtnumber_sup_color_name.Focus();
            ...
            else if ((e.KeyChar > '9') && (e.KeyChar != '\b') && (e.KeyChar != '.') && txtnumber_sup_color_no.Text.Length == 0)
            {
                //e.KeyChar <= '0' || 
                e.Handled = true;
                return;
        ...
        private void txtnumber_sup_color_name_KeyDown(object sender, KeyEventArgs e)
        {

        }
        private void txtnumber_sup_color_name_eng_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
                this.txtnumber_sup_color_remark.Focus();

        }
        private void txtnumber_sup_color_name_remark_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
                this.BtnSave.Focus();
            ...
            if (OK.Trim() != "Y")
            {
                ...
                if (conn.State == System.Data.ConnectionState.Open)
                {
                    ...
                    try
                    {
                        ...
                        cmd2.Parameters.Add("@cdkey", SqlDbType.NVarChar).Value = W_ID_Select.CDKEY.Trim();
                        cmd2.Parameters.Add("@txtco_id", SqlDbType.NVarChar).Value = W_ID_Select.M_COID.Trim();
                        cmd2.Parameters.Add("@txtnumber_sup_color_no", SqlDbType.NVarChar).Value = "999";
                        cmd2.Parameters.Add("@txtnumber_sup_color_id", SqlDbType.NVarChar).Value = "";
                        cmd2.Parameters.Add("@txtnumber_sup_color_name", SqlDbType.NVarChar).Value = "";
                        cmd2.Parameters.Add("@txtnumber_sup_color_name_eng", SqlDbType.NVarChar).Value = "";
                        cmd2.Parameters.Add("@txtnumber_sup_color_remark", SqlDbType.NVarChar).Value = "";
                        cmd2.Parameters.Add("@txtnumber_sup_color_status", SqlDbType.NChar).Value = "0";
                        //==============================
