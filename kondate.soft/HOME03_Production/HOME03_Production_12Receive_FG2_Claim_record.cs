...
{
    public partial class HOME03_Production_12Receive_FG2_Claim_record : Form
    {
        //Move Form ====================================
        ...
        public HOME03_Production_12Receive_FG2_Claim_record()
        {
            InitializeComponent();
        }

        private void HOME03_Production_12Receive_FG2_Claim_record_Load(object sender, EventArgs e)
        {
            this.WindowState = FormWindowState.Maximized;
            this.btnmaximize.Visible = false;
            this.btnmaximize_full.Visible = true;

            W_ID_Select.M_FORM_NUMBER = "H0323FG2RLMRD";
            CHECK_ADD_FORM();
            ...
            this.iblword_status.Text = "บันทึกใบรับคืนส่งเคลม";
            ...
            this.ActiveControl = this.txtCLM_id;
                ...
                cmd2.CommandText = "SELECT c002_11send_FG2_Claim_record.*," +
                                ...
                                " FROM c002_11send_FG2_Claim_record" +
                                   ...
                                   " AND c002_11send_FG2_Claim_record.txtCLM_id = c002_11send_FG2_Claim_record_detail.txtCLM_id" +
                                    ...
                                    //" ON c002_11send_FG2_Claim_record.cdkey = c001_04produce_type.cdkey" +
                                    //" AND c002_11send_FG2_Claim_record.txtco_id = c001_04produce_type.txtco_id" +
                                    //" AND c002_11send_FG2_Claim_record.txtproduce_type_id = c001_04produce_type.txtproduce_type_id" +

                                    //" INNER JOIN c001_02machine" +
                                    //" ON c002_11send_FG2_Claim_record_detail.cdkey = c001_02machine.cdkey" +
                                    //" AND c002_11send_FG2_Claim_record_detail.txtco_id = c001_02machine.txtco_id" +
                                    //" AND c002_11send_FG2_Claim_record_detail.txtmachine_id = c001_02machine.txtmachine_id" +

                                    //" INNER JOIN c001_05face_baking" +
                                    //" ON c002_11send_FG2_Claim_record.cdkey = c001_05face_baking.cdkey" +
                                    //" AND c002_11send_FG2_Claim_record.txtco_id = c001_05face_baking.txtco_id" +
                                    //" AND c002_11send_FG2_Claim_record.txtface_baking_id = c001_05face_baking.txtface_baking_id" +

                                    //" INNER JOIN c001_06number_mat" +
                                    //" ON c002_11send_FG2_Claim_record.cdkey = c001_06number_mat.cdkey" +
                                    //" AND c002_11send_FG2_Claim_record.txtco_id = c001_06number_mat.txtco_id" +
                                    //" AND c002_11send_FG2_Claim_record.txtnumber_mat_id = c001_06number_mat.txtnumber_mat_id" +
                                    ...
                                    //" ON c002_11send_FG2_Claim_record.cdkey = k013_1db_acc_06wherehouse.cdkey" +
                                    //" AND c002_11send_FG2_Claim_record.txtco_id = k013_1db_acc_06wherehouse.txtco_id" +
                                    //" AND c002_11send_FG2_Claim_record.txtwherehouse_id = k013_1db_acc_06wherehouse.txtwherehouse_id" +
                                   ...
                                   //" AND (c002_11send_FG2_Claim_record_detail.txtmat_id = '" + W_ID_Select.MAT_ID + "')" +

                                   //" AND (c002_11send_FG2_Claim_record.txtCLM_id = '" + W_ID_Select.TRANS_ID.Trim() + "')" +
                                   //" AND (c002_11send_FG2_Claim_record.txttrans_date_server BETWEEN @datestart AND @dateend)" +
                                   //" AND (c002_11send_FG2_Claim_record_detail.txtwherehouse_id = '" + this.PANEL1306_WH_txtwherehouse_id.Text.Trim() + "')" +

                                   //" AND (c002_11send_FG2_Claim_record_detail.txtnumber_in_year <> '')" +
                                   //" AND (c002_11send_FG2_Claim_record_detail.txtcut_id = '')" +
                                   " AND (c002_11send_FG2_Claim_record_detail.txtCLM_id = '" + this.txtCLM_id.Text.Trim() + "')" +
                                   " AND (c002_11send_FG2_Claim_record_detail.txtqty_after_cut > 0)" +

                                    " ORDER BY c002_11send_FG2_Claim_record_detail.txtnumber_dyed,c002_11send_FG2_Claim_record_detail.txtfold_number ASC";
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        ...
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            GridView66.Rows[index].Cells["Col_txtCLM_id"].Value = dt2.Rows[j]["txtCLM_id"].ToString();      //1
                            ...
                            GridView66.Rows[index].Cells["Col_txtnumber_in_year"].Value = dt2.Rows[j]["txtnumber_in_year"].ToString();       //36
        ...
        private void Show_GridView66()
        {
            ...
            this.GridView66.Columns[1].Name = "Col_txtCLM_id";
            ...
            this.GridView66.Columns[40].Name = "Col_txtnumber_in_year";


            this.GridView66.Columns[0].HeaderText = "No";
            this.GridView66.Columns[1].HeaderText = "เลขที่ CLM";
            ...
            this.GridView66.Columns[40].HeaderText = "เลขชุด";
            ...
            this.GridView66.Columns["Col_txtCLM_id"].Visible = true;  //"Col_txtCLM_id";
            this.GridView66.Columns["Col_txtCLM_id"].Width = 140;
            this.GridView66.Columns["Col_txtCLM_id"].ReadOnly = true;
            this.GridView66.Columns["Col_txtCLM_id"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.GridView66.Columns["Col_txtCLM_id"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
        ...
        private void GridView66_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                {
                    //======================================================
                    this.txtCLM_id.Text = row.Cells["Col_txtCLM_id"].Value.ToString();
                    ...
                    if (this.ch_change_color.Checked == false)
                    {
                    ...
                    //    return;
                    //}
                    if (this.ch_change_mat_id.Checked == false)
                    {
                    ...
                    {
                        MessageBox.Show("โปรด เลือกคลัง สินค้า ที่มีรายการคืนส่งเคลม ก่อน !", "ผลการทำงาน", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                        return;
                    }
        ...
        private void GridView66_DoubleClick(object sender, EventArgs e)
        {
            ...
            this.GridView1.Rows[index].Cells["Col_txtCLM_id"].Value = this.GridView66.Rows[selectedRowIndex].Cells["Col_txtCLM_id"].Value.ToString();        //1
            ...
            if (this.ch_change_mat_id.Checked == false)
            {
                this.GridView1.Rows[index].Cells["Col_txtmat_no"].Value = this.GridView66.Rows[selectedRowIndex].Cells["Col_txtmat_no"].Value.ToString();      //6
                this.GridView1.Rows[index].Cells["Col_txtmat_id"].Value = this.GridView66.Rows[selectedRowIndex].Cells["Col_txtmat_id"].Value.ToString();      //6
                this.GridView1.Rows[index].Cells["Col_txtmat_name"].Value = this.GridView66.Rows[selectedRowIndex].Cells["Col_txtmat_name"].Value.ToString();      //6

                this.GridView1.Rows[index].Cells["Col_txtmat_unit1_name"].Value = this.GridView66.Rows[selectedRowIndex].Cells["Col_txtmat_unit1_name"].Value.ToString();      //6
                this.GridView1.Rows[index].Cells["Col_txtmat_unit1_qty"].Value = this.GridView66.Rows[selectedRowIndex].Cells["Col_txtmat_unit1_qty"].Value.ToString();      //6
                this.GridView1.Rows[index].Cells["Col_chmat_unit_status"].Value = this.GridView66.Rows[selectedRowIndex].Cells["Col_chmat_unit_status"].Value.ToString();      //6
                this.GridView1.Rows[index].Cells["Col_txtmat_unit2_name"].Value = this.GridView66.Rows[selectedRowIndex].Cells["Col_txtmat_unit2_name"].Value.ToString();      //6
                this.GridView1.Rows[index].Cells["Col_txtmat_unit2_qty"].Value = this.GridView66.Rows[selectedRowIndex].Cells["Col_txtmat_unit2_qty"].Value.ToString();      //6
            }
            else
            {
            ...
            if (this.ch_change_color.Checked == false)
            {
                this.GridView1.Rows[index].Cells["Col_txtnumber_color_id"].Value = this.GridView66.Rows[selectedRowIndex].Cells["Col_txtnumber_color_id"].Value.ToString();      //6
                this.GridView1.Rows[index].Cells["Col_txtnumber_sup_color_id"].Value = this.GridView66.Rows[selectedRowIndex].Cells["Col_txtnumber_sup_color_id"].Value.ToString();      //6
            }
            else
            {
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                cmd2.CommandText = "SELECT k021_mat_average.*," +
                                   ...
                                   " AND (k021_mat_average.txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                    ...
                                    " AND (b001mat_02detail.txtmat_sac_id = '" + this.txtmat_sac_id.Text.Trim() + "')" +  //คืนส่งเคลม
        ...
        private void Show_GridView2()
        {
            ...
            this.GridView2.Columns[16].HeaderText = "รับคืนส่งเคลม(พับ) ";
            this.GridView2.Columns[17].HeaderText = "รับคืนส่งเคลม(กก) ";
            ...
            this.GridView2.Columns[28].HeaderText = "รับคืนส่งเคลม ยกมา";
            this.GridView2.Columns[29].HeaderText = "รับคืนส่งเคลม ปอนด์";
            this.GridView2.Columns[30].HeaderText = "รับคืนส่งเคลม2 ยกไป";

            this.GridView2.Columns[31].HeaderText = "รับคืนส่งเคลม  ยกมา";
            this.GridView2.Columns[32].HeaderText = "รับคืนส่งเคลม  ยกไป";
        ...
        private void Show_GridView1()
        {
            ...
            this.GridView1.Columns[1].Name = "Col_txtCLM_id";
            ...
            this.GridView1.Columns["Col_txtCLM_id"].Visible = false;  //"Col_txtCLM_id";
            this.GridView1.Columns["Col_txtCLM_id"].Width = 0;
            ...
            this.GridView1.Columns["Col_txtmat_id"].Width = 90;
        ...
        private void Show_Qty_Yokma2()
        {
            ...
            for (int i = 0; i < this.GridView1.Rows.Count; i++)
            {
                ...
                //else
                //{
                //    MessageBox.Show("ระบบจะให้ส่งตัดคืนส่งเคลม ได้ที่ละ 1 รหัสคืนส่งเคลม ต่อ 1 ใบส่งตัด เท่านั้น !! ");
                //    return;
                //}
                conn.Open();
                if (conn.State == System.Data.ConnectionState.Open)
                {
                    ...
                    cmd2.CommandText = "SELECT *" +
                                       " FROM c002_11send_FG2_Claim_record_detail" +
                                       " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                       " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
        ...
        private void BtnNew_Click(object sender, EventArgs e)
        {
            ...
            this.Hide();
            var frm2 = new HOME03_Production.HOME03_Production_12Receive_FG2_Claim_record();
        ...
        {
            if (this.txtCLM_id.Text == "")
            {
                MessageBox.Show("โปรด เลือก เลขที่ใบรับคืนส่งเคลม ก่อน !", "ผลการทำงาน", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                this.txtCLM_id.Focus();
                return;
            }
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                try
                {
                    ...
                    if (W_ID_Select.TRANS_BILL_STATUS.Trim() == "N")
                        ...
                        {
                            cmd2.CommandText = "UPDATE c002_12Receive_FG2_Claim_record_trans SET txttrans_id = '" + this.txtFG2RLM_id.Text.Trim() + "'" +
                                               " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                               " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                        ...
                        cmd2.CommandText = "INSERT INTO c002_12Receive_FG2_Claim_record(cdkey,txtco_id,txtbranch_id," +  //1
                    ...
                    cmd2.Parameters.Add("@txttrans_time", SqlDbType.NVarChar).Value = myDateTime2.ToString("HH:mm:ss", UsaCulture);
                       ...
                       //==============================================================================
                        ...
                        cmd2.Parameters.Add("@txtFG2RLM_id", SqlDbType.NVarChar).Value = this.txtFG2RLM_id.Text.Trim();  //7
                    ...
                    //cmd2.Parameters.Add("@txtCLM_id", SqlDbType.NVarChar).Value = ""; // this.txtCLM_id.Text.Trim();  //8
                    ...
                    cmd2.Parameters.Add("@txtVat_id", SqlDbType.NVarChar).Value = this.txtVat_id.Text.Trim();  //11
                        ...
                        cmd2.Parameters.Add("@txtFG2RLM_status", SqlDbType.NVarChar).Value = "0";  //54
                    ...
                    for (int i = 0; i < this.GridView1.Rows.Count; i++)
                    {
                        ...
                        if (this.GridView1.Rows[i].Cells["Col_txtmat_id"].Value != null)
                        {
                            ...
                            //===================================================================================================================
                            //3 c002_11send_FG2RLM_Claim_record_detail

                            cmd2.CommandText = "INSERT INTO c002_12Receive_FG2_Claim_record_detail(cdkey,txtco_id,txtbranch_id," +  //1
                            ...
                            cmd2.CommandText = "UPDATE c002_11send_FG2_Claim_record_detail SET " +
                                                   "txtcut_id = '" + this.txtFG2RLM_id.Text.ToString() + "'," +
                                                   ...
                                                   " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                                   " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                                     " AND (txtCLM_id = '" + this.GridView1.Rows[i].Cells["Col_txtCLM_id"].Value.ToString() + "')" +
                                                   " AND (txtLot_no = '" + this.GridView1.Rows[i].Cells["Col_txtLot_no"].Value.ToString() + "')";
                            //" AND (txtmat_id = '" + this.GridView1.Rows[i].Cells["Col_txtmat_id"].Value.ToString() + "')";
                        ...
                        if (valu != "")
                        {
                            if (Convert.ToDouble(string.Format("{0:n4}", this.GridView2.Rows[i].Cells["Col_txtsum_qty"].Value.ToString())) > 0)
                            {
                                ...
                                cmd2.CommandText = "INSERT INTO k021_mat_average_balance(cdkey,txtco_id,txtbranch_id," +  //1
                                        ...
                                        "'" + this.txtFG2RLM_id.Text.Trim() + "'," +  //7 txtbill_id
                                        "'FG2RLM'," +  //9 txtbill_type
                                        "'รับคืนส่งเคลม " + this.txtrg_remark.Text.Trim() + "'," +  //9 txtbill_remark
                    ...
                    if (dialogResult == DialogResult.Yes)
                    {
                        ...
                        if (this.iblword_status.Text.Trim() == "บันทึกใบรับคืนส่งเคลม")
                        {
        ...
        private void btnPreview_Click(object sender, EventArgs e)
        {
            ...
            UPDATE_PRINT_BY();
            W_ID_Select.TRANS_ID = this.txtFG2RLM_id.Text.Trim();
            W_ID_Select.LOG_ID = "8";
            W_ID_Select.LOG_NAME = "ปริ๊น";
            TRANS_LOG();
            //======================================================
            kondate.soft.HOME03_Production.HOME03_Production_12Receive_FG2_Claim_record_print frm2 = new kondate.soft.HOME03_Production.HOME03_Production_12Receive_FG2_Claim_record_print();
            frm2.Show();
            frm2.BringToFront();
        ...
        private void PANEL0107_NUMBER_COLOR_btnnumber_color_Click(object sender, EventArgs e)
        {
            ...
            if (this.PANEL0107_NUMBER_COLOR.Visible == false)
            {
                ...
                this.PANEL0107_NUMBER_COLOR.Location = new Point(this.PANEL0107_NUMBER_COLOR_txtnumber_sup_color_name.Location.X, this.PANEL0107_NUMBER_COLOR_txtnumber_sup_color_name.Location.Y + 22);
            }
            else
            {
                this.PANEL0107_NUMBER_COLOR.Visible = false;
        ...
        private void UPDATE_PRINT_BY()
        {
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                try
                {
                    ...
                    cmd2.CommandText = "UPDATE c002_12Receive_FG2_Claim_record SET " +
                                                                ...
                                                                " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                                               " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                                               " AND (txtFG2RLM_id = '" + this.txtFG2RLM_id.Text.Trim() + "')";
                    cmd2.ExecuteNonQuery();
        ...
        private void AUTO_BILL_TRANS_ID()
        {
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                cmd1.CommandText = "SELECT *" +
                                  " FROM c002_12Receive_FG2_Claim_record_trans" +
                                  " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                  " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                  " AND (txtbranch_id = '" + W_ID_Select.M_BRANCHID.Trim() + "')" +
                ...
                try
                {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        {
                            TMP = "FG2RLM" + W_ID_Select.M_BRANCHNAME_SHORT.Trim() + "-" + year_now2.Trim() + "" + month_now.Trim() + "" + day_now.Trim() + "-" + trans.Trim();
                        }
                        else
                        {
                            TMP = "FG2RLM" + W_ID_Select.M_BRANCHNAME_SHORT.Trim() + "-" + year_now2.Trim() + "" + month_now.Trim() + "" + day_now.Trim() + "-" + "000001";
                        }
                ...
                this.txtFG2RLM_id.Text = TMP.Trim();
            }
            //จบเชื่อมต่อฐานข้อมูล=======================================================
        ...
        {
            W_ID_Select.WORD_TOP = "ระเบียนใบรับคืนส่งเคลม";
            kondate.soft.HOME03_Production.HOME03_Production_12Receive_FG2_Claim frm2 = new kondate.soft.HOME03_Production.HOME03_Production_12Receive_FG2_Claim();
            frm2.Show();
