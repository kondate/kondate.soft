...
{
    public partial class HOME03_Production_01RG : Form
    {
        //Move Form ====================================
        ...
        private void HOME02_Purchasing_05RG_Load(object sender, EventArgs e)
        {
            ...
            W_ID_Select.M_FORM_NUMBER = "H0301RGGR";
            CHECK_ADD_FORM();
        ...
        private void Fill_Show_DATA_GridView1()
        {
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                cmd2.CommandText = "SELECT c003_receive_record.*," +
                                   ...
                                   //" AND c003_receive_record.txtCPo_id = k018db_po_record.txtCPo_id" +
                                   " INNER JOIN k020db_receive_record_type" +
                                   " ON c003_receive_record.cdkey = k020db_receive_record_type.cdkey" +
                                   //" AND c003_receive_record.txtco_id = k020db_receive_record_type.txtco_id" +
                                   " AND c003_receive_record.txtreceive_type_id = k020db_receive_record_type.txtreceive_type_id" +
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        ...
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            {
                                this.GridView1.Rows[index].Cells["Col_txtCRG_status"].Value = "ออก RG"; //12
                            }
                            else if (dt2.Rows[j]["txtcrg_status"].ToString() == "1")
                            {
                                this.GridView1.Rows[index].Cells["Col_txtCRG_status"].Value = "ยกเลิก RG"; //12
                            }
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        ...
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            //this.GridView1.Columns[9].Name = "Col_txtCPo_id";
                            //this.GridView1.Columns[10].Name = "Col_txtmoney_after_vat";
                            //this.GridView1.Columns[11].Name = "Col_txtCRG_status";
        ...
        private void Show_GridView1()
        {
            ...
            this.GridView1.Columns["Col_txtreceive_type_name"].Visible = true;  //"Col_txtCRG_id";
            ...
            this.GridView1.Columns["Col_txtCRG_id"].Visible = true;  //"Col_txtCRG_id";
            this.GridView1.Columns["Col_txtCRG_id"].Width = 140;
            this.GridView1.Columns["Col_txtCRG_id"].ReadOnly = true;
            ...
            this.GridView1.Columns["Col_txtCPo_id"].Visible = true;  //"Col_txtCPo_id";
            this.GridView1.Columns["Col_txtCPo_id"].Width = 120;
            this.GridView1.Columns["Col_txtCPo_id"].ReadOnly = true;
            ...
            this.GridView1.Columns["Col_txtCRG_status"].Width = 100;
            this.GridView1.Columns["Col_txtCRG_status"].ReadOnly = true;
            this.GridView1.Columns["Col_txtCRG_status"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.GridView1.Columns["Col_txtCRG_status"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
        ...
        private void GridView1_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                var cell = row.Cells["Col_txtCRG_id"].Value;
                if (cell != null)
                {
                    W_ID_Select.RECEIVE_TYPE = row.Cells["Col_txtreceive_type_id"].Value.ToString();
                    W_ID_Select.TRANS_ID = row.Cells["Col_txtCRG_id"].Value.ToString();
                    this.cboSearch.Text = "เลขที่ใบรับสินค้า";

                    if (this.cboSearch.Text == "เลขที่ใบรับสินค้า")
                    {
                        this.txtsearch.Text = row.Cells["Col_txtCRG_id"].Value.ToString();
                        W_ID_Select.TRANS_ID = row.Cells["Col_txtCRG_id"].Value.ToString();
        ...
        private void GridView1_DoubleClick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                kondate.soft.HOME03_Production.HOME03_Production_01RG_record_detail frm2 = new kondate.soft.HOME03_Production.HOME03_Production_01RG_record_detail();
                frm2.Show();
