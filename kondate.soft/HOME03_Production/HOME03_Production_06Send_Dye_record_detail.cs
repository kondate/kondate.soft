...
{
    public partial class HOME03_Production_06Send_Dye_record_detail : Form
    {
        //Move Form ====================================
        ...
        public HOME03_Production_06Send_Dye_record_detail()
        {
            InitializeComponent();
        }
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        ...
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            this.GridView1.Rows[index].Cells["Col_txtface_baking_id"].Value = dt2.Rows[j]["txtface_baking_name"].ToString();       //5
        ...
        private void Show_GridView1()
        {
            ...
            this.GridView1.Columns[36].HeaderText = "คงเหลือ(พับ)";
            this.GridView1.Columns[37].HeaderText = "ส่งย้อม(Kg)";
            this.GridView1.Columns[38].HeaderText = "รับแล้ว(Kg)";
            this.GridView1.Columns[39].HeaderText = "คงเหลือ(Kg)";
            ...
            this.GridView1.Columns["Col_txtmat_name"].Width = 140;
