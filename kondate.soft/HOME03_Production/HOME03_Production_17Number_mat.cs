...
{
    public partial class HOME03_Production_17Number_mat : Form
    {
        //Move Form ====================================
        ...
        public HOME03_Production_17Number_mat()
        {
            InitializeComponent();
        }

        private void HOME03_Production_17Number_mat_Load(object sender, EventArgs e)
        {
            W_ID_Select.M_FORM_NUMBER = "H0317NM";
            CHECK_ADD_FORM();
            ...
            this.iblword_status.Text = "เพิ่มรหัสเบอร์ผ้าใหม่";
            this.txtnumber_mat_id.ReadOnly = false;

            this.ActiveControl = this.txtnumber_mat_id;
        ...
        private void Run_ID()
        {
            if (this.txtnumber_mat_no.Text == "")
            {
                this.txtnumber_mat_no.Text = "001";
            }
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                cmd2.CommandText = "SELECT *" +
                                    ...
                                    " ORDER BY txtnumber_mat_no DESC";
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            GridView1.Rows[index].Cells["Col_txtnumber_mat_no"].Value = dt2.Rows[j]["txtnumber_mat_no"].ToString();      //1
                            GridView1.Rows[index].Cells["Col_txtnumber_mat_id"].Value = dt2.Rows[j]["txtnumber_mat_id"].ToString();      //2
                            GridView1.Rows[index].Cells["Col_txtnumber_mat_name"].Value = dt2.Rows[j]["txtnumber_mat_name"].ToString();      //3
                            GridView1.Rows[index].Cells["Col_txtnumber_mat_name_eng"].Value = dt2.Rows[j]["txtnumber_mat_name_eng"].ToString();      //4
                            GridView1.Rows[index].Cells["Col_txtnumber_mat_remark"].Value = dt2.Rows[j]["txtnumber_mat_remark"].ToString();      //5
                            GridView1.Rows[index].Cells["Col_txtnumber_mat_status"].Value = dt2.Rows[j]["txtnumber_mat_status"].ToString();      //6
        ...
        private void PANEL_FORM1_GridView1()
        {
            ...
            this.GridView1.Columns[1].Name = "Col_txtnumber_mat_no";
            this.GridView1.Columns[2].Name = "Col_txtnumber_mat_id";
            this.GridView1.Columns[3].Name = "Col_txtnumber_mat_name";
            this.GridView1.Columns[4].Name = "Col_txtnumber_mat_name_eng";
            this.GridView1.Columns[5].Name = "Col_txtnumber_mat_remark";
            this.GridView1.Columns[6].Name = "Col_txtnumber_mat_status";

            this.GridView1.Columns[0].HeaderText = "No";
            this.GridView1.Columns[1].HeaderText = "ลำดับ";
            this.GridView1.Columns[2].HeaderText = " รหัส";
            this.GridView1.Columns[3].HeaderText = " ชื่อรหัสเบอร์ผ้า";
            this.GridView1.Columns[4].HeaderText = "ชื่อรหัสเบอร์ผ้า Eng";
            ...
            this.GridView1.Columns[1].Visible = true;  //"Col_txtnumber_mat_no";
            ...
            this.GridView1.Columns[2].Visible = true;  //"Col_txtnumber_mat_id";
            ...
            this.GridView1.Columns[3].Visible = true;  //"Col_txtnumber_mat_name";
            ...
            this.GridView1.Columns[4].Visible = true;  //"Col_txtnumber_mat_name_eng";
            ...
            this.GridView1.Columns[5].Visible = true;  //"Col_txtnumber_mat_name_remark";
            ...
            this.GridView1.Columns[6].Visible = false;  //"Col_txtnumber_mat_status";
        ...
        private void PANEL_FORM1_dataGridView1_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                if (cell != null)
                {
                    ...
                    this.txtnumber_mat_no.Text = row.Cells[1].Value.ToString();
                    this.txtnumber_mat_id.Text = row.Cells[2].Value.ToString();
                    this.txtnumber_mat_name.Text = row.Cells[3].Value.ToString();
                    ...
                    if (conn.State == System.Data.ConnectionState.Open)
                    {
                        ...
                        cmd2.CommandText = "SELECT *" +
                                            " FROM c001_06number_mat" +
                                             " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                             " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                             " AND (txtnumber_mat_id = '" + this.txtnumber_mat_id.Text.Trim() + "')" +
                                           " ORDER BY txtnumber_mat_no ASC";
                        ...
                        try
                        {
                            ...
                            if (dt2.Rows.Count > 0)
                            {
                                for (int j = 0; j < dt2.Rows.Count; j++)
                                {
                                    this.txtnumber_mat_no.Text = dt2.Rows[j]["txtnumber_mat_no"].ToString();      //1
                                    this.txtnumber_mat_id.Text = dt2.Rows[j]["txtnumber_mat_id"].ToString();      //2
                                    this.txtnumber_mat_name.Text = dt2.Rows[j]["txtnumber_mat_name"].ToString();      //3
                                    this.txtnumber_mat_name_eng.Text = dt2.Rows[j]["txtnumber_mat_name_eng"].ToString();      //4
                                    this.txtnumber_mat_remark.Text = dt2.Rows[j]["txtnumber_mat_remark"].ToString();      //6
                                }
                                this.iblword_status.Text = "แก้ไขรหัสเบอร์ผ้า";
                                this.txtnumber_mat_id.ReadOnly = true;
        ...
        private void BtnNew_Click(object sender, EventArgs e)
        {
            ...
            this.Hide();
            var frm2 = new HOME03_Production_17Number_mat();
        ...
        private void BtnSave_Click(object sender, EventArgs e)
        {
            if (this.txtnumber_mat_no.Text == "")
            {
                ...
                this.txtnumber_mat_no.Focus();
                return;
            }
            else
            {
                if (this.txtnumber_mat_no.TextLength == 3)
                {
                }
                else
                {
            ...
            if (this.txtnumber_mat_id.Text == "")
            {
                MessageBox.Show("โปรดใส่รหัสเบอร์ผ้า ก่อน !", "ผลการทำงาน", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                this.txtnumber_mat_id.Focus();
                return;
            }
            if (this.txtnumber_mat_name.Text == "")
            {
                MessageBox.Show("โปรดใส่ชื่อรหัสเบอร์ผ้าก่อน !", "ผลการทำงาน", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                this.txtnumber_mat_name.Focus();
                return;
            }
            ...
            //END เชื่อมต่อฐานข้อมูล=======================================================
            Cursor.Current = Cursors.WaitCursor;
            if (this.iblword_status.Text.Trim() == "เพิ่มรหัสเบอร์ผ้าใหม่")
            {
                conn.Open();
                if (conn.State == System.Data.ConnectionState.Open)
                {
                    ...
                    cmd1.CommandText = "SELECT * FROM c001_06number_mat" +
                                        " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                       " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                       " AND (txtnumber_mat_id = '" + this.txtnumber_mat_id.Text.Trim() + "')";
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        MessageBox.Show("รหัสรหัสเบอร์ผ้า นี้ซ้ำ   : '" + this.txtnumber_mat_id.Text.Trim() + "' โปรดใส่ใหม่ ", "ผลการทำงาน", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                        this.txtnumber_mat_id.Focus();
                        conn.Close();
                        return;
                    }
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                try
                {
                    if (this.iblword_status.Text.Trim() == "เพิ่มรหัสเบอร์ผ้าใหม่")
                    {
                        cmd2.CommandText = "INSERT INTO c001_06number_mat(cdkey,txtco_id," +  //1
                                           "txtnumber_mat_no,txtnumber_mat_id," +  //2
                                           "txtnumber_mat_name,txtnumber_mat_name_eng," +  //3
                                          "txtnumber_mat_remark," +  //5
                                          "txtnumber_mat_status) " +  //6
                        ...
                        cmd2.Parameters.Add("@txtnumber_mat_no", SqlDbType.NVarChar).Value = this.txtnumber_mat_no.Text.ToString();
                        cmd2.Parameters.Add("@txtnumber_mat_id", SqlDbType.NVarChar).Value = this.txtnumber_mat_id.Text.ToString();
                        cmd2.Parameters.Add("@txtnumber_mat_name", SqlDbType.NVarChar).Value = this.txtnumber_mat_name.Text.ToString();
                        cmd2.Parameters.Add("@txtnumber_mat_name_eng", SqlDbType.NVarChar).Value = this.txtnumber_mat_name_eng.Text.ToString();
                        cmd2.Parameters.Add("@txtnumber_mat_remark", SqlDbType.NVarChar).Value = this.txtnumber_mat_remark.Text.ToString();
                        cmd2.Parameters.Add("@txtnumber_mat_status", SqlDbType.NChar).Value = "0";
                        //==============================

                        cmd2.ExecuteNonQuery();

                    }
                    if (this.iblword_status.Text.Trim() == "แก้ไขรหัสเบอร์ผ้า")
                    {
                        cmd2.CommandText = "UPDATE c001_06number_mat SET " +
                                                                     "txtnumber_mat_no = '" + this.txtnumber_mat_no.Text.Trim() + "'," +
                                                                     "txtnumber_mat_name = '" + this.txtnumber_mat_name.Text.Trim() + "'," +
                                                                     "txtnumber_mat_name_eng = '" + this.txtnumber_mat_name_eng.Text.Trim() + "'," +
                                                                     "txtnumber_mat_remark = '" + this.txtnumber_mat_remark.Text.ToString() + "'" +
                                                                    " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                                                   " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                                                   " AND (txtnumber_mat_id = '" + this.txtnumber_mat_id.Text.Trim() + "')";
                        cmd2.ExecuteNonQuery();
                    ...
                    if (dialogResult == DialogResult.Yes)
                    {
                        ...
                        this.txtnumber_mat_id.Text = "";
                        this.txtnumber_mat_name.Text = "";
                        this.txtnumber_mat_name_eng.Text = "";
                        this.txtnumber_mat_remark.Text = "";
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                try
                {
                    if (this.iblword_status.Text.Trim() == "ยกเลิกเอกสาร")
                    {
                        ...
                        cmd2.CommandText = "INSERT INTO c001_06number_mat_cancel(cdkey,txtco_id,txtbranch_id," +  //1
                                                                                                            //"txttrans_date," +
                        ...
                        cmd2.CommandText = "INSERT INTO c001_06number_mat_cancel_detail(cdkey,txtco_id," +  //1
                                             "txtnumber_mat_no,txtnumber_mat_id," +  //2
                                             "txtnumber_mat_name,txtnumber_mat_name_eng," +  //3
                                             "txtnumber_mat_remark," +  //4
                                            "txtnumber_mat_status,cancel_id) " +  //5
                                             "VALUES (@cdkey2,@txtco_id2," +  //1
                                             "@txtnumber_mat_no,@txtnumber_mat_id," +  //2
                                             "@txtnumber_mat_name,@txtnumber_mat_name_eng," +  //3
                                             "@txtnumber_mat_remark," +  //4
                                            "@txtnumber_mat_status,@cancel_id2)";   //5
                        ...
                        cmd2.CommandText = "DELETE FROM c001_06number_mat" +
                                                                    " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                                                    " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                                                   " AND (txtnumber_mat_id = '" + this.txtnumber_mat_id.Text.Trim() + "')";
                        cmd2.ExecuteNonQuery();
                    ...
                    DialogResult dialogResult = MessageBox.Show("คุณต้องการ ยกเลิกเอกสาร รหัส  " + this.txtnumber_mat_id.Text.ToString() + " ใช่หรือไม่่ ?", "โปรดยืนยัน", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question);
                    if (dialogResult == DialogResult.Yes)
                    {
        ...
        private void txtnumber_mat_id_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            if (e.KeyChar == (char)Keys.Enter && this.txtnumber_mat_id.Text == "")
            {
                this.txtnumber_mat_id.Focus();
            }
            //========================================
            else if (e.KeyChar == (char)Keys.Enter && this.txtnumber_mat_id.Text.Trim() != "")
            {
                this.txtnumber_mat_no.Focus();
        ...
        private void txtnumber_mat_no_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == (char)Keys.Enter && this.txtnumber_mat_no.Text == "")
            {
                this.txtnumber_mat_no.Focus();
            }
            //========================================
            else if (e.KeyChar == (char)Keys.Enter && this.txtnumber_mat_no.Text.Trim() != "")
            {
                if (this.txtnumber_mat_no.TextLength == 3)
                {
                    this.txtnumber_mat_name.Focus();
            ...
            else if ((e.KeyChar > '9') && (e.KeyChar != '\b') && (e.KeyChar != '.') && txtnumber_mat_no.Text.Length == 0)
            {
                //e.KeyChar <= '0' || 
                e.Handled = true;
                return;
        ...
        private void txtnumber_mat_name_KeyDown(object sender, KeyEventArgs e)
        {

        }
        private void txtnumber_mat_name_eng_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
                this.txtnumber_mat_remark.Focus();

        }
        private void txtnumber_mat_name_remark_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
                this.BtnSave.Focus();
            ...
            if (OK.Trim() != "Y")
            {
                ...
                if (conn.State == System.Data.ConnectionState.Open)
                {
                    ...
                    try
                    {
                        ...
                        cmd2.Parameters.Add("@cdkey", SqlDbType.NVarChar).Value = W_ID_Select.CDKEY.Trim();
                        cmd2.Parameters.Add("@txtco_id", SqlDbType.NVarChar).Value = W_ID_Select.M_COID.Trim();
                        cmd2.Parameters.Add("@txtnumber_mat_no", SqlDbType.NVarChar).Value = "999";
                        cmd2.Parameters.Add("@txtnumber_mat_id", SqlDbType.NVarChar).Value = "";
                        cmd2.Parameters.Add("@txtnumber_mat_name", SqlDbType.NVarChar).Value = "";
                        cmd2.Parameters.Add("@txtnumber_mat_name_eng", SqlDbType.NVarChar).Value = "";
                        cmd2.Parameters.Add("@txtnumber_mat_remark", SqlDbType.NVarChar).Value = "";
                        cmd2.Parameters.Add("@txtnumber_mat_status", SqlDbType.NChar).Value = "0";
                        //==============================
