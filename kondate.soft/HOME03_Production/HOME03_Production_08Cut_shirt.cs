...
{
    public partial class HOME03_Production_08Cut_shirt : Form
    {
        //Move Form ====================================
        ...
        public HOME03_Production_08Cut_shirt()
        {
            InitializeComponent();
        }

        private void HOME03_Production_08Cut_shirt_Load(object sender, EventArgs e)
        {
            ...
            W_ID_Select.M_FORM_NUMBER = "H0308CSGR";
            CHECK_ADD_FORM();

            CHECK_USER_RULE();

            this.iblword_top.Text = W_ID_Select.WORD_TOP.Trim();
            this.iblword_status.Text = "ระเบียนใบสั่งตัด";
            ...
            //========================================
            this.cboSearch.Items.Add("เลขที่ใบสั่งตัด");
            this.cboSearch.Items.Add("ชื่อผู้บันทึกใบสั่งตัด");
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        ...
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            this.GridView1.Rows[index].Cells["Col_txtCS_id"].Value = dt2.Rows[j]["txtCS_id"].ToString();      //3
                            ...
                            this.GridView1.Rows[index].Cells["Col_txttable_number"].Value = dt2.Rows[j]["txttable_number"].ToString();      //6

                            this.GridView1.Rows[index].Cells["Col_txtshirt_size_id"].Value = dt2.Rows[j]["txtshirt_size_id"].ToString();      //7
                            this.GridView1.Rows[index].Cells["Col_txtshirt_size_name"].Value = dt2.Rows[j]["txtshirt_size_name"].ToString();      //8

                            this.GridView1.Rows[index].Cells["Col_txtshirt_type_id"].Value = dt2.Rows[j]["txtshirt_type_id"].ToString();      //9
                            this.GridView1.Rows[index].Cells["Col_txtshirt_type_name"].Value = dt2.Rows[j]["txtshirt_type_name"].ToString();      //10

                            this.GridView1.Rows[index].Cells["Col_txtnumber_color_id"].Value = dt2.Rows[j]["txtnumber_color_id"].ToString();      //11
                            this.GridView1.Rows[index].Cells["Col_txtnumber_color_name"].Value = dt2.Rows[j]["txtnumber_color_name"].ToString();      //12

                            this.GridView1.Rows[index].Cells["Col_txtcut_type_id"].Value = dt2.Rows[j]["txtcut_type_id"].ToString();      //13
                            this.GridView1.Rows[index].Cells["Col_txtcut_type_name"].Value = dt2.Rows[j]["txtcut_type_name"].ToString();      //14

                            this.GridView1.Rows[index].Cells["Col_txtemp_name_poo_pa"].Value = dt2.Rows[j]["txtemp_name_poo_pa"].ToString();      //15
                            this.GridView1.Rows[index].Cells["Col_txtemp_name_jai_pa"].Value = dt2.Rows[j]["txtemp_name_jai_pa"].ToString();      //16
                            this.GridView1.Rows[index].Cells["Col_txtemp_name_cang_tad"].Value = dt2.Rows[j]["txtemp_name_cang_tad"].ToString();      //17

                            this.GridView1.Rows[index].Cells["Col_txtsupplier_id"].Value = dt2.Rows[j]["txtsupplier_id"].ToString();      //18
                            this.GridView1.Rows[index].Cells["Col_txtsupplier_name"].Value = dt2.Rows[j]["txtsupplier_name"].ToString();      //19

                            this.GridView1.Rows[index].Cells["Col_txtshirt_cut_remark"].Value = dt2.Rows[j]["txtshirt_cut_remark"].ToString();      //20

                            this.GridView1.Rows[index].Cells["Col_txtemp_office_name"].Value = dt2.Rows[j]["txtemp_office_name"].ToString();      //21

                            this.GridView1.Rows[index].Cells["Col_txtsum_qty_pub"].Value = Convert.ToSingle(dt2.Rows[j]["txtsum_qty_pub"]).ToString("###,###.00");      //22
                            this.GridView1.Rows[index].Cells["Col_txtsum_qty_rib"].Value = Convert.ToSingle(dt2.Rows[j]["txtsum_qty_rib"]).ToString("###,###.00");      //23
                            this.GridView1.Rows[index].Cells["Col_txtsum_qty"].Value = Convert.ToSingle(dt2.Rows[j]["txtsum_qty"]).ToString("###,###.00");      //24

                            this.GridView1.Rows[index].Cells["Col_txtqty_chan"].Value = Convert.ToSingle(dt2.Rows[j]["txtqty_chan"]).ToString("###,###.00");      //25
                            this.GridView1.Rows[index].Cells["Col_txtqty_many_per_chan"].Value = Convert.ToSingle(dt2.Rows[j]["txtqty_many_per_chan"]).ToString("###,###.00");      //26
                            this.GridView1.Rows[index].Cells["Col_txtqty_amount"].Value = Convert.ToSingle(dt2.Rows[j]["txtqty_amount"]).ToString("###,###.00");      //27


                            //CS ==============================
                            if (dt2.Rows[j]["txtcs_status"].ToString() == "")
                            {
                                this.GridView1.Rows[index].Cells["Col_txtcs_status"].Value = ""; //28
                            }
                            ...
                            {
                                this.GridView1.Rows[index].Cells["Col_txtcs_status"].Value = "ยกเลิก"; //28
                            }
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                else
                {
                    cmd2.CommandText = "SELECT c002_08Cut_shirt_record.*," +
                                       ...
                                       " WHERE (c002_08Cut_shirt_record.cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                       " AND (c002_08Cut_shirt_record.txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                    " AND (c002_08Cut_shirt_record.txtbranch_id = '" + this.txtbranch_id.Text.Trim() + "')" +
                                  " AND (c002_08Cut_shirt_record.txttrans_date_server BETWEEN @datestart AND @dateend)" +
                                  " ORDER BY c002_08Cut_shirt_record.txtCS_id ASC";
        ...
        private void Show_GridView1()
        {
            ...
            this.GridView1.Columns[3].Name = "Col_txtCS_id";
            this.GridView1.Columns[4].Name = "Col_txttrans_date_server";
            this.GridView1.Columns[5].Name = "Col_txttrans_time";
            this.GridView1.Columns[6].Name = "Col_txttable_number";     //โต๊ะ
            this.GridView1.Columns[7].Name = "Col_txtshirt_size_id";    //ไซส์
            this.GridView1.Columns[8].Name = "Col_txtshirt_size_name";

            this.GridView1.Columns[9].Name = "Col_txtshirt_type_id";  //ชนิดเสื้อ คอV คอกลม
            this.GridView1.Columns[10].Name = "Col_txtshirt_type_name";

            this.GridView1.Columns[11].Name = "Col_txtnumber_color_id";  //สีเสื้อ
            this.GridView1.Columns[12].Name = "Col_txtnumber_color_name";

            this.GridView1.Columns[13].Name = "Col_txtcut_type_id";   //ประเภทตัด
            this.GridView1.Columns[14].Name = "Col_txtcut_type_name";

            this.GridView1.Columns[15].Name = "Col_txtemp_name_poo_pa";
            this.GridView1.Columns[16].Name = "Col_txtemp_name_jai_pa";
            this.GridView1.Columns[17].Name = "Col_txtemp_name_cang_tad";

            this.GridView1.Columns[18].Name = "Col_txtsupplier_id";
            this.GridView1.Columns[19].Name = "Col_txtsupplier_name";

            this.GridView1.Columns[20].Name = "Col_txtshirt_cut_remark";

            this.GridView1.Columns[21].Name = "Col_txtemp_office_name";

            this.GridView1.Columns[22].Name = "Col_txtsum_qty_pub";
            this.GridView1.Columns[23].Name = "Col_txtsum_qty_rib";
            this.GridView1.Columns[24].Name = "Col_txtsum_qty";

            this.GridView1.Columns[25].Name = "Col_txtqty_chan";
            this.GridView1.Columns[26].Name = "Col_txtqty_many_per_chan";
            this.GridView1.Columns[27].Name = "Col_txtqty_amount";
            this.GridView1.Columns[28].Name = "Col_txtcs_status";
            ...
            this.GridView1.Columns[3].HeaderText = " เลขที่ใบสั่งตัด";
            this.GridView1.Columns[4].HeaderText = " วันที่";
            this.GridView1.Columns[5].HeaderText = " เวลา";

            this.GridView1.Columns[6].HeaderText = " โต๊ะที่ ";
            this.GridView1.Columns[7].HeaderText = "รหัสไซส์";
            this.GridView1.Columns[8].HeaderText = "ไซส์ เสื้อ"; // S M L
            this.GridView1.Columns[9].HeaderText = "รหัสชนิดเสื้อ";
            this.GridView1.Columns[10].HeaderText = "ชนิด เสื้อ";   //คอกลม คอวี

            this.GridView1.Columns[11].HeaderText = "รหัสสี";
            this.GridView1.Columns[12].HeaderText = "สี";

            this.GridView1.Columns[13].HeaderText = "รหัสสั่งตัด";
            this.GridView1.Columns[14].HeaderText = "ประเภทสั่งตัด";

            this.GridView1.Columns[15].HeaderText = " ผู้ปูผ้า";
            this.GridView1.Columns[16].HeaderText = " ผู้จ่ายผ้า";
            this.GridView1.Columns[17].HeaderText = " ช่างตัด";

            this.GridView1.Columns[18].HeaderText = " รหัส Supplier";
            this.GridView1.Columns[19].HeaderText = " ชื่อ Supplier";

            this.GridView1.Columns[20].HeaderText = " หมายเหตุ";
            this.GridView1.Columns[21].HeaderText = " ผู้บันทึก";

            this.GridView1.Columns[22].HeaderText = " จำนวน(พับ)";
            this.GridView1.Columns[23].HeaderText = " บุ้ง(พับ)";
            this.GridView1.Columns[24].HeaderText = " จำนวน(Kg)";

            this.GridView1.Columns[25].HeaderText = " จำนวนชั้น";
            this.GridView1.Columns[26].HeaderText = "จำนวนตัว/ชั้น";
            this.GridView1.Columns[27].HeaderText = " จำนวนตัว";

            this.GridView1.Columns[28].HeaderText = " สถานะ";
            ...
            this.GridView1.Columns["Col_txtCS_id"].Width = 140;
            ...
            this.GridView1.Columns["Col_txttable_number"].Width = 80;
            ...
            this.GridView1.Columns["Col_txtshirt_size_name"].Visible = true;  //"Col_txtshirt_size_name";
            this.GridView1.Columns["Col_txtshirt_size_name"].Width = 120;
            this.GridView1.Columns["Col_txtshirt_size_name"].ReadOnly = true;
            this.GridView1.Columns["Col_txtshirt_size_name"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.GridView1.Columns["Col_txtshirt_size_name"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
            ...
            this.GridView1.Columns["Col_txtshirt_type_name"].Width = 120;
            ...
            this.GridView1.Columns["Col_txtnumber_color_name"].Visible = true;  //"Col_txtnumber_color_name";
            this.GridView1.Columns["Col_txtnumber_color_name"].Width = 120;
            this.GridView1.Columns["Col_txtnumber_color_name"].ReadOnly = true;
            this.GridView1.Columns["Col_txtnumber_color_name"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.GridView1.Columns["Col_txtnumber_color_name"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;

            this.GridView1.Columns["Col_txtcut_type_id"].Visible = false;  //"Col_txtcut_type_id";

            this.GridView1.Columns["Col_txtcut_type_name"].Visible = true;  //"Col_txtcut_type_name";
            this.GridView1.Columns["Col_txtcut_type_name"].Width = 120;
            this.GridView1.Columns["Col_txtcut_type_name"].ReadOnly = true;
            this.GridView1.Columns["Col_txtcut_type_name"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.GridView1.Columns["Col_txtcut_type_name"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;

            this.GridView1.Columns["Col_txtemp_name_poo_pa"].Visible = false;  //"Col_txtemp_name_poo_pa";
            this.GridView1.Columns["Col_txtemp_name_poo_pa"].Width = 0;
            this.GridView1.Columns["Col_txtemp_name_poo_pa"].ReadOnly = true;
            this.GridView1.Columns["Col_txtemp_name_poo_pa"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.GridView1.Columns["Col_txtemp_name_poo_pa"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;

            this.GridView1.Columns["Col_txtemp_name_jai_pa"].Visible = false;  //"Col_txtemp_name_jai_pa";
            this.GridView1.Columns["Col_txtemp_name_jai_pa"].Width =0;
            this.GridView1.Columns["Col_txtemp_name_jai_pa"].ReadOnly = true;
            this.GridView1.Columns["Col_txtemp_name_jai_pa"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.GridView1.Columns["Col_txtemp_name_jai_pa"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;

            this.GridView1.Columns["Col_txtemp_name_cang_tad"].Visible = false;  //"Col_txtemp_name_cang_tad";
            this.GridView1.Columns["Col_txtemp_name_cang_tad"].Width = 0;
            this.GridView1.Columns["Col_txtemp_name_cang_tad"].ReadOnly = true;
            this.GridView1.Columns["Col_txtemp_name_cang_tad"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.GridView1.Columns["Col_txtemp_name_cang_tad"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
            ...
            this.GridView1.Columns["Col_txtsupplier_name"].Width =0;
            ...
            this.GridView1.Columns["Col_txtshirt_cut_remark"].Visible = true;  //"Col_txtshirt_cut_remark";
            this.GridView1.Columns["Col_txtshirt_cut_remark"].Width =150;
            this.GridView1.Columns["Col_txtshirt_cut_remark"].ReadOnly = true;
            this.GridView1.Columns["Col_txtshirt_cut_remark"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.GridView1.Columns["Col_txtshirt_cut_remark"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
            ...
            this.GridView1.Columns["Col_txtsum_qty_pub"].Width = 80;
            ...
            this.GridView1.Columns["Col_txtsum_qty_rib"].Width = 80;
            ...
            this.GridView1.Columns["Col_txtsum_qty"].Width = 80;
            ...
            this.GridView1.Columns["Col_txtqty_chan"].Visible = true;  //"Col_txtqty_chan";
            this.GridView1.Columns["Col_txtqty_chan"].Width = 80;
            this.GridView1.Columns["Col_txtqty_chan"].ReadOnly = true;
            this.GridView1.Columns["Col_txtqty_chan"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.GridView1.Columns["Col_txtqty_chan"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;

            this.GridView1.Columns["Col_txtqty_many_per_chan"].Visible = true;  //"Col_txtqty_many_per_chan";
            this.GridView1.Columns["Col_txtqty_many_per_chan"].Width = 120;
            this.GridView1.Columns["Col_txtqty_many_per_chan"].ReadOnly = true;
            this.GridView1.Columns["Col_txtqty_many_per_chan"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.GridView1.Columns["Col_txtqty_many_per_chan"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;

            this.GridView1.Columns["Col_txtqty_amount"].Visible = true;  //"Col_txtqty_amount";
            this.GridView1.Columns["Col_txtqty_amount"].Width = 80;
            ...
            this.GridView1.Columns["Col_txtcs_status"].Visible = true;  //"Col_txtcs_status";
            this.GridView1.Columns["Col_txtcs_status"].Width = 70;
            this.GridView1.Columns["Col_txtcs_status"].ReadOnly = true;
            this.GridView1.Columns["Col_txtcs_status"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.GridView1.Columns["Col_txtcs_status"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
        ...
        private void GridView1_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                if (cell != null)
                {
                    ...
                    this.cboSearch.Text = "เลขที่ใบสั่งตัด";

                    if (this.cboSearch.Text == "เลขที่ใบสั่งตัด")
                    {
                        this.txtsearch.Text = row.Cells[3].Value.ToString();
                        W_ID_Select.TRANS_ID = row.Cells[3].Value.ToString();

                    }
                    else if (this.cboSearch.Text == "ชื่อผู้บันทึกใบสั่งตัด")
                    {
        ...
        private void GridView1_DoubleClick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                W_ID_Select.WORD_TOP = "ดูข้อมูลใบสั่งตัด";
                kondate.soft.HOME03_Production.HOME03_Production_08Cut_shirt_record_detail frm2 = new kondate.soft.HOME03_Production.HOME03_Production_08Cut_shirt_record_detail();
                frm2.Show();
        ...
        private void btnGo4_Click(object sender, EventArgs e)
        {
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                if (this.cboSearch.Text.Trim() == "เลขที่ใบสั่งตัด")
                {
                    cmd2.CommandText = "SELECT c002_08Cut_shirt_record.*," +
                                       "c001_09shirt_size.*," +
                                       "c001_08shirt_type.*," +
                                       ...
                                       " AND (c002_08Cut_shirt_record.txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                   " AND (c002_08Cut_shirt_record.txttrans_date_server BETWEEN @datestart AND @dateend)" +
                                   " AND (c002_08Cut_shirt_record.txtCS_id = '" + this.txtsearch.Text.Trim() + "')" +
                                  " ORDER BY c002_08Cut_shirt_record.txtCS_id ASC";
                }
                else if (this.cboSearch.Text.Trim() == "ชื่อผู้บันทึกใบสั่งตัด")
                {
                    cmd2.CommandText = "SELECT c002_08Cut_shirt_record.*," +
                                       "c001_09shirt_size.*," +
                                       "c001_08shirt_type.*," +
                                    ...
                                    " AND (c002_08Cut_shirt_record.txtbranch_id = '" + this.txtbranch_id.Text.Trim() + "')" +
                                    " AND (c002_08Cut_shirt_record.txttrans_date_server BETWEEN @datestart AND @dateend)" +
                                    " AND (c002_08Cut_shirt_record.txtemp_office_name LIKE '%" + this.txtsearch.Text.Trim() + "%')" +
                                    " ORDER BY c002_08Cut_shirt_record.txtCS_id ASC";
                }
                cmd2.Parameters.Add("@datestart", SqlDbType.Date).Value = this.dtpstart.Value;
                cmd2.Parameters.Add("@dateend", SqlDbType.Date).Value = this.dtpend.Value;
        ...
        private void BtnNew_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                W_ID_Select.WORD_TOP = "บันทึกใบสั่งตัด";
