...
{
    public partial class HOME03_Production_10Receive_FG4_record_Stock : Form
    {
        //Move Form ====================================
        ...
        public HOME03_Production_10Receive_FG4_record_Stock()
        {
            InitializeComponent();
        }
        ...
        private void HOME04_Warehouse_01Mat_Average_Load(object sender, EventArgs e)
        {
            ...
            W_ID_Select.M_FORM_NUMBER = "H0310FG4STGR";
            CHECK_ADD_FORM();

            CHECK_USER_RULE();

            this.iblword_top.Text = W_ID_Select.WORD_TOP.Trim();
            this.iblword_status.Text = "คลิ๊ก ดูสต๊อค รายการเสื้อยึดสำเร็จรูป FG4";
        ...
        private void Fill_Show_DATA_GridView3()
        {
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                cmd2.CommandText = "SELECT c002_10Receive_FG4_record.*," +
                                   ...
                                   //" ON c002_10Receive_FG4_record.cdkey = c001_04produce_type.cdkey" +
                                   //" AND c002_10Receive_FG4_record.txtco_id = c001_04produce_type.txtco_id" +
                                   //" AND c002_10Receive_FG4_record.txtproduce_type_id = c001_04produce_type.txtproduce_type_id" +

                                   //" INNER JOIN c001_02machine" +
                                   //" ON c002_10Receive_FG4_record_detail.cdkey = c001_02machine.cdkey" +
                                   //" AND c002_10Receive_FG4_record_detail.txtco_id = c001_02machine.txtco_id" +
                                   //" AND c002_10Receive_FG4_record_detail.txtmachine_id = c001_02machine.txtmachine_id" +

                                   //" INNER JOIN c001_05face_baking" +
                                   //" ON c002_10Receive_FG4_record.cdkey = c001_05face_baking.cdkey" +
                                   //" AND c002_10Receive_FG4_record.txtco_id = c001_05face_baking.txtco_id" +
                                   //" AND c002_10Receive_FG4_record.txtface_baking_id = c001_05face_baking.txtface_baking_id" +

                                   //" INNER JOIN c001_06number_mat" +
                                   //" ON c002_10Receive_FG4_record.cdkey = c001_06number_mat.cdkey" +
                                   //" AND c002_10Receive_FG4_record.txtco_id = c001_06number_mat.txtco_id" +
                                   //" AND c002_10Receive_FG4_record.txtnumber_mat_id = c001_06number_mat.txtnumber_mat_id" +
                                   ...
                                   //" ON c002_10Receive_FG4_record.cdkey = k013_1db_acc_06wherehouse.cdkey" +
                                   //" AND c002_10Receive_FG4_record.txtco_id = k013_1db_acc_06wherehouse.txtco_id" +
                                   //" AND c002_10Receive_FG4_record.txtwherehouse_id = k013_1db_acc_06wherehouse.txtwherehouse_id" +
                                    ...
                                    " AND (c002_10Receive_FG4_record_detail.txtmat_id = '" + W_ID_Select.MAT_ID + "')" +

                                    //" AND (c002_10Receive_FG4_record.txticrf_id = '" + W_ID_Select.TRANS_ID.Trim() + "')" +
                                    //" AND (c002_10Receive_FG4_record.txttrans_date_server BETWEEN @datestart AND @dateend)" +
                                    " AND (c002_10Receive_FG4_record_detail.txtwherehouse_id = '" + this.PANEL1306_WH_txtwherehouse_id.Text.Trim() + "')" +
                                    " AND (c002_10Receive_FG4_record_detail.txtqty_after_cut > 0)" +
                                    " ORDER BY c002_10Receive_FG4_record_detail.txtLot_no ASC";
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        ...
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            GridView3.Rows[index].Cells["Col_txtFG4_id"].Value = dt2.Rows[j]["txtFG4_id"].ToString();      //1
        ...
        private void Show_GridView3()
        {
            ...
            this.GridView3.Columns[1].Name = "Col_txtFG4_id";
            ...
            this.GridView3.Columns[1].HeaderText = "เลขที่ FG4";
            ...
            this.GridView3.Columns["Col_txtFG4_id"].Visible = true;  //"Col_txtFG4_id";
            this.GridView3.Columns["Col_txtFG4_id"].Width = 140;
            this.GridView3.Columns["Col_txtFG4_id"].ReadOnly = true;
            this.GridView3.Columns["Col_txtFG4_id"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.GridView3.Columns["Col_txtFG4_id"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
        ...
        private void GridView3_CellMouseClick_1(object sender, DataGridViewCellMouseEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                if (cell != null)
                {
                    W_ID_Select.TRANS_ID = row.Cells["Col_txtFG4_id"].Value.ToString();
                    this.cboSearch.Text = "เลขที่FG4 เสื้อยึดสำเร็จรูป FG4";

                    if (this.cboSearch.Text == "เลขที่FG4 เสื้อยึดสำเร็จรูป FG4")
                    {
                        this.txtsearch.Text = row.Cells["Col_txtFG4_id"].Value.ToString();
                        W_ID_Select.TRANS_ID = row.Cells["Col_txtFG4_id"].Value.ToString();
        ...
        private void GridView3_DoubleClick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                W_ID_Select.WORD_TOP = "ดูข้อมูลFG4 เสื้อยึดสำเร็จรูป FG4";
