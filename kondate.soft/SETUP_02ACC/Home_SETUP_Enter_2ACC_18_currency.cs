...
{
    public partial class Home_SETUP_Enter_2ACC_18_currency : Form
    {
        //Move Form ====================================
        ...
        public Home_SETUP_Enter_2ACC_18_currency()
        {
            InitializeComponent();
        }

        private void Home_SETUP_Enter_2ACC_18_Load(object sender, EventArgs e)
        {
            W_ID_Select.M_FORM_NUMBER = "S218";
            CHECK_ADD_FORM();
            ...
            this.iblword_status.Text = "เพิ่มรหัสสกุลเงินใหม่";
            this.txtcurrency_id.ReadOnly = false;

            this.ActiveControl = this.txtcurrency_id;
        ...
        private void Run_ID()
        {
            if (this.txtcurrency_no.Text == "")
            {
                this.txtcurrency_no.Text = "001";
            }
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                cmd2.CommandText = "SELECT *" +
                                    " FROM k013_1db_acc_18currency" +
                                    " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                    //" AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                    " AND (txtcurrency_id <> '')" +
                                    " ORDER BY txtcurrency_no DESC";
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            //this.PANEL_FORM1_dataGridView1.Columns[1].Name = "Col_txtcurrency_no";
                            //this.PANEL_FORM1_dataGridView1.Columns[2].Name = "Col_txtcurrency_id";
                            //this.PANEL_FORM1_dataGridView1.Columns[3].Name = "Col_txtcurrency_name";
                            //this.PANEL_FORM1_dataGridView1.Columns[4].Name = "Col_txtcurrency_name_eng";
                            //this.PANEL_FORM1_dataGridView1.Columns[5].Name = "Col_txtcurrency_name_remark";
                            //this.PANEL_FORM1_dataGridView1.Columns[6].Name = "Col_txtcurrency_status";

                            var index = GridView1.Rows.Add();
                            GridView1.Rows[index].Cells["Col_Auto_num"].Value = ""; //0
                            GridView1.Rows[index].Cells["Col_txtcurrency_no"].Value = dt2.Rows[j]["txtcurrency_no"].ToString();      //1
                            GridView1.Rows[index].Cells["Col_txtcurrency_id"].Value = dt2.Rows[j]["txtcurrency_id"].ToString();      //2
                            GridView1.Rows[index].Cells["Col_txtcurrency_name"].Value = dt2.Rows[j]["txtcurrency_name"].ToString();      //3
                            GridView1.Rows[index].Cells["Col_txtcurrency_name_eng"].Value = dt2.Rows[j]["txtcurrency_name_eng"].ToString();      //4
                            GridView1.Rows[index].Cells["Col_txtcurrency_remark"].Value = dt2.Rows[j]["txtcurrency_remark"].ToString();      //5
                            GridView1.Rows[index].Cells["Col_txtcurrency_status"].Value = dt2.Rows[j]["txtcurrency_status"].ToString();      //6
        ...
        private void PANEL_FORM1_GridView1()
        {
            ...
            this.GridView1.Columns[1].Name = "Col_txtcurrency_no";
            this.GridView1.Columns[2].Name = "Col_txtcurrency_id";
            this.GridView1.Columns[3].Name = "Col_txtcurrency_name";
            this.GridView1.Columns[4].Name = "Col_txtcurrency_name_eng";
            this.GridView1.Columns[5].Name = "Col_txtcurrency_remark";
            this.GridView1.Columns[6].Name = "Col_txtcurrency_status";

            this.GridView1.Columns[0].HeaderText = "No";
            this.GridView1.Columns[1].HeaderText = "ลำดับ";
            this.GridView1.Columns[2].HeaderText = " รหัส";
            this.GridView1.Columns[3].HeaderText = " ชื่อรหัสสกุลเงิน";
            this.GridView1.Columns[4].HeaderText = "ชื่อรหัสสกุลเงิน Eng";
            ...
            this.GridView1.Columns[1].Visible = true;  //"Col_txtcurrency_no";
            ...
            this.GridView1.Columns[2].Visible = true;  //"Col_txtcurrency_id";
            ...
            this.GridView1.Columns[3].Visible = true;  //"Col_txtcurrency_name";
            ...
            this.GridView1.Columns[4].Visible = true;  //"Col_txtcurrency_name_eng";
            ...
            this.GridView1.Columns[5].Visible = true;  //"Col_txtcurrency_name_remark";
            ...
            this.GridView1.Columns[6].Visible = false;  //"Col_txtcurrency_status";
        ...
        private void PANEL_FORM1_dataGridView1_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                if (cell != null)
                {
                    ...
                    this.txtcurrency_no.Text = row.Cells[1].Value.ToString();
                    this.txtcurrency_id.Text = row.Cells[2].Value.ToString();
                    this.txtcurrency_name.Text = row.Cells[3].Value.ToString();
                    ...
                    if (conn.State == System.Data.ConnectionState.Open)
                    {
                        ...
                        cmd2.CommandText = "SELECT *" +
                                            " FROM k013_1db_acc_18currency" +
                                             " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                             //" AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                             " AND (txtcurrency_id = '" + this.txtcurrency_id.Text.Trim() + "')" +
                                           " ORDER BY txtcurrency_no ASC";
                        ...
                        try
                        {
                            ...
                            if (dt2.Rows.Count > 0)
                            {
                                for (int j = 0; j < dt2.Rows.Count; j++)
                                {
                                    this.txtcurrency_no.Text = dt2.Rows[j]["txtcurrency_no"].ToString();      //1
                                    this.txtcurrency_id.Text = dt2.Rows[j]["txtcurrency_id"].ToString();      //2
                                    this.txtcurrency_name.Text = dt2.Rows[j]["txtcurrency_name"].ToString();      //3
                                    this.txtcurrency_name_eng.Text = dt2.Rows[j]["txtcurrency_name_eng"].ToString();      //4
                                    this.txtcurrency_remark.Text = dt2.Rows[j]["txtcurrency_remark"].ToString();      //6
                                }
                                this.iblword_status.Text = "แก้ไขรหัสสกุลเงิน";
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                cmd2.CommandText = "SELECT *" +
                                    " FROM k013_1db_acc_18currency" +
                                     " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                     //" AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                     " AND (txtcurrency_name LIKE '%" + this.PANEL_FORM1_txtsearch.Text.Trim() + "%')" +
                                   " ORDER BY txtcurrency_no ASC";
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            //this.PANEL_FORM1_dataGridView1.Columns[3].Name = "Col_txtcurrency_name";
                            //this.PANEL_FORM1_dataGridView1.Columns[4].Name = "Col_txtcurrency_name_eng";
                            //this.PANEL_FORM1_dataGridView1.Columns[5].Name = "Col_txtcurrency_remark";
                            //this.PANEL_FORM1_dataGridView1.Columns[6].Name = "Col_txtcurrency_status";
                            ...
                            GridView1.Rows[index].Cells["Col_txtcurrency_name"].Value = dt2.Rows[j]["txtcurrency_name"].ToString();      //3
                            GridView1.Rows[index].Cells["Col_txtcurrency_name_eng"].Value = dt2.Rows[j]["txtcurrency_name_eng"].ToString();      //4
                            GridView1.Rows[index].Cells["Col_txtcurrency_remark"].Value = dt2.Rows[j]["txtcurrency_remark"].ToString();      //6
                            GridView1.Rows[index].Cells["Col_txtcurrency_status"].Value = dt2.Rows[j]["txtcurrency_status"].ToString();      //7
        ...
        private void BtnNew_Click(object sender, EventArgs e)
        {
            ...
            this.Hide();
            var frm2 = new Home_SETUP_Enter_2ACC_18_currency();
        ...
        private void BtnSave_Click(object sender, EventArgs e)
        {
            if (this.txtcurrency_no.Text == "")
            {
                ...
                this.txtcurrency_no.Focus();
                return;
            }
            else
            {
                if (this.txtcurrency_no.TextLength == 3)
                {
                }
                else
                {
            ...
            if (this.txtcurrency_id.Text == "")
            {
                MessageBox.Show("โปรดใส่รหัสรหัสสกุลเงิน ก่อน !", "ผลการทำงาน", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                this.txtcurrency_id.Focus();
                return;
            }
            if (this.txtcurrency_name.Text == "")
            {
                MessageBox.Show("โปรดใส่ชื่อรหัสสกุลเงินก่อน !", "ผลการทำงาน", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                this.txtcurrency_name.Focus();
                return;
            }
            ...
            //END เชื่อมต่อฐานข้อมูล=======================================================
            Cursor.Current = Cursors.WaitCursor;
            if (this.iblword_status.Text.Trim() == "เพิ่มรหัสสกุลเงินใหม่")
            {
                conn.Open();
                if (conn.State == System.Data.ConnectionState.Open)
                {
                    ...
                    cmd1.CommandText = "SELECT * FROM k013_1db_acc_18currency" +
                                        " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                       //" AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                       " AND (txtcurrency_id = '" + this.txtcurrency_id.Text.Trim() + "')";
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        MessageBox.Show("รหัสรหัสสกุลเงิน นี้ซ้ำ   : '" + this.txtcurrency_id.Text.Trim() + "' โปรดใส่ใหม่ ", "ผลการทำงาน", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                        this.txtcurrency_id.Focus();
                        conn.Close();
                        return;
                    }
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                try
                {
                    if (this.iblword_status.Text.Trim() == "เพิ่มรหัสสกุลเงินใหม่")
                    {
                        cmd2.CommandText = "INSERT INTO k013_1db_acc_18currency(cdkey,txtco_id," +  //1
                                           "txtcurrency_no,txtcurrency_id," +  //2
                                           "txtcurrency_name,txtcurrency_name_eng," +  //3
                                          "txtcurrency_remark," +  //5
                                          "txtcurrency_status) " +  //6
                        ...
                        cmd2.Parameters.Add("@txtcurrency_no", SqlDbType.NVarChar).Value = this.txtcurrency_no.Text.ToString();
                        cmd2.Parameters.Add("@txtcurrency_id", SqlDbType.NVarChar).Value = this.txtcurrency_id.Text.ToString();
                        cmd2.Parameters.Add("@txtcurrency_name", SqlDbType.NVarChar).Value = this.txtcurrency_name.Text.ToString();
                        cmd2.Parameters.Add("@txtcurrency_name_eng", SqlDbType.NVarChar).Value = this.txtcurrency_name_eng.Text.ToString();
                        cmd2.Parameters.Add("@txtcurrency_remark", SqlDbType.NVarChar).Value = this.txtcurrency_remark.Text.ToString();
                        cmd2.Parameters.Add("@txtcurrency_status", SqlDbType.NChar).Value = "0";
                        //==============================

                        cmd2.ExecuteNonQuery();

                    }
                    if (this.iblword_status.Text.Trim() == "แก้ไขรหัสสกุลเงิน")
                    {
                        cmd2.CommandText = "UPDATE k013_1db_acc_18currency SET " +
                                                                     "txtcurrency_no = '" + this.txtcurrency_no.Text.Trim() + "'," +
                                                                     "txtcurrency_name = '" + this.txtcurrency_name.Text.Trim() + "'," +
                                                                     "txtcurrency_name_eng = '" + this.txtcurrency_name_eng.Text.Trim() + "'," +
                                                                     "txtcurrency_remark = '" + this.txtcurrency_remark.Text.ToString() + "'" +
                                                                    " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                                                   //" AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                                                   " AND (txtcurrency_id = '" + this.txtcurrency_id.Text.Trim() + "')";
                        cmd2.ExecuteNonQuery();
                    ...
                    if (dialogResult == DialogResult.Yes)
                    {
                        ...
                        this.txtcurrency_id.Text = "";
                        this.txtcurrency_name.Text = "";
                        this.txtcurrency_name_eng.Text = "";
                        this.txtcurrency_remark.Text = "";
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                try
                {
                    if (this.iblword_status.Text.Trim() == "ยกเลิกเอกสาร")
                    {
                        ...
                        cmd2.CommandText = "INSERT INTO k013_1db_acc_18currency_cancel(cdkey,txtco_id,txtbranch_id," +  //1
                                                                                                                   //"txttrans_date," +
                        ...
                        cmd2.CommandText = "INSERT INTO k013_1db_acc_18currency_cancel_detail(cdkey,txtco_id," +  //1
                                             "txtcurrency_no,txtcurrency_id," +  //2
                                             "txtcurrency_name,txtcurrency_name_eng," +  //3
                                             "txtcurrency_remark," +  //4
                                            "txtcurrency_status,cancel_id) " +  //5
                                             "VALUES (@cdkey2,@txtco_id2," +  //1
                                             "@txtcurrency_no,@txtcurrency_id," +  //2
                                             "@txtcurrency_name,@txtcurrency_name_eng," +  //3
                                             "@txtcurrency_remark," +  //4
                                            "@txtcurrency_status,@cancel_id2)";   //5
                        ...
                        cmd2.CommandText = "DELETE FROM k013_1db_acc_18currency" +
                                                                    " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                                                    " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                                                   " AND (txtcurrency_id = '" + this.txtcurrency_id.Text.Trim() + "')";
                        cmd2.ExecuteNonQuery();
                    ...
                    DialogResult dialogResult = MessageBox.Show("คุณต้องการ ยกเลิกเอกสาร รหัส  " + this.txtcurrency_id.Text.ToString() + " ใช่หรือไม่่ ?", "โปรดยืนยัน", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question);
                    if (dialogResult == DialogResult.Yes)
                    {
        ...
        private void txtcurrency_id_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            if (e.KeyChar == (char)Keys.Enter && this.txtcurrency_id.Text == "")
            {
                this.txtcurrency_id.Focus();
            }
            //========================================
            else if (e.KeyChar == (char)Keys.Enter && this.txtcurrency_id.Text.Trim() != "")
            {
                this.txtcurrency_no.Focus();
        ...
        private void txtcurrency_no_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == (char)Keys.Enter && this.txtcurrency_no.Text == "")
            {
                this.txtcurrency_no.Focus();
            }
            //========================================
            else if (e.KeyChar == (char)Keys.Enter && this.txtcurrency_no.Text.Trim() != "")
            {
                if (this.txtcurrency_no.TextLength == 3)
                {
                    this.txtcurrency_name.Focus();
            ...
            else if ((e.KeyChar > '9') && (e.KeyChar != '\b') && (e.KeyChar != '.') && txtcurrency_no.Text.Length == 0)
            {
                //e.KeyChar <= '0' || 
                e.Handled = true;
                return;
        ...
        private void txtcurrency_name_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
                this.txtcurrency_name_eng.Focus();

        }
        private void txtcurrency_name_eng_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
                this.txtcurrency_remark.Focus();

        }
        private void txtcurrency_remark_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
                this.BtnSave.Focus();
            ...
            if (OK.Trim() != "Y")
            {
                ...
                if (conn.State == System.Data.ConnectionState.Open)
                {
                    ...
                    try
                    {
                        ...
                        cmd2.Parameters.Add("@cdkey", SqlDbType.NVarChar).Value = W_ID_Select.CDKEY.Trim();
                        cmd2.Parameters.Add("@txtco_id", SqlDbType.NVarChar).Value = W_ID_Select.M_COID.Trim();
                        cmd2.Parameters.Add("@txtcurrency_no", SqlDbType.NVarChar).Value = "999";
                        cmd2.Parameters.Add("@txtcurrency_id", SqlDbType.NVarChar).Value = "";
                        cmd2.Parameters.Add("@txtcurrency_name", SqlDbType.NVarChar).Value = "";
                        cmd2.Parameters.Add("@txtcurrency_name_eng", SqlDbType.NVarChar).Value = "";
                        cmd2.Parameters.Add("@txtcurrency_remark", SqlDbType.NVarChar).Value = "";
                        cmd2.Parameters.Add("@txtcurrency_status", SqlDbType.NChar).Value = "0";
                        //==============================
