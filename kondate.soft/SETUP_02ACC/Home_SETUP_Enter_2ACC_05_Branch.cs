...
{
    public partial class Home_SETUP_Enter_2ACC_05_Branch : Form
    {
        //Move Form ====================================
        ...
        public Home_SETUP_Enter_2ACC_05_Branch()
        {
            InitializeComponent();
        }
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            GridView1.Rows[index].Cells["Col_txtbranch_id"].Value = dt2.Rows[j]["txtbranch_id"].ToString();      //1
                            GridView1.Rows[index].Cells["Col_txtbranch_id_second"].Value = dt2.Rows[j]["txtbranch_id_second"].ToString();      //2
                            GridView1.Rows[index].Cells["Col_txtbranch_name"].Value = dt2.Rows[j]["txtbranch_name"].ToString();      //3
                            GridView1.Rows[index].Cells["Col_txtbranch_name_short"].Value = dt2.Rows[j]["txtbranch_name_short"].ToString();      //4
                            GridView1.Rows[index].Cells["Col_txtbranch_tel"].Value = dt2.Rows[j]["txtbranch_tel"].ToString();      //5
                            GridView1.Rows[index].Cells["Col_txthome_id_full"].Value = dt2.Rows[j]["txthome_id_full"].ToString();      //6
                            GridView1.Rows[index].Cells["Col_txtbranch_status"].Value = dt2.Rows[j]["txtbranch_status"].ToString();      //7
        ...
        private void PANEL_FORM1_GridView1()
        {
            ...
            this.GridView1.Columns[1].Name = "Col_txtbranch_id";
            this.GridView1.Columns[2].Name = "Col_txtbranch_id_second";
            this.GridView1.Columns[3].Name = "Col_txtbranch_name";
            this.GridView1.Columns[4].Name = "Col_txtbranch_name_short";
            this.GridView1.Columns[5].Name = "Col_txtbranch_tel";
            this.GridView1.Columns[6].Name = "Col_txthome_id_full";
            this.GridView1.Columns[7].Name = "Col_txtbranch_status";

            this.GridView1.Columns[0].HeaderText = "No";
            this.GridView1.Columns[1].HeaderText = "รหัส";
            this.GridView1.Columns[2].HeaderText = " รหัสสาขาย่อย";
            this.GridView1.Columns[3].HeaderText = " ชื่อสาขา";
            this.GridView1.Columns[4].HeaderText = "ชื่อย่อสาขา";
            ...
            this.GridView1.Columns[1].Visible = true;  //"Col_txtbranch_id";
            ...
            this.GridView1.Columns[2].Visible = true;  //"Col_txtbranch_id_second";
            ...
            this.GridView1.Columns[3].Visible = true;  //"Col_txtbranch_name";
            ...
            this.GridView1.Columns[4].Visible = true;  //"Col_txtbranch_name_short";
        ...
        private void BtnNew_Click(object sender, EventArgs e)
        {
            ...
            this.Hide();
            var frm2 = new Home_SETUP_Enter_2ACC_05_Branch();
        ...
        private void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                this.txtbranch_name.Text = "สำนักงานใหญ่";
            }
           else
            {
                this.txtbranch_name.Text = this.txtbranch_id_second.Text.Trim();
