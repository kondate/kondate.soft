...
{
    public partial class Home_SETUP_Enter_2ACC_09_code_bank : Form
    {
        //Move Form ====================================
        ...
        public Home_SETUP_Enter_2ACC_09_code_bank()
        {
            InitializeComponent();
        }

        private void Home_SETUP_Enter_2ACC_09_Load(object sender, EventArgs e)
        {
            W_ID_Select.M_FORM_NUMBER = "S209";
            CHECK_ADD_FORM();
            ...
            this.iblword_status.Text = "เพิ่มรหัสธนาคารใหม่";
            this.txtcode_bank_id.ReadOnly = false;

            this.ActiveControl = this.txtcode_bank_id;
        ...
        private void Run_ID()
        {
            if (this.txtcode_bank_no.Text == "")
            {
                this.txtcode_bank_no.Text = "001";
            }
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            //this.PANEL_FORM1_dataGridView1.Columns[1].Name = "Col_txtcode_bank_no";
                            //this.PANEL_FORM1_dataGridView1.Columns[2].Name = "Col_txtcode_bank_id";
                            //this.PANEL_FORM1_dataGridView1.Columns[3].Name = "Col_txtcode_bank_name";
                            //this.PANEL_FORM1_dataGridView1.Columns[4].Name = "Col_txtcode_bank_name_eng";
                            //this.PANEL_FORM1_dataGridView1.Columns[5].Name = "Col_txtcode_bank_name_remark";
                            //this.PANEL_FORM1_dataGridView1.Columns[6].Name = "Col_txtcode_bank_status";

                            var index = GridView1.Rows.Add();
                            GridView1.Rows[index].Cells["Col_Auto_num"].Value = ""; //0
                            GridView1.Rows[index].Cells["Col_txtcode_bank_no"].Value = dt2.Rows[j]["txtcode_bank_no"].ToString();      //1
                            GridView1.Rows[index].Cells["Col_txtcode_bank_id"].Value = dt2.Rows[j]["txtcode_bank_id"].ToString();      //2
                            GridView1.Rows[index].Cells["Col_txtcode_bank_name"].Value = dt2.Rows[j]["txtcode_bank_name"].ToString();      //3
                            GridView1.Rows[index].Cells["Col_txtcode_bank_name_eng"].Value = dt2.Rows[j]["txtcode_bank_name_eng"].ToString();      //4
                            GridView1.Rows[index].Cells["Col_txtcode_bank_remark"].Value = dt2.Rows[j]["txtcode_bank_remark"].ToString();      //5
                            GridView1.Rows[index].Cells["Col_txtcode_bank_status"].Value = dt2.Rows[j]["txtcode_bank_status"].ToString();      //6
        ...
        private void PANEL_FORM1_GridView1()
        {
            ...
            this.GridView1.Columns[1].Name = "Col_txtcode_bank_no";
            this.GridView1.Columns[2].Name = "Col_txtcode_bank_id";
            this.GridView1.Columns[3].Name = "Col_txtcode_bank_name";
            this.GridView1.Columns[4].Name = "Col_txtcode_bank_name_eng";
            this.GridView1.Columns[5].Name = "Col_txtcode_bank_remark";
            this.GridView1.Columns[6].Name = "Col_txtcode_bank_status";

            this.GridView1.Columns[0].HeaderText = "No";
            this.GridView1.Columns[1].HeaderText = "ลำดับ";
            this.GridView1.Columns[2].HeaderText = " รหัส";
            this.GridView1.Columns[3].HeaderText = " ชื่อรหัสธนาคาร";
            this.GridView1.Columns[4].HeaderText = "ชื่อรหัสธนาคาร Eng";
            ...
            this.GridView1.Columns[1].Visible = true;  //"Col_txtcode_bank_no";
            ...
            this.GridView1.Columns[2].Visible = true;  //"Col_txtcode_bank_id";
            ...
            this.GridView1.Columns[3].Visible = true;  //"Col_txtcode_bank_name";
            ...
            this.GridView1.Columns[4].Visible = true;  //"Col_txtcode_bank_name_eng";
            ...
            this.GridView1.Columns[5].Visible = true;  //"Col_txtcode_bank_name_remark";
            ...
            this.GridView1.Columns[6].Visible = false;  //"Col_txtcode_bank_status";
        ...
        private void PANEL_FORM1_dataGridView1_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                if (cell != null)
                {
                    ...
                    this.txtcode_bank_no.Text = row.Cells[1].Value.ToString();
                    this.txtcode_bank_id.Text = row.Cells[2].Value.ToString();
                    this.txtcode_bank_name.Text = row.Cells[3].Value.ToString();
                    ...
                    if (conn.State == System.Data.ConnectionState.Open)
                    {
                        ...
                        cmd2.CommandText = "SELECT *" +
                                            " FROM k013_1db_acc_09code_bank" +
                                             " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                             //" AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                             " AND (txtcode_bank_id = '" + this.txtcode_bank_id.Text.Trim() + "')" +
                                           " ORDER BY txtcode_bank_no ASC";
                        ...
                        try
                        {
                            ...
                            if (dt2.Rows.Count > 0)
                            {
                                for (int j = 0; j < dt2.Rows.Count; j++)
                                {
                                    this.txtcode_bank_no.Text = dt2.Rows[j]["txtcode_bank_no"].ToString();      //1
                                    this.txtcode_bank_id.Text = dt2.Rows[j]["txtcode_bank_id"].ToString();      //2
                                    this.txtcode_bank_name.Text = dt2.Rows[j]["txtcode_bank_name"].ToString();      //3
                                    this.txtcode_bank_name_eng.Text = dt2.Rows[j]["txtcode_bank_name_eng"].ToString();      //4
                                    this.txtcode_bank_remark.Text = dt2.Rows[j]["txtcode_bank_remark"].ToString();      //6
                                }
                                this.iblword_status.Text = "แก้ไขรหัสธนาคาร";
                                this.txtcode_bank_id.ReadOnly = true;
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                cmd2.CommandText = "SELECT *" +
                                    " FROM k013_1db_acc_09code_bank" +
                                     " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                     //" AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                     " AND (txtcode_bank_name LIKE '%" + this.PANEL_FORM1_txtsearch.Text.Trim() + "%')" +
                                   " ORDER BY txtcode_bank_no ASC";
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            //this.PANEL_FORM1_dataGridView1.Columns[3].Name = "Col_txtcode_bank_name";
                            //this.PANEL_FORM1_dataGridView1.Columns[4].Name = "Col_txtcode_bank_name_eng";
                            //this.PANEL_FORM1_dataGridView1.Columns[5].Name = "Col_txtcode_bank_remark";
                            //this.PANEL_FORM1_dataGridView1.Columns[6].Name = "Col_txtcode_bank_status";
                            ...
                            GridView1.Rows[index].Cells["Col_txtcode_bank_name"].Value = dt2.Rows[j]["txtcode_bank_name"].ToString();      //3
                            GridView1.Rows[index].Cells["Col_txtcode_bank_name_eng"].Value = dt2.Rows[j]["txtcode_bank_name_eng"].ToString();      //4
                            GridView1.Rows[index].Cells["Col_txtcode_bank_remark"].Value = dt2.Rows[j]["txtcode_bank_remark"].ToString();      //6
                            GridView1.Rows[index].Cells["Col_txtcode_bank_status"].Value = dt2.Rows[j]["txtcode_bank_status"].ToString();      //7
        ...
        private void BtnNew_Click(object sender, EventArgs e)
        {
            ...
            this.Hide();
            var frm2 = new Home_SETUP_Enter_2ACC_09_code_bank();
        ...
        private void BtnSave_Click(object sender, EventArgs e)
        {
            if (this.txtcode_bank_no.Text == "")
            {
                ...
                this.txtcode_bank_no.Focus();
                return;
            }
            else
            {
                if (this.txtcode_bank_no.TextLength == 3)
                {
                }
                else
                {
            ...
            if (this.txtcode_bank_id.Text == "")
            {
                MessageBox.Show("โปรดใส่รหัสรหัสธนาคาร ก่อน !", "ผลการทำงาน", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                this.txtcode_bank_id.Focus();
                return;
            }
            if (this.txtcode_bank_name.Text == "")
            {
                MessageBox.Show("โปรดใส่ชื่อรหัสธนาคารก่อน !", "ผลการทำงาน", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                this.txtcode_bank_name.Focus();
                return;
            }
            ...
            //END เชื่อมต่อฐานข้อมูล=======================================================
            Cursor.Current = Cursors.WaitCursor;
            if (this.iblword_status.Text.Trim() == "เพิ่มรหัสธนาคารใหม่")
            {
                conn.Open();
                if (conn.State == System.Data.ConnectionState.Open)
                {
                    ...
                    cmd1.CommandText = "SELECT * FROM k013_1db_acc_09code_bank" +
                                        " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                       //" AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                       " AND (txtcode_bank_id = '" + this.txtcode_bank_id.Text.Trim() + "')";
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        MessageBox.Show("รหัสรหัสธนาคาร นี้ซ้ำ   : '" + this.txtcode_bank_id.Text.Trim() + "' โปรดใส่ใหม่ ", "ผลการทำงาน", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                        this.txtcode_bank_id.Focus();
                        conn.Close();
                        return;
                    }
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                try
                {
                    if (this.iblword_status.Text.Trim() == "เพิ่มรหัสธนาคารใหม่")
                    {
                        cmd2.CommandText = "INSERT INTO k013_1db_acc_09code_bank(cdkey,txtco_id," +  //1
                                           "txtcode_bank_no,txtcode_bank_id," +  //2
                                           "txtcode_bank_name,txtcode_bank_name_eng," +  //3
                                          "txtcode_bank_remark," +  //5
                                          "txtcode_bank_status) " +  //6
                        ...
                        cmd2.Parameters.Add("@txtcode_bank_no", SqlDbType.NVarChar).Value = this.txtcode_bank_no.Text.ToString();
                        cmd2.Parameters.Add("@txtcode_bank_id", SqlDbType.NVarChar).Value = this.txtcode_bank_id.Text.ToString();
                        cmd2.Parameters.Add("@txtcode_bank_name", SqlDbType.NVarChar).Value = this.txtcode_bank_name.Text.ToString();
                        cmd2.Parameters.Add("@txtcode_bank_name_eng", SqlDbType.NVarChar).Value = this.txtcode_bank_name_eng.Text.ToString();
                        cmd2.Parameters.Add("@txtcode_bank_remark", SqlDbType.NVarChar).Value = this.txtcode_bank_remark.Text.ToString();
                        cmd2.Parameters.Add("@txtcode_bank_status", SqlDbType.NChar).Value = "0";
                        //==============================

                        cmd2.ExecuteNonQuery();

                    }
                    if (this.iblword_status.Text.Trim() == "แก้ไขรหัสธนาคาร")
                    {
                        cmd2.CommandText = "UPDATE k013_1db_acc_09code_bank SET " +
                                                                     "txtcode_bank_no = '" + this.txtcode_bank_no.Text.Trim() + "'," +
                                                                     "txtcode_bank_name = '" + this.txtcode_bank_name.Text.Trim() + "'," +
                                                                     "txtcode_bank_name_eng = '" + this.txtcode_bank_name_eng.Text.Trim() + "'," +
                                                                     "txtcode_bank_remark = '" + this.txtcode_bank_remark.Text.ToString() + "'" +
                                                                    " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                                                   //" AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                                                   " AND (txtcode_bank_id = '" + this.txtcode_bank_id.Text.Trim() + "')";
                        cmd2.ExecuteNonQuery();
                    ...
                    if (dialogResult == DialogResult.Yes)
                    {
                        ...
                        this.txtcode_bank_id.Text = "";
                        this.txtcode_bank_name.Text = "";
                        this.txtcode_bank_name_eng.Text = "";
                        this.txtcode_bank_remark.Text = "";
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                try
                {
                    if (this.iblword_status.Text.Trim() == "ยกเลิกเอกสาร")
                    {
                        ...
                        cmd2.CommandText = "INSERT INTO k013_1db_acc_09code_bank_cancel(cdkey,txtco_id,txtbranch_id," +  //1
                                                                                                                        //"txttrans_date," +
                        ...
                        cmd2.CommandText = "INSERT INTO k013_1db_acc_09code_bank_cancel_detail(cdkey,txtco_id," +  //1
                                             "txtcode_bank_no,txtcode_bank_id," +  //2
                                             "txtcode_bank_name,txtcode_bank_name_eng," +  //3
                                             "txtcode_bank_remark," +  //4
                                            "txtcode_bank_status,cancel_id) " +  //5
                                             "VALUES (@cdkey2,@txtco_id2," +  //1
                                             "@txtcode_bank_no,@txtcode_bank_id," +  //2
                                             "@txtcode_bank_name,@txtcode_bank_name_eng," +  //3
                                             "@txtcode_bank_remark," +  //4
                                            "@txtcode_bank_status,@cancel_id2)";   //5
                        ...
                        cmd2.CommandText = "DELETE FROM k013_1db_acc_09code_bank" +
                                                                    " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                                                    //" AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                                                   " AND (txtcode_bank_id = '" + this.txtcode_bank_id.Text.Trim() + "')";
                        cmd2.ExecuteNonQuery();
                    ...
                    DialogResult dialogResult = MessageBox.Show("คุณต้องการ ยกเลิกเอกสาร รหัส  " + this.txtcode_bank_id.Text.ToString() + " ใช่หรือไม่่ ?", "โปรดยืนยัน", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question);
                    if (dialogResult == DialogResult.Yes)
                    {
        ...
        private void txtcode_bank_id_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            if (e.KeyChar == (char)Keys.Enter && this.txtcode_bank_id.Text == "")
            {
                this.txtcode_bank_id.Focus();
            }
            //========================================
            else if (e.KeyChar == (char)Keys.Enter && this.txtcode_bank_id.Text.Trim() != "")
            {
                this.txtcode_bank_no.Focus();
        ...
        private void txtcode_bank_no_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == (char)Keys.Enter && this.txtcode_bank_no.Text == "")
            {
                this.txtcode_bank_no.Focus();
            }
            //========================================
            else if (e.KeyChar == (char)Keys.Enter && this.txtcode_bank_no.Text.Trim() != "")
            {
                if (this.txtcode_bank_no.TextLength == 3)
                {
                    this.txtcode_bank_name.Focus();
            ...
            else if ((e.KeyChar > '9') && (e.KeyChar != '\b') && (e.KeyChar != '.') && txtcode_bank_no.Text.Length == 0)
            {
                //e.KeyChar <= '0' || 
                e.Handled = true;
                return;
        ...
        private void txtcode_bank_name_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
                this.txtcode_bank_name_eng.Focus();

        }
        private void txtcode_bank_name_eng_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
                this.txtcode_bank_remark.Focus();

        }
          private void txtcode_bank_name_remark_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
                this.BtnSave.Focus();
            ...
            if (OK.Trim() != "Y")
            {
                ...
                if (conn.State == System.Data.ConnectionState.Open)
                {
                    ...
                    try
                    {
                        ...
                        cmd2.Parameters.Add("@cdkey", SqlDbType.NVarChar).Value = W_ID_Select.CDKEY.Trim();
                        cmd2.Parameters.Add("@txtco_id", SqlDbType.NVarChar).Value = W_ID_Select.M_COID.Trim();
                        cmd2.Parameters.Add("@txtcode_bank_no", SqlDbType.NVarChar).Value = "999";
                        cmd2.Parameters.Add("@txtcode_bank_id", SqlDbType.NVarChar).Value ="";
                        cmd2.Parameters.Add("@txtcode_bank_name", SqlDbType.NVarChar).Value = "";
                        cmd2.Parameters.Add("@txtcode_bank_name_eng", SqlDbType.NVarChar).Value = "";
                        cmd2.Parameters.Add("@txtcode_bank_remark", SqlDbType.NVarChar).Value = "";
                        cmd2.Parameters.Add("@txtcode_bank_status", SqlDbType.NChar).Value = "0";
                        //==============================
