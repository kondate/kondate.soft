...
{
    public partial class Home_SETUP_Enter_2ACC_16_department : Form
    {
        //Move Form ====================================
        ...
        public Home_SETUP_Enter_2ACC_16_department()
        {
            InitializeComponent();
        }

        private void Home_SETUP_Enter_2ACC_16_Load(object sender, EventArgs e)
        {
            W_ID_Select.M_FORM_NUMBER = "S216";
            CHECK_ADD_FORM();
            ...
            this.iblword_status.Text = "เพิ่มรหัสฝ่ายใหม่";
            this.txtdepartment_id.ReadOnly = false;

            this.ActiveControl = this.txtdepartment_id;
        ...
        private void Run_ID()
        {
            if (this.txtdepartment_no.Text == "")
            {
                this.txtdepartment_no.Text = "001";
            }
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                cmd2.CommandText = "SELECT *" +
                                    ...
                                    " ORDER BY txtdepartment_no DESC";
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            //this.PANEL_FORM1_dataGridView1.Columns[1].Name = "Col_txtdepartment_no";
                            //this.PANEL_FORM1_dataGridView1.Columns[2].Name = "Col_txtdepartment_id";
                            //this.PANEL_FORM1_dataGridView1.Columns[3].Name = "Col_txtdepartment_name";
                            //this.PANEL_FORM1_dataGridView1.Columns[4].Name = "Col_txtdepartment_name_eng";
                            //this.PANEL_FORM1_dataGridView1.Columns[5].Name = "Col_txtdepartment_name_remark";
                            //this.PANEL_FORM1_dataGridView1.Columns[6].Name = "Col_txtdepartment_status";

                            var index = GridView1.Rows.Add();
                            GridView1.Rows[index].Cells["Col_Auto_num"].Value = ""; //0
                            GridView1.Rows[index].Cells["Col_txtdepartment_no"].Value = dt2.Rows[j]["txtdepartment_no"].ToString();      //1
                            GridView1.Rows[index].Cells["Col_txtdepartment_id"].Value = dt2.Rows[j]["txtdepartment_id"].ToString();      //2
                            GridView1.Rows[index].Cells["Col_txtdepartment_name"].Value = dt2.Rows[j]["txtdepartment_name"].ToString();      //3
                            GridView1.Rows[index].Cells["Col_txtdepartment_name_eng"].Value = dt2.Rows[j]["txtdepartment_name_eng"].ToString();      //4
                            GridView1.Rows[index].Cells["Col_txtdepartment_remark"].Value = dt2.Rows[j]["txtdepartment_remark"].ToString();      //5
                            GridView1.Rows[index].Cells["Col_txtdepartment_status"].Value = dt2.Rows[j]["txtdepartment_status"].ToString();      //6
        ...
        private void PANEL_FORM1_GridView1()
        {
            ...
            this.GridView1.Columns[1].Name = "Col_txtdepartment_no";
            this.GridView1.Columns[2].Name = "Col_txtdepartment_id";
            this.GridView1.Columns[3].Name = "Col_txtdepartment_name";
            this.GridView1.Columns[4].Name = "Col_txtdepartment_name_eng";
            this.GridView1.Columns[5].Name = "Col_txtdepartment_remark";
            this.GridView1.Columns[6].Name = "Col_txtdepartment_status";

            this.GridView1.Columns[0].HeaderText = "No";
            this.GridView1.Columns[1].HeaderText = "ลำดับ";
            this.GridView1.Columns[2].HeaderText = " รหัส";
            this.GridView1.Columns[3].HeaderText = " ชื่อรหัสฝ่าย";
            this.GridView1.Columns[4].HeaderText = "ชื่อรหัสฝ่าย Eng";
            ...
            this.GridView1.Columns[1].Visible = true;  //"Col_txtdepartment_no";
            ...
            this.GridView1.Columns[2].Visible = true;  //"Col_txtdepartment_id";
            ...
            this.GridView1.Columns[3].Visible = true;  //"Col_txtdepartment_name";
            ...
            this.GridView1.Columns[4].Visible = true;  //"Col_txtdepartment_name_eng";
            ...
            this.GridView1.Columns[5].Visible = true;  //"Col_txtdepartment_name_remark";
            ...
            this.GridView1.Columns[6].Visible = false;  //"Col_txtdepartment_status";
        ...
        private void PANEL_FORM1_dataGridView1_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                if (cell != null)
                {
                    ...
                    this.txtdepartment_no.Text = row.Cells[1].Value.ToString();
                    this.txtdepartment_id.Text = row.Cells[2].Value.ToString();
                    this.txtdepartment_name.Text = row.Cells[3].Value.ToString();
                    ...
                    if (conn.State == System.Data.ConnectionState.Open)
                    {
                        ...
                        cmd2.CommandText = "SELECT *" +
                                            " FROM k013_1db_acc_16department" +
                                             " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                             " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                             " AND (txtdepartment_id = '" + this.txtdepartment_id.Text.Trim() + "')" +
                                           " ORDER BY txtdepartment_no ASC";
                        ...
                        try
                        {
                            ...
                            if (dt2.Rows.Count > 0)
                            {
                                for (int j = 0; j < dt2.Rows.Count; j++)
                                {
                                    this.txtdepartment_no.Text = dt2.Rows[j]["txtdepartment_no"].ToString();      //1
                                    this.txtdepartment_id.Text = dt2.Rows[j]["txtdepartment_id"].ToString();      //2
                                    this.txtdepartment_name.Text = dt2.Rows[j]["txtdepartment_name"].ToString();      //3
                                    this.txtdepartment_name_eng.Text = dt2.Rows[j]["txtdepartment_name_eng"].ToString();      //4
                                    this.txtdepartment_remark.Text = dt2.Rows[j]["txtdepartment_remark"].ToString();      //6
                                }
                                this.iblword_status.Text = "แก้ไขรหัสฝ่าย";
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                cmd2.CommandText = "SELECT *" +
                                    " FROM k013_1db_acc_16department" +
                                     " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                     " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                     " AND (txtdepartment_name LIKE '%" + this.PANEL_FORM1_txtsearch.Text.Trim() + "%')" +
                                   " ORDER BY txtdepartment_no ASC";
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            //this.PANEL_FORM1_dataGridView1.Columns[3].Name = "Col_txtdepartment_name";
                            //this.PANEL_FORM1_dataGridView1.Columns[4].Name = "Col_txtdepartment_name_eng";
                            //this.PANEL_FORM1_dataGridView1.Columns[5].Name = "Col_txtdepartment_remark";
                            //this.PANEL_FORM1_dataGridView1.Columns[6].Name = "Col_txtdepartment_status";
                            ...
                            GridView1.Rows[index].Cells["Col_txtdepartment_name"].Value = dt2.Rows[j]["txtdepartment_name"].ToString();      //3
                            GridView1.Rows[index].Cells["Col_txtdepartment_name_eng"].Value = dt2.Rows[j]["txtdepartment_name_eng"].ToString();      //4
                            GridView1.Rows[index].Cells["Col_txtdepartment_remark"].Value = dt2.Rows[j]["txtdepartment_remark"].ToString();      //6
                            GridView1.Rows[index].Cells["Col_txtdepartment_status"].Value = dt2.Rows[j]["txtdepartment_status"].ToString();      //7
        ...
        private void BtnNew_Click(object sender, EventArgs e)
        {
            ...
            this.Hide();
            var frm2 = new Home_SETUP_Enter_2ACC_16_department();
        ...
        private void BtnSave_Click(object sender, EventArgs e)
        {
            if (this.txtdepartment_no.Text == "")
            {
                ...
                this.txtdepartment_no.Focus();
                return;
            }
            else
            {
                if (this.txtdepartment_no.TextLength == 3)
                {
                }
                else
                {
            ...
            if (this.txtdepartment_id.Text == "")
            {
                MessageBox.Show("โปรดใส่รหัสรหัสฝ่าย ก่อน !", "ผลการทำงาน", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                this.txtdepartment_id.Focus();
                return;
            }
            if (this.txtdepartment_name.Text == "")
            {
                MessageBox.Show("โปรดใส่ชื่อรหัสฝ่ายก่อน !", "ผลการทำงาน", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                this.txtdepartment_name.Focus();
                return;
            }
            ...
            //END เชื่อมต่อฐานข้อมูล=======================================================
            Cursor.Current = Cursors.WaitCursor;
            if (this.iblword_status.Text.Trim() == "เพิ่มรหัสฝ่ายใหม่")
            {
                conn.Open();
                if (conn.State == System.Data.ConnectionState.Open)
                {
                    ...
                    cmd1.CommandText = "SELECT * FROM k013_1db_acc_16department" +
                                        " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                       " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                       " AND (txtdepartment_id = '" + this.txtdepartment_id.Text.Trim() + "')";
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        MessageBox.Show("รหัสรหัสฝ่าย นี้ซ้ำ   : '" + this.txtdepartment_id.Text.Trim() + "' โปรดใส่ใหม่ ", "ผลการทำงาน", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                        this.txtdepartment_id.Focus();
                        conn.Close();
                        return;
                    }
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                try
                {
                    if (this.iblword_status.Text.Trim() == "เพิ่มรหัสฝ่ายใหม่")
                    {
                        cmd2.CommandText = "INSERT INTO k013_1db_acc_16department(cdkey,txtco_id," +  //1
                                           "txtdepartment_no,txtdepartment_id," +  //2
                                           "txtdepartment_name,txtdepartment_name_eng," +  //3
                                          "txtdepartment_remark," +  //5
                                          "txtdepartment_status) " +  //6
                        ...
                        cmd2.Parameters.Add("@txtdepartment_no", SqlDbType.NVarChar).Value = this.txtdepartment_no.Text.ToString();
                        cmd2.Parameters.Add("@txtdepartment_id", SqlDbType.NVarChar).Value = this.txtdepartment_id.Text.ToString();
                        cmd2.Parameters.Add("@txtdepartment_name", SqlDbType.NVarChar).Value = this.txtdepartment_name.Text.ToString();
                        cmd2.Parameters.Add("@txtdepartment_name_eng", SqlDbType.NVarChar).Value = this.txtdepartment_name_eng.Text.ToString();
                        cmd2.Parameters.Add("@txtdepartment_remark", SqlDbType.NVarChar).Value = this.txtdepartment_remark.Text.ToString();
                        cmd2.Parameters.Add("@txtdepartment_status", SqlDbType.NChar).Value = "0";
                        //==============================

                        cmd2.ExecuteNonQuery();

                    }
                    if (this.iblword_status.Text.Trim() == "แก้ไขรหัสฝ่าย")
                    {
                        cmd2.CommandText = "UPDATE k013_1db_acc_16department SET " +
                                                                     "txtdepartment_no = '" + this.txtdepartment_no.Text.Trim() + "'," +
                                                                     "txtdepartment_name = '" + this.txtdepartment_name.Text.Trim() + "'," +
                                                                     "txtdepartment_name_eng = '" + this.txtdepartment_name_eng.Text.Trim() + "'," +
                                                                     "txtdepartment_remark = '" + this.txtdepartment_remark.Text.ToString() + "'" +
                                                                    " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                                                   " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                                                   " AND (txtdepartment_id = '" + this.txtdepartment_id.Text.Trim() + "')";
                        cmd2.ExecuteNonQuery();
                    ...
                    if (dialogResult == DialogResult.Yes)
                    {
                        ...
                        this.txtdepartment_id.Text = "";
                        this.txtdepartment_name.Text = "";
                        this.txtdepartment_name_eng.Text = "";
                        this.txtdepartment_remark.Text = "";
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                try
                {
                    if (this.iblword_status.Text.Trim() == "ยกเลิกเอกสาร")
                    {
                        ...
                        cmd2.CommandText = "INSERT INTO k013_1db_acc_16department_cancel(cdkey,txtco_id,txtbranch_id," +  //1
                                                                                                                               //"txttrans_date," +
                        ...
                        cmd2.CommandText = "INSERT INTO k013_1db_acc_16department_cancel_detail(cdkey,txtco_id," +  //1
                                             "txtdepartment_no,txtdepartment_id," +  //2
                                             "txtdepartment_name,txtdepartment_name_eng," +  //3
                                             "txtdepartment_remark," +  //4
                                            "txtdepartment_status,cancel_id) " +  //5
                                             "VALUES (@cdkey2,@txtco_id2," +  //1
                                             "@txtdepartment_no,@txtdepartment_id," +  //2
                                             "@txtdepartment_name,@txtdepartment_name_eng," +  //3
                                             "@txtdepartment_remark," +  //4
                                            "@txtdepartment_status,@cancel_id2)";   //5
                        ...
                        cmd2.CommandText = "DELETE FROM k013_1db_acc_16department" +
                                                                    " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                                                    " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                                                   " AND (txtdepartment_id = '" + this.txtdepartment_id.Text.Trim() + "')";
                        cmd2.ExecuteNonQuery();
                    ...
                    DialogResult dialogResult = MessageBox.Show("คุณต้องการ ยกเลิกเอกสาร รหัส  " + this.txtdepartment_id.Text.ToString() + " ใช่หรือไม่่ ?", "โปรดยืนยัน", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question);
                    if (dialogResult == DialogResult.Yes)
                    {
        ...
        private void txtdepartment_id_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            if (e.KeyChar == (char)Keys.Enter && this.txtdepartment_id.Text == "")
            {
                this.txtdepartment_id.Focus();
            }
            //========================================
            else if (e.KeyChar == (char)Keys.Enter && this.txtdepartment_id.Text.Trim() != "")
            {
                this.txtdepartment_no.Focus();
        ...
        private void txtdepartment_no_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == (char)Keys.Enter && this.txtdepartment_no.Text == "")
            {
                this.txtdepartment_no.Focus();
            }
            //========================================
            else if (e.KeyChar == (char)Keys.Enter && this.txtdepartment_no.Text.Trim() != "")
            {
                if (this.txtdepartment_no.TextLength == 3)
                {
                    this.txtdepartment_name.Focus();
            ...
            else if ((e.KeyChar > '9') && (e.KeyChar != '\b') && (e.KeyChar != '.') && txtdepartment_no.Text.Length == 0)
            {
                //e.KeyChar <= '0' || 
                e.Handled = true;
                return;
        ...
        private void txtdepartment_name_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
                this.txtdepartment_name_eng.Focus();

        }
        private void txtdepartment_name_eng_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
                this.txtdepartment_remark.Focus();

        }
        private void txtdepartment_name_remark_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
                this.BtnSave.Focus();
            ...
            if (OK.Trim() != "Y")
            {
                ...
                if (conn.State == System.Data.ConnectionState.Open)
                {
                    ...
                    try
                    {
                        ...
                        cmd2.Parameters.Add("@cdkey", SqlDbType.NVarChar).Value = W_ID_Select.CDKEY.Trim();
                        cmd2.Parameters.Add("@txtco_id", SqlDbType.NVarChar).Value = W_ID_Select.M_COID.Trim();
                        cmd2.Parameters.Add("@txtdepartment_no", SqlDbType.NVarChar).Value = "999";
                        cmd2.Parameters.Add("@txtdepartment_id", SqlDbType.NVarChar).Value = "";
                        cmd2.Parameters.Add("@txtdepartment_name", SqlDbType.NVarChar).Value = "";
                        cmd2.Parameters.Add("@txtdepartment_name_eng", SqlDbType.NVarChar).Value = "";
                        cmd2.Parameters.Add("@txtdepartment_remark", SqlDbType.NVarChar).Value = "";
                        cmd2.Parameters.Add("@txtdepartment_status", SqlDbType.NChar).Value = "0";
                        //==============================
