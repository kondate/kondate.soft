...
{
    public partial class Home_SETUP_Enter_2ACC_15_wherehouse_type : Form
    {
        //Move Form ====================================
        ...
        public Home_SETUP_Enter_2ACC_15_wherehouse_type()
        {
            InitializeComponent();
        }

        private void Home_SETUP_Enter_2ACC_15_Load(object sender, EventArgs e)
        {
            W_ID_Select.M_FORM_NUMBER = "S215";
            CHECK_ADD_FORM();
            ...
            this.iblword_status.Text = "เพิ่มรหัสประเภทคลังสินค้าใหม่";
            this.txtwherehouse_type_id.ReadOnly = false;

            this.ActiveControl = this.txtwherehouse_type_id;
        ...
        private void Run_ID()
        {
            if (this.txtwherehouse_type_no.Text == "")
            {
                this.txtwherehouse_type_no.Text = "001";
            }
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                cmd2.CommandText = "SELECT *" +
                                    ...
                                    " ORDER BY txtwherehouse_type_no DESC";
        ...
        private void PANEL_FORM1_Fill_GridView1()
        {
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                cmd2.CommandText = "SELECT *" +
                                    ...
                                    " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                    " AND (txtwherehouse_type_id <> '')" +
                                    " ORDER BY txtwherehouse_type_no ASC";
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            //this.PANEL_FORM1_dataGridView1.Columns[1].Name = "Col_txtwherehouse_type_no";
                            //this.PANEL_FORM1_dataGridView1.Columns[2].Name = "Col_txtwherehouse_type_id";
                            //this.PANEL_FORM1_dataGridView1.Columns[3].Name = "Col_txtwherehouse_type_name";
                            //this.PANEL_FORM1_dataGridView1.Columns[4].Name = "Col_txtwherehouse_type_name_eng";
                            //this.PANEL_FORM1_dataGridView1.Columns[5].Name = "Col_txtwherehouse_type_name_remark";
                            //this.PANEL_FORM1_dataGridView1.Columns[6].Name = "Col_txtwherehouse_type_status";

                            var index = GridView1.Rows.Add();
                            GridView1.Rows[index].Cells["Col_Auto_num"].Value = ""; //0
                            GridView1.Rows[index].Cells["Col_txtwherehouse_type_no"].Value = dt2.Rows[j]["txtwherehouse_type_no"].ToString();      //1
                            GridView1.Rows[index].Cells["Col_txtwherehouse_type_id"].Value = dt2.Rows[j]["txtwherehouse_type_id"].ToString();      //2
                            GridView1.Rows[index].Cells["Col_txtwherehouse_type_name"].Value = dt2.Rows[j]["txtwherehouse_type_name"].ToString();      //3
                            GridView1.Rows[index].Cells["Col_txtwherehouse_type_name_eng"].Value = dt2.Rows[j]["txtwherehouse_type_name_eng"].ToString();      //4
                            GridView1.Rows[index].Cells["Col_txtwherehouse_type_remark"].Value = dt2.Rows[j]["txtwherehouse_type_remark"].ToString();      //5
                            GridView1.Rows[index].Cells["Col_txtwherehouse_type_status"].Value = dt2.Rows[j]["txtwherehouse_type_status"].ToString();      //6
        ...
        private void PANEL_FORM1_GridView1()
        {
            ...
            this.GridView1.Columns[1].Name = "Col_txtwherehouse_type_no";
            this.GridView1.Columns[2].Name = "Col_txtwherehouse_type_id";
            this.GridView1.Columns[3].Name = "Col_txtwherehouse_type_name";
            this.GridView1.Columns[4].Name = "Col_txtwherehouse_type_name_eng";
            this.GridView1.Columns[5].Name = "Col_txtwherehouse_type_remark";
            this.GridView1.Columns[6].Name = "Col_txtwherehouse_type_status";

            this.GridView1.Columns[0].HeaderText = "No";
            this.GridView1.Columns[1].HeaderText = "ลำดับ";
            this.GridView1.Columns[2].HeaderText = " รหัส";
            this.GridView1.Columns[3].HeaderText = " ชื่อรหัสประเภทคลังสินค้า";
            this.GridView1.Columns[4].HeaderText = "ชื่อรหัสประเภทคลังสินค้า Eng";
            ...
            this.GridView1.Columns[1].Visible = true;  //"Col_txtwherehouse_type_no";
            ...
            this.GridView1.Columns[2].Visible = true;  //"Col_txtwherehouse_type_id";
            ...
            this.GridView1.Columns[3].Visible = true;  //"Col_txtwherehouse_type_name";
            ...
            this.GridView1.Columns[4].Visible = true;  //"Col_txtwherehouse_type_name_eng";
            ...
            this.GridView1.Columns[5].Visible = true;  //"Col_txtwherehouse_type_name_remark";
            ...
            this.GridView1.Columns[6].Visible = false;  //"Col_txtwherehouse_type_status";
        ...
        private void PANEL_FORM1_dataGridView1_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                if (cell != null)
                {
                    ...
                    this.txtwherehouse_type_no.Text = row.Cells[1].Value.ToString();
                    this.txtwherehouse_type_id.Text = row.Cells[2].Value.ToString();
                    this.txtwherehouse_type_name.Text = row.Cells[3].Value.ToString();
                    ...
                    if (conn.State == System.Data.ConnectionState.Open)
                    {
                        ...
                        cmd2.CommandText = "SELECT *" +
                                            " FROM k013_1db_acc_15wherehouse_type" +
                                             " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                             " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                             " AND (txtwherehouse_type_id = '" + this.txtwherehouse_type_id.Text.Trim() + "')" +
                                           " ORDER BY txtwherehouse_type_no ASC";
                        ...
                        try
                        {
                            ...
                            if (dt2.Rows.Count > 0)
                            {
                                for (int j = 0; j < dt2.Rows.Count; j++)
                                {
                                    this.txtwherehouse_type_no.Text = dt2.Rows[j]["txtwherehouse_type_no"].ToString();      //1
                                    this.txtwherehouse_type_id.Text = dt2.Rows[j]["txtwherehouse_type_id"].ToString();      //2
                                    this.txtwherehouse_type_name.Text = dt2.Rows[j]["txtwherehouse_type_name"].ToString();      //3
                                    this.txtwherehouse_type_name_eng.Text = dt2.Rows[j]["txtwherehouse_type_name_eng"].ToString();      //4
                                    this.txtwherehouse_type_remark.Text = dt2.Rows[j]["txtwherehouse_type_remark"].ToString();      //6
                                }
                                this.iblword_status.Text = "แก้ไขรหัสประเภทคลังสินค้า";
                                this.txtwherehouse_type_id.ReadOnly = true;
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                cmd2.CommandText = "SELECT *" +
                                    " FROM k013_1db_acc_15wherehouse_type" +
                                     " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                     " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                     " AND (txtwherehouse_type_name LIKE '%" + this.PANEL_FORM1_txtsearch.Text.Trim() + "%')" +
                                   " ORDER BY txtwherehouse_type_no ASC";
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            //this.PANEL_FORM1_dataGridView1.Columns[3].Name = "Col_txtwherehouse_type_name";
                            //this.PANEL_FORM1_dataGridView1.Columns[4].Name = "Col_txtwherehouse_type_name_eng";
                            //this.PANEL_FORM1_dataGridView1.Columns[5].Name = "Col_txtwherehouse_type_remark";
                            //this.PANEL_FORM1_dataGridView1.Columns[6].Name = "Col_txtwherehouse_type_status";
                            ...
                            GridView1.Rows[index].Cells["Col_txtwherehouse_type_name"].Value = dt2.Rows[j]["txtwherehouse_type_name"].ToString();      //3
                            GridView1.Rows[index].Cells["Col_txtwherehouse_type_name_eng"].Value = dt2.Rows[j]["txtwherehouse_type_name_eng"].ToString();      //4
                            GridView1.Rows[index].Cells["Col_txtwherehouse_type_remark"].Value = dt2.Rows[j]["txtwherehouse_type_remark"].ToString();      //6
                            GridView1.Rows[index].Cells["Col_txtwherehouse_type_status"].Value = dt2.Rows[j]["txtwherehouse_type_status"].ToString();      //7
        ...
        private void BtnNew_Click(object sender, EventArgs e)
        {
            ...
            this.Hide();
            var frm2 = new Home_SETUP_Enter_2ACC_15_wherehouse_type();
        ...
        private void btnopen_Click(object sender, EventArgs e)
        {
            ...
            if (this.txtwherehouse_type_id.Text != "")
            {
                this.iblword_status.Text = "แก้ไขรหัสประเภทคลังสินค้า";
                this.txtwherehouse_type_id.ReadOnly = true;
            }
        ...
        private void BtnSave_Click(object sender, EventArgs e)
        {
            if (this.txtwherehouse_type_no.Text == "")
            {
                ...
                this.txtwherehouse_type_no.Focus();
                return;
            }
            else
            {
                if (this.txtwherehouse_type_no.TextLength == 3)
                {
                }
                else
                {
            ...
            if (this.txtwherehouse_type_id.Text == "")
            {
                ...
                this.txtwherehouse_type_id.Focus();
                return;
            }
            if (this.txtwherehouse_type_name.Text == "")
            {
                MessageBox.Show("โปรดใส่ชื่อรหัสประเภทคลังสินค้าก่อน !", "ผลการทำงาน", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                this.txtwherehouse_type_name.Focus();
                return;
            }
            ...
            //END เชื่อมต่อฐานข้อมูล=======================================================
            Cursor.Current = Cursors.WaitCursor;
            if (this.iblword_status.Text.Trim() == "เพิ่มรหัสประเภทคลังสินค้าใหม่")
            {
                conn.Open();
                if (conn.State == System.Data.ConnectionState.Open)
                {
                    ...
                    cmd1.CommandText = "SELECT * FROM k013_1db_acc_15wherehouse_type" +
                                        " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                       " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                       " AND (txtwherehouse_type_id = '" + this.txtwherehouse_type_id.Text.Trim() + "')";
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        MessageBox.Show("รหัสรหัสประเภทคลังสินค้า นี้ซ้ำ   : '" + this.txtwherehouse_type_id.Text.Trim() + "' โปรดใส่ใหม่ ", "ผลการทำงาน", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                        this.txtwherehouse_type_id.Focus();
                        conn.Close();
                        return;
                    }
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                try
                {
                    if (this.iblword_status.Text.Trim() == "เพิ่มรหัสประเภทคลังสินค้าใหม่")
                    {
                        cmd2.CommandText = "INSERT INTO k013_1db_acc_15wherehouse_type(cdkey,txtco_id," +  //1
                                           "txtwherehouse_type_no,txtwherehouse_type_id," +  //2
                                           "txtwherehouse_type_name,txtwherehouse_type_name_eng," +  //3
                                          "txtwherehouse_type_remark," +  //5
                                          "txtwherehouse_type_status) " +  //6
                        ...
                        cmd2.Parameters.Add("@txtwherehouse_type_no", SqlDbType.NVarChar).Value = this.txtwherehouse_type_no.Text.ToString();
                        cmd2.Parameters.Add("@txtwherehouse_type_id", SqlDbType.NVarChar).Value = this.txtwherehouse_type_id.Text.ToString();
                        cmd2.Parameters.Add("@txtwherehouse_type_name", SqlDbType.NVarChar).Value = this.txtwherehouse_type_name.Text.ToString();
                        cmd2.Parameters.Add("@txtwherehouse_type_name_eng", SqlDbType.NVarChar).Value = this.txtwherehouse_type_name_eng.Text.ToString();
                        cmd2.Parameters.Add("@txtwherehouse_type_remark", SqlDbType.NVarChar).Value = this.txtwherehouse_type_remark.Text.ToString();
                        cmd2.Parameters.Add("@txtwherehouse_type_status", SqlDbType.NChar).Value = "0";
                        //==============================

                        cmd2.ExecuteNonQuery();

                    }
                    if (this.iblword_status.Text.Trim() == "แก้ไขรหัสประเภทคลังสินค้า")
                    {
                        cmd2.CommandText = "UPDATE k013_1db_acc_15wherehouse_type SET " +
                                                                     "txtwherehouse_type_no = '" + this.txtwherehouse_type_no.Text.Trim() + "'," +
                                                                     "txtwherehouse_type_name = '" + this.txtwherehouse_type_name.Text.Trim() + "'," +
                                                                     "txtwherehouse_type_name_eng = '" + this.txtwherehouse_type_name_eng.Text.Trim() + "'," +
                                                                     "txtwherehouse_type_remark = '" + this.txtwherehouse_type_remark.Text.ToString() + "'" +
                                                                    " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                                                   " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                                                   " AND (txtwherehouse_type_id = '" + this.txtwherehouse_type_id.Text.Trim() + "')";
                        cmd2.ExecuteNonQuery();
                    ...
                    if (dialogResult == DialogResult.Yes)
                    {
                        ...
                        this.txtwherehouse_type_id.Text = "";
                        this.txtwherehouse_type_name.Text = "";
                        this.txtwherehouse_type_name_eng.Text = "";
                        this.txtwherehouse_type_remark.Text = "";
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                try
                {
                    if (this.iblword_status.Text.Trim() == "ยกเลิกเอกสาร")
                    {
                        ...
                        cmd2.CommandText = "INSERT INTO k013_1db_acc_15wherehouse_type_cancel(cdkey,txtco_id,txtbranch_id," +  //1
                                                                                                                         //"txttrans_date," +
                        ...
                        cmd2.CommandText = "INSERT INTO k013_1db_acc_15wherehouse_type_cancel_detail(cdkey,txtco_id," +  //1
                                             "txtwherehouse_type_no,txtwherehouse_type_id," +  //2
                                             "txtwherehouse_type_name,txtwherehouse_type_name_eng," +  //3
                                             "txtwherehouse_type_remark," +  //4
                                            "txtwherehouse_type_status,cancel_id) " +  //5
                                             "VALUES (@cdkey2,@txtco_id2," +  //1
                                             "@txtwherehouse_type_no,@txtwherehouse_type_id," +  //2
                                             "@txtwherehouse_type_name,@txtwherehouse_type_name_eng," +  //3
                                             "@txtwherehouse_type_remark," +  //4
                                            "@txtwherehouse_type_status,@cancel_id2)";   //5
                        ...
                        cmd2.CommandText = "DELETE FROM k013_1db_acc_15wherehouse_type" +
                                                                    " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                                                    " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                                                   " AND (txtwherehouse_type_id = '" + this.txtwherehouse_type_id.Text.Trim() + "')";
                        cmd2.ExecuteNonQuery();
                    ...
                    DialogResult dialogResult = MessageBox.Show("คุณต้องการ ยกเลิกเอกสาร รหัส  " + this.txtwherehouse_type_id.Text.ToString() + " ใช่หรือไม่่ ?", "โปรดยืนยัน", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question);
                    if (dialogResult == DialogResult.Yes)
                    {
        ...
        private void txtwherehouse_type_id_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            if (e.KeyChar == (char)Keys.Enter && this.txtwherehouse_type_id.Text == "")
            {
                this.txtwherehouse_type_id.Focus();
            }
            //========================================
            else if (e.KeyChar == (char)Keys.Enter && this.txtwherehouse_type_id.Text.Trim() != "")
            {
                this.txtwherehouse_type_no.Focus();
        ...
        private void txtwherehouse_type_no_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == (char)Keys.Enter && this.txtwherehouse_type_no.Text == "")
            {
                this.txtwherehouse_type_no.Focus();
            }
            //========================================
            else if (e.KeyChar == (char)Keys.Enter && this.txtwherehouse_type_no.Text.Trim() != "")
            {
                if (this.txtwherehouse_type_no.TextLength == 3)
                {
                    this.txtwherehouse_type_name.Focus();
            ...
            else if ((e.KeyChar > '9') && (e.KeyChar != '\b') && (e.KeyChar != '.') && txtwherehouse_type_no.Text.Length == 0)
            {
                //e.KeyChar <= '0' || 
                e.Handled = true;
                return;
        ...
        private void txtwherehouse_type_name_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
                this.txtwherehouse_type_name_eng.Focus();

        }
        private void txtwherehouse_type_name_eng_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
                this.txtwherehouse_type_remark.Focus();

        }
        private void txtwherehouse_type_name_remark_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
                this.BtnSave.Focus();
            ...
            if (OK.Trim() != "Y")
            {
                ...
                if (conn.State == System.Data.ConnectionState.Open)
                {
                    ...
                    try
                    {
                        ...
                        cmd2.Parameters.Add("@cdkey", SqlDbType.NVarChar).Value = W_ID_Select.CDKEY.Trim();
                        cmd2.Parameters.Add("@txtco_id", SqlDbType.NVarChar).Value = W_ID_Select.M_COID.Trim();
                        cmd2.Parameters.Add("@txtwherehouse_type_no", SqlDbType.NVarChar).Value = "999";
                        cmd2.Parameters.Add("@txtwherehouse_type_id", SqlDbType.NVarChar).Value = "";
                        cmd2.Parameters.Add("@txtwherehouse_type_name", SqlDbType.NVarChar).Value = "";
                        cmd2.Parameters.Add("@txtwherehouse_type_name_eng", SqlDbType.NVarChar).Value = "";
                        cmd2.Parameters.Add("@txtwherehouse_type_remark", SqlDbType.NVarChar).Value = "";
                        cmd2.Parameters.Add("@txtwherehouse_type_status", SqlDbType.NChar).Value = "0";
                        //==============================
