...
{
    public partial class Home_SETUP_Enter_2ACC_17_job : Form
    {
        //Move Form ====================================
        ...
        public Home_SETUP_Enter_2ACC_17_job()
        {
            InitializeComponent();
        }

        private void Home_SETUP_Enter_2ACC_17_Load(object sender, EventArgs e)
        {
            W_ID_Select.M_FORM_NUMBER = "S217";
            CHECK_ADD_FORM();
            ...
            this.iblword_status.Text = "เพิ่มรหัสงานใหม่";
            this.txtjob_id.ReadOnly = false;

            this.ActiveControl = this.txtjob_id;
        ...
        private void Run_ID()
        {
            if (this.txtjob_no.Text == "")
            {
                this.txtjob_no.Text = "001";
            }
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            //this.PANEL_FORM1_dataGridView1.Columns[1].Name = "Col_txtjob_no";
                            //this.PANEL_FORM1_dataGridView1.Columns[2].Name = "Col_txtjob_id";
                            //this.PANEL_FORM1_dataGridView1.Columns[3].Name = "Col_txtjob_name";
                            //this.PANEL_FORM1_dataGridView1.Columns[4].Name = "Col_txtjob_name_eng";
                            //this.PANEL_FORM1_dataGridView1.Columns[5].Name = "Col_txtjob_name_remark";
                            //this.PANEL_FORM1_dataGridView1.Columns[6].Name = "Col_txtjob_status";

                            var index = GridView1.Rows.Add();
                            GridView1.Rows[index].Cells["Col_Auto_num"].Value = ""; //0
                            GridView1.Rows[index].Cells["Col_txtjob_no"].Value = dt2.Rows[j]["txtjob_no"].ToString();      //1
                            GridView1.Rows[index].Cells["Col_txtjob_id"].Value = dt2.Rows[j]["txtjob_id"].ToString();      //2
                            GridView1.Rows[index].Cells["Col_txtjob_name"].Value = dt2.Rows[j]["txtjob_name"].ToString();      //3
                            GridView1.Rows[index].Cells["Col_txtjob_name_eng"].Value = dt2.Rows[j]["txtjob_name_eng"].ToString();      //4
                            GridView1.Rows[index].Cells["Col_txtjob_remark"].Value = dt2.Rows[j]["txtjob_remark"].ToString();      //5
                            GridView1.Rows[index].Cells["Col_txtjob_status"].Value = dt2.Rows[j]["txtjob_status"].ToString();      //6
        ...
        private void PANEL_FORM1_GridView1()
        {
            ...
            this.GridView1.Columns[1].Name = "Col_txtjob_no";
            this.GridView1.Columns[2].Name = "Col_txtjob_id";
            this.GridView1.Columns[3].Name = "Col_txtjob_name";
            this.GridView1.Columns[4].Name = "Col_txtjob_name_eng";
            this.GridView1.Columns[5].Name = "Col_txtjob_remark";
            this.GridView1.Columns[6].Name = "Col_txtjob_status";

            this.GridView1.Columns[0].HeaderText = "No";
            this.GridView1.Columns[1].HeaderText = "ลำดับ";
            this.GridView1.Columns[2].HeaderText = " รหัส";
            this.GridView1.Columns[3].HeaderText = " ชื่อรหัสงาน";
            this.GridView1.Columns[4].HeaderText = "ชื่อรหัสงาน Eng";
            ...
            this.GridView1.Columns[1].Visible = true;  //"Col_txtjob_no";
            ...
            this.GridView1.Columns[2].Visible = true;  //"Col_txtjob_id";
            ...
            this.GridView1.Columns[3].Visible = true;  //"Col_txtjob_name";
            ...
            this.GridView1.Columns[4].Visible = true;  //"Col_txtjob_name_eng";
            ...
            this.GridView1.Columns[5].Visible = true;  //"Col_txtjob_name_remark";
            ...
            this.GridView1.Columns[6].Visible = false;  //"Col_txtjob_status";
        ...
        private void PANEL_FORM1_dataGridView1_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                if (cell != null)
                {
                    ...
                    this.txtjob_no.Text = row.Cells[1].Value.ToString();
                    this.txtjob_id.Text = row.Cells[2].Value.ToString();
                    this.txtjob_name.Text = row.Cells[3].Value.ToString();
                    ...
                    if (conn.State == System.Data.ConnectionState.Open)
                    {
                        ...
                        cmd2.CommandText = "SELECT *" +
                                            " FROM k013_1db_acc_17job" +
                                             " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                             " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                             " AND (txtjob_id = '" + this.txtjob_id.Text.Trim() + "')" +
                                           " ORDER BY txtjob_no ASC";
                        ...
                        try
                        {
                            ...
                            if (dt2.Rows.Count > 0)
                            {
                                for (int j = 0; j < dt2.Rows.Count; j++)
                                {
                                    this.txtjob_no.Text = dt2.Rows[j]["txtjob_no"].ToString();      //1
                                    this.txtjob_id.Text = dt2.Rows[j]["txtjob_id"].ToString();      //2
                                    this.txtjob_name.Text = dt2.Rows[j]["txtjob_name"].ToString();      //3
                                    this.txtjob_name_eng.Text = dt2.Rows[j]["txtjob_name_eng"].ToString();      //4
                                    this.txtjob_remark.Text = dt2.Rows[j]["txtjob_remark"].ToString();      //6
                                }
                                this.iblword_status.Text = "แก้ไขรหัสงาน";
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                cmd2.CommandText = "SELECT *" +
                                    " FROM k013_1db_acc_17job" +
                                     " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                     " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                     " AND (txtjob_name LIKE '%" + this.PANEL_FORM1_txtsearch.Text.Trim() + "%')" +
                                   " ORDER BY txtjob_no ASC";
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            //this.PANEL_FORM1_dataGridView1.Columns[3].Name = "Col_txtjob_name";
                            //this.PANEL_FORM1_dataGridView1.Columns[4].Name = "Col_txtjob_name_eng";
                            //this.PANEL_FORM1_dataGridView1.Columns[5].Name = "Col_txtjob_remark";
                            //this.PANEL_FORM1_dataGridView1.Columns[6].Name = "Col_txtjob_status";
                            ...
                            GridView1.Rows[index].Cells["Col_txtjob_name"].Value = dt2.Rows[j]["txtjob_name"].ToString();      //3
                            GridView1.Rows[index].Cells["Col_txtjob_name_eng"].Value = dt2.Rows[j]["txtjob_name_eng"].ToString();      //4
                            GridView1.Rows[index].Cells["Col_txtjob_remark"].Value = dt2.Rows[j]["txtjob_remark"].ToString();      //6
                            GridView1.Rows[index].Cells["Col_txtjob_status"].Value = dt2.Rows[j]["txtjob_status"].ToString();      //7
        ...
        private void BtnNew_Click(object sender, EventArgs e)
        {
            ...
            this.Hide();
            var frm2 = new Home_SETUP_Enter_2ACC_17_job();
        ...
        private void BtnSave_Click(object sender, EventArgs e)
        {
            if (this.txtjob_no.Text == "")
            {
                ...
                this.txtjob_no.Focus();
                return;
            }
            else
            {
                if (this.txtjob_no.TextLength == 3)
                {
                }
                else
                {
            ...
            if (this.txtjob_id.Text == "")
            {
                MessageBox.Show("โปรดใส่รหัสรหัสงาน ก่อน !", "ผลการทำงาน", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                this.txtjob_id.Focus();
                return;
            }
            if (this.txtjob_name.Text == "")
            {
                MessageBox.Show("โปรดใส่ชื่อรหัสงานก่อน !", "ผลการทำงาน", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                this.txtjob_name.Focus();
                return;
            }
            ...
            //END เชื่อมต่อฐานข้อมูล=======================================================
            Cursor.Current = Cursors.WaitCursor;
            if (this.iblword_status.Text.Trim() == "เพิ่มรหัสงานใหม่")
            {
                conn.Open();
                if (conn.State == System.Data.ConnectionState.Open)
                {
                    ...
                    cmd1.CommandText = "SELECT * FROM k013_1db_acc_17job" +
                                        " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                       " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                       " AND (txtjob_id = '" + this.txtjob_id.Text.Trim() + "')";
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        MessageBox.Show("รหัสรหัสงาน นี้ซ้ำ   : '" + this.txtjob_id.Text.Trim() + "' โปรดใส่ใหม่ ", "ผลการทำงาน", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                        this.txtjob_id.Focus();
                        conn.Close();
                        return;
                    }
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                try
                {
                    if (this.iblword_status.Text.Trim() == "เพิ่มรหัสงานใหม่")
                    {
                        cmd2.CommandText = "INSERT INTO k013_1db_acc_17job(cdkey,txtco_id," +  //1
                                           "txtjob_no,txtjob_id," +  //2
                                           "txtjob_name,txtjob_name_eng," +  //3
                                          "txtjob_remark," +  //5
                                          "txtjob_status) " +  //6
                        ...
                        cmd2.Parameters.Add("@txtjob_no", SqlDbType.NVarChar).Value = this.txtjob_no.Text.ToString();
                        cmd2.Parameters.Add("@txtjob_id", SqlDbType.NVarChar).Value = this.txtjob_id.Text.ToString();
                        cmd2.Parameters.Add("@txtjob_name", SqlDbType.NVarChar).Value = this.txtjob_name.Text.ToString();
                        cmd2.Parameters.Add("@txtjob_name_eng", SqlDbType.NVarChar).Value = this.txtjob_name_eng.Text.ToString();
                        cmd2.Parameters.Add("@txtjob_remark", SqlDbType.NVarChar).Value = this.txtjob_remark.Text.ToString();
                        cmd2.Parameters.Add("@txtjob_status", SqlDbType.NChar).Value = "0";
                        //==============================

                        cmd2.ExecuteNonQuery();

                    }
                    if (this.iblword_status.Text.Trim() == "แก้ไขรหัสงาน")
                    {
                        cmd2.CommandText = "UPDATE k013_1db_acc_17job SET " +
                                                                     "txtjob_no = '" + this.txtjob_no.Text.Trim() + "'," +
                                                                     "txtjob_name = '" + this.txtjob_name.Text.Trim() + "'," +
                                                                     "txtjob_name_eng = '" + this.txtjob_name_eng.Text.Trim() + "'," +
                                                                     "txtjob_remark = '" + this.txtjob_remark.Text.ToString() + "'" +
                                                                    " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                                                   " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                                                   " AND (txtjob_id = '" + this.txtjob_id.Text.Trim() + "')";
                        cmd2.ExecuteNonQuery();
                    ...
                    if (dialogResult == DialogResult.Yes)
                    {
                        ...
                        this.txtjob_id.Text = "";
                        this.txtjob_name.Text = "";
                        this.txtjob_name_eng.Text = "";
                        this.txtjob_remark.Text = "";
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                try
                {
                    if (this.iblword_status.Text.Trim() == "ยกเลิกเอกสาร")
                    {
                        ...
                        cmd2.CommandText = "INSERT INTO k013_1db_acc_17job_cancel(cdkey,txtco_id,txtbranch_id," +  //1
                                                                                                                       //"txttrans_date," +
                        ...
                        cmd2.CommandText = "INSERT INTO k013_1db_acc_17job_cancel_detail(cdkey,txtco_id," +  //1
                                             "txtjob_no,txtjob_id," +  //2
                                             "txtjob_name,txtjob_name_eng," +  //3
                                             "txtjob_remark," +  //4
                                            "txtjob_status,cancel_id) " +  //5
                                             "VALUES (@cdkey2,@txtco_id2," +  //1
                                             "@txtjob_no,@txtjob_id," +  //2
                                             "@txtjob_name,@txtjob_name_eng," +  //3
                                             "@txtjob_remark," +  //4
                                            "@txtjob_status,@cancel_id2)";   //5
                        ...
                        cmd2.CommandText = "DELETE FROM k013_1db_acc_17job" +
                                                                    " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                                                    " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                                                   " AND (txtjob_id = '" + this.txtjob_id.Text.Trim() + "')";
                        cmd2.ExecuteNonQuery();
                    ...
                    DialogResult dialogResult = MessageBox.Show("คุณต้องการ ยกเลิกเอกสาร รหัส  " + this.txtjob_id.Text.ToString() + " ใช่หรือไม่่ ?", "โปรดยืนยัน", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question);
                    if (dialogResult == DialogResult.Yes)
                    {
        ...
        private void txtjob_id_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            if (e.KeyChar == (char)Keys.Enter && this.txtjob_id.Text == "")
            {
                this.txtjob_id.Focus();
            }
            //========================================
            else if (e.KeyChar == (char)Keys.Enter && this.txtjob_id.Text.Trim() != "")
            {
                this.txtjob_no.Focus();
        ...
        private void txtjob_no_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == (char)Keys.Enter && this.txtjob_no.Text == "")
            {
                this.txtjob_no.Focus();
            }
            //========================================
            else if (e.KeyChar == (char)Keys.Enter && this.txtjob_no.Text.Trim() != "")
            {
                if (this.txtjob_no.TextLength == 3)
                {
                    this.txtjob_name.Focus();
            ...
            else if ((e.KeyChar > '9') && (e.KeyChar != '\b') && (e.KeyChar != '.') && txtjob_no.Text.Length == 0)
            {
                //e.KeyChar <= '0' || 
                e.Handled = true;
                return;
        ...
        private void txtjob_name_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
                this.txtjob_name_eng.Focus();

        }
        private void txtjob_name_eng_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
                this.txtjob_remark.Focus();

        }
        private void txtjob_remark_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
                this.BtnSave.Focus();
            ...
            if (OK.Trim() != "Y")
            {
                ...
                if (conn.State == System.Data.ConnectionState.Open)
                {
                    ...
                    try
                    {
                        ...
                        cmd2.Parameters.Add("@cdkey", SqlDbType.NVarChar).Value = W_ID_Select.CDKEY.Trim();
                        cmd2.Parameters.Add("@txtco_id", SqlDbType.NVarChar).Value = W_ID_Select.M_COID.Trim();
                        cmd2.Parameters.Add("@txtjob_no", SqlDbType.NVarChar).Value = "999";
                        cmd2.Parameters.Add("@txtjob_id", SqlDbType.NVarChar).Value = "";
                        cmd2.Parameters.Add("@txtjob_name", SqlDbType.NVarChar).Value = "";
                        cmd2.Parameters.Add("@txtjob_name_eng", SqlDbType.NVarChar).Value = "";
                        cmd2.Parameters.Add("@txtjob_remark", SqlDbType.NVarChar).Value = "";
                        cmd2.Parameters.Add("@txtjob_status", SqlDbType.NChar).Value = "0";
                        //==============================
