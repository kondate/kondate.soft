...
{
    public partial class Home_SETUP_Enter_2ACC_08_Rport_Chart_of_accounts : Form
    {
        //Move Form ====================================
        ...
        public Home_SETUP_Enter_2ACC_08_Rport_Chart_of_accounts()
        {
            InitializeComponent();
        }

        private void Home_SETUP_Enter_2ACC_08_Rport_Chart_of_accounts_Load(object sender, EventArgs e)
        {
        ...
        private void pictureBox_top_MouseDown(object sender, MouseEventArgs e)
        {
            if (e.Button == MouseButtons.Left)
            {
                ReleaseCapture();
