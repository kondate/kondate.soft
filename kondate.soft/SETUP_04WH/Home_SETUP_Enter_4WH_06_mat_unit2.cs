...
{
    public partial class Home_SETUP_Enter_4WH_06_mat_unit2 : Form
    {
        //Move Form ====================================
        ...
        public Home_SETUP_Enter_4WH_06_mat_unit2()
        {
            InitializeComponent();
        }

        private void Home_SETUP_Enter_4WH_06_Load(object sender, EventArgs e)
        {
            W_ID_Select.M_FORM_NUMBER = "S406";
            CHECK_ADD_FORM();
            ...
            this.txtmat_unit2_id.ReadOnly = false;

            this.ActiveControl = this.txtmat_unit2_id;
        ...
        private void Run_ID()
        {
            if (this.txtmat_unit2_no.Text == "")
            {
                this.txtmat_unit2_no.Text = "001";
            }
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            //this.PANEL_FORM1_dataGridView1.Columns[1].Name = "Col_txtmat_unit2_no";
                            //this.PANEL_FORM1_dataGridView1.Columns[2].Name = "Col_txtmat_unit2_id";
                            //this.PANEL_FORM1_dataGridView1.Columns[3].Name = "Col_txtmat_unit2_name";
                            //this.PANEL_FORM1_dataGridView1.Columns[4].Name = "Col_txtmat_unit2_name_eng";
                            //this.PANEL_FORM1_dataGridView1.Columns[5].Name = "Col_txtmat_unit2_name_remark";
                            //this.PANEL_FORM1_dataGridView1.Columns[6].Name = "Col_txtmat_unit2_status";

                            var index = GridView1.Rows.Add();
                            GridView1.Rows[index].Cells["Col_Auto_num"].Value = ""; //0
                            GridView1.Rows[index].Cells["Col_txtmat_unit2_no"].Value = dt2.Rows[j]["txtmat_unit2_no"].ToString();      //1
                            GridView1.Rows[index].Cells["Col_txtmat_unit2_id"].Value = dt2.Rows[j]["txtmat_unit2_id"].ToString();      //2
                            GridView1.Rows[index].Cells["Col_txtmat_unit2_name"].Value = dt2.Rows[j]["txtmat_unit2_name"].ToString();      //3
                            GridView1.Rows[index].Cells["Col_txtmat_unit2_name_eng"].Value = dt2.Rows[j]["txtmat_unit2_name_eng"].ToString();      //4
                            GridView1.Rows[index].Cells["Col_txtmat_unit2_name_remark"].Value = dt2.Rows[j]["txtmat_unit2_name_remark"].ToString();      //5
                            GridView1.Rows[index].Cells["Col_txtmat_unit2_status"].Value = dt2.Rows[j]["txtmat_unit2_status"].ToString();      //6
        ...
        private void PANEL_FORM1_GridView1()
        {
            ...
            this.GridView1.Columns[1].Name = "Col_txtmat_unit2_no";
            this.GridView1.Columns[2].Name = "Col_txtmat_unit2_id";
            this.GridView1.Columns[3].Name = "Col_txtmat_unit2_name";
            this.GridView1.Columns[4].Name = "Col_txtmat_unit2_name_eng";
            this.GridView1.Columns[5].Name = "Col_txtmat_unit2_name_remark";
            this.GridView1.Columns[6].Name = "Col_txtmat_unit2_status";
            ...
            this.GridView1.Columns[1].Visible = true;  //"Col_txtmat_unit2_no";
            ...
            this.GridView1.Columns[2].Visible = true;  //"Col_txtmat_unit2_id";
            ...
            this.GridView1.Columns[3].Visible = true;  //"Col_txtmat_unit2_name";
            ...
            this.GridView1.Columns[4].Visible = true;  //"Col_txtmat_unit2_name_eng";
            ...
            this.GridView1.Columns[5].Visible = true;  //"Col_txtmat_unit2_name_remark";
            ...
            this.GridView1.Columns[6].Visible = false;  //"Col_txtmat_unit2_status";
        ...
        private void PANEL_FORM1_dataGridView1_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                if (cell != null)
                {
                    ...
                    this.txtmat_unit2_no.Text = row.Cells[1].Value.ToString();
                    this.txtmat_unit2_id.Text = row.Cells[2].Value.ToString();
                    this.txtmat_unit2_name.Text = row.Cells[3].Value.ToString();
                    ...
                    if (conn.State == System.Data.ConnectionState.Open)
                    {
                        ...
                        cmd2.CommandText = "SELECT *" +
                                            ...
                                            " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                            " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                             " AND (txtmat_unit2_id = '" + this.txtmat_unit2_id.Text.Trim() + "')" +
                                           " ORDER BY txtmat_unit2_no ASC";
                        ...
                        try
                        {
                            ...
                            if (dt2.Rows.Count > 0)
                            {
                                for (int j = 0; j < dt2.Rows.Count; j++)
                                {
                                    this.txtmat_unit2_no.Text = dt2.Rows[j]["txtmat_unit2_no"].ToString();      //1
                                    this.txtmat_unit2_id.Text = dt2.Rows[j]["txtmat_unit2_id"].ToString();      //2
                                    this.txtmat_unit2_name.Text = dt2.Rows[j]["txtmat_unit2_name"].ToString();      //3
                                    this.txtmat_unit2_name_eng.Text = dt2.Rows[j]["txtmat_unit2_name_eng"].ToString();      //4
                                    this.txtmat_unit2_name_remark.Text = dt2.Rows[j]["txtmat_unit2_name_remark"].ToString();      //5
                                }
                                this.iblword_status.Text = "แก้ไขหน่วยนับสินค้า";
                                this.txtmat_unit2_id.ReadOnly = true;
        ...
        private void PANEL_FORM1_btnsearch_Click(object sender, EventArgs e)
        {
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                cmd2.CommandText = "SELECT *" +
                                    ...
                                    " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                    " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                     " AND (txtmat_unit2_name LIKE '%" + this.PANEL_FORM1_txtsearch.Text.Trim() + "%')" +
                                   " ORDER BY txtmat_unit2_no ASC";
        ...
        private void BtnNew_Click(object sender, EventArgs e)
        {
            ...
            this.Hide();
            var frm2 = new Home_SETUP_Enter_4WH_06_mat_unit2();
        ...
        private void BtnSave_Click(object sender, EventArgs e)
        {
            if (this.txtmat_unit2_no.Text == "")
            {
                ...
                this.txtmat_unit2_no.Focus();
                return;
            }
            else
            {
                if (this.txtmat_unit2_no.TextLength == 3)
                {
                }
                else
                {
            ...
            if (this.iblword_status.Text.Trim() == "เพิ่มหน่วยนับสินค้าใหม่")
            {
                ...
                if (conn.State == System.Data.ConnectionState.Open)
                {
                    ...
                    cmd1.CommandText = "SELECT * FROM b001_05mat_unit2" +
                                       " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                      " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                       " AND (txtmat_unit2_id = '" + this.txtmat_unit2_id.Text.Trim() + "')";
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        MessageBox.Show("รหัสหน่วยนับสินค้า นี้ซ้ำ   : '" + this.txtmat_unit2_id.Text.Trim() + "' โปรดใส่ใหม่ ", "ผลการทำงาน", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                        this.txtmat_unit2_id.Focus();
                        conn.Close();
                        return;
                    }
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                try
                {
                    if (this.iblword_status.Text.Trim() == "เพิ่มหน่วยนับสินค้าใหม่")
                    {
                        cmd2.CommandText = "INSERT INTO b001_05mat_unit2(cdkey,txtco_id," +  //1
                                           "txtmat_unit2_no,txtmat_unit2_id," +  //2
                                           "txtmat_unit2_name,txtmat_unit2_name_eng," +  //3
                                           "txtmat_unit2_name_remark," +  //4
                                          "txtmat_unit2_status) " +  //5
                        ...
                        cmd2.Parameters.Add("@txtmat_unit2_no", SqlDbType.NVarChar).Value = this.txtmat_unit2_no.Text.ToString();
                        cmd2.Parameters.Add("@txtmat_unit2_id", SqlDbType.NVarChar).Value = this.txtmat_unit2_id.Text.ToString();
                        cmd2.Parameters.Add("@txtmat_unit2_name", SqlDbType.NVarChar).Value = this.txtmat_unit2_name.Text.ToString();
                        cmd2.Parameters.Add("@txtmat_unit2_name_eng", SqlDbType.NVarChar).Value = this.txtmat_unit2_name_eng.Text.ToString();
                        cmd2.Parameters.Add("@txtmat_unit2_name_remark", SqlDbType.NVarChar).Value = this.txtmat_unit2_name_remark.Text.ToString();
                        cmd2.Parameters.Add("@txtmat_unit2_status", SqlDbType.NChar).Value = "0";
                        //==============================
                    ...
                    {
                        cmd2.CommandText = "UPDATE b001_05mat_unit2 SET " +
                                                                     "txtmat_unit2_no = '" + this.txtmat_unit2_no.Text.Trim() + "'," +
                                                                     "txtmat_unit2_name = '" + this.txtmat_unit2_name.Text.Trim() + "'," +
                                                                     "txtmat_unit2_name_eng = '" + this.txtmat_unit2_name_eng.Text.Trim() + "'," +
                                                                     "txtmat_unit2_name_remark = '" + this.txtmat_unit2_name_remark.Text.ToString() + "'" +
                                                                    " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                                                   " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                                                   " AND (txtmat_unit2_id = '" + this.txtmat_unit2_id.Text.Trim() + "')";
                        cmd2.ExecuteNonQuery();
                    ...
                    if (dialogResult == DialogResult.Yes)
                    {
                        ...
                        this.txtmat_unit2_id.Text = "";
                        this.txtmat_unit2_name.Text = "";
                        this.txtmat_unit2_name_eng.Text = "";
                        this.txtmat_unit2_name_remark.Text = "";
            ...
            if (conn.State == System.Data.ConnectionState.Open)
            {
                ...
                try
                {
                    if (this.iblword_status.Text.Trim() == "ยกเลิกเอกสาร")
                    {
                        ...
                        cmd2.CommandText = "INSERT INTO b001_05mat_unit2_cancel(cdkey,txtco_id,txtbranch_id," +  //1
                                                                                                                 //"txttrans_date," +
                        ...
                        cmd2.CommandText = "INSERT INTO b001_05mat_unit2_cancel_detail(cdkey,txtco_id," +  //1
                                             "txtmat_unit2_no,txtmat_unit2_id," +  //2
                                             "txtmat_unit2_name,txtmat_unit2_name_eng," +  //3
                                             "txtmat_unit2_name_remark," +  //4
                                            "txtmat_unit2_status,cancel_id) " +  //5
                                             "VALUES (@cdkey2,@txtco_id2," +  //1
                                             "@txtmat_unit2_no,@txtmat_unit2_id," +  //2
                                             "@txtmat_unit2_name,@txtmat_unit2_name_eng," +  //3
                                             "@txtmat_unit2_name_remark," +  //4
                                            "@txtmat_unit2_status,@cancel_id2)";   //5
                        ...
                        cmd2.CommandText = "DELETE FROM b001_05mat_unit2" +
                                                                    " WHERE (cdkey = '" + W_ID_Select.CDKEY.Trim() + "')" +
                                                                    " AND (txtco_id = '" + W_ID_Select.M_COID.Trim() + "')" +
                                                                   " AND (txtmat_unit2_id = '" + this.txtmat_unit2_id.Text.Trim() + "')";
                        cmd2.ExecuteNonQuery();
                    ...
                    DialogResult dialogResult = MessageBox.Show("คุณต้องการ ยกเลิกเอกสาร รหัส  " + this.txtmat_unit2_id.Text.ToString() + " ใช่หรือไม่่ ?", "โปรดยืนยัน", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question);
                    if (dialogResult == DialogResult.Yes)
                    {
        ...
        private void txtmat_unit2_id_KeyPress(object sender, KeyPressEventArgs e)
        {
...
&& e.KeyChar != 'T' && e.KeyChar != 'U' && e.KeyChar != 'V' && e.KeyChar != 'W' && e.KeyChar != 'X' && e.KeyChar != 'Y' && e.KeyChar != 'Z'
            ...
            if (e.KeyChar == (char)Keys.Enter && this.txtmat_unit2_id.Text == "")
            {
                this.txtmat_unit2_id.Focus();
            }
            //========================================
            else if (e.KeyChar == (char)Keys.Enter && this.txtmat_unit2_id.Text.Trim() != "")
            {
                this.txtmat_unit2_no.Focus();
        ...
        private void txtmat_unit2_no_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == (char)Keys.Enter && this.txtmat_unit2_no.Text == "")
            {
                this.txtmat_unit2_no.Focus();
            }
            //========================================
            else if (e.KeyChar == (char)Keys.Enter && this.txtmat_unit2_no.Text.Trim() != "")
            {
                if (this.txtmat_unit2_no.TextLength == 3)
                {
                    this.txtmat_unit2_name.Focus();
            ...
            else if ((e.KeyChar > '9') && (e.KeyChar != '\b') && (e.KeyChar != '.') && txtmat_unit2_no.Text.Length == 0)
            {
                //e.KeyChar <= '0' || 
                e.Handled = true;
                return;
        ...
        private void txtmat_unit2_name_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
                this.txtmat_unit2_name_eng.Focus();

        }

        private void txtmat_unit2_name_eng_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
                this.txtmat_unit2_name_remark.Focus();

        }

        private void txtmat_unit2_name_remark_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
                this.BtnSave.Focus();
            ...
            if (OK.Trim() != "Y")
            {
                ...
                if (conn.State == System.Data.ConnectionState.Open)
                {
                    ...
                    try
                    {
                        ...
                        cmd2.Parameters.Add("@cdkey", SqlDbType.NVarChar).Value = W_ID_Select.CDKEY.Trim();
                        cmd2.Parameters.Add("@txtco_id", SqlDbType.NVarChar).Value = W_ID_Select.M_COID.Trim();
                        cmd2.Parameters.Add("@txtmat_unit2_no", SqlDbType.NVarChar).Value = "999";
                        cmd2.Parameters.Add("@txtmat_unit2_id", SqlDbType.NVarChar).Value = "";
                        cmd2.Parameters.Add("@txtmat_unit2_name", SqlDbType.NVarChar).Value = "";
                        cmd2.Parameters.Add("@txtmat_unit2_name_eng", SqlDbType.NVarChar).Value = "";
                        cmd2.Parameters.Add("@txtmat_unit2_name_remark", SqlDbType.NVarChar).Value = "";
                        cmd2.Parameters.Add("@txtmat_unit2_status", SqlDbType.NChar).Value = "0";
                        //==============================
