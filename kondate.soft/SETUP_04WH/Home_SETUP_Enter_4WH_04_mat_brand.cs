...
{
    public partial class Home_SETUP_Enter_4WH_04_mat_brand : Form
    {
        //Move Form ====================================
        ...
        public Home_SETUP_Enter_4WH_04_mat_brand()
        {
            InitializeComponent();
        }
                ...
                try
                {
                    ...
                    if (dt2.Rows.Count > 0)
                    {
                        for (int j = 0; j < dt2.Rows.Count; j++)
                        {
                            ...
                            GridView1.Rows[index].Cells["Col_txtmat_brand_no"].Value = dt2.Rows[j]["txtmat_brand_no"].ToString();      //1
                            GridView1.Rows[index].Cells["Col_txtmat_brand_id"].Value = dt2.Rows[j]["txtmat_brand_id"].ToString();      //2
                            GridView1.Rows[index].Cells["Col_txtmat_brand_name"].Value = dt2.Rows[j]["txtmat_brand_name"].ToString();      //3
                            GridView1.Rows[index].Cells["Col_txtmat_brand_name_eng"].Value = dt2.Rows[j]["txtmat_brand_name_eng"].ToString();      //4
                            GridView1.Rows[index].Cells["Col_txtmat_brand_name_remark"].Value = dt2.Rows[j]["txtmat_brand_name_remark"].ToString();      //5
                            GridView1.Rows[index].Cells["Col_txtmat_brand_status"].Value = dt2.Rows[j]["txtmat_brand_status"].ToString();      //6
        ...
        private void PANEL_FORM1_GridView1()
        {
            ...
            this.GridView1.Columns[1].Name = "Col_txtmat_brand_no";
            this.GridView1.Columns[2].Name = "Col_txtmat_brand_id";
            this.GridView1.Columns[3].Name = "Col_txtmat_brand_name";
            this.GridView1.Columns[4].Name = "Col_txtmat_brand_name_eng";
            this.GridView1.Columns[5].Name = "Col_txtmat_brand_name_remark";
            this.GridView1.Columns[6].Name = "Col_txtmat_brand_status";

            this.GridView1.Columns[0].HeaderText = "No";
            this.GridView1.Columns[1].HeaderText = "ลำดับ";
            this.GridView1.Columns[2].HeaderText = " รหัสยี่ห้อ";
            this.GridView1.Columns[3].HeaderText = " ชื่อยี่ห้อสินค้า";
            this.GridView1.Columns[4].HeaderText = "ชื่อยี่ห้อสินค้า Eng";
            ...
            this.GridView1.Columns[1].Visible = true;  //"Col_txtmat_brand_no";
            ...
            this.GridView1.Columns[2].Visible = true;  //"Col_txtmat_brand_id";
            ...
            this.GridView1.Columns[3].Visible = true;  //"Col_txtmat_brand_name";
            ...
            this.GridView1.Columns[4].Visible = true;  //"Col_txtmat_brand_name_eng";
            ...
            this.GridView1.Columns[5].Visible = true;  //"Col_txtmat_brand_name_remark";
            ...
            this.GridView1.Columns[6].Visible = false;  //"Col_txtmat_brand_status";
        ...
        private void BtnNew_Click(object sender, EventArgs e)
        {
            ...
            this.Hide();
            var frm2 = new Home_SETUP_Enter_4WH_04_mat_brand();
